...
BitMapProgress::BitMapProgress() : m_BackColor(0) {}
...
void BitMapProgress::OnPaint() {
  ...
  if ((HBITMAP)m_cbForeground != NULL) {
    ...
    StretchBlt(dc.GetSafeHdc(), rect.left, rect.top, rect.right, rect.bottom,
               memdc, ForegroundRect.left, ForegroundRect.top,
               ForegroundRect.right, ForegroundRect.bottom, SRCCOPY);
