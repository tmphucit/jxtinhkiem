...
cDoodad::~cDoodad() { Clear(); }

/**************************************************************************/
// com interface
/**************************************************************************/
ULONG cDoodad::AddRef() { return ++m_ulCount; }
...
// graphics
/**************************************************************************/
iGraphics *cDoodad::GetGraphics() { return cStatus::GetGraphics(); }

iGround *cDoodad::GetGround() { return cStatus::GetGround(); }

iCamera *cDoodad::GetCamera() { return cStatus::GetCamera(); }

void cDoodad::BeginMacroCommand() { cStatus::BeginMacroCommand(); }

void cDoodad::EndMacroCommand() { cStatus::EndMacroCommand(); }
...
void cDoodad::Save() { SaveAs(m_strName); }
