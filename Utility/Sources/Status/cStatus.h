...
public:
  ...
  static void SetStatus(eStatusType e) {
    ASSERT(e != STATUS_NULL);
    m_eStatus = e;
  }
  ...
  static void SetSelectFile(LPCSTR s, int n) {
    m_strSelectFile = s;
    m_nFrame = n;
  }
  ...
  static eMaskSetting FindFileAndGetValue(LPCSTR szFile, LPCSTR szPath,
                                          stSetting &set);
  ...
  //	static BOOL			GetFileValue(LPCSTR szFile,LPCSTR sKey,
  // CString& sValue);

  static BOOL Create(iGraphics *p, CWnd *pWnd,
  ...
  static BOOL GetIniFile(const CString &strEvent, long lID,
                         const CString &sDynamic, CString &sini);
  static BOOL cStatus::GetObjIniFile(iObj *p, CString &sini);
  //	static BOOL GetIniFile(const CString& strEvent,const CString&
  // sEvent,CString& sini); 	static BOOL GetObjIniFile(iObj* p,CString&
  // sini);
