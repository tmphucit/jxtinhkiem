...
cStatusGroup::~cStatusGroup() { Clear(); }
...
BOOL cStatusGroup::OnCameraMove(CPoint point) { return MoveSelect(point); }
...
// Doodad
/////////////////////////////////////////////////////////////////////
BOOL cStatusGroup::SelectDoodad(cPoint point1, cPoint point2,
                                cDoodad *&pDoodad) {
  if (pDoodad == NULL)
