...
public:
  ...
  enum GameStatusEnum {
    ...
    GameStatus_ConnectFailed,
    GameStatus_AccountVerify,
    GameStatus_AccountVerifying,
    GameStatus_AccountVerifyBack,
    GameStatus_AccountVerifyFailed,
    GameStatus_ChoosePlayer,
    GameStatus_ChoosePlayering,
    GameStatus_ChoosePlayerBack,
    GameStatus_ChoosePlayerFailed,
    GameStatus_Reconnected,
    GameStatus_ServerDown,
    GameStatus_AccountGrab,
    GameStatus_Play,
    GameStatus_Clear,
  };
