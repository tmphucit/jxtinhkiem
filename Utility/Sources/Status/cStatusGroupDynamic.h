...
#if !defined(                                                                  \
    AFX_CSTATUSGROUPDYNAMIC_H__8E949DB1_39DB_4239_AD1D_178BDA73F2D5__INCLUDED_)
...
public:
  ...
  // virtual void AfterCreatePlane(iObj* pPlane,const CString&
  // m_strCopyDataFile);
  virtual void AfterCreatePlane(iObj *pPlane, const CString &m_strSelectFile,
