...
cStatusRegion::cStatusRegion() { m_pRegion = NULL; }

cStatusRegion::~cStatusRegion() { Clear(); }
...
iRegion *cStatusRegion::GetCurrentRegion() { return m_pRegion; }
...
//////////////////////////////////////////////////////////////////////
// virtual call back
BOOL cStatusRegion::OnSelectedFile(LPCTSTR szFile, int nFrame) { return FALSE; }
