...
cStatusObstacle::~cStatusObstacle() { Clear(); }
...
// create
/////////////////////////////////////////////////////////////////////
int cStatusObstacle::GetPointNum() { return m_nPoint; }
...
void cStatusObstacle::AddSelectPoint(iObj *p) {
  ...
  if (param.iPoint > 0) {
    param.aPoint[param.iPoint] =
        param.aPoint[param.iPoint - 1] + param.aPoint[param.iPoint + 1];
...
void cStatusObstacle::OffsetObstalcePoint(iObj *pObstacle, int iPoint,
                                          cPoint ptOffset) {
  cAssertValue assertPointNum(m_nPoint, MAX_POINT);
