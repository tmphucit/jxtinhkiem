...
cStatusGroupDynamic::cStatusGroupDynamic() { m_pDynamic = new cStatusDynamic; }

cStatusGroupDynamic::~cStatusGroupDynamic() { delete m_pDynamic; }
...
void cStatusGroupDynamic::AfterCreatePlane(iObj *pPlane,
...
BOOL cStatusGroupDynamic::SelectDoodad(cPoint point1, cPoint point2,
                                       cDoodad *&pDoodad) {
  m_stSelect.eType = SelectType_Dynamic;
