...
#if !defined(                                                                  \
    AFX_CSTATUSDYNAMIC_H__4016F43B_A6EB_4EE9_A2D3_98234EC11773__INCLUDED_)
...
public:
  ...
  BOOL ShowNpcSetting(iObj *pPlane, const CString &strTemplate,
                      const CString &strSection, const CString &strID);
  BOOL ShowBoxSetting(iObj *pPlane, const CString &strTemplate,
                      const CString &strSection, const CString &strID);
  BOOL ShowTrapSetting(iObj *pPlane, const CString &strTemplate,
                       const CString &strSection, const CString &strID);
  ...
  BOOL SetObjTemplate(iObj *pPlane, const CString &strTemplate,
  ...
  BOOL AfterCreatePlane(iObj *pPlane, const CString &m_strSelectFile,
