...
// common.lib message.lib image.lib graphics.lib command.lib automap.lib
// graphicsutility.lib status.lib
...
BOOL CWorldEditorApp::InitInstance() {
  ...
  pDocTemplate =
      new CSingleDocTemplate(IDR_MAINFRAME, RUNTIME_CLASS(CWorldEditorDoc),
...
void AppParsePathNameExt(LPCSTR sFullPath, CString& sPath, CString& sName,
CString& sExt)
{
        CString szFullPath = sFullPath;
        int pos = szFullPath.ReverseFind('\\');
