...
BOOL CGraphicsWnd::Create(CMainFrame *pParentWnd) {
  ...
  BOOL b = CWnd::CreateEx(
      NULL, AfxRegisterWndClass(CS_HREDRAW | CS_VREDRAW | CS_DBLCLKS),
      "edit Window", style, r, pParentWnd, 0);
...
BOOL CGraphicsWnd::Redo() { return m_pMachine->Redo(); }

BOOL CGraphicsWnd::Undo() { return m_pMachine->Undo(); }

BOOL CGraphicsWnd::CanRedo() { return m_pMachine->CanRedo(); }

BOOL CGraphicsWnd::CanUndo() { return m_pMachine->CanUndo(); }

BOOL CGraphicsWnd::RedoToEnd() { return m_pMachine->RedoToEnd(); }

BOOL CGraphicsWnd::UndoToBegin() { return m_pMachine->UndoToBegin(); }
