...
CMainFrame::~CMainFrame() { SAFE_DELETE(m_pWnd); }
...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT &cs) {
  ...
  cs.style = WS_OVERLAPPED | WS_CAPTION | FWS_ADDTOTITLE | WS_THICKFRAME |
             WS_SYSMENU | WS_MAXIMIZE | WS_MINIMIZEBOX;
...
BOOL CMainFrame::OnNewDocument() { return m_pWnd->OnNewDocument(); }
...
void CMainFrame::OnEditRedo() { m_pWnd->Redo(); }

void CMainFrame::OnEditUndo() { m_pWnd->Undo(); }

void CMainFrame::OnEditRedotoend() { m_pWnd->RedoToEnd(); }

void CMainFrame::OnEditUndotobegin() { m_pWnd->UndoToBegin(); }
...
void CMainFrame::OnToolsMapconvert() { OnExecute("\\MapConvert.exe"); }

void CMainFrame::OnToolsResourceeditor() { OnExecute("\\ResourceManager.exe"); }

void CMainFrame::OnFilePrint() { m_pWnd->PrintScreen(); }

void CMainFrame::OnToolsImagecreate() { OnExecute("\\ImageCreate.exe"); }
