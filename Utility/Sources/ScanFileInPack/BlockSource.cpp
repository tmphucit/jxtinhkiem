...
const BlockSource &BlockSource::operator<<(iostream &DataStream) {
  ...
  /*int Pos = DataStream.tellg();
    ...
    m_BlockLength =
    ComputeBlockSize(m_UnCompressBlockLength,m_BlockPoint.GetStreamPointToData()
    );
...
BlockSource::BlockSource(int ID, int DataLength, int UnCompressLength,
                         char CompressMethod, DataPointFromStream &Point)
    : m_BlockID(ID), m_UnCompressBlockLength(UnCompressLength),
      m_BlockPoint(Point), m_BlockLength(DataLength),
      m_CompressMethod(CompressMethod) {}

unsigned char BlockSource::GetCompressMethod() { return m_CompressMethod; }
long BlockSource::GetUnCompressBlockLength() { return m_UnCompressBlockLength; }
