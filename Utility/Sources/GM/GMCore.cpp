...
KGameMasterCore::KGameMasterCore(ISystemOnline *pISO) {
  ...
  br = ini.GetString("System", "IP", "192.168.20.15",
  ...
  br = ini.GetInteger("System", "AutoCheckInterval", 10000,
                      &nOnlineRegisterAutoCheckInterval);
  // KS_CHECK_BOOLEX(br, hr = E_FAIL);
...
// gameworld
HRESULT KGameMasterCore::GetPlayerAccount(LPCSTR szPlayerName,
                                          BSTR *pbstrAccountArray) {
  // todo...
  return E_NOTIMPL;
}
