...
_declspec(dllexport) HRESULT GU_CameraScreenToGroundScale(iGraphics *pGraphics,
                                                          cPoint ptScreen,
                                                          cPoint &ptGround) {
...
_declspec(dllexport) HRESULT GU_OffsetCameraToScale(iGraphics *pGraphics,
                                                    cPoint ptOffset) {
  ptOffset.x /= c_fScale;
  ptOffset.y /= c_fScale;
  ptOffset.z /= c_fScale;
...
_declspec(dllexport) HRESULT GU_GetCameraOffsetScale(iGraphics *pGraphics,
                                                     cPoint &ptOffset) {
...
_declspec(dllexport) HRESULT GU_OffsetLightToScale(iObj *pObj,
                                                   cPoint ptOffset) {
  ptOffset.x /= c_fScale;
  ptOffset.y /= c_fScale;
  ptOffset.z /= c_fScale;
...
_declspec(dllexport) HRESULT GU_OffsetMissleToScale(iObj *pObj,
                                                    cPoint ptOffset) {
  ptOffset.x /= c_fScale;
  ptOffset.y /= c_fScale;
  ptOffset.z /= c_fScale;
...
//[ground]
//////////////////////////////////////////////////////////////////////////////
_declspec(dllexport) HRESULT GU_LoadGround(iGraphics *pGraphics,
                                           LPCSTR szFile) {
  HRESULT hr = 0;
...
//[camera]
//////////////////////////////////////////////////////////////////////////////
_declspec(dllexport) HRESULT GU_GetCameraOffset(iGraphics *pGraphics,
                                                cPoint &ptTo) {
  iCamera::stParam param;
  param.mask = 0;
  pGraphics->GetiCamera()->GetParam(param);
...
_declspec(dllexport) HRESULT GU_OffsetCameraTo(iGraphics *pGraphics,
                                               cPoint ptTo) {
  iCamera::stParam param;
  param.ptTo = ptTo;
...
_declspec(dllexport) HRESULT GU_CameraScreenToGround(iGraphics *pGraphics,
                                                     cPoint ptScreen,
                                                     cPoint &ptGround) {
  pGraphics->GetiCamera()->ScreenToGround(ptScreen, ptGround);
  return 0;
...
//[map]
//////////////////////////////////////////////////////////////////////////////
_declspec(dllexport) HRESULT GU_GetMapClickPos(iObj *pObj, CPoint ptScreen,
                                               cPoint &ptGround) {
  stMapParam param;
...
_declspec(dllexport) HRESULT GU_GetMapSmallClickPos(iObj *pObj, CPoint ptScreen,
                                                    cPoint &ptGround) {
...
//[obstacle]
//////////////////////////////////////////////////////////////////////////////
_declspec(dllexport) HRESULT GU_SetObstaclePointinfo(iObj *pObj,
...
//[light]
//////////////////////////////////////////////////////////////////////////////
_declspec(dllexport) HRESULT GU_CreateLight(iGraphics *pGraphcis, iObj *&pObj,
                                            float fRange, cColor cr) {
  HRESULT hr;
...
_declspec(dllexport) HRESULT GU_SetEnvironmentBrightness(iGraphics *pGraphics,
                                                         int nBrightness) {
  iGround::stParam st;
...
_declspec(dllexport) HRESULT GU_CreateObj(iGraphics *pGraphcis, iObj *&pObj) {
  ...
  param.SetMask(
      ...
      stPlaneParam::MASK_PLANE_ANGLEXY | stPlaneParam::MASK_PLANE_ANGLEZ |
          stPlaneParam::MASK_PLANE_LIGHTING | stPlaneParam::MASK_PLANE_LIGHTED |
          stPlaneParam::MASK_PLANE_CENTER | stPlaneParam::MASK_PLANE_TYPE);
...
_declspec(dllexport) HRESULT GU_GetObjDynamic(iObj *pObj,
                                              DynamicEnum &lDynamic) {
  HRESULT hr = 0;
  if (pObj == NULL)
    return hr;
  stGroundObjParam param;
...
_declspec(dllexport) HRESULT GU_SetObjDynamic(iObj *pObj,
...
GU_ChangeObjAnimationArray(iObj *pObj, stResourceArray &stResArray) {
  HRESULT hr = 0;
  if (pObj == NULL)
    return hr;
...
//[missle]
//////////////////////////////////////////////////////////////////////////////
_declspec(dllexport) HRESULT GU_CreateMissle(iGraphics *pGraphcis,
                                             iObj *&pObj) {
  HRESULT hr;
...
_declspec(dllexport) HRESULT GU_ChangeMissleDirection(iObj *pObj,
                                                      int nDirection) {
  HRESULT hr = 0;
  if (pObj == NULL)
    return hr;
...
_declspec(dllexport) HRESULT GU_ChangeMissleAnimation(iObj *pObj,
                                                      LPCSTR szSpr) {
  HRESULT hr = 0;
  if (pObj == NULL)
    return hr;
...
_declspec(dllexport) HRESULT GU_ChangeMissleAniSpeed(iObj *pObj, int nAniSpeed,
                                                     BOOL bAniLoop) {
  HRESULT hr = 0;
  if (pObj == NULL)
    return hr;
...
//[menu]
//////////////////////////////////////////////////////////////////////////////
_declspec(dllexport) HRESULT GU_GetSprSize(iGraphics *pGraphcis, LPCSTR szSpr,
                                           long &width, long &height) {
  return 0;
}
_declspec(dllexport) HRESULT GU_GetSprSize(iGraphics *pGraphcis, LPCSTR szSpr,
                                           int frame, long &width,
                                           long &height) {
  return 0;
}
_declspec(dllexport) HRESULT GU_GetSprAlpha(iGraphics *pGraphcis, LPCSTR szSpr,
                                            int frame, POINT pt, BYTE &alpha) {
  return 0;
}
_declspec(dllexport) HRESULT GU_GetSprInfo(iGraphics *pGraphcis, LPCSTR szSpr,
                                           int &frame, int &nInterval) {
  return 0;
}

_declspec(dllexport) HRESULT GU_GetSprReferenceSpot(iGraphics *pGraphcis,
                                                    LPCSTR szSpr, int &h,
                                                    int &v) {
  return 0;
}
...
_declspec(dllexport) HRESULT GU_SetMenuSpr(iObj *pObj, LPCSTR szFile,
                                           int iFrame) {
  HRESULT hr = 0;
  if (pObj == NULL)
    return hr;
