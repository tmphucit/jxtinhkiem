...
struct ISystemEvent {
  ...
  virtual void STDMETHODCALLTYPE PlayerAccountAtGW(char *szAccount,
                                                   DWORD nIP) = 0;
...
struct ISystemConnect {
  ...
  virtual void STDMETHODCALLTYPE SetOption(bool bOnlinePlayer,
                                           bool bRegisterUser,
                                           DWORD nAutoTime) = 0;
  ...
  virtual void STDMETHODCALLTYPE SetPlayerInfo(char *szAccount, WORD ninfo,
                                               void *pData,
                                               size_t dataLength) = 0;
  virtual void STDMETHODCALLTYPE SendMessage(char *szAccount,
                                             char *szMessage) = 0;
