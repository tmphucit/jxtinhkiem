...
cScreenObj::cScreenObj(cGraphics *p) : cObj(p) { m_bInScreen = false; }
...
////////////////////////////////////////////////////////////////////////////
// graphics
cScreen *cScreenObj::GetScreen() { return GetGraphics()->GetcScreen(); }
...
void cScreenObj::Offset(POINT pt) { SetOffset(pt); }
