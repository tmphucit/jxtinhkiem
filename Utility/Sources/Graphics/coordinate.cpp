...
_declspec(dllexport) void TileToDiamond(float x, float y, float &tx,
                                        float &ty) {
  float w = 2.f;
  float h = 1.f;
...
_declspec(dllexport) void DiamondToTile(float x, float y, float &tx,
                                        float &ty) {
  float w = 2.f;
  float h = 1.f;
...
_declspec(dllexport) void TileToDiamondTile(float x, float y, float &tx,
                                            float &ty) {
  float fx, fy;
...
_declspec(dllexport) void TileToDiamondSmallTile(float x, float y, float &tx,
                                                 float &ty) {
  float fx, fy;
