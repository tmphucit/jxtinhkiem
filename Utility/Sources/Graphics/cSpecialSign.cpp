...
const CString c_aStrItem[] = {
    "elementtype", "sign的起始点", "sign的终点", "color", "",
};

const CString *cSpecialSign::GetItemStringArray() { return c_aStrItem; }

const CString c_aStrDescription[] = {
    "不能修改", "不能修改", "cPoint", "cColor", "",
};
...
cPoint cSpecialSign::GetDrawPoint() { return m_param.ptStart; }
