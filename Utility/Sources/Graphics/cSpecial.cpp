...
// graphics
cScreen *cSpecial::GetScreen() { return GetGraphics()->GetcScreen(); }

cGround *cSpecial::GetGround() { return GetGraphics()->GetcGround(); }

cCamera *cSpecial::GetCamera() { return GetGraphics()->GetcCamera(); }
//////////////////////////////////////////////////////////////////////
// com
//////////////////////////////////////////////////////////////////////
ULONG cSpecial::AddRef() { return ++m_ulCount; }
...
HRESULT cSpecial::GetParam(int index, CString &szItem, CString &szValue,
...
// param
//////////////////////////////////////////////////////////////////////
cPoint cSpecial::GetDrawPoint() { return GetCamera()->GetFocus(); }
