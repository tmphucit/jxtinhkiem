...
// com
/**************************************************************************/
ULONG cObj::AddRef() { return ++m_ulCount; }
...
// Graphics
/**************************************************************************/
LPDIRECT3DDEVICE8 cObj::GetDevice() { return GetGraphics()->GetDevice3D(); }
...
HRESULT cObj::OnCommand(long eCommand, stObjParam &param) { return 0; }
