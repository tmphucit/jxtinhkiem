...
cMesh3D::~cMesh3D() { FinalCleanup(); }

LPDIRECT3DDEVICE8 cMesh3D::GetDevice() { return GetGraphics()->GetDevice3D(); }
...
HRESULT cMesh3D::DrawHor() {
  ...
  GetDevice()->DrawIndexedPrimitive(D3DPT_TRIANGLELIST, 0, m_nVertexs, 0,
                                    nFaces);
  return hr;
}
