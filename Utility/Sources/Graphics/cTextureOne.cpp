...
cTextureOne::~cTextureOne() { FinalCleanup(); }
...
ULONG cTextureOne::GetFrames() { return GetTextureSpr()->GetFrames(); }

ULONG cTextureOne::GetDirections() { return GetTextureSpr()->GetDirections(); }
