...
// Purpose		: 释放接口实例对象
*****************************************************************************/
void KFont::Release() { delete this; }
...
*****************************************************************************/
void KFont::DrawCharacter(int x, int y, unsigned char cFirst,
...
/*!*****************************************************************************
// Function		: KFont::TextOut
// Purpose		: 在Device由lost state恢复为operational
state后KFont作Device相关内容的恢复操作。
*****************************************************************************/
bool KFont::RestoreDeviceObjects() { return true; }
