...
cPicture::~cPicture() { FinalCleanup(); }
...
void cPicture::UpdateVertexBuffer() {
  ...
  cRect rUV((float)rc.left / wTex, (float)rc.top / hTex, (float)rc.right / wTex,
            (float)rc.bottom / hTex);
...
// draw
/**************************************************************************/
BOOL cPicture::IsShow() { return GetGraphics()->IsShow(iGraphics::GS_PICTURE); }
