...
ULONG cTexture::AddRef() { return ++m_ulCount; }
...
ULONG cTexture::GetCount() { return m_ulCount; }
...
UsageEnum cTexture::GetUsage() { return m_stResA.stDevice.eUsage; }

D3DFORMAT cTexture::GetResD3DFormat() { return m_stResA.stDevice.format; }

D3DPOOL cTexture::GetResD3DPool() { return m_stResA.stDevice.pool; }

DWORD cTexture::GetResD3DUsage() { return m_stResA.stDevice.usage; }

//////////////////////////////////////////////////////////////////////
// use
//////////////////////////////////////////////////////////////////////
void cTexture::ResetUsed() { m_used.Reset(); }

void cTexture::Used() { m_used.Used(); }

UsedEnum cTexture::GetUsed() { return m_used.GetUsed(); }
...
BOOL cTexture::IsValid() { return m_bInvalid; }
...
void cTexture::Trace() {
  ...
  sMessage.Format("file %s(%d), used %d,%d,%d,%d\n", m_stResA.stRes.szResource,
                  m_stResA.stRes.idResource, size[0], size[1], size[2],
                  size[3]);
