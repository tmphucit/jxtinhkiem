...
_declspec(dllexport) void AppParsePathName(LPCSTR sFullPath, CString &sPath,
                                           CString &sName) {
  CString szFullPath = sFullPath;
  int pos = szFullPath.ReverseFind('\\');
  ASSERT(pos != -1);
...
_declspec(dllexport) void AppParseFileName(LPCSTR sFile, CString &sName,
                                           CString &sExt) {
  sName = sFile;
...
_declspec(dllexport) void AppParsePathNameExt(LPCSTR sFullPath, CString &sPath,
                                              CString &sName, CString &sExt) {
  CString szFullPath = sFullPath;
  int pos = szFullPath.ReverseFind('\\');
  ASSERT(pos != -1);
  sPath = szFullPath.Left(pos);
...
////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////
_declspec(dllexport) BOOL AppCopyFile(LPCSTR szSrc, LPCSTR szDes,
                                      BOOL bFailIfExists) {
  AppBuildPath(szDes);
...
_declspec(dllexport) BOOL AppBuildPath(LPCSTR szDes) {
  ...
  do {
    ...
    if (!strSub.IsEmpty() && !b) {
      ...
      if (!b) {
        /*
                                        CString strMsg = "copy file failure for
           can not create dir: "; strMsg += strSub; AfxMessageBox(strMsg);
                                        return false;
        */
      }
    }
...
////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////
BOOL AppFindFileA(LPCSTR sFileName, LPCSTR lpszFolderPathName,
                  CString &sPathName) {
  CFileFind finder;
  CString strPattern;
...
_declspec(dllexport) BOOL AppFindFile(LPCSTR sFileName,
                                      LPCSTR lpszFolderPathName,
                                      CString &sPathName) {
...
_declspec(dllexport) BOOL AppGetFileDialog(CString &strFile, LPCSTR szPath,
                                           LPCSTR szFilter, BOOL Load) {
  char tmp[256];
  strcpy(tmp, szFilter);
  OPENFILENAME ofn;
...
////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////
_declspec(dllexport) BOOL AppOpenFile(CFile &file, LPCSTR FileName, long flag,
                                      LPCSTR szLocate) {
