...
public:
	...
	void SendRelayAccountData(char* szAccount, const void * const pSrcData1, const size_t& datalength1, const void * const pSrcData2 = NULL, const size_t& datalength2 = 0);
	void SendRelayRoleData(char* szRole, DWORD nIP, DWORD nToRelayID, DWORD nFromRelayID, const void * const pSrcData1, const size_t& datalength1, const void * const pSrcData2 = NULL, const size_t& datalength2 = 0);
	void SendRelayData(DWORD nIP, DWORD nToRelayID, const void * const pSrcData1, const size_t& datalength1, const void * const pSrcData2 = NULL, const size_t& datalength2 = 0);
