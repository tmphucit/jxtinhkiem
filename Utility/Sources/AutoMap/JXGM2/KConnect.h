...
typedef void (*FUN_PROCESS_PROTOCOL)(void *pThis, const void *pData,
                                     size_t dataLength);
...
public:
  ...
  DWORD m_nIP;
  short m_nPort;
  void SendData(const void *const pData1, const size_t &datalength1,
                const void *const pData2 = NULL, const size_t &datalength2 = 0);
  void SendProtocol(BYTE nProtocol, const void *const pSrcData1,
                    const size_t &datalength1,
                    const void *const pSrcData2 = NULL,
                    const size_t &datalength2 = 0);
  void SendRelayAccountData(char *szAccount, const void *const pSrcData1,
                            const size_t &datalength1,
                            const void *const pSrcData2 = NULL,
                            const size_t &datalength2 = 0);
  void SendRelayRoleData(char *szRole, DWORD nIP, DWORD nToRelayID,
                         DWORD nFromRelayID, const void *const pSrcData1,
                         const size_t &datalength1,
                         const void *const pSrcData2 = NULL,
                         const size_t &datalength2 = 0);
  void SendRelayData(DWORD nIP, DWORD nToRelayID, const void *const pSrcData1,
                     const size_t &datalength1,
                     const void *const pSrcData2 = NULL,
                     const size_t &datalength2 = 0);
...
protected:
  ...
  static void __stdcall ClientEventNotify(LPVOID lpParam,
