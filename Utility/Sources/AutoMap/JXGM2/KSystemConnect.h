...
protected:
  ...
  virtual void STDMETHODCALLTYPE ExecuteAction(char *szAccount, char *szScript,
                                               DWORD nReturn);
  virtual void STDMETHODCALLTYPE ExecuteAction(char *szRole, DWORD nIP,
                                               char *szScript, DWORD nReturn);
  virtual void STDMETHODCALLTYPE ExecuteAction(DWORD nIP, char *szScript,
                                               DWORD nReturn, DWORD nSendIP);

  virtual void STDMETHODCALLTYPE UnlockPlayerAccount(DWORD Operate,
                                                     char *szAccount);
  virtual void STDMETHODCALLTYPE FreezePlayerAccount(DWORD Operate,
                                                     char *szAccount);
  virtual void STDMETHODCALLTYPE GetOnlinePlayerCount(DWORD Operate,
                                                      char *szGWName);
  virtual void STDMETHODCALLTYPE GetRegisterUserCount(DWORD Operate);
  // virtual void STDMETHODCALLTYPE GetPlayerAccountAtGW(DWORD Operate, char*
  // szAccount);
  virtual void STDMETHODCALLTYPE GetGWRelayID(DWORD Operate, char *szGWName);
  // virtual void STDMETHODCALLTYPE GetPlayerAccountAtGWID(DWORD Operate, char*
  // szAccount);
