...
PackageFileHead::PackageFileHead()
    : m_FileTypeString(), m_BlockCount(0), m_CompressMethod(0) {}

PackageFileHead::~PackageFileHead() {}

const PackageFileHead &
...
const string &PackageFileHead::GetFileType() const { return m_FileTypeString; }

int PackageFileHead::GetBlockCount() const { return m_BlockCount; }

int PackageFileHead::GetCompressMethod() const { return m_CompressMethod; }
...
PackageFileHead::PackageFileHead(int BlockCount, int CompressMethod,
                                 const string &FileTypeString) {
