...
private:
  // 更新单个字符的点阵数据
  void Update(unsigned char *pCharImage, unsigned char *pTexData,
              int nTexPitch);
...
private:
  ...
  LPDIRECT3DDEVICE8 m_pd3dDevice;    // Direct 3d device接口的实例的指针
  LPDIRECT3DTEXTURE8 m_pCharTexture; // 贴图句柄
};
