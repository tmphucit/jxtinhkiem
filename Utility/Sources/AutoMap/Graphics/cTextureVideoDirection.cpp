// cTextureVideoDirection.cpp: implementation of the cTextureVideoDirection
// class.
//
//////////////////////////////////////////////////////////////////////
...
cTextureVideoDirection::cTextureVideoDirection(cGraphics *p)
    : cTextureVideo(p) {
  m_nDirection = -1;
...
void cTextureVideoDirection::GetImageSize(int frame, ULONG &width,
                                          ULONG &height) {
...
void cTextureVideoDirection::GetTextureSize(int frame, ULONG &width,
                                            ULONG &height) {
  if (m_listInfo[frame] != NULL) {
