...
const cRect c_rectMin((float)MAX_LONG, (float)MAX_LONG, (float)MIN_LONG,
                      (float)MIN_LONG);
const cRect c_rectMax((float)MIN_LONG, (float)MIN_LONG, (float)MAX_LONG,
                      (float)MAX_LONG);
class iFps;
