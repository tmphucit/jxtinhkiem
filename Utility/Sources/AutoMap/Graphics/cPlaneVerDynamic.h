...
#if !defined(                                                                  \
    AFX_CPLANEVERDYNAMIC_H__70248D32_0A21_4720_A9BA_DC9AFE468ACC__INCLUDED_)
...
public:
  ...
  stPlaneVerDynamicParam *GetPlaneVerDynamicParam() {
    return (stPlaneVerDynamicParam *)m_pParam;
  };
  ...
  stResourceArray &GetResArray() {
    return GetPlaneVerDynamicParam()->stResArray;
  }
  int GetResNum() { return GetPlaneVerDynamicParam()->stResArray.nResource; }
  stResource &GetResA(int i) {
    return GetPlaneVerDynamicParam()->stResArray.aResource[i];
  }
