...
stVertexGround *cPlaneVerDynamic::GetVG(int i) { return m_aaVG[i]; }
...
float cPlaneVerDynamic::GetBottomSeamLengthSquare() { return 0; }
...
HRESULT cPlaneVerDynamic::DrawSub(cPoint p1, cPoint p2) { return Draw(); }
