...
cMesh::~cMesh() { FinalCleanup(); }

/**************************************************************************/
// com
/**************************************************************************/
ULONG cMesh::AddRef() { return ++m_ulCount; }
...
// graphics
/**************************************************************************/
cGround *cMesh::GetGround() { return GetGraphics()->GetcGround(); }
...
bool cMesh::CheckDisplay(const cRect &r) {
  ...
  if (m_eType == MESH_HOR) {
    ...
    // 带高度物体
    if (v[2].sx < r.l && v[3].sx < r.l || v[2].sx > r.r && v[3].sx > r.r ||
...
// device
/////////////////////////////////////////////////////////////
HRESULT cMesh::InitDeviceObjects() { return S_OK; }

HRESULT cMesh::RestoreDeviceObjects() { return S_OK; }

HRESULT cMesh::InvalidateDeviceObjects() { return S_OK; }

HRESULT cMesh::DeleteDeviceObjects() { return S_OK; }
...
HRESULT cMesh::Draw() { return S_OK; }
