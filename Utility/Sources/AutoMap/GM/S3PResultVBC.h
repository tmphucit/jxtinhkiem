...
#if !defined(                                                                  \
    AFX_S3PRESULTVBC_H__D0D0FB5C_3D6A_4C6F_8F43_2AAFCD93ADF2__INCLUDED_)
...
public:
  ...
  virtual bool set_field_data(unsigned int nfieldindex, const void *pData,
                              unsigned long nsize) = 0;
  virtual int unuse() = 0;
};
