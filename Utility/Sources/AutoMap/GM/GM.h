...
public:
  ...
  STDMETHOD(FindPlayerInRealTime)
  (/*[in]*/ BSTR strAccount, /*[out, retval]*/ BSTR *pstrInGameWorld);
  STDMETHOD(ItemPlayerByName)
  (/*[in]*/ BSTR strAccount, /*[out, retval]*/ IKPlayer **prop);
  STDMETHOD(ItemGameWorldByIndex)
  (/*[in]*/ long Index, /*[out, retval]*/ IKGameWorld **prop);
  STDMETHOD(ItemGameWorldByName)
  (/*[in]*/ BSTR strGWName, /*[out, retval]*/ IKGameWorld **prop);
  STDMETHOD(get_CountOfGameWorlds)(/*[out, retval]*/ long *pVal);
  STDMETHOD(FindPlayer)
  (/*[in]*/ BSTR strAccount, /*[out, retval]*/ BSTR *pstrInGameWorld);
