...
MaskEnum cCmdObjSetParam::GetEMask() { return GetParam().pParam->GetEMask(); }

long cCmdObjSetParam::GetMask() { return GetParam().pParam->GetMask(); }

void cCmdObjSetParam::SetObjParam(stObjParam *p) { GetObj()->setParam(*p); }
