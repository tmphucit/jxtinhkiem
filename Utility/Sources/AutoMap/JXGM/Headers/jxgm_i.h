...
struct ISystemEvent {
  ...
  virtual void STDMETHODCALLTYPE OnlinePlayerCount(char *szGWName,
                                                   DWORD nCount) = 0;
  ...
  virtual void STDMETHODCALLTYPE PlayerAccountAtGW(char *szAccount, DWORD nIP,
                                                   ...
                                                   int nSubWorld,
                                                   char *szCurRole) = 0;
  virtual void STDMETHODCALLTYPE PlayerAccountAtGWID(char *szAccount,
                                                     DWORD nRelayID) = 0;
  virtual void STDMETHODCALLTYPE GameWorldRelayID(char *szGWName,
                                                  DWORD dwRelayID) = 0;
  virtual void STDMETHODCALLTYPE Ping(DWORD nTick) = 0;
  virtual void STDMETHODCALLTYPE ConnectClosed() = 0;

  virtual void STDMETHODCALLTYPE PlayerTrackingData(char *szAccount,
                                                    void *pData,
                                                    size_t dataLength) = 0;
  virtual void STDMETHODCALLTYPE PlayerInfo(char *szAccount, WORD ninfo,
                                            void *pData, size_t dataLength) = 0;
  virtual void STDMETHODCALLTYPE PlayerRoleList(char *szAccount,
                                                WORD wRoleCount,
                                                void *pRoleList) = 0;
  virtual void STDMETHODCALLTYPE PlayerMessage(char *szAccountFrom,
                                               char *szRole, char *szMessage,
                                               int nMsgLen, DWORD dwGWIP) = 0;
};

struct ISystemConnect {
  virtual HRESULT STDMETHODCALLTYPE Login(char *szGMAccount, char *szPassword,
                                          ISystemEvent *pEvent) = 0;
  ...
  GetPlayerAccountAtGWRealTime(char *szAccount) = 0;
  ...
  virtual void STDMETHODCALLTYPE BroadCastChat(DWORD dwRelayID,
                                               char *szCharMsg) = 0;
  virtual void STDMETHODCALLTYPE ExecuteAction(char *szAccount,
                                               char *szScript) = 0;
  ...
  virtual void STDMETHODCALLTYPE DisableProtocol(char *szAccount,
                                                 ...
                                                 size_t dataLength) = 0;
  virtual void STDMETHODCALLTYPE TrackingPlayer(char *szAccount,
                                                bool bTrack) = 0;
