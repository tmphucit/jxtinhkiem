...
public:
  ...
  void CloseDocs();
  void NewMessage(const char *szAccountFrom, const char *szRole,
                  const char *szMessage, int nMsgLen, DWORD dwGWIP);
  void ErrorMessage(const char *szError);

  void SendPing();
  void ExecuteAction(const char *szAccount, const char *szScript,
                     DWORD nReturn);
  void ExecuteAction(const char *szRole, DWORD nRelayID, const char *szScript,
                     DWORD nReturn);
  void ExecuteAction(DWORD nRelayID, const char *szScript, DWORD nReturn,
                     DWORD nSendIP);
