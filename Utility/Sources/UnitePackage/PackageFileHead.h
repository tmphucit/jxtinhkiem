...
#if !defined(                                                                  \
    AFX_PACKAGEFILEHEAD_H__1E5A6AAF_1702_42F3_8336_D3C12F628B4C__INCLUDED_)
...
public:
  ...
  PackageFileHead(unsigned long BlockCount, unsigned long IndexOffset,
                  const string &FileTypeString, unsigned long DataOffset,
                  unsigned long CRC32);
