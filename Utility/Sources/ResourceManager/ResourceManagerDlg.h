...
#if !defined(                                                                  \
    AFX_RESOURCEMANAGERDLG_H__63C4FB53_6709_49B4_9E8B_BE2713B1516F__INCLUDED_)
...
protected:
  ...
  // show property
  void CreateTxtFile(const CString &strFile, const CString &strIcon,
                     const CString &strType, const CString &strGameType,
                     const CString &strSpr, int frames, int directions);
