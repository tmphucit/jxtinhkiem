...
HCURSOR CMapConvertDlg::OnQueryDragIcon() { return (HCURSOR)m_hIcon; }
/////////////////////////////////////////////////////////////////////////
// common
/////////////////////////////////////////////////////////////////////////
...
void CMapConvertDlg::OnMap() { GetFile(m_strFile); }
...
BOOL CMapConvertDlg::CheckFileIncluded(const char *pszPath,
                                       const char *pszFile) {
...
void CMapConvertDlg::OnRemoveMap() {
  ...
  HWND hListWnd = NULL;
  GetDlgItem(IDC_MAP_LIST, &hListWnd);
  while ((nItem = ListView_GetNextItem(hListWnd, nItem - 1, LVNI_SELECTED)) >=
         0)
