...
ULONG CDownNotify::OnStatusFileName(PDOWNLOADSTATUS pDownStatus) { return 0; }

ULONG CDownNotify::OnStatusFileSize(PDOWNLOADSTATUS pDownStatus) { return 0; }

ULONG CDownNotify::OnStatusFileDowned(PDOWNLOADSTATUS pDownStatus) { return 0; }
