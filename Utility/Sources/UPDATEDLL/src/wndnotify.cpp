...
CWndNotify::CWndNotify() { m_ulNotifyMessage = -1; }

CWndNotify::CWndNotify(ULONG ulMessage) { m_ulNotifyMessage = ulMessage; }
...
int CWndNotify::GetNotifyMessage(ULONG ulMessage) { return m_ulNotifyMessage; }
