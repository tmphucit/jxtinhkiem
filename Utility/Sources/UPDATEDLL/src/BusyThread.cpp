...
int CBusyThread::IsThreadOK() { return (m_hProcessor != NULL); }
...
int CBusyThread::StartThread() {
  ...
  DWORD dwThreadID = 0;
  m_hProcessor = CreateThread(NULL, 0, CBusyThread::InnerThreadProc,
...
int CBusyThread::PreExecution() { return true; }
