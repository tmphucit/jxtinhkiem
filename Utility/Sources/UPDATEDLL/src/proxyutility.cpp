...
//  int  ValidateProxySetting(KPROXY_SETTING& ProxySetting)       // NOT
//  implemented int SetDownloadProxy(CDownloadFile& DownloadFile, LPCTSTR
//  lpszHostUrl)
//
//////////////////////////////////////////////////////////////////////////////////////
int IsCurrentUseProxy() {
...
int SetDownloadProxy(CDownloadFile &DownloadFile, LPCTSTR lpszHostUrl) {
  ...
  DownloadFile.SetProxy(nProxyMode, g_UpdateData.ProxySetting.szHostAddr,
