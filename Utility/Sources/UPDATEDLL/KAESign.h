...
const char g_cszKAECopyRight[] = "Kingsoft AntiVirus Database.   Copyright (c) "
                                 "1999, 2001 Kingsoft AntiVirus.\x1A";
...
typedef struct IKAESignVtbl {
  ...
  ULONG(STDMETHODCALLTYPE __RPC_FAR *AddRef)(IKAESign __RPC_FAR *This);

  ULONG(STDMETHODCALLTYPE __RPC_FAR *Release)(IKAESign __RPC_FAR *This);
...
interface IKAESign { CONST_VTBL struct IKAESignVtbl __RPC_FAR *lpVtbl; };
...
#define IKAESign_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IKAESign_Release(This) (This)->lpVtbl->Release(This)
...
#define IKAESign_UnInitSignBuffer(This) (This)->lpVtbl->UnInitSignBuffer(This)
...
IKAESign_AddSignBuffer_Proxy(IKAESign __RPC_FAR *This,
                             /* [in] */ int nBufSize,
                             /* [size_is][in] */ const byte __RPC_FAR *pcbyBuf);
...
HRESULT STDMETHODCALLTYPE
IKAESign_UnInitSignBuffer_Proxy(IKAESign __RPC_FAR *This);
...
HRESULT STDMETHODCALLTYPE
IKAESign_UnInitSignFileName_Proxy(IKAESign __RPC_FAR *This);
...
HRESULT STDMETHODCALLTYPE
IKAESign_GetSignVersion_Proxy(IKAESign __RPC_FAR *This,
                              /* [out] */ int __RPC_FAR *pnSignVersion);
...
HRESULT STDMETHODCALLTYPE
IKAESign_GetVirusCount_Proxy(IKAESign __RPC_FAR *This,
                             /* [out] */ int __RPC_FAR *pnVirusCount);
