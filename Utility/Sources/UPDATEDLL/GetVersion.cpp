...
int GetVersionStringFromInt(int nMajorVersion, int nMinorVersion,
...
int GetVersionFromString(const char cszVersion[], unsigned *puMajorVersion,
...
int GetVersion(const char cszFileName[], char *pszVersion, int nVersionSize) {
  ...
  *pszVersion = '\0';
  ...
  nRetCode = GetVersionStringFromInt(dwMajorVersion, dwMinorVersion, pszVersion,
                                     nVersionSize);
  KAV_ASSERT_EXIT(nRetCode);
