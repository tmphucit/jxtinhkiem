// cCmdGroundChangeBrightness.cpp: implementation of the
// cCmdGroundChangeBrightness class.
//
//////////////////////////////////////////////////////////////////////
...
cCmdGroundChangeBrightness::cCmdGroundChangeBrightness(iCommandMachine *p)
    : cCommand(p) {}
...
BOOL cCmdGroundChangeBrightness::Merge(iCommand *p) {
  ...
  cCmdGroundChangeBrightness *pCmd =
      dynamic_cast<cCmdGroundChangeBrightness *>(p);
  ASSERT(pCmd);
