...
#if !defined(                                                                  \
    AFX_SAMPLEPROCESS_H__F773A2E5_BFA2_4DAC_872E_8A871E026EFF__INCLUDED_)
...
template <class InputIterator, class OutputIterator> class SampleProcess {
public:
  SampleProcess() {}
  virtual ~SampleProcess() {}
  virtual OutputIterator Process(InputIterator _First, InputIterator _Last,
