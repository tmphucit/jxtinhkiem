...
KScanFile::KScanFile()
    : m_sScanPath(), m_sRootPath(), m_sOutFile(), m_pFile(NULL)
...
BOOL KScanFile::RunSearch(const char *lpRootPath, const char *lpScanPath,
                          const char *lpOutFile) {
...
void KScanFile::SetRootPath(string RootPath) { m_sRootPath = RootPath; }

void KScanFile::SetOutFile(string OutFile) { m_sOutFile = OutFile; }

void KScanFile::SetScanPath(string ScanPath) { m_sScanPath = ScanPath; }
