...
//[menu]
//the normal operator
_declspec(dllexport) HRESULT GU_DrawMenu(iGraphics* pGraphcis,iScreen::stDraw&
st); _declspec(dllexport) HRESULT GU_GetSprSize(iGraphics* pGraphcis, LPCSTR
szSpr, long& width, long& height); _declspec(dllexport) HRESULT
GU_GetSprSize(iGraphics* pGraphcis, LPCSTR szSpr, int frame, long& width, long&
height); _declspec(dllexport) HRESULT GU_GetSprAlpha(iGraphics* pGraphcis,
LPCSTR szSpr, int frame, POINT pt, BYTE& alpha); _declspec(dllexport) HRESULT
GU_GetSprInfo(iGraphics* pGraphcis, LPCSTR szSpr, int& frame, int& nInterval);
_declspec(dllexport) HRESULT GU_GetSprReferenceSpot(iGraphics* pGraphcis, LPCSTR
szSpr, int& h, int& v);
*/
// the new operator
