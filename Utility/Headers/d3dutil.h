...
//-----------------------------------------------------------------------------
VOID D3DUtil_InitLight(D3DLIGHT8 &light, D3DLIGHTTYPE ltType, FLOAT x = 0.0f,
...
#define D3DPSP_WRITEMASK_C                                                     \
  (D3DPSP_WRITEMASK_B | D3DPSP_WRITEMASK_G | D3DPSP_WRITEMASK_R)
#define D3DPSP_WRITEMASK_ALL                                                   \
...
#define D3DPS_DST(_Num)                                                        \
  (D3DPS_REGNUM_MASK(_Num) | D3DSPR_TEMP | D3DPSP_WRITEMASK_ALL)
#define D3DPS_SRC_TEMP(_Num)                                                   \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_TEMP)
#define D3DPS_SRC_INPUT(_Num)                                                  \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_INPUT)
#define D3DPS_SRC_CONST(_Num)                                                  \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_CONST)
#define D3DPS_SRC_TEXTURE(_Num)                                                \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_TEXTURE)
#define D3DVS_SRC_ADDR(_Num)                                                   \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_ADDR)
#define D3DVS_SRC_RASTOUT(_Num)                                                \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_RASTOUT)
#define D3DVS_SRC_ATTROUT(_Num)                                                \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_ATTROUT)
#define D3DVS_SRC_TEXCRDOUT(_Num)                                              \
  (D3DPS_REGNUM_MASK(_Num) | D3DSP_NOSWIZZLE | D3DSPR_TEXCRDOUT)
