...
public:
  ...
  virtual BOOL GetValue(LPCSTR szItem, CString &strValue,
                        LPCSTR szSection = "MAIN") = 0;
  virtual BOOL SetValue(LPCSTR szItem, const CString &strValue,
                        LPCSTR szSection = "MAIN") = 0;
  virtual BOOL GetValue(LPCSTR szItem, CString &strValue,
...
_declspec(dllexport) BOOL SetSectionString(stSection *p, LPCSTR sKey,
                                           const CString &sValue);
_declspec(dllexport) BOOL GetSectionString(const stSection *p, LPCSTR sKey,
                                           CString &sValue);
...
template <class T> BOOL SetSectionValue(stSection *p, LPCSTR sKey, T &value) {
  CString strValue;
...
template <class T> BOOL GetItemValue(iItem *pItem, LPCSTR sKey, T &value) {
...
template <class T> BOOL SetItemValue(iItem *pItem, LPCSTR sKey, T &value) {
