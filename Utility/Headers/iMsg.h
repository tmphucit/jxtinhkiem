...
public:
  ...
  virtual void SetData(void *buffer, MSGSIZE size, MSGTYPE type,
                       eMsgPack pack = PACK_NULL,
                       eMsgCode code = CODE_NULL) = 0;
  // 整个消息的大小和位置
...
_declspec(dllexport) iMsg *Message_CreateMsg(eMsgType eType, long verson1 = 0,
                                             long verson2 = 0);
...
_declspec(dllexport) iMsgQueue *
Message_CreateMsgQueue(eMsgQueueType eType, long verson1 = 0, long verson2 = 0);
