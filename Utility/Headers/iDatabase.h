...
typedef UINT (*HandleDatabaseMessageFunc)(stMsg *pMsg, DWORD msgSize,
                                          void *pPlayer);
...
public:
  ...
  virtual HRESULT Open(LPCSTR szDatabase, LPCSTR szAccount,
                       LPCSTR szPassword) = 0;
  ...
  virtual BOOL VerifyPassword(LPCSTR szAccount, LPCSTR szPassword,
                              iServerLink *pLink) = 0;
  virtual BOOL QueryAccountInfo(LPCSTR szAccount, iServerLink *pPlayer) = 0;
  virtual BOOL QueryPlayerInfo(LPCSTR szAccount, LPCSTR szName,
                               iServerLink *pPlayer) = 0;
};
