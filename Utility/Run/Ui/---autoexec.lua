...
AddCommand("A", "3d", "Set3D(1)")
AddCommand("C", "2d", "Set3D(0)")
...
AddCommand("Ctrl+B", "", "Open([[OpenTong(2)]])")
...
SetPhrase(0, "你在哪里？:S")
SetPhrase(1, "跟我来！:K")
SetPhrase(2, "大伙一起上啊，人多力量大！:F")
SetPhrase(3, "危险，快逃！:$")
SetPhrase(4, "快帮我加血！:M")
SetPhrase(5, "有没有人一起组队？我还单身呢。^o^")
SetPhrase(6, "街坊邻居快来看啊，刚出炉的装备道具大拍卖啊。:E")
SetPhrase(7, "你是哪里人，多少级了？:o")
SetPhrase(8, "嘿，哥们姐们老少爷们！哪位手头宽裕的赏在下俩钱儿！:)")
SetPhrase(9, "在下初到宝地，人生地不熟，还请各位关照则个！:I")
