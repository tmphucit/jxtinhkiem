...
inline bool TestResultDecorator::shouldStop() { return m_result->shouldStop(); }
...
inline int TestResultDecorator::runTests() { return m_result->runTests(); }

// Gets the number of detected errors.
inline int TestResultDecorator::testErrors() { return m_result->testErrors(); }
...
inline void TestResultDecorator::stop() { m_result->stop(); }
