...
void CPerformanceDlg::OnOK() {
  ...
  m_DBServerIPCtrl.GetAddress(m_byField[0], m_byField[1], m_byField[2],
                              m_byField[3]);
  CDialog::OnOK();
}
...
BOOL CPerformanceDlg::OnInitDialog() {
  ...
  m_DBServerIPCtrl.SetAddress(m_byField[0], m_byField[1], m_byField[2],
                              m_byField[3]);
  return TRUE; // return TRUE unless you set the focus to a control
               // EXCEPTION: OCX Property Pages should return FALSE
}

void CPerformanceDlg::GetAddress(BYTE &byField0, BYTE &byField1, BYTE &byField2,
                                 BYTE &byField3) {
...
void CPerformanceDlg::OnFieldchangedDbserverAddr(NMHDR *pNMHDR,
                                                 LRESULT *pResult) {
