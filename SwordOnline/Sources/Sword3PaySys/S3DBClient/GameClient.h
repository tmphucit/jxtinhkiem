...
public:
  CGameClient(const OnlineGameLib::Win32::_tstring &addressToConnectServer,
              unsigned short portToConnectServer, size_t maxFreeBuffers,
              size_t bufferSize = 1024);

  CGameClient(size_t maxFreeBuffers, size_t bufferSize = 1024);
...
private:
  ...
  virtual void PreWrite(OnlineGameLib::Win32::CIOBuffer *pBuffer,
