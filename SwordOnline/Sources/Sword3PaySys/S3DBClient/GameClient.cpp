...
CGameClient::CGameClient(
    ...
    unsigned short portToConnectServer, size_t maxFreeBuffers,
    size_t bufferSize /* = 1024 */
    )
    : OnlineGameLib::Win32::CSocketClient(addressToConnectServer,
                                          portToConnectServer, maxFreeBuffers,
                                          bufferSize),
      m_pRecvBuf(NULL), m_dwRecvSize(0) {
  m_hHasRecvdata = CreateEvent(NULL,       // no security attributes
...
CGameClient::CGameClient(size_t maxFreeBuffers, size_t bufferSize /* = 1024 */
                         )
...
void CGameClient::OnStartConnections() { Output(_T("OnStartConnections")); }

void CGameClient::OnStopConnections() { Output(_T("OnStopConnections")); }

void CGameClient::OnShutdownInitiated() { Output(_T("OnShutdownInitiated")); }

void CGameClient::OnShutdownComplete() { Output(_T("OnShutdownComplete")); }

void CGameClient::OnError(const OnlineGameLib::Win32::_tstring &message) {
  Output(_T("OnError - ") + message);
}

void CGameClient::OnConnect() { Output(_T("OnConnect")); }

void CGameClient::OnClose() { Output(_T("OnClose")); }
...
void CGameClient::PreWrite(OnlineGameLib::Win32::CIOBuffer *pBuffer,
