...
CS3AccClientSampleDlg::CS3AccClientSampleDlg(CWnd *pParent /*=NULL*/)
    : CDialog(CS3AccClientSampleDlg::IDD, pParent), m_pSample(NULL) {
...
HCURSOR CS3AccClientSampleDlg::OnQueryDragIcon() { return (HCURSOR)m_hIcon; }
...
void CS3AccClientSampleDlg::OnSend() {
  ...
  const DWORD params[] = {LOGIN_A_SERVERLIST, LOGIN_A_LOGIN,
                          LOGIN_A_DECACCOUNTDEPOSIT, LOGIN_A_LOGOUT};
  ASSERT(NULL != m_pSample);
  switch (params[iSel]) {
