...
#define pthread_create(A, B, C, D)                                             \
  thr_create(NULL, 65536L, (C), (D), THR_DETACHED, (A))
...
#define pthread_key_create(A, B)                                               \
  pthread_keycreate(A, (B) ? (pthread_destructor_t)(B)                         \
...
#if defined(HAVE_PTHREAD_ATTR_CREATE) || defined(_AIX) ||                      \
    defined(HAVE_GETHOSTBYNAME_R_GLIBC2_STYLE)
#if !defined(HPUX)
struct hostent;
#endif /* HPUX */
struct hostent *my_gethostbyname_r(const char *name, struct hostent *result,
...
#endif /* defined(HAVE_PTHREAD_ATTR_CREATE) || defined(_AIX) ||                \
          defined(HAVE_GETHOSTBYNAME_R_GLIBC2_STYLE) */
