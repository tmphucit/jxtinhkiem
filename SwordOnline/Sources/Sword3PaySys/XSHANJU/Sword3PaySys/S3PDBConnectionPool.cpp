...
void S3PDBConnectionPool::InitAccountDBInfo() {
  ...
  DWORD dwLen = KPIGetPrivateProfileString(
      def_ACCOUNTSECTIONNAME, def_SERVERKEYNAME, "", szServer, def_KEYNAMELEN,
      m_strINIPath.c_str());
  ...
  dwLen = KPIGetPrivateProfileString(def_ACCOUNTSECTIONNAME,
                                     def_DATABASEKEYNAME, "", szDataBase,
                                     def_KEYNAMELEN, m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szDataBase[dwLen] = 0;
  } else {
    szDataBase[0] = 0;
  ...
  dwLen =
      KPIGetPrivateProfileString(def_ACCOUNTSECTIONNAME, def_USERKEYNAME, "",
                                 szUser, def_KEYNAMELEN, m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szUser[dwLen] = 0;
  } else {
    szUser[0] = 0;
  ...
  dwLen = KPIGetPrivateProfileString(def_ACCOUNTSECTIONNAME,
                                     def_PASSWORDKEYNAME, "", szPassword,
                                     def_KEYNAMELEN, m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szPassword[dwLen] = 0;
  } else {
...
void S3PDBConnectionPool::InitRoleDBInfo() {
  ...
  DWORD dwLen = KPIGetPrivateProfileString(
      def_ROLESECTIONNAME, def_SERVERKEYNAME, "", szServer, def_KEYNAMELEN,
      m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szServer[dwLen] = 0;
  } else {
  ...
  dwLen = KPIGetPrivateProfileString(def_ROLESECTIONNAME, def_DATABASEKEYNAME,
                                     "", szDataBase, def_KEYNAMELEN,
                                     m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szDataBase[dwLen] = 0;
  } else {
  ...
  dwLen =
      KPIGetPrivateProfileString(def_ROLESECTIONNAME, def_USERKEYNAME, "",
                                 szUser, def_KEYNAMELEN, m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szUser[dwLen] = 0;
  } else {
  ...
  dwLen = KPIGetPrivateProfileString(def_ROLESECTIONNAME, def_PASSWORDKEYNAME,
                                     "", szPassword, def_KEYNAMELEN,
                                     m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szPassword[dwLen] = 0;
  } else {
...
void S3PDBConnectionPool::InitCardDBInfo() {
  ...
  DWORD dwLen = KPIGetPrivateProfileString(
      def_CARDSECTIONNAME, def_SERVERKEYNAME, "", szServer, def_KEYNAMELEN,
      m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szServer[dwLen] = 0;
  } else {
  ...
  dwLen = KPIGetPrivateProfileString(def_CARDSECTIONNAME, def_DATABASEKEYNAME,
                                     "", szDataBase, def_KEYNAMELEN,
                                     m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szDataBase[dwLen] = 0;
  ...
  dwLen =
      KPIGetPrivateProfileString(def_CARDSECTIONNAME, def_USERKEYNAME, "",
                                 szUser, def_KEYNAMELEN, m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szUser[dwLen] = 0;
  } else {
  ...
  dwLen = KPIGetPrivateProfileString(def_CARDSECTIONNAME, def_PASSWORDKEYNAME,
                                     "", szPassword, def_KEYNAMELEN,
                                     m_strINIPath.c_str());
  if (dwLen < def_KEYNAMELEN) {
    szPassword[dwLen] = 0;
