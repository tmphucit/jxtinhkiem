...
Test *S3PTestRoleInfoDAO::suite() {
  ...
  // testSuite->addTest (new TestCaller <S3PTestRoleInfoDAO> ("testAdd",
  // testAdd)); testSuite->addTest (new TestCaller <S3PTestRoleInfoDAO>
  // ("testAddGroup", testAddGroup));
  testSuite->addTest(
      new TestCaller<S3PTestRoleInfoDAO>("testQuery", testQuery));
  // testSuite->addTest (new TestCaller <S3PTestRoleInfoDAO> ("testUpdate",
  // testUpdate)); testSuite->addTest (new TestCaller <S3PTestRoleInfoDAO>
