...
S3PDBSocketParser::S3PDBSocketParser() { Init(); }

S3PDBSocketParser::~S3PDBSocketParser() { Release(); }

BOOL S3PDBSocketParser::Encode(const IBYTE *pRawData, unsigned long ulRawSize,
                               IBYTE *pEncodedData,
