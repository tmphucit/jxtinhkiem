...
void S3PTestRole::testAdd() {
  ...
  S3PTableObjList<S3PEquipRequireInfo> *pEquipRequireInfoList =
      pEquipment->GetEquipRequireInfoList();
  ...
  S3PTableObjList<S3PEquipBaseInfo> *pEquipBaseInfoList =
      pEquipment->GetEquipBaseInfoList();
  ...
  S3PTableObjList<S3PEquipEfficInfo> *pEquipEfficInfoList =
      pEquipment->GetEquipEfficInfoList();
