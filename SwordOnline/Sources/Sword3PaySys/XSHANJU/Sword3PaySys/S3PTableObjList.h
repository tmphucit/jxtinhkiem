...
#if !defined(                                                                  \
    AFX_S3PTABLEOBJLIST_H__0F1D2380_72D6_4A8B_8D68_2A937A1748E7__INCLUDED_)
...
template <class T> class S3PTableObjList {
protected:
  BOOL m_bInit;
  std::vector<T *> m_list;
...
public:
  S3PTableObjList(std::string tableName, std::string orderBy,
                  std::string foreignKey, std::string foreignValue) {
