...
S3PLifeSkill::S3PLifeSkill() { Init(); }

S3PLifeSkill::~S3PLifeSkill() { Clear(); }
...
std::string S3PLifeSkill::GetAutoIncrementField() { return "iid"; }

std::string S3PLifeSkill::GetMandatoryField() { return "iLifeSkill"; }