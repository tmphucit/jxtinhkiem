...
inline CppUnitException::CppUnitException(std::string message, long lineNumber,
                                          std::string fileName)
...
inline long CppUnitException::lineNumber() { return m_lineNumber; }
