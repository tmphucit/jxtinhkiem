...
//-----------------------------------------//
#if !defined(                                                                  \
    AFX_S3PDBSOCKETPARSER_H__8B70E8D1_C829_49AA_95E9_E8E092F44010__INCLUDED_)
...
public:
  ...
  inline operator _LPCPARSEDDATAPACKET() const { return this; }
  inline operator _LPPARSEDDATAPACKET() { return this; }
  static BOOL Encode(const IBYTE *pRawData /* Input */,
                     unsigned long ulRawSize /* Input */,
                     IBYTE *pEncodedData /* Output */,
                     unsigned long &ulEncodedSize /* Output */);
  virtual BOOL Parse(IBYTE *lpData, DWORD dwSize, BOOL bEncrypt = TRUE);

protected:
  virtual BOOL Decode(IBYTE *lpData /*Input*/, DWORD &dwSize /*Input/Output*/,
                      IBYTE *lpRetData /*Output*/);
  virtual void Init();
