...
class CSocketClient : protected CThread,
...
public:
  ...
  void ConnectTo(const _tstring &addressToConnectServer,
...
protected:
  CSocketClient(const _tstring &addressToConnectServer,
                unsigned short portToConnectServer, size_t maxFreeBuffers,
                size_t bufferSize /* = 1024 */
  );

  CSocketClient(size_t maxFreeBuffers, size_t bufferSize /* = 1024 */
  );

  virtual void PreWrite(CIOBuffer *pBuffer, const char *pData,
                        size_t dataLength) {};
...
private:
   ...
   */
  virtual SOCKET CreateConnectionSocket(const _tstring &addressToConnectServer,
