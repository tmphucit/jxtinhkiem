...
S3PEquipBaseInfo::S3PEquipBaseInfo() { Init(); }

S3PEquipBaseInfo::~S3PEquipBaseInfo() { Clear(); }
...
std::string S3PEquipBaseInfo::GetAutoIncrementField() { return "iid"; }

std::string S3PEquipBaseInfo::GetMandatoryField() { return "cInfoText"; }
