...
CGameServerWorkerThread::CGameServerWorkerThread(CIOCompletionPort &iocp)
...
void CGameServerWorkerThread::ReadCompleted(CSocketServer::Socket *pSocket,
                                            CIOBuffer *pBuffer) {
  try {
...
void CGameServerWorkerThread::OnError(
    const OnlineGameLib::Win32::_tstring &message) {
  Output(_T("OnError - ") + message);
}

void CGameServerWorkerThread::ProcessCommand(CSocketServer::Socket *pSocket,
...
CIOBuffer *
CGameServerWorkerThread::ProcessDataStream(CSocketServer::Socket *pSocket,
