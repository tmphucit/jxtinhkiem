...
private:
  virtual void
  ReadCompleted(OnlineGameLib::Win32::CSocketServer::Socket *pSocket,
  ...
  ProcessDataStream(OnlineGameLib::Win32::CSocketServer::Socket *pSocket,
                    OnlineGameLib::Win32::CIOBuffer *pBuffer) const;

  void ProcessCommand(OnlineGameLib::Win32::CSocketServer::Socket *pSocket,
