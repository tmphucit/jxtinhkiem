...
public:
  ...
  static int ServerLogin(S3PDBConVBC *pConn, const char *strAccName,
                         ...
                         const short Port, const BYTE Mac[6], DWORD &nGameID);
  ...
  static int CheckAddress(S3PDBConVBC *pConn, const DWORD Address,
                          const short Port);
  static int GetAccountCount(S3PDBConVBC *pConn, DWORD nGameID, BOOL bOnline,
                             DWORD &dwCount);
  ...
  static int GetAccountsTime(S3PDBConVBC *pConn, DWORD ClientID,
