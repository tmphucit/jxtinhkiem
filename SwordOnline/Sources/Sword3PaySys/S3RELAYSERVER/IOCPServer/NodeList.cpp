...
CNodeList::Node *CNodeList::Head() const { return m_pHead; }

size_t CNodeList::Count() const { return m_numNodes; }

bool CNodeList::Empty() const { return (0 == m_numNodes); }
...
CNodeList::Node *CNodeList::Node::Next() const { return m_pNext; }
