...
public:
  CGameServer(const std::string &welcomeMessage,
              unsigned long addressToListenOn, unsigned short portToListenOn,
              size_t maxFreeSockets, size_t maxFreeBuffers,
              size_t bufferSize = 1024, size_t numThreads = 0);

  CGameServer(const std::string &welcomeMessage, size_t maxFreeSockets,
...
private:
  ...
  CreateWorkerThread(OnlineGameLib::Win32::CIOCompletionPort &iocp);
  ...
  virtual void
  OnConnectionEstablished(OnlineGameLib::Win32::CSocketServer::Socket *pSocket,
                          OnlineGameLib::Win32::CIOBuffer *pAddress);

  virtual void
  OnConnectionClosed(OnlineGameLib::Win32::CSocketServer::Socket *pSocket);

  virtual void OnConnectionDestroyed();

  virtual void OnError(const OnlineGameLib::Win32::_tstring &message);

  virtual void PreWrite(OnlineGameLib::Win32::CSocketServer::Socket *pSocket,
