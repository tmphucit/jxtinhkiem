...
void CTongConnect::Proc0_Tong(const void* pData, size_t size)
{
	...
	case enumC2S_TONG_CHANGE_TITLE_FEMALE:
		{
			STONG_CHANGE_TITLE_FEMALE_COMMAND	*pChange = (STONG_CHANGE_TITLE_FEMALE_COMMAND*)pData;
    ...
    case enumC2S_TONG_CHANGE_TITLE_MALE:
		{
			STONG_CHANGE_TITLE_MALE_COMMAND	*pChange = (STONG_CHANGE_TITLE_MALE_COMMAND*)pData;
