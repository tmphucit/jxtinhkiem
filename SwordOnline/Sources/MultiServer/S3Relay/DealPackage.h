...
private:
  ...
  typedef BOOL (CDealPackage::*LPFNDEALPROC)(const CNetConnect *pConn,
...
private:
  BOOL Proc_c2sRegisterFamily(const CNetConnect *pConn, const void *pData,
                              unsigned len);
  BOOL Proc_c2sEnterGame(const CNetConnect *pConn, const void *pData,
                         unsigned len);
  BOOL Proc_c2sLeaveGame(const CNetConnect *pConn, const void *pData,
                         unsigned len);
