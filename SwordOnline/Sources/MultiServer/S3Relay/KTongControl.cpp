...
BOOL	CTongControl::ChangeTitleFemale(STONG_CHANGE_TITLE_FEMALE_COMMAND *pChange, STONG_CHANGE_TITLE_FEMALE_SYNC *pSync)
{
...
BOOL	CTongControl::ChangeTitleMale(STONG_CHANGE_TITLE_MALE_COMMAND *pChange, STONG_CHANGE_TITLE_MALE_SYNC *pSync)
{
...
BOOL	CTongControl::ChangeTitle(STONG_CHANGE_TITLE_COMMAND *pChange, STONG_CHANGE_TITLE_SYNC *pSync)
{
