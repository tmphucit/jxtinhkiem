...
void CNetConnect::_NotifyClientConnectCreate() { OnClientConnectCreate(); }
...
BOOL CNetConnect::IsReady() const { return m_pNetServer->GetServer() != NULL; }
...
BOOL CNetConnect::Route() { return DoRoute(); }
