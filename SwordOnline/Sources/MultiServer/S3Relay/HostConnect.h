...
private:
  ...
  void Proc2_Relay_AskWay_AccountRoleID(const void *pData, size_t size,
                                        BOOL acc);
...
public:
  BOOL FindPlayerByAcc(const std::_tstring &acc, std::_tstring *pRole,
                       DWORD *pNameID, unsigned long *pParam,
                       std::_tstring *pRealAcc = NULL);
  BOOL FindPlayerByRole(const std::_tstring &role, std::_tstring *pAcc,
                        DWORD *pNameID, unsigned long *pParam,
                        std::_tstring *pRealRole = NULL);
  BOOL FindPlayerByParam(unsigned long param, std::_tstring *pAcc,
