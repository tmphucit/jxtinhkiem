...
CLockSRSW::CLockSRSW() { ::InitializeCriticalSection(&m_csExclusive); }

CLockSRSW::~CLockSRSW() { ::DeleteCriticalSection(&m_csExclusive); }

void CLockSRSW::EnterRead() { ::EnterCriticalSection(&m_csExclusive); }

void CLockSRSW::LeaveRead() { ::LeaveCriticalSection(&m_csExclusive); }

void CLockSRSW::EnterWrite() { ::EnterCriticalSection(&m_csExclusive); }

void CLockSRSW::LeaveWrite() { ::LeaveCriticalSection(&m_csExclusive); }
...
void CLockMRSW::LeaveWrite() { ::LeaveCriticalSection(&m_csExclusive); }
