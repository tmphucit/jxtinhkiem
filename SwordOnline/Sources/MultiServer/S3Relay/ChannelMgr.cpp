...
CChannelMgr::CChannelMgr()
	...
	m_chChannTEAM(0), m_chChannKIM(0), m_chChannFAC(0), m_chChannTONG(0), m_chChannSCRN(0),
	m_minTeamID(0), m_maxTeamID(-1), m_minKimID(0), m_maxKimID(-1), m_minFacID(0), m_maxFacID(-1), m_minTongID(0), m_maxTongID(-1),
	m_defCost(0),
	m_costTeam(0), m_costKim(0), m_costFac(0), m_costTong(0), m_costScrn(0), m_costBc(0)
{
...
BOOL CChannelMgr::Initialize()
{
	...
	m_chChannKIM = gGetPrivateProfileCharEx(sec_kim, key_escSpec, file_channcfg, defCHANN_KIM);
	...
	m_costKim = (BYTE)gGetPrivateProfileIntEx(sec_kim, key_cost, file_channcfg, (INT)(UINT)m_defCost);
