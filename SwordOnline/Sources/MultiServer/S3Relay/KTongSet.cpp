...
BOOL	CTongSet::ChangeTitleFemale(STONG_CHANGE_TITLE_FEMALE_COMMAND *pChange, STONG_CHANGE_TITLE_FEMALE_SYNC *pSync)
{
	if (!pChange || !pSync)
		return FALSE;
	if (!m_pcTong)
...
BOOL	CTongSet::ChangeTitleMale(STONG_CHANGE_TITLE_MALE_COMMAND *pChange, STONG_CHANGE_TITLE_MALE_SYNC *pSync)
{
	if (!pChange || !pSync)
		return FALSE;
	if (!m_pcTong)
...
BOOL	CTongSet::ChangeTitle(STONG_CHANGE_TITLE_COMMAND *pChange, STONG_CHANGE_TITLE_SYNC *pSync)
{
	if (!pChange || !pSync)
		return FALSE;
	if (!m_pcTong)
