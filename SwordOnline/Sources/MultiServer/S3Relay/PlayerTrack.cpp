...
BOOL CPlayerTrack::Uninitialize() { return FALSE; }
...
BOOL CPlayerTrack::Login(const std::_tstring &acc, const std::_tstring &role,
                         DWORD nameid, unsigned long conn, int idx) {
