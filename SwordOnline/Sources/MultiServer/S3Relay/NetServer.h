...
private:
  static void __stdcall ServerEventNotify(LPVOID lpParam,
                                          const unsigned long &ulnID,
                                          const unsigned long &ulnEventType);

public:
  BOOL Startup(size_t nPlayerMaxCount, size_t nPrecision,
...
protected:
  virtual CNetConnect *CreateConnect(CNetServer *pNetServer,
