 ...
 */
#define DB_UNDO(op)                                                            \
  ((op) == DB_TXN_ABORT || (op) == DB_TXN_BACKWARD_ROLL ||                     \
   (op) == DB_TXN_BACKWARD_ALLOC)
...
#define DB_SURPRISE_KID                                                        \
  (-30894)                       /* Child commit where parent                  \
...
#define DB_LOGFILEID_INVALID -1
  ...
  int(*open)
      __P((DB *, DB_TXN *, const char *, const char *, DBTYPE, u_int32_t, int));
  ...
  int(*set_dup_compare) __P((DB *, int (*)(DB *, const DBT *, const DBT *)));
  ...
  int(*set_bt_compare) __P((DB *, int (*)(DB *, const DBT *, const DBT *)));
  ...
  int(*db_am_remove)
      __P((DB *, DB_TXN *, const char *, const char *, DB_LSN *));
  int(*db_am_rename)
      __P((DB *, DB_TXN *, const char *, const char *, const char *));
...
#define DB_MULTIPLE_INIT(pointer, dbt)                                         \
  (pointer = (u_int8_t *)((DBT *)(dbt))->data + ((DBT *)(dbt))->ulen -         \
             sizeof(u_int32_t))
#define DB_MULTIPLE_NEXT(pointer, dbt, retdata, retdlen)                       \
  do {                                                                         \
    ...
    retdata = (u_int8_t *)((DBT *)(dbt))->data + *(u_int32_t *)(pointer);      \
    (pointer) = (u_int32_t *)(pointer) - 1;                                    \
    retdlen = *(u_int32_t *)(pointer);                                         \
    (pointer) = (u_int32_t *)(pointer) - 1;                                    \
    if (retdlen == 0 && retdata == (u_int8_t *)((DBT *)(dbt))->data)           \
      retdata = NULL;                                                          \
  } while (0)
#define DB_MULTIPLE_KEY_NEXT(pointer, dbt, retkey, retklen, retdata, retdlen)  \
  do {                                                                         \
    ...
    retkey = (u_int8_t *)((DBT *)(dbt))->data + *(u_int32_t *)(pointer);       \
    (pointer) = (u_int32_t *)(pointer) - 1;                                    \
...
#define DB_VERB_WAITSFOR 0x0010    /* Dump waits-for table. */
  ...
  int(*set_alloc) __P((DB_ENV *, void *(*)(size_t), void *(*)(void *, size_t),
                       void (*)(void *)));
  ...
  int(*lock_get) __P((DB_ENV *, u_int32_t, u_int32_t, const DBT *,
                      db_lockmode_t, DB_LOCK *));
  ...
  int(*lock_vec)
      __P((DB_ENV *, u_int32_t, u_int32_t, DB_LOCKREQ *, int, DB_LOCKREQ **));
  int(*lock_downgrade) __P((DB_ENV *, DB_LOCK *, db_lockmode_t, u_int32_t));
  ...
  int(*memp_nameop)
      __P((DB_ENV *, u_int8_t *, const char *, const char *, const char *));
  int(*memp_register)
  ...
  int(*set_rep_election)
      __P((DB_ENV *, u_int32_t, u_int32_t, u_int32_t, u_int32_t));
...
int db_env_set_func_seek __P((int (*)(int, size_t, db_pgno_t, u_int32_t, int,
                                      int)));
