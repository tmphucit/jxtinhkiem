...
CSockThread::CSockThread() : m_step(step_NONE), m_cntLoop(0), m_tickLoop(0) {}
...
BOOL CSockThread::TraceInfo() {
  static const char *stepdesc[] = {
      "NONE",        "EnterLoop",  "PrepareSock",   "RelayCenter",
      "RelayServer", "RootCenter", "GatewayCenter", "HostServer",
      "TongServer",  "ChatServer", "UnprepareSock", "LeaveLoop",
      "Sleep",
  };

  rTRACE("message: [SockThread] tickLoop: %d, cntLoop: %d, step: %s",
