...
inline void CCriticalSection::Enter() { ::EnterCriticalSection(&m_crit); }

inline void CCriticalSection::Leave() { ::LeaveCriticalSection(&m_crit); }
...
inline CCriticalSection::Owner::~Owner() { m_crit.Leave(); }
