...
HRESULT D3DMath_VertexMatrixMultiply(D3DVERTEX &vDest, D3DVERTEX &vSrc,
  ...
  if (SUCCEEDED(hr = D3DMath_VectorMatrixMultiply(*pDestVec, *pSrcVec, mat))) {
...
// Desc: Converts a normalized axis and angle to a unit quaternion.
//-----------------------------------------------------------------------------
VOID D3DMath_RotationFromQuaternion(D3DVECTOR &v, FLOAT &fTheta, FLOAT x,
...
VOID D3DMath_QuaternionSlerp(FLOAT &Qx, FLOAT &Qy, FLOAT &Qz, FLOAT &Qw,
                             FLOAT Ax, FLOAT Ay, FLOAT Az, FLOAT Aw, FLOAT Bx,
                             FLOAT By, FLOAT Bz, FLOAT Bw, FLOAT fAlpha) {
