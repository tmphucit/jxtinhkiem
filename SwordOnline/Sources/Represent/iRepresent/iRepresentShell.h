...
#define LIGHTING_GRID_WIDTH                                                    \
  (AREGION_WIDTH / LIGHTING_GRID_SIZEX * 3) // 九个焦点区域安格子计算的宽度
#define LIGHTING_GRID_HEIGHT                                                   \
  (AREGION_HEIGHT / LIGHTING_GRID_SIZEY * 3) // 九个焦点区域安格子计算的高度
...
public:
  ...
  virtual void DrawPrimitivesOnImage(
      ...
      const char *pszImage,
      // ## 目标图形的id
      unsigned int uImage, short &nImagePosition) = 0;
