    ...
    if (nLineWidth) {
      if (h + m_nOutputWidth > nLineWidth) {
        ...
        nHalfIndex = 0;
                 ...
                 h + m_nOutputWidth + m_nFontHalfWidth[nHalfIndex] >=
                     nLineWidth) {
...
*****************************************************************************/
void KFont2::DrawCharacter(int x, int y, unsigned char cFirst,
                           unsigned char cNext, int nColor) const {
