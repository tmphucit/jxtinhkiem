...
typedef void (*fnRenderText)(KFontVertex *pPolyVertices,
...
private:
  ...
  static void RenderTextDirect(KFontVertex *pPolyVertices,
                               unsigned int nNumPolys);
  static void RenderTextCmp(KFontVertex *pPolyVertices, unsigned int nNumPolys);
  static void RenderTextCmpReverse(KFontVertex *pPolyVertices,
                                   unsigned int nNumPolys);
