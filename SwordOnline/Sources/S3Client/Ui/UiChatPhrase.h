...
public:
  ...
  int SetEmote(char *szCmd, char *szName, char *szStringTarget,
               char *szStringSelf, int nIndex = -1);
  //
  ...
  // 制作字符串
  int ConvertEmoteString(char *szString, int nStringLen, const char *szMyName,
...
private:
  ...
  int HandleLoad(KIniFile *pIni, EMOTE_PHRASE *pData, int nCount,
