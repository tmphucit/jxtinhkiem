...
public:
	...
	int		AddOneMessage(const char* pText, int nLen, ChatItem* pItem = NULL, bool bHaveItem = false, int nPos = 0,
			int nLinePos = 1, int nFace = 0, unsigned int uTextBKColor = 0);//sua~ lai.
