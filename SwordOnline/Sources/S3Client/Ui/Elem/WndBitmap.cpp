...
//	功能：构造函数
//--------------------------------------------------------------------------
KWndBitmap::KWndBitmap() { m_bBitmapLoaded = FALSE; }

//--------------------------------------------------------------------------
//	功能：析构函数
//--------------------------------------------------------------------------
KWndBitmap::~KWndBitmap() { m_Bitmap.Free(); }
...
//	}
  ...
  //	else
  {
    ...
    if (l_pFont16) {
      l_pFont16->TextOut(m_Caption, KF_ZERO_END, m_nAbsoluteLeft + 3,
                         m_nAbsoluteTop + 3);
      l_pFont16->TextOut(m_Caption, KF_ZERO_END, m_nAbsoluteLeft + 2,
                         m_nAbsoluteTop + 2, 0xFFFFFFFF);
    }
  }
#endif
}