...
#define WNDTEXT_ES_HALIGN_FILTER                                               \
  (WNDTEXT_ES_HALIGN_RIGHT | WNDTEXT_ES_HALIGN_CENTRE)
#define WNDTEXT_ES_VALIGN_FILTER                                               \
  (WNDTEXT_ES_VALIGN_BOTTOM | WNDTEXT_ES_VALIGN_CENTRE)
#define WNDTEXT_ES_ALIGN_FILTER                                                \
  (WNDTEXT_ES_HALIGN_FILTER | WNDTEXT_ES_VALIGN_FILTER)
