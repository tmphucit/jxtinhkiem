...
//dinh mau chu~
void KWndPureTextBtn::SetColor(unsigned int uNormal, unsigned int uNormalBorder, unsigned int uOver,
					unsigned int uOverBorder, unsigned int uSel, unsigned int uSelBorder)
{
