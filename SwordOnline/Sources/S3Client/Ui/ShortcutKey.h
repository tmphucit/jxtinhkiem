...
#define SCK_SHORTCUT_ATI "Switch([[ati]])"

#define SCK_SHORTCUT_KTC "Switch([[ktc]])"
...
public:
  ...
  static BOOL RegisterFunctionAlias(const char *strFunAlias, const char *strFun,
                                    int nParam, const PARAMLIST &List);
