...
public:
	...
	//用于新聊天协议到达的处理
	static int				NewChannelMessageArrival(int figure, DWORD nChannelID, char* szSendName, const char* pMsgBuff, unsigned short nMsgLength);
...
private:
	...
	void	ChannelMessageArrival(int figure, int nChannelIndex, char* szSendName, const char* pMsgBuff, unsigned short nMsgLength, KWndMessageListBox* pM, bool bName);
