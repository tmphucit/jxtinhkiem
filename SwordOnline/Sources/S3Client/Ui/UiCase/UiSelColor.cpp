...
unsigned char KUiSelColor::m_MenuData[MENU_DATA_SIZE(UI_INPUT_MSG_MAX_COLOR)] =
    {0};
...
void KUiSelColor::PopupMenu(KWndWindow *pCaller, unsigned int uParam, int x,
                            int y, int nWidth) {
  KPopupMenu::Cancel();
  KPopupMenuData *pMenuData = (KPopupMenuData *)&m_MenuData;
  pMenuData->nX = x;
...
void KUiSelColor::CancelMenu() { KPopupMenu::Cancel(); }
