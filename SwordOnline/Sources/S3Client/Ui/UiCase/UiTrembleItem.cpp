...
KUiTrembleItem::KUiTrembleItem() { m_nStatus = STATUS_WAITING_MATERIALS; }
 ...
 * 功能：载入界面方案
 **********************************************************************/
int KUiTrembleItem::WndProc(unsigned int uMsg, unsigned int uParam,
                            int nParam) {
  switch (uMsg) {
...
int KCanGetNumImage::GetMaxFrame() { return m_Image.nNumFrames; }

int KCanGetNumImage::GetCurrentFrame() { return m_Image.nFrame; }