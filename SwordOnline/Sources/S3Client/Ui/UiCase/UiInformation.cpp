...
void UIMessageBox(const char *pMsg, KWndWindow *pCaller /*= 0*/,
  ...
  g_UiInformation.Show(pMsg, pszFirstBtnText, pszSecondBtnText, pCaller,
                       uParam);
}

void UiCloseMessageBox() { g_UiInformation.Close(); }
...
//	功能：显示窗口
//--------------------------------------------------------------------------
void KUiInformation::Show(const char *pInformation, const char *pszFirstBtnText,
                          const char *pszSecondBtnText /*= 0*/,
...
//	功能：窗口函数
//--------------------------------------------------------------------------
int KUiInformation::WndProc(unsigned int uMsg, unsigned int uParam,
                            int nParam) {
  int nRet = 0;
  switch (uMsg) {
