...
//--------------------------------------------------------------------------
KBuySlectItemShop *
KBuySlectItemShop::OpenWindow(KUiObjAtContRegion *pObj,
...
//	功能：窗口消息函数
//--------------------------------------------------------------------------
int KBuySlectItemShop::WndProc(unsigned int uMsg, unsigned int uParam,
                               int nParam) {
  int nRet = 0;
  switch (uMsg) {
...
void KBuySlectItemShop::OnCancel() { CloseWindow(false); }
