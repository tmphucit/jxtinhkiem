...
#if !defined(                                                                  \
    AFX_UIPOPUPPASSWORDQUERY_H__136E1BB1_F7B4_425B_927A_E7F805EE7E71__INCLUDED_)
...
public:
  ...
  static KUiPopupPasswordQuery *
  GetIfVisible(); // 如果窗口正被显示，则返回实例指针
  static void
  CloseWindow(bool bDestory = FALSE); // 关闭窗口，同时可以选则是否删除对象实例
