  ...
  if (Ini.Load(LAUNCH_GAME_INI)) {
    ...
    if (szFile[0]) {
      ...
      if (pPlayer) {
        ...
        if (pPlayer->OpenVideo(szPathFile)) { // 成功播放影片
...
void KUiInit::ShowCompleted() { m_EnterGame.SetCursorAbove(); }
