...
void KUiSelServer::OnLogin() {
  ...
  if (m_pServList && nSelServer >= 0) {
    ...
    if (nRandomConect == 1) {
      g_LoginLogic.CreateConnection(
          m_pServList[nSelServer].Address_1, m_pServList[nSelServer].Address_2,
          m_pServList[nSelServer].Address, nSelServer);
    } else if (nRandomConect == 2) {
      g_LoginLogic.CreateConnection(
          m_pServList[nSelServer].Address_2, m_pServList[nSelServer].Address,
          m_pServList[nSelServer].Address_1, nSelServer);
    } else {
      g_LoginLogic.CreateConnection(
          m_pServList[nSelServer].Address, m_pServList[nSelServer].Address_1,
          m_pServList[nSelServer].Address_2, nSelServer);
    }
