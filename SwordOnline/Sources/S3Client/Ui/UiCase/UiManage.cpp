...
//	功能：初始化
//--------------------------------------------------------------------------
int KUiCliqueManage::Init() { return true; }
...
//	功能：窗口函数
//--------------------------------------------------------------------------
int KUiCliqueManage::WndProc(unsigned int uMsg, unsigned int uParam,
                             int nParam) {
...
//	功能：初始化
//--------------------------------------------------------------------------
int KUiConfraternityManage::Init() { return true; }
...
//	功能：窗口函数
//--------------------------------------------------------------------------
int KUiConfraternityManage::WndProc(unsigned int uMsg, unsigned int uParam,
                                    int nParam) // 窗口函数
{
  return KWndPage::WndProc(uMsg, uParam, nParam);
}
...
//	功能：队伍内容变更
//--------------------------------------------------------------------------
void KUiManage::UpdateTeamData(int nID) { m_TeamPad.UpdateDataTeam(nID); }
...
void KUiManage::UpdateLeaderData() {
  ...
  g_pCoreShell->OperationRequest(GDI_PLAYER_LEADERSHIP, (unsigned int)&Leader,
                                 0);
