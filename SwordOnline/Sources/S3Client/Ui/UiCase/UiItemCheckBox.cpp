...
// 功能	: 窗口函数
// -------------------------------------------------------------------------
int KUiItemCheckBox::WndProc(unsigned int uMsg, unsigned int uParam, int nParam)
{
	switch(uMsg)
	{
...
void KUiItemCheckBox::OnItemPickDrop(ITEM_PICKDROP_PLACE* pPickPos, ITEM_PICKDROP_PLACE* pDropPos)
{
