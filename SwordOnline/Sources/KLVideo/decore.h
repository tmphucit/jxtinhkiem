...
//
int decore(
    unsigned long handle,  // handle	- the handle of the calling entity, must
                           // be unique
    unsigned long dec_opt, // dec_opt - the option for docoding, see below
    void *param1,  // param1	- the parameter 1 (it's actually meaning depends
                   // on dec_opt
    void *param2); // param2	- the parameter 2 (it's actually meaning depends
                   // on dec_opt
