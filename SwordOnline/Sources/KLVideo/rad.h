...
#if (defined(__MWERKS__) && !defined(__INTEL__)) || defined(THINK_C) ||        \
    defined(powerc) || defined(macintosh) || defined(__powerc)
...
#define radmemcpy(dest, source, size)                                          \
  BlockMoveData((Ptr)(source), (Ptr)(dest), size)

#define radmemcpydb(dest, source, size)                                        \
  BlockMoveData((Ptr)(source), (Ptr)(dest), size)
...
u32 mult64anddiv(u32 m1, u32 m2, u32 d);
#pragma aux mult64anddiv = "mul ecx"                                           \
                           "div ebx" parm[eax][ecx][ebx] modify[EDX eax];

s32 radabs(s32 ab);
#pragma aux radabs = "test eax,eax"                                            \
                     "jge skip"                                                \
                     "neg eax"                                                 \
                     "skip:" parm[eax];
...
#pragma aux DOSOutNum = "mov ah,0x40"                                          \
                        "mov ebx,1"                                            \
...
#pragma aux ErrOutNum = "mov ah,0x40"                                          \
                        "xor ebx,ebx"                                          \
                        "int 0x21" parm[edx][ecx] modify[eax ebx];
...
#pragma aux radstrupr = "mov ecx,edi"                                          \
                        "lp:"                                                  \
                        "mov al,[edi]"                                         \
                        "cmp al,'a'"                                           \
                        "jb c1"                                                \
...
#pragma aux radstrlwr = "mov ecx,edi"                                          \
                        "lp:"                                                  \
                        "mov al,[edi]"                                         \
                        "cmp al,'A'"                                           \
                        "jb c1"                                                \
...
#define _16To32(ptr16)                                                         \
  ((void *)((                                                                  \
      (GetSelectorBase((u16)(((u32)(ptr16)) >> 16)) + ((u16)(u32)(ptr16))) -   \
...
s16 radabs(s16 ab);
#pragma aux radabs = "test ax,ax"                                              \
                     "jge skip"                                                \
                     "neg ax"                                                  \
                     "skip:" parm[ax] value[ax];

s32 radabs32(s32 ab);
#pragma aux radabs32 = "test dx,dx"                                            \
                       "jge skip"                                              \
                       "neg dx"                                                \
                       "neg ax"                                                \
                       "sbb dx,0"                                              \
...
#pragma aux radstricmp = "and edi,0xffff"                                      \
                         "push ds"                                             \
                         "mov ds,dx"                                           \
                         "and esi,0xffff"                                      \
                         "lp:"                                                 \
...
u32 mult64anddiv(u32 m1, u32 m2, u32 d);
#pragma aux mult64anddiv = "shl ecx,16"                                        \
                           "mov cx,ax"                                         \
                           "shrd eax,edx,16"                                   \
                           "mov ax,si"                                         \
                           "mul ecx"                                           \
                           ...
                           "shld edx,eax,16"                                   \
                           "and edx,0xffff"                                    \
                           "and eax,0xffff" parm[cx ax][dx si]                 \
    [di bx] modify[ax bx cx dx si di] value[dx ax];
...
u8 radtoupper(u8 p);
#pragma aux radtoupper = "cmp al,'a'"                                          \
                         "jb c1"                                               \
                         "cmp al,'z'"                                          \
                         "ja c1"                                               \
                         "sub al,32"                                           \
...
#define LockedIncrement(var)                                                   \
  { ++(var); }
#define LockedDecrement(var)                                                   \
  { --(var); }

#define LockedIncrementFunc(ptr)                                               \
  { ++(*((u32 *)(var))); }
#define LockedDecrementFunc(ptr)                                               \
  { --(*((u32 *)(var))); }
