...
// 返回:	void
//---------------------------------------------------------------------------
BOOL KCanvas::MakeClip(long nX, long nY, long nWidth, long nHeight,
                       KClipper *pClipper) {
  // 初始化裁减量
  pClipper->x = nX;
  pClipper->y = nY;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::DrawLineAlpha(int nX1, int nY1, int nX2, int nY2, int nColor,
                            int nAlpha) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
void KCanvas::DrawSpriteMixColor(int nX, int nY, int nWidth, int nHeight,
                                 void *lpSprite, void *lpPalette, int nColor,
                                 int nAlpha) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
void KCanvas::DrawSpriteBorder(int nX, int nY, int nWidth, int nHeight,
                               int nColor, void *lpSprite) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
  //	Node.m_pDrawFunc = g_DrawSpriteAlpha;
...
void KCanvas::DrawSprite3LevelAlpha(int nX, int nY, int nWidth, int nHeight,
                                    void *lpSprite, void *lpPalette) {
  KDrawNode Node;
  //	Node.m_pPrev = NULL;
  //	Node.m_pNext = NULL;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::DrawFont(int nX, int nY, int nWidth, int nHeight, int nColor,
                       int nAlpha, void *lpFont) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
void KCanvas::DrawFontWithBorder(int nX, int nY, int nWidth, int nHeight,
                                 int nColor, int nAlpha, void *lpFont,
                                 int nBorderColor) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::DrawFontSolid(int nX, int nY, int nWidth, int nHeight, int nColor,
                            int nAlpha, void *lpFont) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::DrawBitmap(int nX, int nY, int nWidth, int nHeight,
                         void *lpBitmap, void *lpPalette) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::DrawBitmap16(int nX, int nY, int nWidth, int nHeight,
                           void *lpBitmap) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::DrawBitmap16mmx(int nX, int nY, int nWidth, int nHeight,
                              void *lpBitmap) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::DrawBitmap16win(int nX, int nY, int nWidth, int nHeight,
                              void *lpBitmap) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
...
// 返回:	void
//---------------------------------------------------------------------------
void KCanvas::ClearAlpha(int nX, int nY, int nWidth, int nHeight, int nColor,
                         int nAlpha) {
  KDrawNode Node;
  Node.m_pPrev = NULL;
  Node.m_pNext = NULL;
