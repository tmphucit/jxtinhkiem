...
KSortBinTree::KSortBinTree() { m_pTreeRoot = NULL; }
...
//---------------------------------------------------------------------------
TBinTreeNode *KSortBinTree::Search(TBinTreeNode *pParentTBinTreeNode,
...
//---------------------------------------------------------------------------
TBinTreeNode *KSortBinTree::AddNode(TBinTreeNode *pNewTBinTreeNode,
                                    TBinTreeNode *pTBinTreeNode) {
...
// 返回:	TBinTreeNode *
//---------------------------------------------------------------------------
TBinTreeNode *KSortBinTree::RemoveNode(TBinTreeNode *pTBinTreeNode,
