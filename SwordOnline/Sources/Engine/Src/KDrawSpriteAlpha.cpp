...
void g_DrawSpriteAlpha(void *node, void *canvas) {
  ...
  // 对绘制区域进行裁剪
  KClipper Clipper;
  if (pCanvas->MakeClip(pNode->m_nX, pNode->m_nY, pNode->m_nWidth,
                        pNode->m_nHeight, &Clipper) == 0)
    return;
...
_DrawFullLineSection_Line_: {
  movd edx, mm1 // mm1: Clipper.width
    ...
    read_alpha_2_ebx_run_length_2_eax
        ...
        or ebx,
        ebx jnz _DrawFullLineSection_LineLocal_Alpha_ lea edi,
        [edi + eax * 2] sub edx,
      ...
      sub edx, eax mov ecx,
          ...
          //_DrawFullLineSection_LineLocal_DirectCopy_:
          {
            ...
            mm0 // mm0: pPalette
                ...
                sub ecx,
            4 jl _DrawFullLineSection_CopyPixel_continue
            _DrawFullLineSection_CopyPixel4_ :
                {copy_4pixel_use_eax

                     sub ecx,
                 4 jg _DrawFullLineSection_CopyPixel4_}
            _DrawFullLineSection_CopyPixel_continue : add ecx,
            4 jz _DrawFullLineSection_CopyPixel_End

                _DrawFullLineSection_CopyPixel_ :
                    {copy_pixel_use_eax dec ecx jnz
                         _DrawFullLineSection_CopyPixel_}
      ...
      _DrawFullLineSection_LineLocal_HalfAlpha_ : {
        movd mm6, edx shr ebx, 3 movd mm3,
            ebx // mm3: nAlpha
                _DrawFullLineSection_HalfAlphaPixel_
            : {mix_2_pixel_color_alpha_use_eabdx loop
                   _DrawFullLineSection_HalfAlphaPixel_} movd edx,
              mm6 or edx,
              edx jnz _DrawFullLineSection_LineLocal_
...
_DrawPartLineSection_
  ...
  mov eax, edx movd edx,
      mm1 // mm1: Clipper.width
          or eax,
...
_DrawPartLineSection_LineLocal_Alpha_: {
  ...
  _DrawPartLineSection_LineLocal_HalfAlpha_ : {
    movd mm6, edx shr ebx, 3 movd mm3,
        ...
        : {mix_2_pixel_color_alpha_use_eabdx loop
               _DrawPartLineSection_HalfAlphaPixel_} movd edx,
          mm6 jmp _DrawPartLineSection_LineLocal_
  }
}
_DrawPartLineSection_LineLocal_Alpha_Part_: {
  add eax, edx mov ecx, eax cmp ebx,
      ...
      //_DrawPartLineSection_LineLocal_DirectCopy_Part_:
      {
        ...
        255 jmp _DrawPartLineSection_LineSkip_
      }
  ...
  _DrawPartLineSection_LineLocal_HalfAlpha_Part_ : {
    movd mm6, edx shr ebx, 3 movd mm3,
        ...
        : {mix_2_pixel_color_alpha_use_eabdx loop
               _DrawPartLineSection_HalfAlphaPixel_Part_} movd edx,
          mm6 neg edx mov ebx,
          nAlpha shl ebx,
          3 // 如果想要确切的原ebx(alpha)值可以在前头push ebx，此处pop获得
          add ebx,
          1 dec Clipper.height jg _DrawPartLineSection_LineSkip_ jmp _EXIT_WAY_
  }
}
}
...
_DrawPartLineSection_SkipLeft_LineLocal_Alpha_: {
        ...
        mm0 // mm0: pPalette
            _DrawPartLineSection_SkipLeft_CopyPixel_ :
                {copy_pixel_use_eax loop
                     _DrawPartLineSection_SkipLeft_CopyPixel_} or
            edx,
  ...
  _DrawPartLineSection_SkipLeft_LineLocal_nAlpha_ : {
    movd mm6, edx shr ebx, 3 movd mm3,
        ...
        : {mix_2_pixel_color_alpha_use_eabdx loop
               _DrawPartLineSection_SkipLeft_HalfAlphaPixel_} movd edx,
          mm6 or edx,
          edx jnz _DrawPartLineSection_SkipLeft_LineLocal_ dec Clipper.height jg
              _DrawPartLineSection_SkipLeft_LineSkip_ jmp _EXIT_WAY_
  }
...
_DrawPartLineSection_SkipRight_LineLocal_Alpha_: {
  ...
  _DrawPartLineSection_SkipRight_LineLocal_HalfAlpha_ : {
    movd mm6, edx shr ebx, 3 movd mm3,
        ...
        : {mix_2_pixel_color_alpha_use_eabdx loop
               _DrawPartLineSection_SkipRight_HalfAlphaPixel_} movd edx,
          mm6 jmp _DrawPartLineSection_SkipRight_LineLocal_
  }
}
_DrawPartLineSection_SkipRight_LineLocal_Alpha_Part_: {
  ...
  _DrawPartLineSection_SkipRight_LineLocal_HalfAlpha_Part_ : {
    movd mm6, edx shr ebx, 3 movd mm3,
        ...
        : {mix_2_pixel_color_alpha_use_eabdx loop
               _DrawPartLineSection_SkipRight_HalfAlphaPixel_Part_} movd edx,
          mm6 neg edx mov ebx,
...
_DrawFullLineSection_Line_: {
  movd edx, mm1 // mm1: Clipper.width
    ...
    read_alpha_2_ebx_run_length_2_eax
      ...
      _DrawFullLineSection_LineLocal_HalfAlpha_ : {
        movd mm6,
            edx _DrawFullLineSection_HalfAlphaPixel_
...
_DrawPartLineSection_LineLocal_Alpha_: {
  cmp eax,
      ...
      //_DrawPartLineSection_LineLocal_DirectCopy_:
      {
        ...
        mm0 // mm0: pPalette
        _DrawPartLineSection_CopyPixel_ :
            {copy_pixel_use_eax loop _DrawPartLineSection_CopyPixel_} movd eax,
        mm5 sub edx,
  ...
  _DrawPartLineSection_LineLocal_HalfAlpha_ : {
    movd mm6,
        edx _DrawPartLineSection_HalfAlphaPixel_
        : {mix_2_pixel_color_use_eabdx loop
               _DrawPartLineSection_HalfAlphaPixel_} movd edx,
          mm6 movd eax,
          mm5 sub edx,
...
_DrawPartLineSection_LineLocal_Alpha_Part_: {
  movd mm5, eax mov ecx, edx cmp ebx,
      ...
      //_DrawPartLineSection_LineLocal_DirectCopy_Part_:
      {
        ...
        _DrawPartLineSection_CopyPixel_Part_ :
            {copy_pixel_use_eax loop
                 _DrawPartLineSection_CopyPixel_Part_} movd eax,
        mm5
  ...
  _DrawPartLineSection_LineLocal_HalfAlpha_Part_ : {
    movd mm6,
        edx _DrawPartLineSection_HalfAlphaPixel_Part_
        : {mix_2_pixel_color_use_eabdx loop
               _DrawPartLineSection_HalfAlphaPixel_Part_} movd edx,
          mm6 movd eax,
          mm5 dec Clipper.height jz _EXIT_WAY_ sub eax,
          edx mov edx,
          eax mov ebx,
          128 // 如果想要确切的原ebx(alpha)值可以在前头push ebx，此处pop获得
          jmp _DrawPartLineSection_LineSkip_
  }
}
}
...
loc_DrawSpriteAlpha_0111:
                ...
                xchg	eax, ebx               // exchange eax,ebx
                mul		ecx                    // eax = eax * (32 -
alpha) add		eax, ebx               // eax = eax + ebx shr
eax, 5                 // c = (c1 * alpha + c2 * (32 - alpha)) / 32 and     eax,
nMask32           // eax = .g.r.b mov     cx, ax                 // ecx = ...r.b
                shr     eax, 16                // eax = ....g.
                or      ax, cx                 // eax = ...rgb
...
loc_Draw_GetLength:						// edx
记录该行压缩数据到裁剪左端的长度，可能是负值
                ...
                inc		esi
                cmp		edx, eax
                jge		loc_Draw_AllLeft		// edx >= eax,
所有数据都在左边界外 mov		ecx, Clipper.width		// ecx
得到Clipper宽度 add		ecx, edx				// ecx =
Clipper宽度 + 压缩数据左端被剪长度 cmp		ecx, 0 jle
loc_Draw_AllRight		// ecx <= 0，所有数据都在右边界外 sub
ecx, eax				// 比较压缩数据长度和 ecx
，ecx小于0的话，ecx值为该段右端裁剪长度 jge		loc_Draw_GetLength_0
// ecx >= eax 说明右端无裁剪 cmp		edx, 0 jl
loc_Draw_RightClip		// 左端有裁剪，右端也有 jmp
loc_Draw_AllClip loc_Draw_GetLength_0: cmp		edx, 0 jl
loc_Draw_NoClip			// 左右都没裁剪 jmp loc_Draw_LeftClip
//---------------------------------------------------------------------------
// 全在左端外
//---------------------------------------------------------------------------
loc_Draw_AllLeft:
...
//loc_Draw_AllRight_0:
                ...
                add		edi, nNextLine
                dec		Clipper.height
                jnz		loc_DrawSpriteAlpha_0400	//
行结束，下一行开始 jmp		loc_DrawSpriteAlpha_exit loc_Draw_AllRight_1:
                add		edi, eax
                add		edi, eax
                add		esi, eax
                sub		edx, eax
                ...
                dec		Clipper.height
                jnz		loc_DrawSpriteAlpha_0400	//
行结束，下一行开始 jmp		loc_DrawSpriteAlpha_exit
//---------------------------------------------------------------------------
// 处理左右端都不用裁剪的压缩段
//---------------------------------------------------------------------------
loc_Draw_NoClip:
...
loc_Draw_AllClip:
                or		ebx, ebx				//
设置标志位 jnz		loc_Draw_AllClip_1		// Alpha值不为零的处理
//loc_Draw_AllClip_0:
                add		edi, eax
                add		edi, eax
                sub		edx, eax
                ...
                cmp		ecx, Clipper.right
                jl		loc_Draw_GetLength		//
Spr该行没完，接着处理 add		edi, nNextLine dec
Clipper.height jnz		loc_DrawSpriteAlpha_0400// 行结束，下一行开始
                jmp		loc_DrawSpriteAlpha_exit
loc_Draw_AllClip_1:
                add		edi, eax
                add		edi, eax
...
eax < 0
                ...
                add		edi, edx				//
补回前面多减的部分 add		edi, edx				//
edi和esi指向实际要 add		esi, edx				//
绘制的部分
                ...
                push	ecx
                mov		ecx, Clipper.width		//
前后都被裁剪，所以绘制长度为Clipper.width mov		ebx, lpPalette
...
loc_Draw_AllClip_End:
                neg		ecx
                add		edi, ecx				//
把edi、esi指针指向下一段 add		edi, ecx add		esi, ecx cmp
ecx, Clipper.right jl		loc_Draw_GetLength		//
Spr该行没完，接着处理 add		edi, nNextLine dec
Clipper.height jnz		loc_DrawSpriteAlpha_0400// 行结束，下一行开始
                jmp		loc_DrawSpriteAlpha_exit
//---------------------------------------------------------------------------
