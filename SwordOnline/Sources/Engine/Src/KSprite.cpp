...
void KSprite::Draw(int nX, int nY, int nFrame) {
  ...
  // draw the frame
  g_pCanvas->DrawSprite(nX + pFrame->OffsetX, nY + pFrame->OffsetY,
                        pFrame->Width, pFrame->Height, pFrame->Sprite,
                        m_pPal16);
}
...
void KSprite::DrawCenter(int nX, int nY, int nFrame) {
  ...
  // draw the frame
  g_pCanvas->DrawSprite(X0 + pFrame->OffsetX, Y0 + pFrame->OffsetY,
                        pFrame->Width, pFrame->Height, pFrame->Sprite,
                        m_pPal16);
}
//---------------------------------------------------------------------------
...
void KSprite::DrawMixColor(int nX, int nY, int nFrame, int nColor, int nAlpha) {
  ...
  // draw the frame
  g_pCanvas->DrawSpriteMixColor(nX + pFrame->OffsetX, nY + pFrame->OffsetY,
                                pFrame->Width, pFrame->Height, pFrame->Sprite,
...
// 返回:	void
//---------------------------------------------------------------------------
void KSprite::DrawWithColor(int nX, int nY, int nFrame, int nColor,
                            int nAlpha) {
  // check frame range
  if (nFrame < 0 || nFrame >= m_nFrames)
    return;
  ...
  // draw the frame
  g_pCanvas->DrawSpriteWithColor(nX + pFrame->OffsetX, nY + pFrame->OffsetY,
                                 pFrame->Width, pFrame->Height, pFrame->Sprite,
                                 m_pPal16, nColor, nAlpha);
}
...
void KSprite::DrawAlpha(int nX, int nY, int nFrame, int nExAlpha) {
  ...
  // draw the frame
  g_pCanvas->DrawSpriteAlpha(nX + pFrame->OffsetX, nY + pFrame->OffsetY,
                             pFrame->Width, pFrame->Height, pFrame->Sprite,
                             m_pPal16, nExAlpha);
}
//---------------------------------------------------------------------------
...
void KSprite::DrawAlphaCenter(int nX, int nY, int nFrame, int nExAlpha) {
  ...
  // draw the frame
  g_pCanvas->DrawSpriteAlpha(X0 + pFrame->OffsetX, Y0 + pFrame->OffsetY,
                             pFrame->Width, pFrame->Height, pFrame->Sprite,
                             m_pPal16, nExAlpha);
}
