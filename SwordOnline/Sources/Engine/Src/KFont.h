...
// #define CHARASET_GBK_MAXFONT		23940			//For GBK
// (0xFE-0x80)*(0xFE-0x3F-1)=23940 #define CHARASET_GB2132_MAXFONT	94 * 94
// //for GB2132 = 35 KB #define CHARASET_BIG5_MAXFONT		94 * 190
// // for BIG5 = 70 KB
