...
// MOUSE_HOVER_MSG_SENT	-->
// 无鼠标活动事件的持续时间超过了设定的时间限制，已发送了WM_NCMOUSEHOVER消息
// 其他值				-->
// 无鼠标活动事件的持续时间未超过设定的时间限制，此值表示无鼠标活动的开始时间
...
BOOL KWin32App::InitWindow(HINSTANCE hInstance) {
  HWND hWnd = CreateWindowEx(
      WS_EX_APPWINDOW, m_szClass, m_szTitle,
      ...
      0, 0, WND_INIT_WIDTH + 6, WND_INIT_HEIGHT + 25, NULL, NULL, hInstance,
      NULL);
...
//			FALSE		失败
//---------------------------------------------------------------------------
BOOL KWin32App::GameInit() { return TRUE; }
//---------------------------------------------------------------------------
// 函数:	GameLoop
// 功能:	游戏主循环
// 参数:	void
...
//			FALSE		失败
//---------------------------------------------------------------------------
BOOL KWin32App::GameExit() { return TRUE; }
//---------------------------------------------------------------------------
// 函数:	MsgProc
// 功能:	窗口回调函数
// 参数:	hWnd		窗口句柄
...
// 返回:	void
//---------------------------------------------------------------------------
void KWin32App::ShowMouse(BOOL bShow) { m_bShowMouse = bShow; }
//---------------------------------------------------------------------------
// 函数:	SetMultiGame
// 功能:	设置是否是后台继续运行的多人游戏
// 参数:	bMulti		BOOL
// 返回:	void
//---------------------------------------------------------------------------
void KWin32App::SetMultiGame(BOOL bMulti) { m_bMultiGame = bMulti; }
