...
BOOL KLuaScriptSet::RunFunction(DWORD nKey, char * szFuncName, int nResults,
char * szFormat, ...)
{
        KLuaScript * pScript;
        pScript = (KLuaScript *) this->GetScript(nKey, 1, 1);
        if (pScript)
        {
                ...
                bResult = pScript->CallFunction(szFuncName, nResults, szFormat,
va); va_end(va); return bResult;
...
BOOL KLuaScriptSet::RunFunction(char * szKey, char * szFuncName, int nResults,
char * szFormat, ...)
{
        KLuaScript * pScript;
        pScript = (KLuaScript *) this->GetScript(szKey, 1, 1);
