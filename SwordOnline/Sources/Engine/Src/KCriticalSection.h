...
public:
  KCriticalSection() { InitializeCriticalSection(&m_CriticalSection); }

  ~KCriticalSection() { DeleteCriticalSection(&m_CriticalSection); }
...
public:
  ...
  ~KAutoCriticalSection() { m_CriticalSection.UnLock(); }
};
