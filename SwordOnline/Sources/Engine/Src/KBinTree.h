...
private:
  ...
  TBinTreeNode *RemoveNode(TBinTreeNode *pTBinTreeNode,
                           TBinTreeNode **ppRootTBinTreeNode);
  TBinTreeNode *Search(TBinTreeNode *pParentTBinTreeNode,
                       TBinTreeNode *pTBinTreeNode, TBinTreeNode *pKeyNode,
                       BOOL *pResult);
