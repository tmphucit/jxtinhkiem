...
BOOL KBmpFile24::SaveBuffer24(LPSTR lpFileName, PVOID pBitmap, int nPitch,
                              int nWidth, int nHeight) {
  return SaveBuffer(lpFileName, pBitmap, nPitch, nWidth, nHeight, true);
}

BOOL KBmpFile24::SaveBuffer32(LPSTR lpFileName, PVOID pBitmap, int nPitch,
                              int nWidth, int nHeight) {
  return SaveBuffer(lpFileName, pBitmap, nPitch, nWidth, nHeight, false);
}

//---------------------------------------------------------------------------
// 函数:	BOOL SaveBuffer(LPSTR lpFileName, PVOID pBitmap, int nWidth, int
// nHeight, bool bIs24Bit) 功能:	编码 参数:	lpFileName	文件名
//			pBitmap		16位色位图
// 返回:	TRUE		成功
//			FALSE		失败
//---------------------------------------------------------------------------
BOOL KBmpFile24::SaveBuffer(LPSTR lpFileName, PVOID pBitmap, int nPitch,
