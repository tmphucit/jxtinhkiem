...
// 返回:	主窗口句柄(有可能为NULL)
//---------------------------------------------------------------------------
HWND g_GetMainHWnd(void) { return g_hWndMain; }
//---------------------------------------------------------------------------
// 函数:	SetMainHWnd
// 功能:	设置主窗口句柄
// 参数:	hWnd	主窗口句柄
// 返回:	void
//---------------------------------------------------------------------------
void g_SetMainHWnd(HWND hWnd) { g_hWndMain = hWnd; }
//---------------------------------------------------------------------------
// 函数:	GetDrawHWnd
// 功能:	取得绘图窗口句柄
// 参数:	void
// 返回:	窗口句柄(有可能为NULL)
//---------------------------------------------------------------------------
HWND g_GetDrawHWnd(void) { return g_hWndDraw; }
//---------------------------------------------------------------------------
// 函数:	SetDrawHWnd
// 功能:	设置绘图窗口句柄
// 参数:	hWnd	窗口句柄
// 返回:	void
//---------------------------------------------------------------------------
void g_SetDrawHWnd(HWND hWnd) { g_hWndDraw = hWnd; }
//---------------------------------------------------------------------------
// 函数:	Get Client Rect
// 功能:	取得窗口客户坐标矩形
// 参数:	lpRect	矩形区域
