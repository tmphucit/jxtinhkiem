...
BOOL KAviFile::GetAudioIndex() {
  ...
  m_audio_index =
      (audio_index_entry *)g_MemAlloc(nai * sizeof(audio_index_entry));
...
BOOL KAviFile::GetVideoIndex() {
  ...
  m_video_index =
      (video_index_entry *)g_MemAlloc(nvi * sizeof(video_index_entry));
...
// 返回:
//---------------------------------------------------------------------------
int KAviFile::VideoStreams() { return m_video_strn; }
//---------------------------------------------------------------------------
// 函数:	AudioStreams
...
// 返回:
//---------------------------------------------------------------------------
int KAviFile::AudioStreams() { return m_audio_strn; }
//---------------------------------------------------------------------------
...
// 返回:
//---------------------------------------------------------------------------
int KAviFile::CurrentFrame() { return m_video_pos; }
//---------------------------------------------------------------------------
// 函数:	TotalFrames
...
// 返回:
//---------------------------------------------------------------------------
int KAviFile::TotalFrames() { return m_video_frames; }
//---------------------------------------------------------------------------
// 函数:	VideoSeek
