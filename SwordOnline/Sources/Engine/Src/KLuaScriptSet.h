...
public:
        ...
        virtual BOOL RunFunction(DWORD nKey, char * szFuncName, int nResults,
char * szFormat, ...); virtual BOOL RunFunction(char * szKey, char * szFuncName,
int nResults, char * szFormat, ...);
