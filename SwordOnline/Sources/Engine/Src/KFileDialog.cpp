...
// 返回:	void
//---------------------------------------------------------------------------
void KFileDialog::SetTitle(LPSTR szTitle) { g_StrCpy(m_szTitle, szTitle); }
//---------------------------------------------------------------------------
// 函数:	SetFlags
// 功能:	设置文件对话窗的标志
// 参数:	Flags	标志
...
//				"Text files (*.txt)|*.TXT|Pascal files
//(*.pas)|*.PAS";
// 返回:	void
//---------------------------------------------------------------------------
...
// 返回:	void
//---------------------------------------------------------------------------
void KFileDialog::SetDefExt(LPSTR szDefExt) { g_StrCpy(m_szDefExt, szDefExt); }
//---------------------------------------------------------------------------
// 函数:	SetFilePath
// 功能:	设置文件路径
// 参数:	lpstrPath	文件路径
