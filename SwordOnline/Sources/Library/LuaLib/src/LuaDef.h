...
int Lua_SetTable_StringFromId(Lua_State *L, int nIndex, int Id,
                              const char *szString);
...
int Lua_SetTable_CFunFromName(Lua_State *L, int nIndex,
                              const char *szMemberName, Lua_CFunction CFun);
int Lua_SetTable_CFunFromId(Lua_State *L, int nIndex, int nId,
                            Lua_CFunction CFun);
int Lua_SetTable_StringFromName(Lua_State *L, int nIndex,
                                const char *szMemberName, char *szString);
int Lua_SetTable_IntFromName(Lua_State *L, int nIndex, const char *szMemberName,
                             int Number);
int Lua_SetTable_DoubleFromName(Lua_State *L, int nIndex,
                                const char *szMemberName, double Number);
