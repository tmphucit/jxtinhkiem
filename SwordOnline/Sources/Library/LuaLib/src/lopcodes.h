...
#define SETARG_U(i, u)                                                         \
  ((i) = (((i) & MASK0(SIZE_U, POS_U)) | ((Instruction)(u) << POS_U)))
...
#define CREATE_AB(o, a, b)                                                     \
  ((Instruction)(o) | ((Instruction)(a) << POS_A) | ((Instruction)(b) << POS_B))
#define GETARG_A(i) ((int)((i) >> POS_A))
#define SETARG_A(i, a)                                                         \
  ((i) = (((i) & MASK0(SIZE_A, POS_A)) | ((Instruction)(a) << POS_A)))
#define GETARG_B(i) ((int)(((i) >> POS_B) & MASK1(SIZE_B, 0)))
#define SETARG_B(i, b)                                                         \
  ((i) = (((i) & MASK0(SIZE_B, POS_B)) | ((Instruction)(b) << POS_B)))
