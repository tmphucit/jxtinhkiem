...
static CORBA::TypeCode_ptr _0RL_tc_Message = CORBA::TypeCode::PR_struct_tc(
    "IDL:Message:1.0", "Message", _0RL_structmember_Message, 3);
const CORBA::TypeCode_ptr _tc_Message = _0RL_tc_Message;

static CORBA::TypeCode_ptr _0RL_tc_MessageSeq = CORBA::TypeCode::PR_alias_tc(
    "IDL:MessageSeq:1.0", "MessageSeq",
    CORBA::TypeCode::PR_sequence_tc(0, _0RL_tc_Message));

const CORBA::TypeCode_ptr _tc_MessageSeq = _0RL_tc_MessageSeq;

const CORBA::TypeCode_ptr _tc_AssistantServer =
    CORBA::TypeCode::PR_interface_tc("IDL:AssistantServer:1.0",
                                     "AssistantServer");
...
_0RL_tcParser_getMemberDesc_Message(tcStructDesc *_desc, CORBA::ULong _index,
...
CORBA::Boolean operator>>=(const CORBA::Any &_a, const Message *&_sp) {
  ...
  if (_sp == 0) {
    ...
    if (_0RL_tctmp->equivalent(_0RL_tc_Message))
      return 1;
    _sp = 0;
    return 0;
  }
...
static void _0RL_tcParser_setElementCount_s0_cMessage(tcSequenceDesc *_desc,
                                                      CORBA::ULong _len) {
...
static CORBA::Boolean _0RL_tcParser_getElementDesc_s0_cMessage(
    tcSequenceDesc *_desc, CORBA::ULong _index, tcDescriptor &_newdesc,
    _CORBA_ULong &_contiguous) {
  _0RL_buildDesc_cMessage(
      _newdesc,
      (*((_CORBA_Unbounded_Sequence<Message> *)_desc->opq_seq))[_index]);

  return 1;
}

static void
_0RL_buildDesc_s0_cMessage(tcDescriptor &_desc,
                           const _CORBA_Unbounded_Sequence<Message> &_data) {
  _desc.p_sequence.opq_seq = (void *)&_data;
  _desc.p_sequence.setElementCount = _0RL_tcParser_setElementCount_s0_cMessage;
  _desc.p_sequence.getElementCount = _0RL_tcParser_getElementCount_s0_cMessage;
  _desc.p_sequence.getElementDesc = _0RL_tcParser_getElementDesc_s0_cMessage;
}
#endif
...
void _0RL_seq_delete_MessageSeq(void *_data) { delete (MessageSeq *)_data; }
...
CORBA::Boolean operator>>=(const CORBA::Any &_a, const MessageSeq *&_s_out) {
  ...
  if (stmp == 0) {
    ...
    if (_a.PR_unpackTo(_tc_MessageSeq, &tcdesc)) {
      ((CORBA::Any *)&_a)
          ->PR_setCachedData((void *)stmp, _0RL_seq_delete_MessageSeq);
      _s_out = stmp;
      return 1;
    } else {
...
static void _0RL_tcParser_setObjectPtr_AssistantServer(tcObjrefDesc *_desc,
  ...
  if (_desc->opq_release && !CORBA::is_nil(*pp))
    CORBA::release(*pp);
  *pp = _p;
  CORBA::release(_ptr);
}
...
void _0RL_buildDesc_cAssistantServer(
    tcDescriptor &_desc,
    const _CORBA_ObjRef_tcDesc_arg<_objref_AssistantServer,
                                   AssistantServer_Helper> &_d) {
...
void operator<<=(CORBA::Any &_a, AssistantServer_ptr _s) {
  tcDescriptor tcd;
  _CORBA_ObjRef_tcDesc_arg<_objref_AssistantServer, AssistantServer_Helper> tmp(
      _s, 0);
  ...
  if (sp == 0) {
    ...
    if (_a.PR_unpackTo(_tc_AssistantServer, &tcd)) {
      if (!omniORB::omniORB_27_CompatibleAnyExtraction) {
        ((CORBA::Any *)&_a)
            ->PR_setCachedData((void *)(AssistantServer_ptr)tmp,
                               _0RL_delete_AssistantServer);
      }
      _s = tmp._retn();
      return 1;
    } else {
      _s = AssistantServer::_nil();
      return 0;
    }
  } else {
