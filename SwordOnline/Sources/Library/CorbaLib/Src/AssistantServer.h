...
public:
  ...
  inline MessageSeq(_CORBA_ULong _max, _CORBA_ULong _len, Message *_val,
...
public:
  ...
  inline Message &operator[](_CORBA_ULong s) { return (*_pd_seq)[s]; }
...
public:
  ...
  inline MessageSeq_out(T_var &s) : _data(s._pd_seq) { s = (T *)0; }
  ...
  inline Message &operator[](_CORBA_ULong i) { return (*_data)[i]; }
...
typedef _CORBA_ObjRef_Var<_objref_AssistantServer, AssistantServer_Helper>
    AssistantServer_var;
typedef _CORBA_ObjRef_OUT_arg<_objref_AssistantServer, AssistantServer_Helper>
    AssistantServer_out;
...
class _objref_AssistantServer : public virtual CORBA::Object,
...
public:
  ...
  _objref_AssistantServer(const char *, IOP::TaggedProfileList *,
...
public:
  inline _pof_AssistantServer()
      : proxyObjectFactory(AssistantServer::_PD_repoId) {}
...
class _impl_AssistantServer : public virtual omniServant {
public:
...
class POA_AssistantServer : public virtual _impl_AssistantServer,
...
inline size_t AssistantServer::_alignedSize(AssistantServer_ptr obj,
                                            size_t offset) {
  return CORBA::AlignedObjRef(obj, _PD_repoId, 24, offset);
}

inline void AssistantServer::_marshalObjRef(AssistantServer_ptr obj,
                                            NetBufferedStream &s) {
