...
size_t Message::_NP_alignedSize(size_t _initialoffset) const {
...
void Message::operator>>=(NetBufferedStream &_n) const {
  MsgId >>= _n;
  PlayerId >>= _n;
  MsgData >>= _n;
}

void Message::operator<<=(NetBufferedStream &_n) {
  MsgId <<= _n;
  PlayerId <<= _n;
  MsgData <<= _n;
}

void Message::operator>>=(MemBufferedStream &_n) const {
  MsgId >>= _n;
  PlayerId >>= _n;
  MsgData >>= _n;
}

void Message::operator<<=(MemBufferedStream &_n) {
  MsgId <<= _n;
  PlayerId <<= _n;
  MsgData <<= _n;
}
...
size_t AssistantServer_Helper::NP_alignedSize(AssistantServer_ptr obj,
                                              size_t offset) {
  return AssistantServer::_alignedSize(obj, offset);
}

void AssistantServer_Helper::marshalObjRef(AssistantServer_ptr obj,
                                           NetBufferedStream &s) {
  AssistantServer::_marshalObjRef(obj, s);
}

AssistantServer_ptr
AssistantServer_Helper::unmarshalObjRef(NetBufferedStream &s) {
...
AssistantServer_ptr
AssistantServer_Helper::unmarshalObjRef(MemBufferedStream &s) {
  return AssistantServer::_unmarshalObjRef(s);
}

AssistantServer_ptr AssistantServer::_duplicate(AssistantServer_ptr obj) {
...
AssistantServer_ptr AssistantServer::_narrow(CORBA::Object_ptr obj) {
...
AssistantServer_ptr AssistantServer::_nil() {
  static _objref_AssistantServer *_the_nil_ptr = 0;
  if (!_the_nil_ptr) {
    omni::nilRefLock().lock();
    if (!_the_nil_ptr)
      _the_nil_ptr = new _objref_AssistantServer;
...
void *_objref_AssistantServer::_ptrToObjRef(const char *id) {
...
class _0RL_cd_7a99751ce44193ca_00000000 : public omniCallDescriptor {
public:
  inline _0RL_cd_7a99751ce44193ca_00000000(LocalCallFn lcfn, const char *op,
                                           size_t oplen, _CORBA_Boolean oneway,
                                           const MessageSeq &a_0,
                                           const char *a_1)
...
CORBA::ULong
_0RL_cd_7a99751ce44193ca_00000000::alignedSize(CORBA::ULong msgsize) {
...
void _0RL_cd_7a99751ce44193ca_00000000::marshalArguments(GIOP_C &giop_client) {
  ...
  {
    CORBA::ULong _len =
        (((const char *)arg_1) ? strlen((const char *)arg_1) + 1 : 1);

    _len >>= giop_client;
    if (_len > 1)
      giop_client.put_char_array((const CORBA::Char *)((const char *)arg_1),
                                 _len);
    else {
...
void _0RL_cd_7a99751ce44193ca_00000000::unmarshalReturnedValues(
    GIOP_C &giop_client) {
...
static void _0RL_lcfn_7a99751ce44193ca_10000000(omniCallDescriptor *cd,
                                                omniServant *svnt) {
  _0RL_cd_7a99751ce44193ca_00000000 *tcd =
      (_0RL_cd_7a99751ce44193ca_00000000 *)cd;
  _impl_AssistantServer *impl = (_impl_AssistantServer *)svnt->_ptrToInterface(
      AssistantServer::_PD_repoId);
  tcd->pd_result = impl->ExecuteSeq(tcd->arg_0, tcd->arg_1);
}

CORBA::Long _objref_AssistantServer::ExecuteSeq(const MessageSeq &MsgSeq,
                                                const char *DataServerName) {
  _0RL_cd_7a99751ce44193ca_00000000 _call_desc(
      _0RL_lcfn_7a99751ce44193ca_10000000, "ExecuteSeq", 11, 0, MsgSeq,
      DataServerName);
...
class _0RL_cd_7a99751ce44193ca_20000000 : public omniCallDescriptor {
public:
  inline _0RL_cd_7a99751ce44193ca_20000000(LocalCallFn lcfn, const char *op,
                                           size_t oplen, _CORBA_Boolean oneway,
                                           const Message &a_0, const char *a_1)
      : omniCallDescriptor(lcfn, op, oplen, oneway), arg_0(a_0), arg_1(a_1) {}
...
CORBA::ULong
_0RL_cd_7a99751ce44193ca_20000000::alignedSize(CORBA::ULong msgsize) {
  msgsize = arg_0._NP_alignedSize(msgsize);
...
void _0RL_cd_7a99751ce44193ca_20000000::unmarshalReturnedValues(
    GIOP_C &giop_client) {
...
// Local call call-back function.
static void _0RL_lcfn_7a99751ce44193ca_30000000(omniCallDescriptor *cd,
                                                omniServant *svnt) {
  _0RL_cd_7a99751ce44193ca_20000000 *tcd =
      (_0RL_cd_7a99751ce44193ca_20000000 *)cd;
  _impl_AssistantServer *impl = (_impl_AssistantServer *)svnt->_ptrToInterface(
      AssistantServer::_PD_repoId);
  tcd->pd_result = impl->Execute(tcd->arg_0, tcd->arg_1);
}

CORBA::Long _objref_AssistantServer::Execute(const Message &Msg,
                                             const char *DataServerName) {
  _0RL_cd_7a99751ce44193ca_20000000 _call_desc(
      _0RL_lcfn_7a99751ce44193ca_30000000, "Execute", 8, 0, Msg,
      DataServerName);
...
omniObjRef *_pof_AssistantServer::newObjRef(const char *mdri,
                                            IOP::TaggedProfileList *p,
                                            omniIdentity *id,
                                            omniLocalIdentity *lid) {
...
CORBA::Boolean _pof_AssistantServer::is_a(const char *id) const {
  if (!strcmp(id, AssistantServer::_PD_repoId))
    return 1;
...
CORBA::Boolean _impl_AssistantServer::_dispatch(GIOP_S &giop_s) {
...
void *_impl_AssistantServer::_ptrToInterface(const char *id) {
  if (!strcmp(id, CORBA::Object::_PD_repoId))
    return (void *)1;
  if (!strcmp(id, AssistantServer::_PD_repoId))
...
const char *_impl_AssistantServer::_mostDerivedRepoId() {
