...
public:
  ...
  inline DataSeq() {}
  inline DataSeq(const DataSeq &s) : _CORBA_Unbounded_Sequence<CORBA::Any>(s) {}

  inline DataSeq(_CORBA_ULong _max)
      : _CORBA_Unbounded_Sequence<CORBA::Any>(_max) {}
  inline DataSeq(_CORBA_ULong _max, _CORBA_ULong _len, CORBA::Any *_val,
...
public:
  ...
  inline CORBA::Any &operator[](_CORBA_ULong s) { return (*_pd_seq)[s]; }
...
public:
  ...
  inline DataSeq_out(T_var &s) : _data(s._pd_seq) { s = (T *)0; }
  ...
  inline CORBA::Any &operator[](_CORBA_ULong i) { return (*_data)[i]; }
...
typedef _CORBA_ObjRef_Var<_objref_SynDataSets, SynDataSets_Helper>
    SynDataSets_var;
typedef _CORBA_ObjRef_OUT_arg<_objref_SynDataSets, SynDataSets_Helper>
    SynDataSets_out;
...
class _objref_SynDataSets : public virtual CORBA::Object,
...
public:
  ...
  _objref_SynDataSets(const char *, IOP::TaggedProfileList *, omniIdentity *,
                      omniLocalIdentity *);
...
class _impl_SynDataSets : public virtual omniServant {
public:
  virtual ~_impl_SynDataSets();

  virtual CORBA::Long Lock(CORBA::Long MapId, CORBA::Long StyleId,
                           CORBA::Long Id, const char *ObjName) = 0;
  virtual CORBA::Long UnLock(CORBA::Long MapId, CORBA::Long StyleId,
                             CORBA::Long Id, CORBA::Long index) = 0;
  virtual CORBA::Any *GetData(CORBA::Long MapId, CORBA::Long StyleId,
                              CORBA::Long Id) = 0;
  virtual CORBA::Any *GetDataMember(CORBA::Long MapId, CORBA::Long StyleId,
                                    CORBA::Long Id, CORBA::Long MemberId) = 0;
  virtual CORBA::Long SetData(CORBA::Long MapId, CORBA::Long StyleId,
                              CORBA::Long Id, const CORBA::Any &data) = 0;
  virtual CORBA::Long SetDataMember(CORBA::Long MapId, CORBA::Long StyleId,
                                    CORBA::Long Id, CORBA::Long MemberId,
                                    const CORBA::Any &data) = 0;
  virtual CORBA::Any *GetDataWithLock(CORBA::Long MapId, CORBA::Long StyleId,
                                      CORBA::Long Id, CORBA::Long &Result,
                                      const char *ObjName) = 0;
  virtual CORBA::Any *
  GetDataMemberWithLock(CORBA::Long MapId, CORBA::Long StyleId, CORBA::Long Id,
                        CORBA::Long MemberId, const CORBA::Any &data,
                        CORBA::Long &Result, const char *ObjName) = 0;
  virtual CORBA::Long SetDataWithLock(CORBA::Long MapId, CORBA::Long StyleId,
                                      CORBA::Long Id, const CORBA::Any &data,
                                      CORBA::Long &Result,
                                      const char *ObjName) = 0;
  virtual CORBA::Long
  SetDataMemberWithLock(CORBA::Long MapId, CORBA::Long StyleId, CORBA::Long Id,
                        CORBA::Long MemberId, const CORBA::Any &data,
                        CORBA::Long &Result, const char *ObjName) = 0;
  virtual CORBA::Any *GetDataWithOnce(CORBA::Long MapId, CORBA::Long StyleId,
                                      CORBA::Long Id, CORBA::Long &Result,
                                      const char *ObjName) = 0;
  virtual CORBA::Any *GetDataMemberWithOnce(CORBA::Long MapId,
                                            CORBA::Long StyleId, CORBA::Long Id,
                                            CORBA::Long MemberId,
                                            CORBA::Long &Result,
                                            const char *ObjName) = 0;
  virtual CORBA::Long SetDataWithOnce(CORBA::Long MapId, CORBA::Long StyleId,
                                      CORBA::Long Id, const CORBA::Any &data,
                                      CORBA::Long &Result,
                                      const char *ObjName) = 0;
  virtual CORBA::Long
  SetDataMemberWithOnce(CORBA::Long MapId, CORBA::Long StyleId, CORBA::Long Id,
                        CORBA::Long MemberId, const CORBA::Any &data,
                        CORBA::Long &Result, const char *ObjName) = 0;
...
class POA_SynDataSets : public virtual _impl_SynDataSets,
...
inline size_t SynDataSets::_alignedSize(SynDataSets_ptr obj, size_t offset) {
  return CORBA::AlignedObjRef(obj, _PD_repoId, 20, offset);
}

inline void SynDataSets::_marshalObjRef(SynDataSets_ptr obj,
                                        NetBufferedStream &s) {
