...
public:
  ...
  CORBA::Long SetDataMember(CORBA::Long id, CORBA::Long MemberId,
                            const CORBA::Any &data);
  CORBA::Any *GetDataWithLock(CORBA::Long id, CORBA::Long &Result,
                              const char *ObjName);
  CORBA::Any *GetDataMemberWithLock(CORBA::Long id, CORBA::Long MemberId,
                                    CORBA::Long &Result, const char *ObjName);
  CORBA::Long SetDataWithLock(CORBA::Long id, const CORBA::Any &data,
                              CORBA::Long &Result, const char *ObjName);
  CORBA::Long SetDataMemberWithLock(CORBA::Long id, CORBA::Long MemberId,
                                    const CORBA::Any &data, CORBA::Long &Result,
                                    const char *ObjName);
  CORBA::Any *GetDataWithOnce(CORBA::Long id, CORBA::Long &Result,
                              const char *ObjName);
  CORBA::Any *GetDataMemberWithOnce(CORBA::Long id, CORBA::Long MemberId,
                                    CORBA::Long &Result, const char *ObjName);
  CORBA::Long SetDataWithOnce(CORBA::Long id, const CORBA::Any &data,
                              CORBA::Long &Result, const char *ObjName);
  CORBA::Long SetDataMemberWithOnce(CORBA::Long id, CORBA::Long MemberId,
                                    const CORBA::Any &data, CORBA::Long &Result,
                                    const char *ObjName);
