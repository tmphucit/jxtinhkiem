...
static CORBA::TypeCode_ptr _0RL_tc_DataSeq = CORBA::TypeCode::PR_alias_tc(
    "IDL:DataSeq:1.0", "DataSeq",
    CORBA::TypeCode::PR_sequence_tc(0, CORBA::TypeCode::PR_any_tc()));

const CORBA::TypeCode_ptr _tc_DataSeq = _0RL_tc_DataSeq;

const CORBA::TypeCode_ptr _tc_SynDataSets =
    CORBA::TypeCode::PR_interface_tc("IDL:SynDataSets:1.0", "SynDataSets");

#ifndef __0RL_tcParser_buildDesc_s0_cany__
#define __0RL_tcParser_buildDesc_s0_cany__
static void _0RL_tcParser_setElementCount_s0_cany(tcSequenceDesc *_desc,
                                                  CORBA::ULong _len) {
...
_0RL_tcParser_getElementDesc_s0_cany(tcSequenceDesc *_desc, CORBA::ULong _index,
                                     tcDescriptor &_newdesc,
                                     _CORBA_ULong &_contiguous) {
  _0RL_buildDesc_cany(
      _newdesc,
      (*((_CORBA_Unbounded_Sequence<CORBA::Any> *)_desc->opq_seq))[_index]);

  return 1;
}

static void
_0RL_buildDesc_s0_cany(tcDescriptor &_desc,
                       const _CORBA_Unbounded_Sequence<CORBA::Any> &_data) {
  _desc.p_sequence.opq_seq = (void *)&_data;
  _desc.p_sequence.setElementCount = _0RL_tcParser_setElementCount_s0_cany;
  _desc.p_sequence.getElementCount = _0RL_tcParser_getElementCount_s0_cany;
  _desc.p_sequence.getElementDesc = _0RL_tcParser_getElementDesc_s0_cany;
}
#endif
...
void _0RL_seq_delete_DataSeq(void *_data) { delete (DataSeq *)_data; }
...
CORBA::Boolean operator>>=(const CORBA::Any &_a, const DataSeq *&_s_out) {
  ...
  if (stmp == 0) {
    ...
    if (_a.PR_unpackTo(_tc_DataSeq, &tcdesc)) {
      ((CORBA::Any *)&_a)
          ->PR_setCachedData((void *)stmp, _0RL_seq_delete_DataSeq);
      _s_out = stmp;
      return 1;
    } else {
      delete (DataSeq *)stmp;
...
static void _0RL_tcParser_setObjectPtr_SynDataSets(tcObjrefDesc *_desc,
...
void _0RL_buildDesc_cSynDataSets(
    tcDescriptor &_desc,
    const _CORBA_ObjRef_tcDesc_arg<_objref_SynDataSets, SynDataSets_Helper>
        &_d) {
  ...
  if (sp == 0) {
    ...
    if (_a.PR_unpackTo(_tc_SynDataSets, &tcd)) {
      if (!omniORB::omniORB_27_CompatibleAnyExtraction) {
        ((CORBA::Any *)&_a)
            ->PR_setCachedData((void *)(SynDataSets_ptr)tmp,
                               _0RL_delete_SynDataSets);
      }
      _s = tmp._retn();
      return 1;
    } else {
