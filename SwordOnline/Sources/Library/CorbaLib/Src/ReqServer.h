...
typedef _CORBA_ObjRef_OUT_arg<_objref_ReqServer, ReqServer_Helper>
    ReqServer_out;
...
class _objref_ReqServer : public virtual CORBA::Object,
...
public:
  ...
  _objref_ReqServer(const char *, IOP::TaggedProfileList *, omniIdentity *,
                    omniLocalIdentity *);
...
class _impl_ReqServer : public virtual omniServant {
public:
  virtual ~_impl_ReqServer();

  virtual void SendResult(CORBA::Long id, CORBA::Long index,
                          CORBA::Long reserve) = 0;
...
class POA_ReqServer : public virtual _impl_ReqServer,
...
inline size_t ReqServer::_alignedSize(ReqServer_ptr obj, size_t offset) {
  return CORBA::AlignedObjRef(obj, _PD_repoId, 18, offset);
}

inline void ReqServer::_marshalObjRef(ReqServer_ptr obj, NetBufferedStream &s) {
  CORBA::MarshalObjRef(obj, _PD_repoId, 18, s);
}

inline void ReqServer::_marshalObjRef(ReqServer_ptr obj, MemBufferedStream &s) {
  CORBA::MarshalObjRef(obj, _PD_repoId, 18, s);
}
