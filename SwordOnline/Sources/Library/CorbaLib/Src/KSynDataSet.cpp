...
CORBA::Object_ptr GetObjectReference(char *szObjName, char *szObjType,
                                     CORBA::ORB_ptr orb);
CORBA::Boolean BindObjectToName(CORBA::ORB_ptr orb, CORBA::Object_ptr objref,
                                char *ObjName, char *ObjType);
...
CORBA::Long KSynDataSet::Lock(CORBA::Long id, const char *ObjName) {
  ...
  if ((lockid = m_LockSets[id].Lock()) < 0) {
    ...
    if (!m_ServerList.IsEmpty()) {
      ...
      for (pServerData = (TServerNode *)m_ServerList.GetHead();
           pServerData != NULL;) {
    ...
    // 未找到的话
    if (!pNode->pServer) // Server  is Not Exist ,Then Build a New Server
                         // Connection
    {
      char cString[100];
...
CORBA::Any *KSynDataSet::GetDataWithLock(CORBA::Long id, CORBA::Long &Result,
                                         const char *ObjName) {
...
CORBA::Long KSynDataSet::SetDataWithLock(CORBA::Long id, const CORBA::Any &data,
                                         CORBA::Long &Result,
                                         const char *ObjName) {
...
CORBA::Long KSynDataSet::SetDataWithOnce(CORBA::Long id, const CORBA::Any &data,
                                         CORBA::Long &Result,
                                         const char *ObjName) {
...
CORBA::Any *KSynDataSet::GetDataWithOnce(CORBA::Long id, CORBA::Long &Result,
                                         const char *ObjName) {
  CORBA::Any *result;
...
CORBA::Boolean BindObjectToName(CORBA::ORB_ptr orb, CORBA::Object_ptr objref,
  ...
  try {
    ...
    objectName.length(1);
    objectName[0].id =
        (const char *)ObjName; //"CorbaPartical";   // string copied
...
CORBA::Long KSynDataSet::SetDataMember(CORBA::Long id, CORBA::Long MemberId,
...
CORBA::Any *KSynDataSet::GetDataMemberWithLock(CORBA::Long id,
                                               CORBA::Long MemberId,
                                               CORBA::Long &Result,
                                               const char *ObjName) {
  if ((Result = Lock(id, ObjName)) > 0) {
...
CORBA::Long KSynDataSet::SetDataMemberWithLock(CORBA::Long id,
                                               CORBA::Long MemberId,
                                               const CORBA::Any &data,
                                               CORBA::Long &Result,
                                               const char *ObjName) {
...
CORBA::Any *KSynDataSet::GetDataMemberWithOnce(CORBA::Long id,
                                               CORBA::Long MemberId,
                                               CORBA::Long &Result,
                                               const char *ObjName) {
  CORBA::Any *result;
...
CORBA::Long KSynDataSet::SetDataMemberWithOnce(CORBA::Long id,
                                               CORBA::Long MemberId,
                                               const CORBA::Any &data,
                                               CORBA::Long &Result,
                                               const char *ObjName) {
