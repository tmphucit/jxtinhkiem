...
ReqServer_ptr ReqServer_Helper::_nil() { return ReqServer::_nil(); }

CORBA::Boolean ReqServer_Helper::is_nil(ReqServer_ptr p) {
  return CORBA::is_nil(p);
}

void ReqServer_Helper::release(ReqServer_ptr p) { CORBA::release(p); }
...
ReqServer_ptr ReqServer::_duplicate(ReqServer_ptr obj) {
...
ReqServer_ptr ReqServer::_narrow(CORBA::Object_ptr obj) {
...
ReqServer_ptr ReqServer::_nil() {
  static _objref_ReqServer *_the_nil_ptr = 0;
  if (!_the_nil_ptr) {
    omni::nilRefLock().lock();
    if (!_the_nil_ptr)
      _the_nil_ptr = new _objref_ReqServer;
...
void *_objref_ReqServer::_ptrToObjRef(const char *id) {
...
class _0RL_cd_d47783c81a1a3517_00000000 : public omniCallDescriptor {
public:
  inline _0RL_cd_d47783c81a1a3517_00000000(LocalCallFn lcfn, const char *op,
...
CORBA::ULong
_0RL_cd_d47783c81a1a3517_00000000::alignedSize(CORBA::ULong msgsize) {
...
static void _0RL_lcfn_d47783c81a1a3517_10000000(omniCallDescriptor *cd,
                                                omniServant *svnt) {
  _0RL_cd_d47783c81a1a3517_00000000 *tcd =
      (_0RL_cd_d47783c81a1a3517_00000000 *)cd;
  _impl_ReqServer *impl =
      (_impl_ReqServer *)svnt->_ptrToInterface(ReqServer::_PD_repoId);
  impl->SendResult(tcd->arg_0, tcd->arg_1, tcd->arg_2);
}

void _objref_ReqServer::SendResult(CORBA::Long id, CORBA::Long index,
                                   CORBA::Long reserve) {
  _0RL_cd_d47783c81a1a3517_00000000 _call_desc(
      _0RL_lcfn_d47783c81a1a3517_10000000, "SendResult", 11, 0, id, index,
      reserve);
...
// Proxy call descriptor class. Mangled signature:
//  _cstring
class _0RL_cd_d47783c81a1a3517_20000000 : public omniCallDescriptor {
public:
  inline _0RL_cd_d47783c81a1a3517_20000000(LocalCallFn lcfn, const char *op,
                                           size_t oplen, _CORBA_Boolean oneway)
...
void _0RL_cd_d47783c81a1a3517_20000000::unmarshalReturnedValues(
    GIOP_C &giop_client) {
...
// Local call call-back function.
static void _0RL_lcfn_d47783c81a1a3517_30000000(omniCallDescriptor *cd,
                                                omniServant *svnt) {
  _0RL_cd_d47783c81a1a3517_20000000 *tcd =
      (_0RL_cd_d47783c81a1a3517_20000000 *)cd;
  _impl_ReqServer *impl =
      (_impl_ReqServer *)svnt->_ptrToInterface(ReqServer::_PD_repoId);
...
char *_objref_ReqServer::GetServerInfo() {
  _0RL_cd_d47783c81a1a3517_20000000 _call_desc(
      _0RL_lcfn_d47783c81a1a3517_30000000, "GetServerInfo", 14, 0);
...
omniObjRef *_pof_ReqServer::newObjRef(const char *mdri,
                                      IOP::TaggedProfileList *p,
                                      omniIdentity *id,
...
CORBA::Boolean _pof_ReqServer::is_a(const char *id) const {
  if (!strcmp(id, ReqServer::_PD_repoId))
    return 1;
...
CORBA::Boolean _impl_ReqServer::_dispatch(GIOP_S &giop_s) {
  ...
  if (!strcmp(giop_s.operation(), "GetServerInfo")) {
    ...
    if (giop_s.response_expected()) {
      ...
      {
        CORBA::ULong _len =
            (((const char *)result) ? strlen((const char *)result) + 1 : 1);

        _len >>= giop_s;
        if (_len > 1)
          giop_s.put_char_array((const CORBA::Char *)((const char *)result),
                                _len);
        else {
...
void *_impl_ReqServer::_ptrToInterface(const char *id) {
  if (!strcmp(id, CORBA::Object::_PD_repoId))
    return (void *)1;
  if (!strcmp(id, ReqServer::_PD_repoId))
...
const char *_impl_ReqServer::_mostDerivedRepoId() {
