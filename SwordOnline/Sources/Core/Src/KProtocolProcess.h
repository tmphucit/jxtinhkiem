...
public:
  ...
  void SyncCurPlayerHeight(BYTE *pMsg);
  ...
  void SyncMaskLock(BYTE *pMsg); // MASK
  void PlayerBlockItemReturn(BYTE *pMsg);
  void PlayerUnBlockItemReturn(BYTE *pMsg);
  void PlayerBlockItemNow(BYTE *pMsg);

  void PlayerUpdateItemVertion(BYTE *pMsg);
  void PlayerUpdateTong(BYTE *pMsg);
  void PlayerOpenStringBox(BYTE *pMsg);
  void PlayerOpenCheckItemBox(BYTE *pMsg);
  void PlayerOpenSlectCheckBox(BYTE *pMsg);
  void PlayerOpenPGBoxItem(BYTE *pMsg);
  void PlayerShopPriceReturn(BYTE *pMsg);
  void PlayerUpdateShopPrice(BYTE *pMsg);
  void PlayerOpenShopReturn(BYTE *pMsg);
  void PlayerUpdateShop(BYTE *pMsg);
  void SysListItemBuyShop(BYTE *pMsg);
  void SysItemBuyShop(BYTE *pMsg);
  void SysNcPosMin(BYTE *pMsg);
  void PlayerBlockBox(BYTE *pMsg);
  void PlayerOpenNewPWBoxItem(BYTE *pMsg);
  void PlayerSendTopTKNew(BYTE *pMsg);
  void PlayerTKSync(BYTE *pMsg);
  ...
  void NpcRideCommand(int nIndex, BYTE *pProtocol);
