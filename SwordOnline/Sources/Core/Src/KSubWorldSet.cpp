...
pPlayScript =(KLuaScript*) g_GetScript("\\script\\congthanh\\npccongthanh.lua");
    if (!pPlayScript)
	{
	}
    else
...
{
		printf("Xay ra loi chay Spcrit dieu khien \\script\\congthanh\\npccongthanh.lua !!!!!");
}
...
pPlayScript =(KLuaScript*) g_GetScript("\\script\\songbac\\chusongbac.lua");
    if (!pPlayScript)
	{
	}
    else
...
{
		printf("Xay ra loi chay Spcrit dieu khien \\script\\songbac\\chusongbac.lua !!!!!");
}
...
pPlayScript =(KLuaScript*) g_GetScript("\\script\\daihoianhhung\\sugia.lua");
    if (!pPlayScript)
	{
	}
    else
...
{
		printf("Xay ra loi chay Spcrit dieu khien \\script\\daihoianhhung\\sugia.lua !!!!!");
}
...
pPlayScript =(KLuaScript*) g_GetScript("\\script\\loidai\\sugialoidai.lua");
    if (!pPlayScript)
	{
	}
    else
...
{
		printf("Xay ra loi chay Spcrit dieu khien \\script\\loidai\\sugialoidai.lua !!!!!");
}
...
pPlayScript =(KLuaScript*) g_GetScript("\\script\\tongkim\\dieukhientk.lua");
    if (!pPlayScript)
	{
	}
    else
...
{
		printf("Xay ra loi chay Spcrit dieu khien \\script\\tongkim\\dieukhientk.lua !!!!!");
}
