...
public:
  ...
  void SetDownSpeed(float nSpeed) { m_nDownSpeed = nSpeed; }

  void SetWindSpeed(float nSpeed) { m_nWindSpeed = nSpeed; }
  ...
  void ShutDown() { m_bIsShutingDown = true; }
...
public:
  ...
  void SetFlareTime(int nTime) { m_nFlareTime = nTime * 2 * 20; }

public:
  virtual bool IsShutDown() { return m_bIsShutDown; }
...
public:
  KWeatherSnow() { m_bIsShutDown = false; }
