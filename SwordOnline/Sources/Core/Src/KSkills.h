...
private:
	...
	int					CastZoneZ				     (TOrdinSkillParam * pSkillParam, int nDir, int nRefPX, int nRefPY) const ;
...
public:
	...
	static void			GetDesc(unsigned long ulSkillId, unsigned long ulLevel,unsigned long ulCurLevel, char * pszMsg, int nOwnerIndex,  bool bGetNextLevelDesc);
