...
/*
  ...
  3、
  技能范围：新手无法学习和使用，技能不能升级，白名以外的人之间可以相互作用，不受战斗关系限制；
  4、  技能消耗：使用此技能消耗角色的内力X点；
  5、
  技能命中：此技能命中率由主动方与被动方等级差决定，命中率＝30－|Lv1－Lv2|×0.3。
  二、任务系统：
  1、  与乞丐对话，选择是否给乞丐钱；
...
public:
  ...
  unsigned long GetDelayPerCastHorse() { return m_ulDelayPerCastHorse; };
  ...
  void GetDesc(unsigned long ulSkillId, unsigned long ulLevel,
  ...
  unsigned long m_ulDelayPerCastHorse;
