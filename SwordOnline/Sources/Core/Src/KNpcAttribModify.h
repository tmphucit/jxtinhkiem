...
private:
	void	(KNpcAttribModify::*ProcessFunc[magic_pass_new_end])(KNpc* pNpc, void* pData);	
	...
	void	StateSkillTime(KNpc* pNpc, void* pData);
	void	ManaShieldPointP(KNpc* pNpc, void* pData);
	void	FatallyStrikeP(KNpc* pNpc, void* pData);
	void	PoisonDamageReturnP(KNpc* pNpc, void* pData);
	void	BuffEmtyReturnP(KNpc* pNpc, void* pData);
	void	ReturnDoSkillEmtyP(KNpc* pNpc, void* pData);
	void	LifeReplenishAddP(KNpc* pNpc, void* pData);
	void	BuffEmtyResP(KNpc* pNpc, void* pData);
	void	TimeCastSkillEffecV(KNpc* pNpc, void* pData);
	void	DoSkillEffecP(KNpc* pNpc, void* pData);
	void	ManaFromDameP(KNpc* pNpc, void* pData);
	void	DoSkillBuff1(KNpc* pNpc, void* pData);
	void	DoSkillBuff2(KNpc* pNpc, void* pData);
	void	DoSkillBuff3(KNpc* pNpc, void* pData);
	void	DoSkillBuff4(KNpc* pNpc, void* pData);
	void	DoSkillBuff5(KNpc* pNpc, void* pData);
	void	DoSkillEffec1P(KNpc* pNpc, void* pData);
	void	TimeCastSkillEffec1V(KNpc* pNpc, void* pData);
	void	DoSkillEffec2P(KNpc* pNpc, void* pData);
	void	TimeCastSkillEffec2V(KNpc* pNpc, void* pData);
	void	ManaShieldExV(KNpc* pNpc, void* pData);
	void	AddSkillLevelV(KNpc* pNpc, void* pData);
	void	AddAllSkillsLevelV(KNpc* pNpc, void* pData);
	void	DamageReturnResistP(KNpc* pNpc, void* pData);
	void	ItemPinkNoMagic(KNpc* pNpc, void* pData);
};
