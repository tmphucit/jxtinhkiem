...
public:
  ...
  KItemDropRateNode() { m_pItemDropRate = NULL; }
  ~KItemDropRateNode() {
    //	if (m_pItemDropRate)
...
public:
  ...
  void InitNpcLevelData(KTabFile *pKindFile, int nNpcTemplateId, int nLevel);
  static int GetNpcLevelDataFromScript(KLuaScript *pScript, char *szDataName,
                                       int nLevel, char *szParam);
  static int GetNpcLevelDataFromScript(KLuaScript *pScript, char *szDataName,
                                       int nLevel, double nParam1,
                                       double nParam2, double nParam3);
