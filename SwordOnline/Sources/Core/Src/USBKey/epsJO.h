 ...
 * Argument			: const
 *char*pszPassword:超级用户的密码(初始密码是“rockey”) Remark : 最先调用
 ************************************************/
...
* Remark			:
在epj_Init()时在内存生成一个随机数(int)，在每次epj_ReadKeyCode后将此
