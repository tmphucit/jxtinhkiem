...
#endif
{
  ...
  virtual void ProcessClientMessage(int nIndex, const char *pChar,
                                    int nSize) = 0;
  virtual void ProcessNewClientMessage(IClient *pTransfer, DWORD dwFromIP,
                                       DWORD dwFromRelayID, int nPlayerIndex,
                                       const char *pChar, int nSize) = 0;
  ...
  virtual bool PlayerDbLoading(int nPlayerIndex, int bSyncEnd, int &nStep,
  ...
  virtual void KickAcountAndBlock(int nPlayerIndex,
                                  const char *szNameCpuIp) = 0;
  ...
  virtual int AddCharacter(int nExtPoint, int nChangeExtPoint, void *pBuffer,
                           GUID *pGuid) = 0;
  ...
  virtual BOOL GroupChat(IClient *pClient, DWORD FromIP,
                         unsigned long FromRelayID, DWORD channid, BYTE tgtcls,
                         DWORD tgtid, const void *pData, size_t size) = 0;
