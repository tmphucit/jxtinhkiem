...
NPC_RELATION KNpcSet::GetRelation(int nId1, int nId2)
{
	...
	{
		if (Npc[nId1].m_Kind == kind_player && Npc[nId2].m_Kind == kind_player && (Npc[nId1].m_nPKFlag == 0 || (Npc[nId1].m_nPKFlag == 1 && Npc[nId2].m_nPKFlag == 0)) && (!Npc[nId1].m_FightMode || !Npc[nId2].m_FightMode))
			return relation_none;

		if ((Npc[nId1].m_Kind == kind_player && Npc[nId2].m_Kind != kind_player && !Npc[nId1].m_FightMode) || (Npc[nId2].m_Kind == kind_player && Npc[nId1].m_Kind != kind_player && !Npc[nId2].m_FightMode))
			return relation_none;
		...
		if (Npc[nId2].m_TypeNpc == 3 && Npc[nId2].m_CurrentCamp == Npc[nId1].m_CurrentCamp)
			return relation_none; 
	...
	else if (Player[CLIENT_PLAYER_INDEX].m_nIndex == nId1)
	{
		...
		if (Npc[nId2].m_Kind == kind_player && 
			...
			(Player[CLIENT_PLAYER_INDEX].m_cPK.GetNormalPKState() == 1 && Npc[nId2].m_nPKFlag == 0) || 
			(Npc[nId1].m_PKValue == MAX_DEATH_PUNISH_PK_VALUE && Npc[nId2].m_PKValue != MAX_DEATH_PUNISH_PK_VALUE) ||
		...
		if (Npc[nId2].m_Kind != kind_player && Npc[nId2].m_Kind != kind_dialoger && !Npc[nId1].m_FightMode)
			return relation_none;
	...
	else	// if (Player[CLIENT_PLAYER_INDEX].m_nIndex == nId2)
	{
		...
		if (Npc[nId1].m_Kind != kind_player && Npc[nId1].m_Kind != kind_dialoger && !Npc[nId2].m_FightMode)
			return relation_none;
	...
	if (Npc[nId1].m_Kind != kind_player || Npc[nId2].m_Kind != kind_player)
	{
		...
		if ((Npc[nId1].m_Kind == kind_player && !Npc[nId1].m_FightMode) || (Npc[nId2].m_Kind == kind_player && !Npc[nId2].m_FightMode))
			return relation_none;
...
//			return relation_none;
		...
		if (nRelation == relation_enemy)
		{
			if (Player[Npc[nId1].m_nPlayerIdx].m_cPK.GetNormalPKState() == 0 || 
				(Player[Npc[nId1].m_nPlayerIdx].m_cPK.GetNormalPKState() == 1 && Player[Npc[nId2].m_nPlayerIdx].m_cPK.GetNormalPKState() == 0) ||
                (Player[Npc[nId1].m_nPlayerIdx].m_cPK.GetPKValue() == MAX_DEATH_PUNISH_PK_VALUE && Player[Npc[nId2].m_nPlayerIdx].m_cPK.GetPKValue() != MAX_DEATH_PUNISH_PK_VALUE) ||
				!Npc[nId1].m_FightMode ||
			    !Npc[nId2].m_FightMode 
				)
				return relation_none;
