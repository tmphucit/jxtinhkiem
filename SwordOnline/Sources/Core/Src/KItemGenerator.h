...
public:
  ...
  BOOL Gen_Quest(IN int, IN OUT KItem *, IN int, IN const int *, IN int);
  ...
  BOOL Gen_Equipment(IN int, IN int, IN int, IN int, IN const int *, IN int,
                     IN int, IN OUT KItem *);
  BOOL Gen_ExistEquipment(IN int, IN int, IN int, IN int, IN const int *,
                          IN int, IN int, IN OUT KItem *);
...
private:
  ...
  BOOL Gen_MagicAttribPink(int, const int *, int, int, KItemNormalAttrib *,
                           int nVersion);

  BOOL Gen_MagicAttribGold(const KBASICPROP_EQUIPMENT *, const int *, int,
                           KItemNormalAttrib *, int nVersion);
