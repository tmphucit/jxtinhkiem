...
private:
	...
	BOOL Gen_MagicAttribPink(int, const int*, int, int, KItemNormalAttrib*, int nVersion);

	BOOL Gen_MagicAttribGold(const KBASICPROP_EQUIPMENT*, const int*, int, KItemNormalAttrib*, int nVersion);
