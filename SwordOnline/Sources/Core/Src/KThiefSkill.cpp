...
int KThiefSkill::OnSkill(KNpc * pNpc)
{
	...
	pNpc->m_SkillList.SetNextCastTime(pNpc->m_ActiveSkillID, SubWorld[pNpc->m_SubWorldIndex].m_dwCurrentTime + GetDelayPerCastHorse());
	else
...
#ifndef _SERVER
void	KThiefSkill::GetDesc(unsigned long ulSkillId,unsigned long ulLevel, unsigned long ulCurLevel, char * pszMsg, int nOwnerIndex,  bool bGetNextLevelDesc)
{
