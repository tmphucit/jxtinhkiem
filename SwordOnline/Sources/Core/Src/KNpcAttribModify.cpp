...
KNpcAttribModify::KNpcAttribModify() {
  ...
  ProcessFunc[magic_meleedamagereturn_v] =
      &KNpcAttribModify::MeleeDamageReturnV;
  ProcessFunc[magic_meleedamagereturn_p] =
      &KNpcAttribModify::MeleeDamageReturnP;
  ProcessFunc[magic_rangedamagereturn_v] =
      &KNpcAttribModify::RangeDamageReturnV;
  ProcessFunc[magic_rangedamagereturn_p] =
      &KNpcAttribModify::RangeDamageReturnP;
  ProcessFunc[magic_damagetomana_p] = &KNpcAttribModify::Damage2ManaP;
  ProcessFunc[magic_adddefense_v] =
      &KNpcAttribModify::ArmorDefenseV; // 与装备加防御统一处理
  ...
  ProcessFunc[magic_poisondamagereduce_v] =
      &KNpcAttribModify::PoisonDamageReduceV;
  ...
  ProcessFunc[magic_addlightingdamage_v] =
      &KNpcAttribModify::AddLightingDamageV;
  ...
  ProcessFunc[magic_stateskilltime] = &KNpcAttribModify::StateSkillTime;
  ProcessFunc[magic_manashieldpoint_p] = &KNpcAttribModify::ManaShieldPointP;
  ProcessFunc[magic_poisondamagereturn_p] =
      &KNpcAttribModify::PoisonDamageReturnP;
  ProcessFunc[magic_buffemtyreturn_p] = &KNpcAttribModify::BuffEmtyReturnP;
  ProcessFunc[magic_returndoskillemty_p] =
      &KNpcAttribModify::ReturnDoSkillEmtyP;
  ProcessFunc[magic_lifereplenishadd_p] = &KNpcAttribModify::LifeReplenishAddP;
  ProcessFunc[magic_buffemtyres_p] = &KNpcAttribModify::BuffEmtyResP;
  ProcessFunc[magic_timecastskilleffec_v] =
      &KNpcAttribModify::TimeCastSkillEffecV;
  ProcessFunc[magic_doskilleffec_p] = &KNpcAttribModify::DoSkillEffecP;
  ProcessFunc[magic_manafromdame_p] = &KNpcAttribModify::ManaFromDameP;
  ProcessFunc[magic_doskillbuff1] = &KNpcAttribModify::DoSkillBuff1;
  ProcessFunc[magic_doskillbuff2] = &KNpcAttribModify::DoSkillBuff2;
  ProcessFunc[magic_doskillbuff3] = &KNpcAttribModify::DoSkillBuff3;
  ProcessFunc[magic_doskillbuff4] = &KNpcAttribModify::DoSkillBuff4;
  ProcessFunc[magic_doskillbuff5] = &KNpcAttribModify::DoSkillBuff5;
  ProcessFunc[magic_doskilleffec1_p] = &KNpcAttribModify::DoSkillEffec1P;
  ProcessFunc[magic_timecastskilleffec1_v] =
      &KNpcAttribModify::TimeCastSkillEffec1V;
  ProcessFunc[magic_doskilleffec2_p] = &KNpcAttribModify::DoSkillEffec2P;
  ProcessFunc[magic_timecastskilleffec2_v] =
      &KNpcAttribModify::TimeCastSkillEffec2V;
  ProcessFunc[magic_manashieldex_v] = &KNpcAttribModify::ManaShieldExV;
  ProcessFunc[magic_addskilllevel_v] = &KNpcAttribModify::AddSkillLevelV;
  ProcessFunc[magic_addallskillslevel_v] =
      &KNpcAttribModify::AddAllSkillsLevelV;
  ProcessFunc[magic_damagereturnresist_p] =
      &KNpcAttribModify::DamageReturnResistP;
  ProcessFunc[magic_itempinknomagic] = &KNpcAttribModify::ItemPinkNoMagic;
}
...
void KNpcAttribModify::ModifyAttrib(KNpc *pNpc, void *pData) {
  ...
  if (pMagic->nAttribType < 0 || pMagic->nAttribType >= magic_pass_new_end ||
      NULL == ProcessFunc[pMagic->nAttribType])
    return;
...
#define defNORMAL_COLD_TIME 60
  ...
  if (pNpc->m_CurrentColdDamage.nValue[0] > 0 &&
      pNpc->m_CurrentColdDamage.nValue[2] > 0)
    pNpc->m_CurrentColdDamage.nValue[1] = thoi_gian_bang;
  else {
...
#define WEAPON_NONE ((MAX_MELEE_WEAPON) + 3)
  ...
  if (nType == WEAPON_ALL) {
    ...
    g_DebugLog("[数值]%s所有物理攻击力增加百分之%d", pNpc->Name,
               pMagic->nValue[0]);
  } else if (nType == WEAPON_RANGE_ALL) {
    pNpc->m_CurrentRangeEnhance += pMagic->nValue[0];
    g_DebugLog("[数值]%s远程物理攻击力增加百分之%d", pNpc->Name,
               pMagic->nValue[0]);
  } else if (nType == WEAPON_NONE) {
    pNpc->m_CurrentHandEnhance += pMagic->nValue[0];
    g_DebugLog("[数值]%s空手物理攻击力增加百分之%d", pNpc->Name,
               pMagic->nValue[0]);
  } else if (nType == WEAPON_MELEE_ALL) {
    for (int i = 0; i < MAX_MELEE_WEAPON; i++) {
      pNpc->m_CurrentMeleeEnhance[i] += pMagic->nValue[0];
    }
    g_DebugLog("[数值]%s近程物理攻击力增加百分之%d", pNpc->Name,
               pMagic->nValue[0]);
  } else if (nType >= 0 && nType < MAX_MELEE_WEAPON) {
    pNpc->m_CurrentMeleeEnhance[nType] += pMagic->nValue[0];
    g_DebugLog("[数值]%s近程武器%d物理攻击力增加百分之%d", pNpc->Name, nType,
               pMagic->nValue[0]);
  }
}
...
#define defPOISON_DAMAGE_INTERVAL 10
  ...
  if (pNpc->m_CurrentPoisonDamage.nValue[0] > 0) {
    pNpc->m_CurrentPoisonDamage.nValue[1] =
        defPOISON_DAMAGE_TIME; // pMagic->nValue[1];
    pNpc->m_CurrentPoisonDamage.nValue[2] =
        defPOISON_DAMAGE_INTERVAL; // pMagic->nValue[2];
  } else {
    pNpc->m_CurrentPoisonDamage.nValue[0] = 0;
    pNpc->m_CurrentPoisonDamage.nValue[1] = 0;
    pNpc->m_CurrentPoisonDamage.nValue[2] = 0;
  }
  g_DebugLog("[数值]%s毒状态变为：间隔%d帧发作一次%d伤害，共持续%d帧",
             pNpc->Name, pNpc->m_CurrentPoisonDamage.nValue[2],
             pNpc->m_CurrentPoisonDamage.nValue[0],
             pNpc->m_CurrentPoisonDamage.nValue[1]);
}
...
void KNpcAttribModify::AttackRatingP(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("[数值]%s命中率增加百分之%d(%d点)", pNpc->Name, pMagic->nValue[0],
             pNpc->m_AttackRating * pMagic->nValue[0] / 100);
}
...
void KNpcAttribModify::BurnTimeReduceP(KNpc *pNpc, void *pData) { return; }
...
void KNpcAttribModify::ColdArmorV(KNpc *pNpc, void *pData) {
  ...
  if (pMagic->nValue[0] > 0) {
    ...
    g_DebugLog("[数值]%s冰护盾变为%d点持续%d帧", pNpc->Name, pMagic->nValue[0],
               pMagic->nValue[1]);
  } else {
...
void KNpcAttribModify::EarthSkillV(KNpc *pNpc, void *pData) {
  ...
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentLightDamage2.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentLightDamage2.nValue[2] += pMagic->nValue[0];
...
void KNpcAttribModify::FastHitRecoverV(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("Thoi gian phuc hoi: name %s - value %d", pNpc->Name,
             pMagic->nValue[0]);
}
...
void KNpcAttribModify::FastWalkRunP(KNpc *pNpc, void *pData) {
  ...
  pNpc->m_CurrentRWSpeed += pMagic->nValue[0];

  pNpc->m_CurrentWalkSpeed =
      pNpc->m_WalkSpeed + (pNpc->m_WalkSpeed * pNpc->m_CurrentRWSpeed) / 100;
  pNpc->m_CurrentRunSpeed =
      pNpc->m_RunSpeed + (pNpc->m_RunSpeed * pNpc->m_CurrentRWSpeed) / 100;
...
void KNpcAttribModify::FireArmorV(KNpc *pNpc, void *pData) {
  ...
  if (pMagic->nValue[0] > 0) {
    ...
    g_DebugLog("[数值]%s火护盾变为%d点持续%d帧", pNpc->Name, pMagic->nValue[0],
               pMagic->nValue[1]);
  } else {
...
void KNpcAttribModify::FireSkillV(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentFireDamage2.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentFireDamage2.nValue[2] += pMagic->nValue[0];
...
void KNpcAttribModify::LifeMaxP(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("[数值]%s生命上限增加了百分之%d(%d点)", pNpc->Name,
             pMagic->nValue[0], pNpc->m_LifeMax * pMagic->nValue[0] / 100);
}
...
void KNpcAttribModify::LightingArmorV(KNpc *pNpc, void *pData) {
  ...
  if (pMagic->nValue[0] > 0) {
    ...
    g_DebugLog("[数值]%s电护盾变为%d点持续%d帧", pNpc->Name, pMagic->nValue[0],
               pMagic->nValue[1]);
  } else {
...
void KNpcAttribModify::ManaMaxP(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("[数值]%s内力上限增加了百分之%d(%d点)", pNpc->Name,
             pMagic->nValue[0], pNpc->m_ManaMax * pMagic->nValue[0] / 100);
}
...
void KNpcAttribModify::ManaShieldP(KNpc *pNpc, void *pData) {
  ...
  if (pMagic->nValue[1] > 0) {
    ...
    g_DebugLog("[数值]%s吸收伤害百分比为%d，持续%d帧", pNpc->Name,
               pMagic->nValue[0], pMagic->nValue[1]);
  } else {
    pNpc->m_ManaShield.nValue[0] += pMagic->nValue[0];
...
void KNpcAttribModify::StateSkillTime(KNpc *pNpc, void *pData) {}

void KNpcAttribModify::ManaShieldPointP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  if (pMagic->nValue[0] > 0) {
    pNpc->m_ManaShieldPoint.nValue[0] += pMagic->nValue[0];
    g_DebugLog("[数值]%s吸收伤害百分比为%d，持续%d帧", pNpc->Name,
               pMagic->nValue[0], pMagic->nValue[1]);
  } else {
    pNpc->m_ManaShieldPoint.nValue[0] += pMagic->nValue[0];
...
void KNpcAttribModify::LifeReplenishAddP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  pNpc->m_CurrentLifeStolenAddPercent += pMagic->nValue[0];
}

void KNpcAttribModify::BuffEmtyResP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  pNpc->m_CurrentBuffEmtyResistPercent.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentBuffEmtyResistPercent.nValue[1] = pMagic->nValue[1];
  pNpc->m_CurrentBuffEmtyResistPercent.nValue[2] = pMagic->nValue[2];
}

void KNpcAttribModify::TimeCastSkillEffecV(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentTimeCastSkillEffec.nValue[0] += pMagic->nValue[0];
}

void KNpcAttribModify::TimeCastSkillEffec1V(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentTimeCastSkillEffec1.nValue[0] += pMagic->nValue[0];
}

void KNpcAttribModify::TimeCastSkillEffec2V(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentTimeCastSkillEffec2.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentTimeCastSkillEffec2.nValue[1] += pMagic->nValue[1];
}

void KNpcAttribModify::DoSkillEffecP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  pNpc->m_CurrentDoSkillEffecPercent.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentDoSkillEffecPercent.nValue[1] = pMagic->nValue[1];
  pNpc->m_CurrentDoSkillEffecPercent.nValue[2] = pMagic->nValue[2];
}

void KNpcAttribModify::DoSkillEffec1P(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  pNpc->m_CurrentDoSkillEffecPercent1.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentDoSkillEffecPercent1.nValue[1] = pMagic->nValue[1];
  pNpc->m_CurrentDoSkillEffecPercent1.nValue[2] = pMagic->nValue[2];
}

void KNpcAttribModify::DoSkillEffec2P(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  pNpc->m_CurrentDoSkillEffecPercent2.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentDoSkillEffecPercent2.nValue[1] = pMagic->nValue[1];
  pNpc->m_CurrentDoSkillEffecPercent2.nValue[2] = pMagic->nValue[2];
}

void KNpcAttribModify::ManaShieldExV(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  if (pMagic->nValue[0] > 0) {
    pNpc->m_CurrentManaShieldExPoint = pMagic->nValue[0] * pNpc->m_CurrentMana;
    pNpc->m_CurrentMana = 0;
  } else
    pNpc->m_CurrentManaShieldExPoint = 0;
}

void KNpcAttribModify::AddSkillLevelV(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  int SkillAddId = pMagic->nValue[2];
  int SkillAddLevel = pMagic->nValue[0];

  if (SkillAddId < 0)
    SkillAddId = -SkillAddId;

  if (SkillAddId > 0 && SkillAddId < MAX_SKILL) {
    pNpc->m_SkillList.m_CurrentListSkillAddLevel[SkillAddId - 1] +=
        SkillAddLevel;
    pNpc->m_SkillList.UpdateMagicAddSkillLevel();
  }
}

void KNpcAttribModify::AddAllSkillsLevelV(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  for (int i = 0; i < MAX_SKILL; i++) {
    pNpc->m_SkillList.m_CurrentListSkillAddLevel[i - 1] += pMagic->nValue[0];
  }

  pNpc->m_SkillList.UpdateMagicAddSkillLevel();
  g_DebugLog("AddAllSkill: %d", pMagic->nValue[0]);
}

void KNpcAttribModify::ManaFromDameP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  pNpc->m_CurrentManaFromDamePercent += pMagic->nValue[0];
}

void KNpcAttribModify::DoSkillBuff1(KNpc *pNpc, void *pData) {}

void KNpcAttribModify::DoSkillBuff2(KNpc *pNpc, void *pData) {}

void KNpcAttribModify::DoSkillBuff3(KNpc *pNpc, void *pData) {}

void KNpcAttribModify::DoSkillBuff4(KNpc *pNpc, void *pData) {}

void KNpcAttribModify::DoSkillBuff5(KNpc *pNpc, void *pData) {}

void KNpcAttribModify::ReturnDoSkillEmtyP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;

  pNpc->m_ReturnDoSkillEmty.nValue[0] += pMagic->nValue[0];
  pNpc->m_ReturnDoSkillEmty.nValue[1] = pMagic->nValue[1];
  pNpc->m_ReturnDoSkillEmty.nValue[2] = pMagic->nValue[2];
}

void KNpcAttribModify::MeleeDamageReturnP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentMeleeDmgRetPercent += pMagic->nValue[0];
  g_DebugLog("[数值]%s近程物理伤害反弹百分比增加%d", pNpc->Name,
             pMagic->nValue[0]);
}
...
void KNpcAttribModify::MetalSkillV(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentPhysicsDamage2.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentPhysicsDamage2.nValue[2] += pMagic->nValue[0];
...
void KNpcAttribModify::PhysicsArmorV(KNpc *pNpc, void *pData) {
  ...
  if (pMagic->nValue[0] > 0) {
    ...
    g_DebugLog("[数值]%s物理护盾变为%d点持续%d帧", pNpc->Name,
               pMagic->nValue[0], pMagic->nValue[1]);
  } else {
...
void KNpcAttribModify::PoisonArmorV(KNpc *pNpc, void *pData) {
  ...
  if (pMagic->nValue[0] > 0) {
    ...
    g_DebugLog("[数值]%s毒护盾变为%d点持续%d帧", pNpc->Name, pMagic->nValue[0],
               pMagic->nValue[1]);
  } else {
...
void KNpcAttribModify::DamageReturnResistP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentDmgRetPercentResist += pMagic->nValue[0];
}

void KNpcAttribModify::ItemPinkNoMagic(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
}

void KNpcAttribModify::PoisonDamageReturnP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentPoisonDmgRetPercent += pMagic->nValue[0];
  g_DebugLog("[数值]%s远程伤害反弹百分比增加%d", pNpc->Name, pMagic->nValue[0]);
}

void KNpcAttribModify::BuffEmtyReturnP(KNpc *pNpc, void *pData) {
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentBuffEmtyRetPercent.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentBuffEmtyRetPercent.nValue[1] = pMagic->nValue[1];
  pNpc->m_CurrentBuffEmtyRetPercent.nValue[2] = pMagic->nValue[2];
...
void KNpcAttribModify::StaminaMaxP(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("[数值]%s体力上限增加了百分之%d(%d点)", pNpc->Name,
             pMagic->nValue[0], pNpc->m_StaminaMax * pMagic->nValue[0] / 100);
}
...
void KNpcAttribModify::StealLifeP(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("[数值]%s偷生命百分比为%d(比原本上升了%d点)", pNpc->Name,
             pNpc->m_CurrentLifeStolen, pMagic->nValue[0]);
}
...
void KNpcAttribModify::StealManaP(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("[数值]%s偷内力百分比为%d(比原本上升了%d点)", pNpc->Name,
             pNpc->m_CurrentManaStolen, pMagic->nValue[0]);
}
...
void KNpcAttribModify::StealStaminaP(KNpc *pNpc, void *pData) {
  ...
  g_DebugLog("[数值]%s偷体力百分比为%d(比原本上升了%d点)", pNpc->Name,
             pNpc->m_CurrentStaminaStolen, pMagic->nValue[0]);
}
...
void KNpcAttribModify::WaterSkillV(KNpc *pNpc, void *pData) {
  ...
  pNpc->m_CurrentColdDamage2.nValue[0] += pMagic->nValue[0];
  pNpc->m_CurrentColdDamage2.nValue[2] += pMagic->nValue[0];
  if (pNpc->m_CurrentColdDamage2.nValue[0] > 0 &&
      pNpc->m_CurrentColdDamage2.nValue[2] > 0)
    pNpc->m_CurrentColdDamage2.nValue[1] = thoi_gian_bang;
  else {
    pNpc->m_CurrentColdDamage2.nValue[0] = 0;
    pNpc->m_CurrentColdDamage2.nValue[1] = 0;
    pNpc->m_CurrentColdDamage2.nValue[2] = 0;
  }
...
#define defPOISON_DAMAGE_INTERVAL 10
  KMagicAttrib *pMagic = (KMagicAttrib *)pData;
  pNpc->m_CurrentPoisonDamage2.nValue[0] += pMagic->nValue[0];

  if (pNpc->m_CurrentPoisonDamage2.nValue[0] > 0) {
    pNpc->m_CurrentPoisonDamage2.nValue[1] =
        defPOISON_DAMAGE_TIME; // pMagic->nValue[1];
    pNpc->m_CurrentPoisonDamage2.nValue[2] =
        defPOISON_DAMAGE_INTERVAL; // pMagic->nValue[2];
  } else {
    pNpc->m_CurrentPoisonDamage2.nValue[0] = 0;
    pNpc->m_CurrentPoisonDamage2.nValue[1] = 0;
    pNpc->m_CurrentPoisonDamage2.nValue[2] = 0;
  }
...
void KNpcAttribModify::LifePotionV(KNpc *pNpc, void *pData) {
  ...
  pNpc->m_LifeState.nValue[0] =
      (nX1 * nY1 + nX2 * nY2) / pNpc->m_LifeState.nTime;
  g_DebugLog("[数值]%s喝了补血药，获得%d帧内每10帧回复%d点生命的效果",
             pNpc->Name, pNpc->m_LifeState.nTime, pNpc->m_LifeState.nValue[0]);
}
...
void KNpcAttribModify::ManaPotionV(KNpc *pNpc, void *pData) {
  ...
  pNpc->m_ManaState.nValue[0] =
      (nX1 * nY1 + nX2 * nY2) / pNpc->m_ManaState.nTime;
  g_DebugLog("[数值]%s喝了补内力药，获得%d帧内每10帧回复%d点内力的效果",
             pNpc->Name, pNpc->m_ManaState.nTime, pNpc->m_ManaState.nValue[0]);
}
