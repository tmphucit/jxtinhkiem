...
KNpcAttribModify::KNpcAttribModify()
{
	...
	ProcessFunc[magic_returndoskillemty_p] = &KNpcAttribModify::ReturnDoSkillEmtyP;
	...
	ProcessFunc[magic_timecastskilleffec_v] = &KNpcAttribModify::TimeCastSkillEffecV;
	...
	ProcessFunc[magic_timecastskilleffec1_v] = &KNpcAttribModify::TimeCastSkillEffec1V;
	ProcessFunc[magic_doskilleffec2_p] = &KNpcAttribModify::DoSkillEffec2P;
	ProcessFunc[magic_timecastskilleffec2_v] = &KNpcAttribModify::TimeCastSkillEffec2V;
	...
	ProcessFunc[magic_addallskillslevel_v] = &KNpcAttribModify::AddAllSkillsLevelV;
	ProcessFunc[magic_damagereturnresist_p] = &KNpcAttribModify::DamageReturnResistP;
...
void KNpcAttribModify::ModifyAttrib(KNpc* pNpc, void* pData)
{
	...
	if (pMagic->nAttribType < 0 || pMagic->nAttribType >= magic_pass_new_end || NULL == ProcessFunc[pMagic->nAttribType])
		return;
...
void KNpcAttribModify::FastHitRecoverV(KNpc* pNpc, void* pData)
{
	...
	g_DebugLog("Thoi gian phuc hoi: name %s - value %d", pNpc->Name, pMagic->nValue[0]);
}
...
void KNpcAttribModify::FastWalkRunP(KNpc* pNpc, void* pData)
{
	...
	pNpc->m_CurrentWalkSpeed = pNpc->m_WalkSpeed + (pNpc->m_WalkSpeed * pNpc->m_CurrentRWSpeed) / 100;
	pNpc->m_CurrentRunSpeed = pNpc->m_RunSpeed + (pNpc->m_RunSpeed * pNpc->m_CurrentRWSpeed) / 100;
...
{
pNpc->m_SkillList.m_CurrentListSkillAddLevel[SkillAddId-1] += SkillAddLevel;
...
thoi_gian_bang = 64;
	...
	if (pNpc->m_CurrentColdDamage2.nValue[0] > 0 && pNpc->m_CurrentColdDamage2.nValue[2] > 0)
...
#define	defPOISON_DAMAGE_INTERVAL	10
	...
	{
		pNpc->m_CurrentPoisonDamage2.nValue[1] = defPOISON_DAMAGE_TIME;//pMagic->nValue[1];
		pNpc->m_CurrentPoisonDamage2.nValue[2] = defPOISON_DAMAGE_INTERVAL;//pMagic->nValue[2];
	}
	else
	{
