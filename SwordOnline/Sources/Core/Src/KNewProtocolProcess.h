...
protected:
  typedef void (*FUN_PROCESS_NEW_PROTOCOL)(IClient *pTransfer, DWORD dwFromIP,
                                           DWORD dwFromRelayID,
...
public:
  ...
  static void P_ProcessGMExecute(IClient *pTransfer, DWORD dwFromIP,
                                 DWORD dwFromRelayID, int nPlayerIndex,
                                 BYTE *pData, int nDataSize);
  static void P_ProcessGMFindPlayer(IClient *pTransfer, DWORD dwFromIP,
                                    DWORD dwFromRelayID, int nPlayerIndex,
                                    BYTE *pData, int nDataSize);

  static void P_ProcessPlayerCommExtend(IClient *pTransfer, DWORD dwFromIP,
                                        DWORD dwFromRelayID, int nPlayerIndex,
                                        BYTE *pData, int nDataSize);

  static void P_ProcessChatExtend(IClient *pTransfer, DWORD dwFromIP,
                                  DWORD dwFromRelayID, int nPlayerIndex,
                                  BYTE *pData, int nDataSize);
