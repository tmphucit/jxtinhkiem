...
enum MAGIC_ATTRIB {
  ...
  magic_addskilldame6,
  magic_skilllevelexp,
  magic_skilladdmissles,
  magic_nstatus_p,
  magic_invisibility_p,
  magic_madness_p,
  magic_dame_new_end,

  magic_pass_new_begin,
  magic_stateskilltime,
  magic_manashieldpoint_p,
  magic_poisondamagereturn_p,
  magic_buffemtyreturn_p,
  magic_returndoskillemty_p,
  magic_lifereplenishadd_p,
  magic_buffemtyres_p,
  magic_timecastskilleffec_v,
  magic_doskilleffec_p,
  magic_manafromdame_p,
  magic_doskillbuff1,
  magic_doskillbuff2,
  magic_doskillbuff3,
  magic_doskillbuff4,
  magic_doskillbuff5,
  magic_doskilleffec1_p,
  magic_timecastskilleffec1_v,
  magic_doskilleffec2_p,
  magic_timecastskilleffec2_v,
  magic_manashieldex_v,
  magic_addskilllevel_v,
  magic_addallskillslevel_v,
  magic_damagereturnresist_p,
  magic_itempinknomagic,
  magic_pass_new_end,

};

extern const char MAGIC_ATTRIB_STRING[magic_pass_new_end + 1][100];
