...
//	if (Npc[nNpcIdx].m_nCurConutTimeSyn > 1 || Npc[nNpcIdx].m_nCurConutTimeSyn < 0)
//	{
...
//	if (Object[pNode->m_nIndex].m_nCurConutTimeSyn > 1 || Object[pNode->m_nIndex].m_nCurConutTimeSyn < 0)
//	{
