...
public:
  ...
  // 绘制
  void DrawAlpha(int nX,             // 屏幕坐标 x
                 int nY,             // 屏幕坐标 y
                 int nExAlpha = 32); // alpha 度
  // 绘制边框
  void DrawBorder(int nX,      // 屏幕坐标 x
                  int nY,      // 屏幕坐标 y
                  int nColor); // 颜色
};
