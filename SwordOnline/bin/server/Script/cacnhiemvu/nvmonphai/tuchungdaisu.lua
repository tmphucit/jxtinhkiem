...
if GetTask(103) == 23 then
	SetTask(103,24)
	Talk(1,"","Ng­¬i ®· ®Õn trÔn 1 b­íc, §¹i S­ Trô Tr× ®i <color=yellow>Kim Quang §éng<color> vÉn ch­a vÒ ",
	"Ng­¬i h·y ®Õn ®ã t×m gióp ta nhĞ !")
	Msg2Player("§i Kim Quang §éng vµ biÕt ®­îc n¬i ®©y cã mét tªn ph¶n t¨ng hoµnh hµnh b¸ ®¹o tªn lµ Thµnh Kh«n 179/185, 204/190. Cã thÓ Trô Tr× ®ang gÆp nguy hiÓm")
