...
SayNew("<color=green>¡n Mµy: <color> §©u ph¶i c¸i g× muèn còng cã ®©u, cø tiÒn ®i tr­íc rïi tİnh tiÕp nhĞ ",2,
"Giao cho h¾n 5 v¹n l­îng lÊy Tİn VËt /chotien",
"Tho¸t /no")
else
SayNew("<color=green>¡n Mµy: <color>§¹i hiÖp xin bè thİ cho kÎ ¨n xin kh«ng n¬i n­¬ng tùa nµy chót xİu ®Ó sèng qua ngµy..",2,
