...
Talk(1,"","<color=green>M¹c SÇu: <color> Ta ®· nãi lµ nã ë Ph­îng T­êng 232/219 råi mµ. H·y ®i nhanh ®i !")
...
function nhannv()
SetTask(157,5)
Msg2Player("<color=green>[NhiÖm Vô Hoµng Kim] <color=red>Tiªu diÖt Lý M¹c SÇu gi¶ ë Ph­îng T­êng 232/219")
Talk(1,"","<color=green>M¹c SÇu: <color> Lý M¹c SÇu gi¶ ®ang ë Ph­îng T­êng 232/219. H·y gióp ta nhÐ !")
end
function no()
end
