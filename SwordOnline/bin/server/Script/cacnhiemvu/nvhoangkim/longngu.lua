...
function main()
SayNew("<color=green>Long Ngò <color>: Chµo <color=red>"..GetName().."<color>, chóng ta h·y b¾t ®Çu vµo nh÷ng thö th¸ch míi nµo!",3,
...
Pay(50000)
	if GetCash() == (n-50000) then
	AddMagic(210,1)
	else
	Talk(1,"","Hack ha em")
	end
else
Talk(1,"","<color=green>Long Ngò <color>: B¹n kh«ng mang ®ñ <color=yellow> 5 v¹n<color> l­îng")
end
end
function nvtanthu()
if GetTask(nv) == 0 then
SayNew("<color=green>Long Ngò <color>: Chµo <color=red>"..GetName().."<color>, chóng ta h·y b¾t ®Çu vµo nh÷ng thö th¸ch míi nµo!",2,
"NhËn nhiÖm vô /nhnv",
"Tho¸t./no")
elseif GetTask(nv) == 1 then
	if GetTask(sl) >= 3 then
		...
		"<color=green>Long Ngò <color>: H·y ®Õn D­îc §iÕm ë Ph­îng T­êng mua 1 b×nh Ngò Hoa T¸n ®em vÒ cho ta !")
	else
...
elseif GetTask(nv) == 2 then
	...
	Talk(1,"","<color=green>Long Ngò <color>: H·y ®Õn D­îc §iÕm ë Ph­îng T­êng mua 1 b×nh Ngò Hoa T¸n ®em vÒ cho ta !")
	end
...
if GetTask(nv) == 4 then
 	Talk(1,"","<color=green>Long Ngò <color>: §Õn Ph­îng T­êng 212/197 t×m <color=red> Lý M¹c SÇu ")	
elseif GetTask(nv) < 4 then
