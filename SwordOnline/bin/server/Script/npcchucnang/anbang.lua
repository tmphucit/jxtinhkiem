function main()
SayNew("<color=green>An Bang Sø Gi¶: <color> Ng­êi cã mang theo <color=red> LÖnh Bµi An Bang <color> ®Õn ®©y kh«ng? ",5,
...
if GetItemCount(38) >= 1 then
	...
	Msg2Player("B¹n NhËn §­îc 1 An Bang §iÒn Hoµng Th¹ch Ngäc Béi ")
	Talk(0,"no","")
	else
	Talk(1,"","hack ha em")
	end
...
Msg2Player("B¹n kh«ng mang theo <color=red> LÖnh Bµi An Bang ")
end
...
if GetItemCount(37) >= 1 then
	...
	Msg2Player("B¹n NhËn §­îc 1 An Bang Kª HuyÕt Th¹ch Giíi ChØ ")
	Talk(0,"no","")
	else
	Talk(1,"","hack ha em")
	end
...
if GetItemCount(36) >= 1 then
	...
	Msg2Player("B¹n NhËn §­îc 1 An Bang Cóc Hoa Th¹ch ChØ Hoµn")
	Talk(0,"no","")
	else
	Talk(1,"","hack ha em")
	end
...
if GetItemCount(35) >= 1 then
	...
	Msg2Player("B¹n NhËn §­îc 1 An Bang Tinh Th¹ch H¹ng Liªn")
	Talk(0,"no","")
	else
	Talk(1,"","hack ha em")
	end
...
Msg2Player("B¹n kh«ng mang theo <color=yellow> LÖnh Bµi An Bang")
end
