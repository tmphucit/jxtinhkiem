...
function thanhthi()
	w,x,y = GetWorldPos()
	SayNew("Chän Thµnh ThÞ muèn ®Õn : ",8,
...
function thontran99()
	w,x,y = GetWorldPos()
	SayNew("Chän Th«n trÊn muèn ®Õn : ",5,
...
function duongchau()
if GetCash() < 0 then
Talk(1,"","B¹n kh«ng ®ñ 200 l­îng kh«ng thÓ di chuyÓn D­¬ng ch©u !")
return
end
Pay(200)
SetFightState(0)
...
function laman()
if GetCash() < 0 then
Talk(1,"","B¹n kh«ng ®ñ 200 l­îng kh«ng thÓ di chuyÓn L©m An !")
return
end
Pay(200)
SetFightState(0)
i = random(1,4)
if i == 1 then
NewWorld(63,1602,2921);
elseif i == 4 then
NewWorld(63,1379,3336);
elseif i == 3 then
