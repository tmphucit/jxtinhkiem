...
Include("\\script\\event\\nhagiao\\dsbohoahong.lua")
Include("\\script\\event\\nhagiao\\dstopngay.lua")
Include("\\script\\event\\nhagiao\\dsnhanthuong.lua")
...
"NhËn th­ëng sù kiÖn Top L¸ Th­ ThÇy §å /nhanthuonglathuthaydo",
--"GhÐp L¸ Th­ ThÇy §å /ghepbohoahong",
--"TÆng L¸ Th­ ThÇy §å /noplaco",
--"KiÓm tra danh s¸ch Top Sù KiÖn /kiemtratop",
--"Gia h¹n sù kiÖn Phô N÷ ViÖt Nam /giahan", 
--"NhËn th­ëng mèc L¸ Th­ ThÇy §å /nhanthuongmoc",
