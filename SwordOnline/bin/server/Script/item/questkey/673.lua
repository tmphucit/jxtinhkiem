...
if GetItemCount(673) >= 1 then
	...
	if GetItemCount(673) == (n-1) then
		...
		SetTask(530, 16)
		SetTask(531, 1000000)
		Talk(1,"","§· sö dông thµnh c«ng <color=green>H¹t May M¾n<color>, nhËn ®­îc <color=yellow>1.000.000 kinh nghiÖm<color> liªn tôc trong 15 phót !")
		Msg2Player("§· sö dông thµnh c«ng <color=green>H¹t May M¾n<color=red>, nhËn ®­îc <color=yellow>1.000.000 kinh nghiÖm<color=red> liªn tôc trong 15 phót !")
