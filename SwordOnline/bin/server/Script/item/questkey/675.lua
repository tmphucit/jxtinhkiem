...
n = GetItemCount(675)
if GetItemCount(675) >= 1 then
	DelItemIdx(idx);
	if GetItemCount(675) == (n-1) then
		SetTask(529 , ngay)
		SetTask(530, 16)
		SetTask(531, 1600000)
		Talk(1,"","§· sö dông thµnh c«ng <color=green>H¹t Thñy Tinh<color>, nhËn ®­îc <color=yellow>1.600.000 kinh nghiÖm<color> liªn tôc trong 15 phót !")
		Msg2Player("§· sö dông thµnh c«ng <color=green>H¹t Thñy Tinh<color=red>, nhËn ®­îc <color=yellow>1.600.000 kinh nghiÖm<color=red> liªn tôc trong 15 phót !")
