...
n = GetItemCount(674)
if GetItemCount(674) >= 1 then
	DelItemIdx(idx);
	if GetItemCount(674) == (n-1) then
		SetTask(529 , ngay)
		SetTask(530, 16)
		SetTask(531, 1300000)
		Talk(1,"","§· sö dông thµnh c«ng <color=green>H¹t Hoa Hång<color>, nhËn ®­îc <color=yellow>1.300.000 kinh nghiÖm<color> liªn tôc trong 15 phót !")
		Msg2Player("§· sö dông thµnh c«ng <color=green>H¹t Hoa Hång<color=red>, nhËn ®­îc <color=yellow>1.300.000 kinh nghiÖm<color=red> liªn tôc trong 15 phót !")
