...
SetNpcScript(quai1[i], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 2
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+50], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 3
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+100], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 4
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+150], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 5
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+200], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 6
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+250], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
bossall1=AddNpc(594+887,99,ai,196*8*32,201*16*32)
SetNpcScript(bossall1, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 7
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+300], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
boss22=AddNpc(595+887,99,ai,196*8*32,201*16*32)
SetNpcScript(boss22, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 8
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+350], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
boss23=AddNpc(596+887,99,ai,196*8*32,201*16*32)
SetNpcScript(boss23, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 9
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+400], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
boss24=AddNpc(597+887,99,ai,196*8*32,201*16*32)
SetNpcScript(boss24, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 10
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+450], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
bossall5=AddNpc(598+887,99,ai,196*8*32,201*16*32)
SetNpcScript(bossall5, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 11
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+500], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 12
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+550], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 13
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+600], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 14
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+650], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
boss26=AddNpc(599+887,99,ai,196*8*32,201*16*32)
SetNpcScript(boss26, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 15
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+700], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
boss27=AddNpc(random(600+887,601+887),99,ai,196*8*32,201*16*32)
SetNpcScript(boss27, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 16
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+750], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
boss28=AddNpc(random(602+887,603+887),99,ai,196*8*32,201*16*32)
SetNpcScript(boss28, "\\script\\hoatdong\\vuotai\\bossall1.lua")
-- Ai 17
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+800], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
-- Ai 18
for i=1,50 do
ai = SubWorldID2Idx(27)
...
SetNpcScript(quai1[i+850], "\\script\\hoatdong\\vuotai\\sugiaall.lua")
end
ai = SubWorldID2Idx(27)
...
SetNpcScript(boss29, "\\script\\hoatdong\\vuotai\\bossall5.lua")
end
