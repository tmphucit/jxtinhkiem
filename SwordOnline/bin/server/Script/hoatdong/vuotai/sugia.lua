...
SetNpcScript(quai[i], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 2
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+50], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 3
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+100], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 4
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+150], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 5
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+200], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 6
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+250], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss11=AddNpc(594,99,ai,196*8*32,201*16*32)
SetNpcScript(boss11, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 7
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+300], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss12=AddNpc(595,99,ai,196*8*32,201*16*32)
SetNpcScript(boss12, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 8
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+350], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss13=AddNpc(596,99,ai,196*8*32,201*16*32)
SetNpcScript(boss13, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 9
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+400], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss14=AddNpc(597,99,ai,196*8*32,201*16*32)
SetNpcScript(boss14, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 10
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+450], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss15=AddNpc(598,99,ai,196*8*32,201*16*32)
SetNpcScript(boss15, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 11
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+500], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 12
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+550], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 13
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+600], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 14
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+650], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss16=AddNpc(599,99,ai,196*8*32,201*16*32)
SetNpcScript(boss16, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 15
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+700], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss17=AddNpc(random(600,601),99,ai,196*8*32,201*16*32)
SetNpcScript(boss17, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 16
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+750], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
boss18=AddNpc(random(602,603),99,ai,196*8*32,201*16*32)
SetNpcScript(boss18, "\\script\\hoatdong\\vuotai\\boss1.lua")
-- Ai 17
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+800], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
-- Ai 18
for i=1,50 do
ai = SubWorldID2Idx(26)
...
SetNpcScript(quai[i+850], "\\script\\hoatdong\\vuotai\\sugia.lua")
end
ai = SubWorldID2Idx(26)
...
SetNpcScript(boss19, "\\script\\hoatdong\\vuotai\\boss5.lua")
end
...
if GetTeam() ~= nil then
	if GetTeamSize() >= 6 then
		if IsCaptain() == 1 then
			SayNew("<color=green>Sö gi¶ V­ît ¶i<color>: V­ît ¶i sÏ cÇn cã <color=red>5 S¸t thñ gi¶n<color> vµ tÊt c¶ thµnh viªn level trªn <color=red>70<color>. H·y t×m nhanh ®i !",2,
...
Talk(1,"no","Trong tæ ®éi ®· cã thµnh viªn ®i V­ît ¶i 1 lÇn trong ngµy hoÆc kh«ng mang theo LÖnh Bµi V­ît ¶i. H·y chän ng­êi kh¸c ®i")
end
else
...
LoginLog = openfile("Data/LogVuotAi_SuGia.txt", "a");
if LoginLog then
