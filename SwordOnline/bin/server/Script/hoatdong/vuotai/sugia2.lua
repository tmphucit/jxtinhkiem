...
SetNpcScript(quai2[i], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 2
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+50], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 3
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+100], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 4
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+150], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 5
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+200], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 6
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+250], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss31=AddNpc(594,99,ai,196*8*32,201*16*32)
SetNpcScript(boss31, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 7
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+300], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss32=AddNpc(595,99,ai,196*8*32,201*16*32)
SetNpcScript(boss32, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 8
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+350], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss33=AddNpc(596,99,ai,196*8*32,201*16*32)
SetNpcScript(boss33, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 9
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+400], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss34=AddNpc(597,99,ai,196*8*32,201*16*32)
SetNpcScript(boss34, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 10
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+450], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss35=AddNpc(598,99,ai,196*8*32,201*16*32)
SetNpcScript(boss35, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 11
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+500], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 12
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+550], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 13
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+600], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 14
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+650], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss36=AddNpc(599,99,ai,196*8*32,201*16*32)
SetNpcScript(boss36, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 15
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+700], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss37=AddNpc(random(600,601),99,ai,196*8*32,201*16*32)
SetNpcScript(boss37, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 16
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+750], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
boss38=AddNpc(random(602,603),99,ai,196*8*32,201*16*32)
SetNpcScript(boss38, "\\script\\hoatdong\\vuotai\\boss31.lua")
-- Ai 17
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+800], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
-- Ai 18
for i=1,50 do
ai = SubWorldID2Idx(28)
...
SetNpcScript(quai2[i+850], "\\script\\hoatdong\\vuotai\\sugia2.lua")
end
ai = SubWorldID2Idx(28)
...
SetNpcScript(boss39, "\\script\\hoatdong\\vuotai\\boss35.lua")
end
...
PlayerIndex = q	
	...
	Msg2Player("Nhãm cña b¹n ®· v­ît qua ¶i thø : "..GetGlbMissionV(33).." - "..mangten[GetGlbMissionV(33)][2].."")
...
LoginLog = openfile("Data/LogVuotAi_SuGia2.txt", "a");
if LoginLog then
