...
if GetGlbMissionV(60) == 1000 then
	...
	if (GetTask(12) == 2) then
		...
		--if (die_tuvonglientuc < 5) then
						...
						Msg2World("Kim "..danhhieu[GetTask(19)][1].." <color=green>"..giet.." <color=red>h¹ s¸t Tèng "..danhhieu[die_dh][1].." <color=yellow>"..die_name.." ")
						...
						UpdateTopTKNew()
	--		else
	--				Msg2Player("<color=yellow>HÖ thèng chèng Post §iÓm: "..die_name.." ®· tö vong liªn tôc 5 lÇn")
	--		end
			else
