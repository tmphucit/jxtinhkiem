...
if returnCreateBossTK() == 1 then
	if GetGlbMissionV(60) == 2000 then
		if GetGlbMissionV(81) > GetGlbMissionV(82) then
			...
			Msg2WorldById("Nguyªn So¸i phe Kim ®· xuÊt hiÖn ........ ",37)
			SetGlbMissionV(87,1)
		elseif GetGlbMissionV(81) < GetGlbMissionV(82) then
			HideNpc(GetGlbMissionV(85),0)
			Msg2WorldById("Nguyªn So¸i phe Tèng ®· xuÊt hiÖn ........ ",37)
			SetGlbMissionV(88,1)
		else
			HideNpc(GetGlbMissionV(85),0)
			HideNpc(GetGlbMissionV(86),0)
	...
	for i=1,GetCountPlayerMax() do
		...
		if GetTask(40) == 1 then
			 if (GetGlbMissionV(60) == 1000 and w == 33)  then
				...
				--		Msg2SubWorld("<color=yellow>Top 1 Phe Tèng "..TopTong.." <color=red>nhËn ®­îc: "..GetNameItemBox(idxitem).."")
				--	else
				...
				--	if sxitem < 50 then
				--		idxitem = AddEventItem(116)
				--	Msg2SubWorld("<color=yellow>Top 1 Phe Kim "..TopKim.." <color=red>nhËn ®­îc: "..GetNameItemBox(idxitem).."")
				--	else
				--		idxitem = AddEventItem(120)
				--	Msg2SubWorld("<color=yellow>Top 1 Phe Kim "..TopKim.." <color=red>nhËn ®­îc: "..GetNameItemBox(idxitem).."")
				--	end
...
phut = tonumber(date("%M"))
	Msg2Player("Thêi gian tham chiÕn: <color=yellow>"..GetTask(118).." phót <color=red>- §iÓm TÝch Lòy: <color=yellow>"..GetTask(31).." ®iÓm")
	...
	if xephang == 1  then
		...
		-- Msg2SubWorld("<color=yellow>Chóc mõng "..GetName().." nhËn ®­îc 1 ChiÕu D¹ 7 Ngµy")
		-- Msg2SubWorld("<color=yellow>Chóc mõng "..GetName().." nhËn ®­îc 100 Xu")
		-- Msg2SubWorld("<color=yellow>Chóc mõng "..GetName().." nhËn ®­îc 6KNB")
		Msg2SubWorld("<color=yellow>Chóc mõng "..GetName().." nhËn ®­îc 200 v¹n")
		Earn(2000000)
		-- AddEventItem(17)
		-- AddEventItem(17)
		-- AddEventItem(17)
	...
	if xephang == 2  then
		...
		-- SetTimeItem(itemidx,550324)
		-- SetHSD(itemidx, 2022 , thangvp, ngayvp, gio)
		-- Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc ngùa XÝch Thè 7 Ngµy")
		-- Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 70 Xu")
		-- Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 4KNB")
		Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 140 v¹n")
		Earn(1400000)
		-- AddEventItem(17)
		-- AddEventItem(17)
		-- AddEventItem(17)
	...
	if xephang == 3  then
		...
		-- SetTimeItem(itemidx,550324)
		-- SetHSD(itemidx, 2022 , thangvp, ngayvp, gio)
		-- Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc TuyÕt ¶nh 7 Ngµy")
		-- Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 50 Xu")
		-- Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 2KNB")
		Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 100 v¹n")
		Earn(1000000)
		-- AddEventItem(17)
		-- AddEventItem(17)
	...
	if xephang > 3 and xephang <= 10 then
		...
		Earn(400000)
		-- Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 20 Xu ")
		Msg2SubWorld("<color=pink>Chóc mõng "..GetName().." nhËn ®­îc 40 v¹n ")
	end
...
-- if soluong > 0 then
	-- for i=1,soluong do 
		-- AddEventItem(659) 
	-- end
	-- Msg2Player("§iÓm tÝch lòy cña b¹n "..GetTask(31)..", nhËn ®­îc <color=yellow>"..soluong.." Tèng Kim B¶o R­¬ng")
-- else
	-- Msg2Player("§iÓm tÝch lòy cña b¹n "..GetTask(31)..", kh«ng ®ñ ®iÒu kiÖn nhËn b¶o r­¬ng")
-- end
...
if num == 1 then
		if GetTask(118) < 20 then
			...
			Msg2Player("B¹n nhËn ®­îc 5.000.000 kinh nghiÖm v× tham chiÕn 10 - 19 phót !")
		elseif GetTask(118) < 30 then
			...
			SetTask(612,GetTask(612)+1)
			Msg2Player("B¹n nhËn ®­îc 1 ®iÓm sù kiÖn")
			Msg2Player("B¹n nhËn ®­îc 5.000.000 kinh nghiÖm v× tham chiÕn 20 - 29 phót !")
		elseif GetTask(118) < 40 then
			...
			SetTask(612,GetTask(612)+1)
			Msg2Player("B¹n nhËn ®­îc 1 ®iÓm sù kiÖn")
			Msg2Player("B¹n nhËn ®­îc 10.000.000 kinh nghiÖm v× tham chiÕn 30 - 39 phót !")
		elseif GetTask(118) < 70 then
			...
			Msg2Player("B¹n nhËn ®­îc 5 ®iÓm sù kiÖn")
			Msg2Player("B¹n nhËn ®­îc 1 Hoµng Kim S¸t")
			Msg2Player("B¹n nhËn ®­îc 15.000.000 kinh nghiÖm v× tham chiÕn trªn 40 phót !")
		end	
elseif num == 2 then
		if GetTask(118) < 20 then
			for i=1,15 do AddOwnExp(1000000) end
			...
			SetTask(612,GetTask(612)+1)
			Msg2Player("B¹n nhËn ®­îc 1 ®iÓm sù kiÖn")
			Msg2Player("B¹n nhËn ®­îc 15.000.000 kinh nghiÖm v× tham chiÕn 10 - 19 phót !")
		elseif GetTask(118) < 30 then
			SetTask(612,GetTask(612)+1)
			Msg2Player("B¹n nhËn ®­îc 1 ®iÓm sù kiÖn")
			for i=1,15 do AddOwnExp(1000000) end
			...
			Msg2Player("B¹n nhËn ®­îc 15.000.000 kinh nghiÖm v× tham chiÕn 20 - 29 phót !")
		elseif GetTask(118) < 40 then
			SetTask(612,GetTask(612)+1)
			Msg2Player("B¹n nhËn ®­îc 1 ®iÓm sù kiÖn")
			for i=1,15 do AddOwnExp(1000000) end
			...
			Msg2Player("B¹n nhËn ®­îc 15.000.000 kinh nghiÖm v× tham chiÕn 30 - 39 phót !")
		elseif GetTask(118) < 70 then
			SetTask(612,GetTask(612)+5)
			...
			Msg2Player("B¹n nhËn ®­îc 5 ®iÓm sù kiÖn")
			Msg2Player("B¹n nhËn ®­îc 2 Hoµng Kim S¸t")
			for i=1,25 do AddOwnExp(1000000) end
			Msg2Player("B¹n nhËn ®­îc 25.000.000 kinh nghiÖm v× tham chiÕn trªn 40 phót !")
		end	
end			
	...
	mtichluy = 0
			...
			AddRepute(mdanhvong)
			Msg2Player("B¹n nhËn ®­îc: <color=yellow>"..mdanhvong.." danh väng, "..mtichluy.." tÝch lòy ")			
