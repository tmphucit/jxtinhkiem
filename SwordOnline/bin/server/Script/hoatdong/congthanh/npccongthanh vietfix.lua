...
Msg2SubWorld("Chóc mõng bang héi "..mang_daugiakcl[bangnhat][1].." ®· th¾ng trong cuéc ®Êu gi¸ h«m nay.")
		...
		if a == 0 then
			...
			Msg2SubWorld("TrËn c«ng thµnh chiÕn ngµy mai vµo lóc 20h00 ngµy "..(ngay+1).."/"..thang.."/2024")
			Msg2SubWorld("C«ng Thµnh "..DSCTC[vitritt()][1][1].." vs. Thñ Thµnh  "..DSCTC[vitritt()][2][1].." ")
			AddGlobalCountNews("Bang héi <color=red>"..mang_daugiakcl[bangnhat][1].."<color> ®· giµnh chiÕn th¾ng trong ®Êu gi¸ h«m nay vµ sÏ tham gia C«ng Thµnh ChiÕn víi bang  "..DSCTC[vitritt()][2][1].." vµo lóc 20h00 ngµy "..(ngay+1).."/"..thang.."/2024 ",1)
			save()
...
function hoatdong()
Talk(3,"","§Êu gi¸ Khiªu ChiÕn LÖnh vµo 18h00 - 19h00 ",
"C«ng Thµnh ChiÕn vµo 20h00 - 22h00 ",
"Thø 2: BiÖn Kinh. ")
end


function timedaugia()
Talk(2,"","Thêi gian ®Êu gi¸ b¾t ®Çu tõ 18h00 - 19h00 NPC Qu¶n Lý Bang Héi c¸c thµnh thÞ .",
"Sau khi kÕt thóc Bang Héi nµo giµnh chiÕn th¾ng ®Êu gi¸ sÏ ®­îc C«ng Thµnh ChiÕn vµo ngµy mai !")
end
function timectc()
Talk(2,"","Thêi gian c«ng thµnh chiÕn b¾t ®Çu tõ 20h00 - 22h00 t¹i NPC Qu¶n Lý Bang Héi c¸c thµnh thÞ .",
"Bang héi chiÕm thµnh sÏ nhËn ®­îc phÇn th­ëng ")
end
