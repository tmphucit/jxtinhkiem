...
dsdau_temp = {}
function main()
--(1,"","TÝnh n¨ng t¹m khãa ®îi cËp nhËt tÝnh n¨ng míi thay thÕ !")
--end
--function main__()
W,X,Y = GetWorldPos()
...
SayNew("Ng­¬i cÇn ta gióp g× ?",3,
"Cöa hµng vinh dù /doipt",
"NhËn phÇn th­ëng Vinh Dù th¸ng 12/nhanphanthuongthang6",
"Tho¸t/no")
...
gio,phut,giay = GetTimeNew()
	if check_khoang_time_ld(1,4) == 1 and ngay >= ngaybatdau and ngay <= ngayketthuc then
		SayNew("<color=green>Sø gi¶ Liªn ®Êu <color>: HiÖn ®ang trong giai ®o¹n <color=yellow>B¸o Danh Liªn §Êu<color>, c¸c b¹n h·y nhanh ch©n ®¨ng ký ",3,
	...
	--	"Cöa hµng vinh dù /doipt",
		...
		SayNew("<color=green>Sø gi¶ Héi Tr­êng: <color>: Thêi gian b¸o danh Vâ L©m Liªn §Êu ch­a b¾t ®Çu !",2,
		"Xem th«ng tin liªn ®Êu /XemThongTin",
	--	"Xem Danh S¸ch Top Cao Thñ/xemtop",
	--	"Cöa hµng vinh dù /doipt",
		"Tho¸t./no")
...
SayNew("HiÖn t¹i b¹n cã <color=red>"..GetTask(124).."<color> ®iÓm vinh dù. B¹n muèn ®æi g× ?",9,
"§æi An Bang [Khãa]/muaitem",
"§æi §Þnh Quèc §¹i [Khãa] /muaitem",
"§æi §Þnh Quèc TiÓu [Khãa] /muaitem",
"§æi An Bang /muaitem",
"§æi §Þnh Quèc §¹i/muaitem",
"§æi §Þnh Quèc TiÓu/muaitem",
"Mua LB Vinh Dù /muaitem",
"§æi Phi V©n [70000 ®iÓm]/muaitem",
"Tho¸t./no")
end
...
function muaanbang()
SayNew("<color=green>Sø Gi¸ Liªn §Êu<color>: Trang bÞ Khãa VÜnh ViÔn",9,
"D©y ChuyÒn §¹i [30000]/muaab1",
"NhÉn Cóc Hoa §¹i [25000]/muaab1",
"NhÉn Kª HuyÕt §¹i [25000]/muaab1",
"Ngäc Béi §¹i [20000]/muaab1",
"D©y ChuyÒn TiÓu [6000]/muaab1",
"NhÉn Cóc Hoa TiÓu [5000]/muaab1",
"NhÉn Kª HuyÕt TiÓu [5000]/muaab1",
"Ngäc Béi TiÓu [4000]/muaab1",
"Tho¸t./no")
end
...
SayNew("<color=green>Sø Gi¸ Liªn §Êu<color>: Trang bÞ Kh«ng Khãa",9,
"D©y ChuyÒn §¹i [60000]/muaab1_x2",
"NhÉn Cóc Hoa §¹i [50000]/muaab1_x2",
"NhÉn Kª HuyÕt §¹i [50000]/muaab1_x2",
"Ngäc Béi §¹i [40000]/muaab1_x2",
...
SayNew("<color=green>Sø Gi¸ Liªn §Êu<color>: Trang bÞ Khãa VÜnh ViÔn",6,
"Nãn §Þnh Quèc §¹i [15000]/muadq1",
"¸o §Þnh Quèc §¹i [15000]/muadq1",
"Giµy §Þnh Quèc §¹i [5000]/muadq1",
"Bao Tay §Þnh Quèc §¹i [5000]/muadq1",
"Th¾t L­ng §Þnh Quèc §¹i [5000]/muadq1",
"Tho¸t./no")
end

function muadinhquoc2()
SayNew("<color=green>Sø Gi¸ Liªn §Êu<color>: Trang bÞ Khãa VÜnh ViÔn",6,
"Nãn §Þnh Quèc TiÓu [3000]/muadq2",
"¸o §Þnh Quèc TiÓu [3000]/muadq2",
"Giµy §Þnh Quèc TiÓu [1000]/muadq2",
"Bao Tay §Þnh Quèc TiÓu [1000]/muadq2",
"Th¾t L­ng §Þnh Quèc TiÓu [1000]/muadq2",
"Tho¸t./no")
end
...
SayNew("<color=green>Sø Gi¸ Liªn §Êu<color>: Trang bÞ Kh«ng Khãa",6,
"Nãn §Þnh Quèc §¹i [30000]/muadq1_x2",
"¸o §Þnh Quèc §¹i [30000]/muadq1_x2",
"Giµy §Þnh Quèc §¹i [10000]/muadq1_x2",
"Bao Tay §Þnh Quèc §¹i [10000]/muadq1_x2",
"Th¾t L­ng §Þnh Quèc §¹i [10000]/muadq1_x2",
"Tho¸t./no")
end

function muadinhquoc2_x2()
SayNew("<color=green>Sø Gi¸ Liªn §Êu<color>: Trang bÞ Kh«ng Khãa",6,
"Nãn §Þnh Quèc TiÓu [6000]/muadq2_x2",
"¸o §Þnh Quèc TiÓu [6000]/muadq2_x2",
"Giµy §Þnh Quèc TiÓu [2000]/muadq2_x2",
"Bao Tay §Þnh Quèc TiÓu [2000]/muadq2_x2",
"Th¾t L­ng §Þnh Quèc TiÓu [2000]/muadq2_x2",
"Tho¸t./no")
end

function muadq1_x2(nsel)
i = nsel + 1
vang = 0
if i == 1 then
	vang = 30000
...
"Lam Thñy Tinh [500®]/muavpquy1",
"Tö Thñy Tinh [500®]/muavpquy1",
"Lôc Thñy Tinh [500®]/muavpquy1",
"Ngäc C­êng Hãa [500®]/muavpquy1",
"Phóc Duyªn §¹i [300 ®iÓm]/muavpquy1",
"Ngäc C­êng Hãa Cao CÊp +3 [1500®]/muavpquy1",
"Ngäc C­êng Hãa Cao CÊp +4 [2000®]/muavpquy1",
"Danh Väng §an [500®]/muavpquy1",
"Tho¸t./no")
end
...
mangitem = {
{35,"LÖnh Bµi [Liªn §Êu] An Bang B¨ng Tinh Th¹ch H¹ng Liªn",5000},
{36,"LÖnh Bµi [Liªn §Êu] An Bang Cóc Hoa Th¹ch ChØ Hoµn",3500},
{37,"LÖnh Bµi [Liªn §Êu] An Bang Kª HuyÕt Th¹ch Giíi ChØ ",3500},
{38,"LÖnh Bµi [Liªn §Êu] An Bang §iÒn Hoµng Th¹ch Ngäc Béi ",3000},
{39,"LÖnh Bµi §Þnh Quèc ¤ Sa Ph¸t Qu¸n",3000},
{40,"LÖnh Bµi §Þnh Quèc Thanh Sa Tr­êng Sam",3000},
{41,"LÖnh Bµi §Þnh Quèc Ng©n TÇm Yªu §¸i ",1500},
{42,"LÖnh Bµi §Þnh Quèc XÝch QuyÒn NhuyÔn Ngoa",1500},
{43,"LÖnh Bµi §Þnh Quèc Tö §»ng Hé UyÓn",1500},
...
{28,"Lam Thñy Tinh",500},
{29,"Tö Thñy Tinh",500},
{30,"Lôc Thñy Tinh",500},
{414,"Ngäc C­êng Hãa",500},
{175,"Phóc Duyªn §¹i",300},
{586,"Ngäc C­êng Hãa Cao CÊp +3",1500},
{587,"Ngäc C­êng Hãa Cao CÊp +4",2000},
{363,"Danh Väng §an",500},
}
			...
			if w == 42 and GetTaskTemp(22) == 1 then 
				...
				elseif GetTaskTemp(22) > 0 then
					if GetTaskTemp(22) == getn(dsdau) and mod(GetTaskTemp(22),2) == 1 then
						...
						SetDeathScript("\\script\\hoatdong\\liendau\\sugiald.lua")
...
if ngay > ngayketthuc or ngay < ngaybatdau then
	SayNew("<color=green>Sø gi¶ Liªn ®Êu <color>: HiÖn t¹i ®ang trong thêi gian nghØ ng¬i, kh«ng cã bÊt kú trËn thi ®Êu nµo diÔn ra. Thêi gian liªn ®Êu tõ ngµy 8 ®Õn 28 hµng th¸ng.",3,
	"Ta ®Õn nhËn phÇn th­ëng xÕp h¹ng liªn ®Êu /nhanphanthuong",
	"Cöa hµng vinh dù /doipt",
	"Tho¸t ./no")
else
	SayNew("<color=green>Sø gi¶ Liªn ®Êu <color>:",3,
