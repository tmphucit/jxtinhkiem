...
SetNpcScript(quai1[i], "\\script\\hoatdong\\phonglangdo\\thuyenphu.lua")
end
...
if GetItemCount(135) >= 1 then
		...
		SetTask(614,GetTask(614)+1)
		DelItem(135)
		Msg2Player("Sè LÇn §i: "..GetTask(614).."/"..SoLuongGioiHan.."")
...
if phut >= 20 and GetGlbMissionV(15) == 1 then
	...
	SetNpcScript(Boss1, "\\script\\hoatdong\\phonglangdo\\boss.lua")
