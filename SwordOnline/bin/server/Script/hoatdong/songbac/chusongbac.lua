...
Msg2SubWorld("<color=green>[BÇu Cua] <color=red>Ph¸t Tµi Ph¸t Léc t¹i <color=yellow>T­¬ng D­¬ng 182/202.<color=red> Thêi gian cßn l¹i "..(59-phut).." phót n÷a")
return
end
-- if gio == 23 and phut == 0 then
if (gio == 23 or gio == 9) and phut == 00 then
SetGlbMissionV(11 , 1)
Msg2SubWorld("<color=green>[BÇu Cua] <color=red> L­ît ®Æt c­îc BÇu Cua thø 1 b¾t ®Çu. H·y ®Õn <color=yellow>T­¬ng D­¬ng 182/202 <color=red>®Ó tham gia ®Æt c­îc !")
return
end
...
if GetTaskTemp(1) == 1 then
OpenStringBox (2,"§¬n VÞ: V¹n" , "datcuoctienvan")
else
OpenStringBox (2,"§¬n VÞ: Vµng" , "datcuocvang")
end
end
...
Talk(1,"","ChØ ®­îc ®Æt c­îc tõ 5 v¹n - 50 v¹n l­îng, vui lßng ®Æt c­îc l¹i !")
return
end
...
Talk(1,"","ChØ ®­îc ®Æt c­îc tõ 1 vµng - 20 vµng, vui lßng ®Æt c­îc l¹i !")
return
end
