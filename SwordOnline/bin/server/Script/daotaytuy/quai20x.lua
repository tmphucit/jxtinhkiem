...
if HaveMagic(a) >= 1 and HaveMagic(a) < 20 then
		SetTask(TaskSkillFaction9x1,GetTask(TaskSkillFaction9x1)+1500)
...
if HaveMagic(b) >= 1 and HaveMagic(b) < 20 then
		SetTask(TaskSkillFaction9x2,GetTask(TaskSkillFaction9x2)+1500)
...
if HaveMagic(c) >= 1 and HaveMagic(c) < 20 then
		SetTask(TaskSkillFaction9x3,GetTask(TaskSkillFaction9x3)+1500)
...
if HaveMagic(d) >= 1 and HaveMagic(d) < 20 then
		SetTask(TaskSkillFaction12x1,GetTask(TaskSkillFaction12x1)+1200)
