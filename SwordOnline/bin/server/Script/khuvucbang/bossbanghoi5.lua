...
for i=1,GetCountPlayerMax() do
	...
	w1,x1,y1 = GetWorldPos()
		...
		SetTask(472 , ngay)
		AddOwnExp(150000000)
		Msg2Player("B¹n nhËn ®­îc 150.000.000 kinh nghiÖm tù Boss Bang Héi !")	
		for k=1,30 do AddEventItem(23) end
		Msg2Player("B¹n nhËn ®­îc 30 Khiªu ChiÕn LÖnh !")
		sxtt = random(1,100)
		if sxtt < 20 then
			sx2 = random(1,30)
			if sx2 == 1 then
			...
			elseif sx2 == 11 or sx2 == 12 or sx2 == 13 or sx2 == 14 then
				AddEventItem(120)
				Msg2World("Chóc mõng "..GetName().." may m¾n nhËn ®­îc 1 <color=yellow>Tiªn Th¶o Lé 6 giê  ")
