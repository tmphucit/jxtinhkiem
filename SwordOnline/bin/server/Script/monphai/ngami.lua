...
--if GetTask(103) > 0 then
		...
		if HaveMagic(85) < 0 or HaveMagic(80) < 0 then
		AddMagic(85)
		AddMagic(80)
		end
				end
				if GetTask(103) >= 8 then
		if HaveMagic(77) < 0 or HaveMagic(79) < 0 then
		AddMagic(77)
		AddMagic(79)
		end
				end
				if GetTask(103) >= 11 then
	if HaveMagic(93) < 0 then
	AddMagic(93)
	end
				end
				if GetTask(103) >= 16 then
	if HaveMagic(334) < 0 or HaveMagic(82) < 0 or HaveMagic(89) < 0 then
	AddMagic(334)
	AddMagic(82)
	AddMagic(89)
	end
	...
	if HaveMagic(86) < 0 then
	AddMagic(86)
	end
				end
				if GetTask(103) >= 26 then
	if HaveMagic(92) < 0 then
	AddMagic(92)
	end
				end
				if GetTask(103) >= 33 then
	if HaveMagic(252) < 0 or HaveMagic(88) < 0 or HaveMagic(91) < 0 or HaveMagic(282) < 0 then
	AddMagic(252)
	AddMagic(88)
	AddMagic(91)
	AddMagic(282)
