...
tennpc = "ThiÕu L©m Ch­ëng M«n"
tenphai = "ThiÕu L©m Ph¸i"
nguhanh = 0
tennguhanh = "hÖ kim "
tenfaction = "Thieu Lam Phai"
idmonphai = 1
...
function hockynang()
		...
		if HaveMagic(14) < 0 or HaveMagic(10) < 0 then
			AddMagic(14)
			AddMagic(10)
		end		
				end
				if GetTask(103) >= 8 then
		if HaveMagic(8) < 0 or HaveMagic(4) < 0 or HaveMagic(6) < 0 then
		AddMagic(8)
		AddMagic(4)
		AddMagic(6)	
		end
	...
	if HaveMagic(15) < 0 then
	AddMagic(15)
	end
				end
				if GetTask(103) >= 16 then
	if HaveMagic(16) < 0 then
	AddMagic(16)
	end
				end
				if GetTask(103) >= 21 then
	if HaveMagic(20) < 0 then
	AddMagic(20)
	end
				end
				if GetTask(103) >= 26 then
	if HaveMagic(271) < 0 or HaveMagic(11) < 0 or HaveMagic(19) < 0 then
	AddMagic(271)
	AddMagic(11)
	AddMagic(19)
	end
	...
	if HaveMagic(21) < 0 or HaveMagic(273) < 0 then
	AddMagic(21)
	AddMagic(273)
	end
				end
	-- if GetTask(103) >= 45 then
		-- if HaveMagic(350) > 0 then
