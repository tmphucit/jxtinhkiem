...
tennpc = "Thóy Yªn Ch­ëng M«n"
tenphai = "Thóy Yªn M«n"
nguhanh = 2
tennguhanh = "hÖ thñy "
tenfaction = "Thuy Yen Mon"
idmonphai = 6
...
if GetLevel() >= 10 and GetLevel() < 20 then
		...
		if HaveMagic(99) < 0 or HaveMagic(102) < 0 then
		AddMagic(99)
		AddMagic(102)
		end
				end
				if GetTask(103) >= 8 then
		if HaveMagic(95) < 0 or HaveMagic(97) < 0 then
		AddMagic(95)
		AddMagic(97)
		end
				end
				if GetTask(103) >= 11 then
	if HaveMagic(269) < 0  then
	AddMagic(269)
	end
				end
				if GetTask(103) >= 16 then
	if HaveMagic(105) < 0  then
	AddMagic(105)
	AddMagic(113)
	end
				end
				if GetTask(103) >= 21 then
	if HaveMagic(100) < 0  then
	AddMagic(100)
	end
				end
				if GetTask(103) >= 26 then
	if HaveMagic(109) < 0  then
	AddMagic(109)
	end
				end
				if GetTask(103) >= 33 then	
	if HaveMagic(114) < 0  then
	AddMagic(114)
	AddMagic(108)
	AddMagic(111)
	end
