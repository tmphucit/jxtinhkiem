tennpc = "Vâ §ang Ch­ëng M«n"
tenphai = "Vâ §ang Ph¸i"
nguhanh = 4
tennguhanh = "hÖ thæ "
tenfaction = "Vo Dang Phai"
idmonphai = 9
...
function hockynang()
	if GetLevel() >= 10 and GetLevel() < 20 then
		...
		if HaveMagic(152) < 0 then
		AddMagic(152)
		AddMagic(151)
		end
				end
				if GetTask(103) >= 11 then
		if HaveMagic(159) < 0 then
		AddMagic(159)
		end
				end
				if GetTask(103) >= 16 then
		if HaveMagic(164) < 0 then
		AddMagic(164)
		AddMagic(158)
		end
				end
				if GetTask(103) >= 21 then
		if HaveMagic(160) < 0 then
		AddMagic(160)
		end
				end
				if GetTask(103) >= 26 then
		if HaveMagic(157) < 0 then
		AddMagic(157)
		end
				end
				if GetTask(103) >= 33 then
		if HaveMagic(166) < 0 then
		AddMagic(166)
		AddMagic(165)
		AddMagic(267)
		end
