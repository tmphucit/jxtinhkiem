...
tennpc = "Ngò §éc Ch­ëng M«n"
tenphai = "Ngò §éc Gi¸o"
nguhanh = 1
tennguhanh = "hÖ méc "
tenfaction = "Ngu Doc Giao"
idmonphai = 4
function hockynang()
--if GetTask(103) > 0 then
		...
		if HaveMagic(63) < 0 then
		AddMagic(63)
		AddMagic(65)
		end
				end
				if GetTask(103) >= 8 then
		if HaveMagic(62) < 0 then
		AddMagic(62)
		AddMagic(60)
		AddMagic(67)
		end
		...
		if HaveMagic(70) < 0 then
		AddMagic(70)
		AddMagic(66)
		end
				end
				if GetTask(103) >= 16 then
		if HaveMagic(68) < 0 then
		AddMagic(68)
		AddMagic(333)
		AddMagic(64)
		AddMagic(69)
		...
		if HaveMagic(72) < 0 then
		AddMagic(72)
		end
				end
				if GetTask(103) >= 33 then
		if HaveMagic(75) < 0 then
		AddMagic(75)
		AddMagic(71)
		AddMagic(74)
		end
