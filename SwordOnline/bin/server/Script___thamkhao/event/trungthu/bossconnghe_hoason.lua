...
Msg2World("Boss Con Ngh™ Æ∑ bﬁ nh„m cÒa <color=yellow>"..GetName().."<color=red> ti™u di÷t.")
...
if team == nil then
			AddOwnExp(3000000)
			Msg2Player("Bπn nhÀn Æ≠Óc 3.000.000 kinh nghi÷m")
			AddRepute(10)	
			Msg2Player("Bπn nhÀn Æ≠Óc 10 Æi”m danh v‰ng")
			for k=1,20 do AddEventItem(126) end
			Msg2Player("Bπn nhÀn Æ≠Óc 20 Gi y Ki’ng ß· ")
			AddEventItem(723)
