...
if GetTask(323) == 0 then
	SetTask(323, id)
elseif GetTask(324) == 0 then
	if MANG_TRAP[id][1] == MANG_TRAP[GetTask(323)][1] then
	return
	end
	SetTask(324,id)
elseif GetTask(325) == 0 then
	if MANG_TRAP[id][1] == MANG_TRAP[GetTask(323)][1] or MANG_TRAP[id][1] == MANG_TRAP[GetTask(324)][1] then
	return
	end
	SetTask(325, id)
else
	if MANG_TRAP[id][1] == MANG_TRAP[GetTask(323)][1] or MANG_TRAP[id][1] == MANG_TRAP[GetTask(324)][1] or MANG_TRAP[id][1] == MANG_TRAP[GetTask(325)][1] then
	return
	end
	SetTask(323, GetTask(324))
	SetTask(324, GetTask(325))
	SetTask(325, id)
end
