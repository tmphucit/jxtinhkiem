...
Msg2Player("B¹n nhËn ®­îc "..name.." 1 phót t¨ng s¸t th­¬ng l«i hÖ néi c«ng "..(100+(level-1)*10).." ®iÓm ")
Msg2Player("B¹n nhËn ®­îc "..name.." 1 phót t¨ng s¸t th­¬ng l«i hÖ ngo¹i c«ng "..(100+(level-1)*20).." ®iÓm ")
addbaovat()
end
