...
SetNpcName(tongtrinhsat, "Trinh Sat");

kimtrinhsat=AddNpc(833,95,tongkim,1664*32,3087*32)
SetNpcScript(kimtrinhsat, "\\script\\tongkim\\trinhsat.lua");
SetNpcName(kimtrinhsat, "Trinh Sat");


-- TRAP BEN KIM CUU SAT
for j=-5,5 do
AddTrap(37,(1664-j)*32,(3102-j)*32,"\\script\\tongkim\\boss2\\kim\\cuarabenkim.lua")
AddTrap(37,(1664-j+1)*32,(3102-j)*32,"\\script\\tongkim\\boss2\\kim\\cuarabenkim.lua")
end
for j=-5,5 do
AddTrap(37,(1595-j)*32,(3166-j)*32,"\\script\\tongkim\\boss2\\kim\\cuavaobenkim.lua")
AddTrap(37,(1595-j+1)*32,(3166-j)*32,"\\script\\tongkim\\boss2\\kim\\cuavaobenkim.lua")
end

for j=-5,5 do
AddTrap(37,(1542-j)*32,(3165+j)*32,"\\script\\tongkim\\boss2\\kim\\trap1.lua") -- 1544 3168
AddTrap(37,(1542-j+1)*32,(3165+j)*32,"\\script\\tongkim\\boss2\\kim\\trap1.lua")
end
for j=-5,5 do
AddTrap(37,(1530-j)*32,(3245-j)*32,"\\script\\tongkim\\boss2\\kim\\trap2.lua") -- 1531 3242
AddTrap(37,(1530-j+1)*32,(3245-j)*32,"\\script\\tongkim\\boss2\\kim\\trap2.lua")
end
for j=-5,5 do
AddTrap(37,(1609-j)*32,(3229+j)*32,"\\script\\tongkim\\boss2\\kim\\trap3.lua") -- 1607 3226
AddTrap(37,(1609-j+1)*32,(3229+j)*32,"\\script\\tongkim\\boss2\\kim\\trap3.lua")
end

-- TRAP BEN TONG CUU SAT
for j=-5,5 do
AddTrap(37,(1255-j)*32,(3532-j)*32,"\\script\\tongkim\\boss2\\tong\\cuarabentong.lua")
AddTrap(37,(1255-j+1)*32,(3532-j)*32,"\\script\\tongkim\\boss2\\tong\\cuarabentong.lua")
end
for j=-5,5 do
AddTrap(37,(1293-j)*32,(3484-j)*32,"\\script\\tongkim\\boss2\\tong\\cuavaobentong.lua")
AddTrap(37,(1293-j+1)*32,(3484-j)*32,"\\script\\tongkim\\boss2\\tong\\cuavaobentong.lua")
end
for j=-5,5 do
AddTrap(37,(1303-j)*32,(3416+j)*32,"\\script\\tongkim\\boss2\\tong\\trap1.lua")
AddTrap(37,(1303-j+1)*32,(3416+j)*32,"\\script\\tongkim\\boss2\\tong\\trap1.lua")
end
for j=-5,5 do
AddTrap(37,(1360-j)*32,(3408-j)*32,"\\script\\tongkim\\boss2\\tong\\trap2.lua")
AddTrap(37,(1360-j+1)*32,(3408-j)*32,"\\script\\tongkim\\boss2\\tong\\trap2.lua")
end
for j=-5,5 do
AddTrap(37,(1347-j)*32,(3479+j)*32,"\\script\\tongkim\\boss2\\tong\\trap3.lua")
AddTrap(37,(1347-j+1)*32,(3479+j)*32,"\\script\\tongkim\\boss2\\tong\\trap3.lua")
end
