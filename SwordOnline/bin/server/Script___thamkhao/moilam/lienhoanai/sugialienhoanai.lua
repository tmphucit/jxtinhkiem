...
function bdvuotai()
SayNew("<color=blue>Su Gia Lien Hoan Ai<color>: Cac ha gap ta co chuyen gi nho va chang",2,
"Tham Gia Vuot Ai./tmctddva",
"Thoat./no")
end;

function vuotai()
SayNew("<color=blue>Su Gia Lien Hoan Ai<color>: Thoi Gian Bao Danh: <color=red>9h00 , 14h00, 21h00",1,"Ket Thuc Doi Thoai./no")
end;
...
if (IsCaptain() == 1) then
SayNew("<color=blue>Su Gia Lien Hoan Ai<color>: Phi moi lan tham gia vuot ai la <color=fire>100 van luong<color>, nguoi co dang cap 80 co the tham gia, nguoi ta to doi da chuan bi du chua ?",2,
