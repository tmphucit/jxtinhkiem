...
--"NhËn hç trî BÝ Kip 90 /nhanphanthuonglevel",
...
Talk(1,"","B¹n kh«ng ®ñ ®iÒu kiÖn nhËn phÇn th­ëng BÝ Kip 90 !")
return
end
...
if GetTask(task) == 0 then
	if GetLevel() >= 1 then
		...
		Msg2Player("NhËn phÇn th­ëng ®¹t cÊp 1: <color=yellow>ThÇn Hµnh Phï [3 ngµy], Cöu Nguyªn Th¹ch [3 ngµy]")
	else
		Talk(1,"","§¼ng cÊp nhËn phÇn th­ëng tiÕp theo: <color=yellow>CÊp 1")
	end
