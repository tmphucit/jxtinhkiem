...
if GetFaction() ~= "" then
SayNewEx({"<color=cyan>Tho Ren<color>: Nguoi co muon che tao cac vat pham than bi trong vo lam hay khong?","Che Tao Trang Bi./chetaotrangbi","Che Tao Vu Khi./chetaovukhi","Thoat./Exit"})
...
if GetFaction() ~= "" then
SayNewEx({"<color=cyan>Tho Ren<color>: Nguoi thuoc mon phai: <color=red>"..GetFaction().."<color> Nen chi che tao duoc cac mon do cua mon phai.",
"Non./NonMonPhai",
"Ao Giap./AoMonPhai",
...
function chetaovukhi_2()
	if kiemtramonphai() == 1 then
	SayNewEx({"<color=cyan>Tho Ren<color>: Nguoi muon che tao loai Vu Khi nao ?",
