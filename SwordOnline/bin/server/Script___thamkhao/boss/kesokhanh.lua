	...
	if GetTeam() == team then
		...
		if GetTask(102) < gioihan() then
				if GetLevel() < 120 then	
					...
					Msg2Player("Sè l­îng Boss KÎ Së Khanh tiªu diÖt ®­îc: "..GetTask(102).." / "..gioihan().." ")
					AddOwnExp(3000000)
					...
					Talk(1,"","§¼ng cÊp cña b¹n trªn 120 kh«ng thÓ nhËn phÇn th­ëng tõ Boss !")
					Msg2Player("§¼ng cÊp cña b¹n trªn 120 kh«ng thÓ nhËn phÇn th­ëng tõ Boss !")
				end
		else
