...
SayNewEx({"<color="..colorS()..">Bao Ruong<color> :Server Ho Tro Lam Pass Ruong Mien Phi","Vang ta muon lap ma ruong./lapmaruong1","Quay lai./main",can})
end
end;

function lapmaruong1()
SayNewEx({"<color="..colorS()..">Bao Ruong<color> : dien mat ma.","1/number","2/number","3/number","4/number","5/number","6/number","7/number","8/number","9/number"})
end;
...
function conti2()
		SayNewEx({"<color="..colorS()..">Bao Ruong<color> : dien mat ma.","1/number1","2/number1","3/number1","4/number1","5/number1","6/number1","7/number1","8/number1","9/number1"})
end;

function conti3()
		SayNewEx({"<color="..colorS()..">Bao Ruong<color> : dien mat ma.","1/number2","2/number2","3/number2","4/number2","5/number2","6/number2","7/number2","8/number2","9/number2"})
end;
...
function xoamaruong()
if GetTask(30) > 1 then
SayNewEx({"<color="..colorS()..">Bao Ruong<color> : Day dien mat ma ruong de xoa mat ma...","Dien mat ma vao./conti3",can})
else
