...
if IsCaptain() == 1 then
	...
	if LOI_DAI[1][1] == "" then
		SayNew("<color=green>C«ng B×nh Tö <color>: HiÖn t¹i ch­a cã Tæ §éi nµo ®¨ng ký l«i ®µi, sè l­îng thµnh viªn trong nhãm b¹n sÏ quy ®Þnh thÓ lo¹i thi ®Êu ",2,
		"Ta muèn ®¨ng ký thÓ lo¹i thi ®Êu "..GetTeamSize().." vs "..GetTeamSize().." /dangky",
		"Tho¸t./no")
	else
		soluong = tinhtongsoluongthanhvien()
		SayNew("<color=green>C«ng B×nh Tö <color>: HiÖn t¹i ®· cã Tæ §éi ®¨ng ký h×nh thøc thi ®Êu "..soluong.." vs "..soluong..". B¹n ph¶i cã sè thµnh viªn b»ng sè sè l­îng quy ®Þnh míi vµo ®­îc ",2,
