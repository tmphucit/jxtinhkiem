...
elseif GetTask(nv) == 1 then
	if GetTask(sl) >= 3 then
		...
		"<color=green>Long Ngò <color>: H·y ®Õn D­îc §iÕm ë BiÖn Kinh mua 1 b×nh Ngò Hoa T¸n ®em vÒ cho ta !")
	else
...
elseif GetTask(nv) == 2 then
	...
	Talk(1,"","<color=green>Long Ngò <color>: H·y ®Õn D­îc §iÕm ë BiÖn Kinh mua 1 b×nh Ngò Hoa T¸n ®em vÒ cho ta !")
	end
...
if GetTask(nv) == 4 then
 	Talk(1,"","<color=green>Long Ngò <color>: §Õn BiÖn Kinh 212/197 t×m <color=red> Lý M¹c SÇu ")	
elseif GetTask(nv) < 4 then
