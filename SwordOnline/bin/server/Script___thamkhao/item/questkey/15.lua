...
SayNew("<color=green>HÖ Thèng<color>: B¹n cÇn <color=red>500 v¹n<color> ®Ó trë thµnh 1 s­ phô kÓ tõ b©y giê ",2,
...
SayNew("<color=green>HÖ Thèng<color>: H·y t×m s­ phô <color=red>"..SU_DO[GetTask(163)][1].."<color> vµ xuÊt s­ ®i b¹n !!",2,
"XuÊt s­/xuatsu",
"Tho¸t./no")
else
SayNew("<color=green>HÖ Thèng<color>: S­ phô ®· trôc xuÊt b¹n!!",2,
"Roi khoi su phu/roisp3",
"Tho¸t./no")
end
elseif GetTask(165) == 3 then
SayNew("<color=green>HÖ Thèng<color>: Chän chøc n¨ng: ",4,
"NhËn ®iÓm phôc mÖnh/nhanexp",
"Reset nh©n ®«i cho §Ö tö/resettime",
"Trôc xuÊt §Ö tö/trucxuat",
"Tho¸t./no")
elseif GetTask(165) == 2 then
SayNew("<color=green>HÖ Thèng<color>: B¹n ch­a cã <color=red>§Ö tö<color>:",2,
"NhËn ®Ö tö/nhandt",
"Tho¸t./no")
...
SayNew("<color=green>HÖ Thèng<color>: H·y t×m 1 s­ phô ch©n chÝnh ®Ó b¸i s­ !",1,
"Tho¸t./no") 
end
end
...
function roisp()
if GetUUID() == SU_DO[GetTask(163)][5] then
SayNew("<color=green>HÖ Thèng<color>: B¹n cã ch¾c muèn ph¶n s­ m«n !",2,
"Ta §ång Y(/roisp2",
"Tho¸t./no")
else
SayNew("<color=green>HÖ Thèng<color>: S­ phô ®· trôc xuÊt b¹n !!",2,
...
function trucxuat()
SayNew("<color=green>HÖ Thèng<color>: B¹n ch¾c ch¾n muèn trôc xuÊt <color=red>"..SU_DO[vtsp()][4].."<color> ra khái s­ m«n? ",2,
"Ta ®ång ý/trucxuat2",
"Tho¸t./no")
end
function trucxuat2()
...
if GetTeamSize() == 2 then
	if IsCaptain() == 1 then
		SayNew("<color=green>HÖ Thèng<color>: B¹n cã muèn nhËn thµnh viªn trong nhãm lµm ®Ö tö kh«ng?: ",2,
		"Ta ®ång ý/nhandt2",
		"Tho¸t./no")
	else
