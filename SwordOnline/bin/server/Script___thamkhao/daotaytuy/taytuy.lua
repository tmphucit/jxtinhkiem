...
function main()
SayNewEx({"<color=red>Tay Tuy Dai Su <color>: Nguoi den tim ta co chuyen gi khong",
	"Ta Muon Tay Tuy./Tay",
...
function tuluyen()
SayNewEx({"<color=red> Tay Tuy Dai Su <color>: Thi chu hay lua chon viec lam",
		"Tu Luyen./tuluyen1",
...
SayNewEx({"<color=red>Tay Tuy Dai Su <color>: Thi chu hay lua chon ki nang can tu luyen",
	skills[timmonphai()][2][1].."/sk1",
	skills[timmonphai()][3][1].."/sk2",
	skills[timmonphai()][4][1].."/sk3",
	"Thoat/no"})
else
SayNewEx({"<color=blue>Tay Tuy Dai Su:<color> Thi chu hay lua chon ki nang can tu luyen",
		skills[timmonphai()][2][1].."/sk1",
		skills[timmonphai()][3][1].."/sk2",
		"Thoat/no"})
end
