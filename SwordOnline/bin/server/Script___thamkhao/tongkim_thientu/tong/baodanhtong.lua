...
--Msg2Player("<color=green>15h00 ngµy 18/09/2021: Thö nghiÖm tèi ­u chÊt l­îng PK Tèng Kim, Fix mét sè lçi vÆt. NÕu cã ph¸t sinh lçi ngoµi ı muèn vui lßng b¸o lªn Fanpage ®Ó chóng t«i hoµn thiÖn.")
	...
	if GetTongName() ~= TEN_BANG[1] then
	Talk(1,"","B¹n kh«ng thuéc bang "..TEN_BANG[1]..", kh«ng thÓ vµo phe Tèng")
	return
	end
	...
	if GetGlbMissionV(60) == 0 then
		...
		if GetTask(123) == GetGlbMissionV(61) then
			...
			elseif GetTask(12) == 2 then	
				SayNew("Tªn Kim binh kia, c¶ gan th©m nhËp vµo l·nh ®Şa ®¹i Tèng, râ rµng lµ tù t×m c¸i chÕt!",1,"Tho¸t./no")
			...
			SayNew(""..returnType()..", mäi ng­êi h·y v× tö d©n ®¹i tèng, tôc ng÷ cã c©u: Thiªn h¹ h­ng vong, thÊt phu h÷u tr¸ch. Nay ng­êi kim x©m ph¹m bê câi chóng ta, ®©y lµ lóc b¸o hiÕu ®Êt n­íc, nµo ng­êi anh em cßn chÇn chõ g× n÷a!",2,"Ta tham gia! §iÓm tİch lòy trë vÒ 0/baodanh2","Tho¸t/no")
		end
	end;
end
...
--if checkIP(1) == 1  and GetTaskTemp(4) ~= 546879 then
--Talk(1,"","HiÖn t¹i ®· cã nh©n vËt cïng IP bªn phe Kim, b¹n kh«ng thÓ tham gia vµo phe Tèng !")
--return
--end
...
Talk(1,"","Sè l­îng qu©n Tèng ®· ®ñ 50 ng­êi, kh«ng thÓ tham gia thªm !")
return
end
...
LoginLog = openfile("Data/BaoDanhTong.txt", "a");
if LoginLog then
