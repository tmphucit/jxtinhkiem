		...
		--	Msg2Player(""..OrgPlayer.." "..CheckTrungNhanVat(OrgPlayer).." ")
			...
			--	SetTask(452, OrgPlayer)
				...
				--end
					...
					Msg2Player("<color=yellow>B¹n ®· ®¸nh träng th­¬ng Kim Binh "..danhhieu[die_dh][1].." "..die_name.." nhËn ®­îc "..tongdiem.." ®iÓm tİch luü, liªn tr¶m "..GetTask(21)..", sè ng­êi giÕt ®­îc "..GetTask(11)..", tİch luü hiÖn t¹i "..GetTask(31).." ®iÓm")
					UpdateTopTKNew()	
				--else
