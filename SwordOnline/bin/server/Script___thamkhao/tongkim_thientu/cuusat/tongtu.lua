		...
		--if kill_dh - die_dh < 2 then
			...
			--	SetTask(452, OrgPlayer)
				...
				--end
						...
						Msg2Player("<color=yellow>B¹n ®· ®¸nh träng th­¬ng Tèng Binh "..danhhieu[die_dh][1].." "..die_name.." nhËn ®­îc "..tongdiem.." ®iÓm tİch luü, liªn tr¶m "..GetTask(21)..", sè ng­êi giÕt ®­îc "..GetTask(11)..", tİch luü hiÖn t¹i "..GetTask(31).." ®iÓm")
						UpdateTopTKNew()
		--	else
...
s = tonumber(date("%S"))
	...
	if giet == GetName() then
		...
		Msg2Player("<color=pink>B¹n ®· bŞ ["..danhhieu[kill_dh][1].."] "..giet.." ®¸nh träng th­¬ng, liªn tr¶m trë vÒ  0")
	end
	UpdateTopTKNew()
end
end
