...
if returnTimeRandomMission() == 1 and GetGlbMissionV(60) == 0 then -- Bao Danh Tong Kim
	...
	if hinhthuc == 1 then
		...
		AddGlobalCountNews("ChiÕn dŞch Tèng Kim h×nh thøc Cõu S¸t ®ang ë giai ®o¹n b¸o danh, vŞ vâ l©m nh©n sü nµo muèn tham gia th× h·y ®Õn T­¬ng D­¬ng hoÆc Chu Tiªn trÊn ®Ó vµo khu vùc b¸o danh. Thêi gian khai chiÕn cßn:"..RestMin.." phót !",1)
		Msg2SubWorld("ChiÕn dŞch Tèng Kim h×nh thøc Cõu S¸t ®ang ë giai ®o¹n b¸o danh, vŞ vâ l©m nh©n sü nµo muèn tham gia th× h·y ®Õn T­¬ng D­¬ng hoÆc Chu Tiªn trÊn ®Ó vµo khu vùc b¸o danh. Thêi gian khai chiÕn cßn:"..RestMin.." phót !")

	else
		HideNpc(GetGlbMissionV(85),9999999)
		HideNpc(GetGlbMissionV(86),9999999)
		SetGlbMissionV(60,1500)
		AddGlobalCountNews("ChiÕn dŞch Tèng Kim h×nh thøc B¶o VÖ Nguyªn So¸i ®ang ë giai ®o¹n b¸o danh, vŞ vâ l©m nh©n sü nµo muèn tham gia th× h·y ®Õn T­¬ng D­¬ng hoÆc Chu Tiªn trÊn ®Ó vµo khu vùc b¸o danh. Thêi gian khai chiÕn cßn:"..RestMin.." phót !",1)
	end
	idx = PlayerIndex
...
if returnTimeRandomMission() == 2 and (GetGlbMissionV(60) == 500 or GetGlbMissionV(60) == 1500) then -- TK Bat Dau
	if GetGlbMissionV(60) == 500 then
		...
		Msg2WorldById("Tèng Kim §¹i ChiÕn chİnh thøc b¾t ®Çu ........ !",37)
	elseif GetGlbMissionV(60) == 1500 then
...
elseif returnTimeTK() == 2 then
	if GetGlbMissionV(60) == 1000 then
		...
		Msg2WorldById("Tİch lòy qu©n Tèng <color=yellow>"..GetGlbMissionV(81).."",33)
		Msg2WorldById("Tİch lòy qu©n Kim <color=green>"..GetGlbMissionV(82).."",33)
		Msg2WorldById("Tİch lòy qu©n Tèng <color=yellow>"..GetGlbMissionV(81).."",37)
		Msg2WorldById("Tİch lòy qu©n Kim <color=green>"..GetGlbMissionV(82).."",37)
...
if returnCreateBossTK() == 1 then
	if GetGlbMissionV(60) == 2000 then
		if GetGlbMissionV(81) > GetGlbMissionV(82) then
			...
			Msg2WorldById("<color=yellow>Nguyªn So¸i phe Kim ®· xuÊt hiÖn ........ ",33)
			Msg2WorldById("<color=yellow>Nguyªn So¸i phe Kim ®· xuÊt hiÖn ........ ",37)
			SetGlbMissionV(87,1)
		elseif GetGlbMissionV(81) < GetGlbMissionV(82) then
			HideNpc(GetGlbMissionV(85),0)
			Msg2WorldById("<color=yellow>Nguyªn So¸i phe Tèng ®· xuÊt hiÖn ........ ",33)
			Msg2WorldById("<color=yellow>Nguyªn So¸i phe Tèng ®· xuÊt hiÖn ........ ",37)
			SetGlbMissionV(88,1)
		else
			HideNpc(GetGlbMissionV(85),0)
			HideNpc(GetGlbMissionV(86),0)
...
if GetTask(118) >= 30*60 then	
	if num == 1 then
		...
		Msg2Player("<color=green>B¹n nhËn ®­îc 10 ®iÓm Tİch Lòy Sù KiÖn")
		SetTask(484, GetTask(484) + 20)
		Msg2Player("B¹n nhËn ®­îc <color=green>20 ®iÓm Tİch Lòy VIP")
	else
		SetTask(481, GetTask(481) + 5)
		Msg2Player("<color=green>B¹n nhËn ®­îc 5 ®iÓm Tİch Lòy Sù KiÖn")
		SetTask(484, GetTask(484) + 10)
		Msg2Player("B¹n nhËn ®­îc <color=green>10 ®iÓm Tİch Lòy VIP")
	end
else
	Msg2Player("Thêi gian tham chiÕn cña b¹n: "..(GetTask(118)/60).." phót, kh«ng ®ñ 30 phót nªn kh«ng nhËn th­ëng")
end
end
