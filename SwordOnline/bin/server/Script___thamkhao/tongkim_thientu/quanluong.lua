...
function main()
	SayNew("<color=green>Tèng Qu©n Nhu: <color> B¹n ®ang cã: \n+ <color=yellow>"..GetTask(15).."<color> ®iÓm tÝch luü Tèng Kim.",5,
...
if GetTask(968) == 0 then
		SetTask(968, 1)
		AddOwnExp(20000000)
		Msg2Player("B¹n nhËn ®­îc 20.000.000 kinh nghiÖm ®Òn bï ")
else
...
"§æi 500.000 kinh nghiÖm [1000 ®iÓm]/doidiemkinhnghiem",
"Tho¸t./no")
end
...
if mod(GetTask(347),1000) >= 10 then
Talk(1,"","B¹n ®· nhËn ®ñ 5.000.000 kinh nghiÖm h«m nay")
return
end
...
if GetTask(15) >= cost then
		...
		if GetTask(15) == task - cost then
			...
			AddOwnExp(500000)
			Msg2Player("Giíi h¹n sö dông TÝch Lòy: "..mod(GetTask(347),1000).." / 10 lÇn")
		else
			Talk(1,"","hack ha em")
		end
	else
