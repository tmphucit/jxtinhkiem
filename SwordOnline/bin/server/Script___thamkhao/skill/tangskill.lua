...
function tangkill9x()
	SayNewEx({"<color=blue>Npc ADMIN:<color> Khoi khuc skill mon phai ?<color>",
		"Xoa Skills/delski",
...
function kpski()
	...
	SayNewski = "Skill thuong./kpski1"
	SayNewski1 = skillskp[mp][2][1].."/thuchienrbski"
	SayNewski2 = skillskp[mp][3][1].."/thuchienrbski1"
	if id1 >= 4 then
		SayNewski3 = skillskp[mp][4][1].."/thuchienrbski2"
	end
	if id1 <= 3 then
		SayNewEx({"<color=blue>Npc ADMIN:<color> Ban muon toi khoi phuc skill nao ?<color>",SayNewski,SayNewski1,SayNewski2,"Thoi de lan sau./no"});
	else
		SayNewEx({"<color=blue>Npc ADMIN:<color> Ban muon toi khoi phuc skill nao ?<color>",SayNewski,SayNewski1,SayNewski2,SayNewski3,"Thoi de lan sau./no"});
	end
end;
function kpski1()
	ktmp()
