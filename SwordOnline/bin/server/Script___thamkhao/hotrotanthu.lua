...
function main()
SetTask(100 , 500)
SayNew("<color=green>Hç Trî T©n Thñ <color>: Chµo "..GetName()..", ng­¬i cÇn ta gióp g× ?",9,
"NhËn hç trî t©n thñ/nhanhotrotanthu",
"NhËn hç trî c¬ b¶n/phatson_nhanhotrocoban",
"NhËn trang bÞ xanh/nhantbxanh1",
"NhËn Trang bÞ Hoµng Kim/phatson_abdq",
"NhËn Hoµng Kim M«n Ph¸i /nhanhkmp",
"NhËn vËt phÈm hç trî Test /nhanhotrotestnew",
--"Häc khinh c«ng /hockhinhcong",
--"NhËn Nguyªn LiÖu/phatson_nguyenlieu",
--"NhËn §å Phæ/phatson_dopho",
--"NhËn ngua/nhanviptest",
...
Msg2Player("B¹n nhËn ®­îc Set Hoµng Kim T©n Thñ vµ Ngùa §Ých L«, ®Õn Thî RÌn ®Ó hñy trang bÞ khãa vÜnh viÔn")
else
Talk(1,"","§¼ng cÊp 90 trë lªn kh«ng nhËn ®­îc hç trî !")
end
end
...
monphai = mp()
if monphai == 0 then
Talk(1,"","Ng­¬i ch­a gia nhËp ph¸i, kh«ng thÓ nhËn")
return
end

if monphai == 1 then
AddItem(0,0,1,62,0,0,0)
AddItem(0,0,2,62,0,0,0)
AddItem(0,2,33,2,0,0,0)
elseif monphai == 2 then
AddItem(0,0,3,62,0,0,0)
AddItem(0,0,4,62,0,0,0)
AddItem(0,0,1,122,0,0,0)
elseif monphai == 3 then
AddItem(0,1,1,22,0,0,0)
AddItem(0,1,0,42,0,0,0)
AddItem(0,1,2,32,0,0,0)
elseif monphai == 4 then
AddItem(0,0,1,172,0,0,0)
AddItem(0,7,19,2,0,0,0)
elseif monphai == 5 then
AddItem(0,0,0,62,0,0,0)
AddItem(0,9,16,2,0,0,0)
elseif monphai == 6 then
AddItem(0,0,5,62,0,0,0)
AddItem(0,0,1,182,0,0,0)
elseif monphai == 7 then
AddItem(0,8,15,2,0,0,0)
AddItem(0,0,2,122,0,0,0)
elseif monphai == 8 then
AddItem(0,7,24,2,0,0,0)
AddItem(0,0,3,122,0,0,0)
elseif monphai == 9 then
AddItem(0,9,13,2,0,0,0)
AddItem(0,0,0,172,0,0,0)
elseif monphai == 10 then
AddItem(0,7,26,2,0,0,0)
AddItem(0,0,1,152,0,0,0)
...
function nhanhotrotestnew()
SayNew("<color=green>Hç Trî T©n Thñ <color>: ",9,
"Nh¹c V­¬ng KiÕm /addnhacvuongkiem",
"Cöu Nguyªn Th¹ch /nhancuunguyenthach",
"Lam Thñy Tinh/vpquy",
"Tö Thñy Tinh/vpquy",
"Lôc Thñy Tinh/vpquy",
"Tinh Hång B¶o Th¹ch/vpquy",
"Ho¸n Binh Th¹ch/hoanbinhthach",
"X¸ Lîi + B¸t Nh· /xaloi",
...
function vpquy(nsel)
AddEventItem(26+nsel)
end
function hoanbinhthach()
AddEventItem(674)
end
function xaloi()
AddEventItem(59)
...
function nhancuunguyenthach()
AddEventItem(910)
Msg2Player("B¹n nhËn ®­îc 1 Cöu Nguyªn Th¹ch")
end
function addnhacvuongkiem()
AddEventItem(164)
Msg2Player("B¹n nhËn ®­îc 1 Nh¹c V­¬ng KiÕm ")
end
function phatson_nguyenlieu()
SayNew("<color=green>Hç Trî T©n Thñ <color>: ",3,
"NhËn HuyÒn Tinh 8/phatson_huyentinh",
"NhËn ThÇn BÝ Kho¸ng Th¹ch/phatson_thanbi",
"Tho¸t./no")
end

function phatson_dopho()
SayNew("<color=green>Hç Trî T©n Thñ <color>: ",10,
"ThiÕu L©m /phatson_dopho_1",
"Thiªn V­¬ng /phatson_dopho_1",
"§­êng M«n/phatson_dopho_1",
"Ngò §éc /phatson_dopho_1",
"Nga Mi /phatson_dopho_1",
"Thóy Yªn/phatson_dopho_1",
"C¸i Bang /phatson_dopho_1",
"Thiªn NhÉn /phatson_dopho_1",
"Vâ §ang /phatson_dopho_1",
"C«n L«n /phatson_dopho_1")
end

function phatson_dopho_1(nsel)
i = nsel+1
if i == 1 then
	for k=752,766 do AddEventItem(k) end
elseif i == 2 then
	for k=767,781 do AddEventItem(k) end
elseif i == 3 then
	for k=782,801 do AddEventItem(k) end	
elseif i == 4 then
	for k=802,816 do AddEventItem(k) end
elseif i == 5 then
	for k=817,831 do AddEventItem(k) end
elseif i == 6 then
	for k=832,841 do AddEventItem(k) end	
elseif i == 7 then
	for k=842,851 do AddEventItem(k) end	
elseif i == 8 then
	for k=852,866 do AddEventItem(k) end
elseif i == 9 then
	for k=867,876 do AddEventItem(k) end
elseif i == 10 then
	for k=877,891 do AddEventItem(k) end

end
end

function phatson_thanbi()
for i=1,5 do AddEventItem(74) end
end
function phatson_huyentinh()
for i=1,5 do AddEventItem(51) end
end

function phatson_abdq()
SayNew("Chän trang bÞ cÇn nhËn: ",7,
"Trang bÞ An Bang /test_nhanab",
"Trang bÞ §Þnh Quèc/test_nhandq",
"Trang bÞ HiÖp Cèt/test_nhanhc",
"Trang bÞ Nhu T×nh/test_nhannt",
"Trang bÞ Thiªn Hoµng/test_nhanth",
"NhËn TTK, VLMT /phatson_ttk",
"Tho¸t./no")
end

function test_nhanhc()
AddItem(0,9,4,1,0,0,0)
AddItem(0,2,31,1,0,0,0) 
AddItem(0,4,5,1,0,0,0)
AddItem(0,3,6,1,0,0,0)
end
function test_nhannt()
AddItem(0,2,32,2,0,0,0)
AddItem(0,9,5,1,0,0,0)
AddItem(0,4,4,1,0,0,0)
AddItem(0,3,5,1,0,0,0)
end

function test_nhanth()
...
function phatson_nhanhotrocoban()
SayNew("<color=green>Hç Trî T©n Thñ <color>: ",9,
"NhËn Level /phatson_nhanlevel",
"NhËn Max Skill 9x /muadaithanh1",
"NhËn Max Skill 12x /bk120",
"NhËn Ng©n L­îng/phatson_nganluong",
"NhËn TiÒn §ång /phatson_tiendong",
"NhËn Ngùa MiÔn PhÝ /phatson_nhanngua",
"NhËn TÈy Tñy /phatson_taytuy",
"NhËn TÝch Lòy Tèng Kim/phatson_tichluy",
"Tho¸t./no")
end

function phatson_tichluy()
SetTask(15, 1000000)
Msg2Player("B¹n nhËn ®­îc 1.000.000 tÝch lòy Tèng Kim")
end

function bk120()
AddEventItem(19)
end
function phatson_nganluong()
Pay(GetCash())
Earn(10000000)
end
function phatson_tiendong()
for i=1,100 do AddEventItem(697) end
end
function phatson_nhanngua()
...
function phatson_taytuy()
TayKyNang()
TayTiemNang()
end
function phatson_ttk()
if CheckFreeBoxItem(4,364,1,1) == 0 then
	Talk(1,"","Hµnh trang ph¶i ®Ó trèng 6 x 5 « míi cã thÓ nhËn !")
	return
end
for i=1,10 do AddEventItem(0) end
for i=1,15 do AddEventItem(1) end
end


function phatson_nhanlevel()
SayNew("<color=green>Hç Trî T©n Thñ <color>: ",5,
"T¨ng 10 cÊp /phatson_nhanlevel_1",
"Gi¶m 10 cÊp /phatson_nhanlevel_1",
"NhËn cÊp 130 /phatson_nhanlevel_1",
"NhËn cÊp 150 /phatson_nhanlevel_1",
"Tho¸t./no")
end
function phatson_nhanlevel_1(nsel)
if nsel == 0 then
	level = 10
	if GetLevel() + 10 > 130 then
		level = 130 - GetLevel()
	end
	if level == 0 then
		Talk(1,"","§¼ng cÊp tèi ®a kh«ng thÓ nhËn thªm !")
		return
	end
	for i=1,level do AddOwnExp(2000000000) end
elseif nsel == 1 then
	level = GetLevel() - 10
	SetLevel(level)
	TayKyNang()
...
-- AddEventItemMagic(168,5)
-- AddEventItemMagic(167,5,0,0,0,0,0)
-- OpenTong(1)
-- AddEventItem(164)
itemidx = AddEventItem(166)
SetTimeItem(itemidx,550324);
SetHSD(itemidx, 2022 , 5, 20, 22 )
end
