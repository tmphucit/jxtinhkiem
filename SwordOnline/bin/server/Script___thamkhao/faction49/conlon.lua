...
W,X,Y = GetWorldPos()
	if GetFaction() == "" then
		if GetSeries() == nguhanh then
			if GetLevel() >= 10 then
				SayNew("<color=green>"..tennpc.."<color>: Ng­¬i c?muèn tham gia vµo m«n ph¸i <color=yellow>"..tenphai.."<color> hay kh«ng?",2,
	...
	elseif GetFaction() == tenfaction then
			if GetSeries() == nguhanh then
				...
				if GetTask(103) < 9 then
					if GetLevel() >= 10 then
						SayNew("<color=green>"..tennpc.."<color>: Ng­¬i c?muèn tham gia vµo m«n ph¸i <color=yellow>"..tenphai.."<color> hay kh«ng?",3,
						"NhiÖm v?m«n ph¸i./nhapphai",
						"Xem nhiÖm v?®ang lµm /xemnvdanglam",
						"Tho¸t/Exit")
					else
						Talk(1,"","<color=green>"..tennpc.."<color>: Ng­êi h·y luyÖn tËp ®Õn <color=red>cÊp ®é 10<color> råi h·y quay l¹i gÆp ta !")
					end
				elseif GetTask(103) >= 9 and GetTask(103) <= 11 then
					if GetLevel() >= 20 then
						SayNew("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y c?g¾ng lªn nh?",3,
						"NhiÖm v?m«n ph¸i cÊp ®é 20/nhiemvu20",
						"Xem nhiÖm v?®ang lµm /xemnvdanglam",
						"Ta ch?nh©n tiÖn gh?qua th«i !/Exit")
				...
				elseif GetTask(103) >= 12 and GetTask(103) <= 16 then
 					if GetLevel() >= 30 then
						SayNew("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y c?g¾ng lªn nh?",3,
						"NhiÖm v?m«n ph¸i cÊp ®é 30/nhiemvu30",
						"Xem nhiÖm v?®ang lµm /xemnvdanglam",
						"Ta ch?nh©n tiÖn gh?qua th«i !/Exit")						
					else
				...
				elseif GetTask(103) >= 17 and GetTask(103) <= 21 then
					if GetLevel() >= 40 then
						SayNew("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y c?g¾ng lªn nh?",3,
						"NhiÖm v?m«n ph¸i cÊp ®é 40/nhiemvu40",
						"Xem nhiÖm v?®ang lµm /xemnvdanglam",
						"Ta ch?nh©n tiÖn gh?qua th«i !/Exit")						
					else
				...
				elseif GetTask(103) >= 22 and GetTask(103) <= 26 then
					if GetLevel() >= 50 then
						SayNew("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y c?g¾ng lªn nh?",3,
						"NhiÖm v?m«n ph¸i cÊp ®é 50/nhiemvu50",
						"Xem nhiÖm v?®ang lµm /xemnvdanglam",
						"Ta ch?nh©n tiÖn gh?qua th«i !/Exit")						
					else
				...
				elseif GetTask(103) >= 34 and GetTask(103) <= 45 then
					if GetLevel() >= 90 then
						SayNew("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y c?g¾ng lªn nh?",3,
						"NhiÖm v?Trïng Ph¶n S?M«n/nhiemvu90",
						"Xem nhiÖm v?®ang lµm /xemnvdanglam",
						"Ta ch?nh©n tiÖn gh?qua th«i !/Exit")						
					else
						Talk(3,"","<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn ngoµi giang h?cña ng­¬i th?nµo, tèt c?ch?",
						"<color=green>"..tennpc.."<color>: Míi võa ra ®i l¹i quay v?råi, ®õng c?l­êi nh?th? tiÕp tôc tu luyÖn ®i ",
						"<color=green>"..tennpc.."<color>: Ng­êi h·y luyÖn tËp ®Õn <color=red>cÊp ®é 90<color> råi h·y quay l¹i gÆp ta !")
					end
				else
					SayNew("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y c?g¾ng lªn nh?",2,
						"NhiÖm v?K?N¨ng TuyÖt Häc 120/nhiemvu120",
						"Ta ch?nh©n tiÖn gh?qua th«i !/Exit")	
				end
...
function nhapphai() -- nv lv 10
	...
	elseif GetTask(103) >= 4 and GetTask(103) <= 7 then
		Talk(1,"","Ng­¬i ®ang lµm nhiÖm v?M«n Ph¸i, h·y hoµn thµnh råi quay l¹i gÆp ta !")
	...
	elseif GetTask(103) == 8 then
		...
		Talk(1,"","<color=green>"..tennpc.."<color>: Nh÷ng g?ta giao ph?ng­¬i ®· lµm rÊt tèt, chİnh thøc nhËn ng­¬i vµo <color=yellow>"..tenphai.."<color>")	
