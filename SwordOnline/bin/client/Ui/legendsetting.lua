...
AddCommand("F", "", "Switch([[setautostate]])")
AddCommand("Ctrl + F", "", "Switch([[openauto]])")
...
AddCommand("H", "","HoldCursor()")
AddCommand("F11", "", "Open([[tasknote]])")

AddCommand("Ctrl+H", "", "Switch([[fastpk]])")
AddCommand("F9", "", "Switch([[fastpk]])")
AddCommand("C", "", "Switch([[trade]])")
AddCommand("Ctrl+C", "", "Switch([[trade]])")
AddCommand("O", "", "Switch([[trade]])")
AddCommand("V", "", "Open([[map]])")
--AddCommand("J", "", "Open([[mapex]])")
