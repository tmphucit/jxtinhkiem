...
#define ARGB(a, r, g, b)                                                       \
  ((DWORD)((((a) & 0xff) << 24) | (((r) & 0xff) << 16) | (((g) & 0xff) << 8) | \
           ((b) & 0xff)))
...
struct cColor {
  long r, g, b, a;
  cColor(long _r, long _g, long _b, long _a = 255)
      : r(_r), g(_g), b(_b), a(_a) {}
...
struct cRect {
  ...
  cRect operator&(cRect &rect) {
    return cRect(fmax(rect.l, l), fmax(rect.t, t), fmin(rect.r, r),
                 fmin(rect.b, b));
  }

  cRect operator|(cRect &rect) {
    return cRect(fmin(rect.l, l), fmin(rect.t, t), fmax(rect.r, r),
                 fmax(rect.b, b));
  }
  ...
  void Offset(cPoint pt) { Offset(pt.x, pt.y); }
  ...
  void FormatMinMax(cPoint pt) { FormatMinMax(pt.x, pt.y); }
