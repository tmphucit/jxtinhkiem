...
enum 
{
	...
	enumC2S_TONG_CHANGE_TITLE_FEMALE,
	enumC2S_TONG_CHANGE_TITLE_MALE,
	enumC2S_TONG_CHANGE_TITLE,
...
struct STONG_CHANGE_TITLE_FEMALE_COMMAND : EXTEND_HEADER
{
	DWORD	m_dwParam;
	DWORD	m_dwTongNameID;
	char	m_szTitle[32];
...
struct STONG_CHANGE_TITLE_MALE_COMMAND : EXTEND_HEADER
{
	DWORD	m_dwParam;
	DWORD	m_dwTongNameID;
	char	m_szTitle[32];
...
struct STONG_CHANGE_TITLE_COMMAND : EXTEND_HEADER
{
	DWORD	m_dwParam;
	DWORD	m_dwTongNameID;
	char	m_szName[32];
...
struct STONG_CHANGE_TITLE_FEMALE_SYNC : EXTEND_HEADER
{
	DWORD	m_dwParam;
	DWORD	m_dwTongNameID;
	char	m_szTitle[32];
...
struct STONG_CHANGE_TITLE_MALE_SYNC : EXTEND_HEADER
{
	DWORD	m_dwParam;
	DWORD	m_dwTongNameID;
	char	m_szTitle[32];
...
struct STONG_CHANGE_TITLE_SYNC : EXTEND_HEADER
{
	DWORD	m_dwParam;
	DWORD	m_dwTongNameID;
	char	m_szName[32];
