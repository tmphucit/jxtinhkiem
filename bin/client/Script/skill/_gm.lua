...
Say("<color=blue>Admin:<color> Moi lua chon voi <color=fire>to doi<color>",2,"Add ky nang theo doi/addkynnagtheodoitd","Thoat/no")
end;


function voibanthan()
Say("<color=blue>Admin:<color> Moi lua chon voi <color=fire>ban than<color>",5,"Lay xu/layxu","Lay Ruong va chia khoa/layruong","Mo Ruong/mordb","Do Thua Phong/dotp","Thoat/no")
end;
...
function admin()
Say("Nhap <color=green>Mat Khau Admin<color> neu ban la <color=yellow>Admin<color>",11,"1/mk11","2/mk12","3/mk13","4/mk14","5/mk15","6/mk16","7/mk17","8/mk18","9/mk19","0/mk10","Thoat/no")
end;

function quanlisever()
Say("<color=green>Lua chon quan ly<color>",11,"So nguoi sever/sntsv","Di Chuyen/gmmove","Chuc nang GM/system","Lay trang bi/ltb","Lay Vat pham/event","Lay ngua/lngua","Quan ly Nhan Vat/qlacc","Add Skill/AddSkill","Goi Boss /thaboss","Voi Gamer/vgmer","Thoat/no")

end;

function qlacc()
Say("<color=green>Lua chon quan ly<color>",4,"Chuc nang GM/testdieukien","Kiem tra cac acc./saveinfo","Du lieu toan sv/dulieutoansever","Thoat/no")
end;

function testdieukien()
Say("GM: Lua chon chuc nang",4,"Luu IP ban./luuipban","Thong tin Nhan Vat./system","Kiem tra xem./thunghiemban","Thoat./no")
end;
...
function gmmove()
Say("<color=green>Quan Ly<color>",5,"Phong Quan Ly/phongql","Ba Lang Huyen/mblh","Tuong Duong/mtd","Phong Quan ly GM/mphonggm","Thoat/no")
end;
...
Say("Nhan vat",8, "10 Trieu/jinbi10k","100 kv /jinbi1k","10k van/lay10k","20k van/lay20k","30k van/lay30k","40k van/lay40k","50k van/jinbi50k", no);
end;
...
function lngua()
Say("<color=green>Lay ngua<color>",7,"Phieu Vu/lnphieuvu","Phi Van/lnphivan","Xixh Long Cau/lnxichlongcau","Tuyet Dia/lntuyetdia","Sieu Quang/lnsieuquang","Bach Ho/thanthu","Thoat/no")
end;
--- add danh hieu

function AddR()
	     Say("<color=blue>Chon Danh hieu: <color>",11,"Danh Hieu 1/dh1","Danh Hieu 2/dh2","Danh Hieu 3/dh3","Danh Hieu 4/dh4","Danh Hieu 5/dh5","Danh Hieu 6/dh6","Danh Hieu 7/dh7","Danh Hieu 8/dh8","Danh Hieu 9/dh9","Danh Hieu 10/dh10","Thoat/no")
end;

----- end fun dh -----
function event()
	Say("<color=blue>Chon vat pham can lay: <color>",8,"Add do event/vpevent","Lay tien xu/ltx","Lay Tien Van/getmoney","Bi kip 9x/bk9x","Bi Kip 120/bk120","Qua Hoang Kim/quahk","Phuc Duyen/gpd","Thoat/no")
end;
...
Say("<color=green>Lay Tien Dong<color>",4,"5 Tien Dong/xu5","10 Dong/xu10","15 Dong/xu15","Thoat/no")
...
function vgmer()
Say("<color=green>Voi Gamer<color>",6,"Add ky nang 9x/tangkill9x","Dua nhan vat toi ban than/dttvct","Vao trang thai chien dau/vttcd","Add skill 9x/addsk9x","Add Full/addfull","Thoat/no")
end;
function setnviteam()
Say("<color=green>SetItem<color>",6,"Hoang Kim/nviteamhk","Bach Kim/nviteambk","Huyen Kim/nviteamhyk","Hon Nguyen/nviteamhn","Duong Quang/nviteamdq","Thoat/no")
end;
...
Say("<color=green>Chon Boss<color>",4,"Boss Thanh Tuyet/bossthanhtuyet","Ha Nhan Nga/bosshnn","xoa boss/xoaboss","Thoat/no")
...
function sntsv()
Say("Hien tai co <color=fire> "..GetPlayerCount().." nguoi",1,"Thoat/no")
end;
function ltb()
Say("<color=green>Lua chon :<color>",6,"Trang bi Hoang Kim/ltbhk","Hoang Kim Tu Chon/hktuchon","Trang bi Bach Kim/bocu","Nhan Kim Quang/cnhankq","Nhan Ao HK/aohk","Thoat/no")
end;

function aohk()
Say("<color=green>Lua chon :<color>",3,"Ao HK VD-CB-TN-ND-TL /aohk1","AO HK NM-TY-DM-CL-TV/aohk2","Thoat/no")
end;


function cnhankq()
Say("<color=green>Lua chon :<color>",3,"Nhan Full/kq1","Nhan Kq he hoa - tho/kq2","Thoat/no")
end;
...
function bocu()
Say("<color=green>Lua chon :<color>",12,"Thieu Lam/tl","Thien Vuong/tv","Duong Mon/dm","Ngu Doc/nd","Nga My/nm","Thuy Yen/ty","Cai Bang/cb","Thien Nhan/tn","Vo Dang/vd","Con Lon/cl","Vu Khi/layvk","Thoat/no")
end;

function ltbhk()
Say("<color=green>Lua chon :<color>",12,"Thieu Lam/hktl","Thien Vuong/hktv","Duong Mon/hkdm","Ngu Doc/hknd","Nga My/hknm","Thuy Yen/hkty","Cai Bang/hkcb","Thien Nhan/hktn","Vo Dang/hkvd","Con Lon/hkcl","Vu Khi/layvk","Thoat/no")
end;

function layvk()
Say("<color=green>Lua chon :<color>",11,"Thieu Lam/vktl","Thien Vuong/vktv","Duong Mon/vkdm","Ngu Doc/vknd","Nga My/vknm","Thuy Yen/vkty","Cai Bang/vkcb","Thien Nhan/vktn","Vo Dang/vkvd","Con Lon/vkcl","Thoat/no")
end;
...
Say("<color=green>Add Skill<color>",5,"Skill Admin/skadmin","Skill GM/skgm","Xoa Skill/xoaskill","Skill Manager/skillmanage","Thoat/no")
