...
function doipt()
Say("HiÖn t¹i b¹n cã <color=red>"..GetTask(124).."<color> ®iÓm vinh dù. B¹n muèn ®æi g× ?",5,
"Mua trang bÞ An Bang Liªn §Êu /muaitem",
"Mua trang bÞ §Þnh Quèc Liªn §Êu /muaitem",
"Mua LÖnh Bµi Vinh Dù /muaitem",
"Mua VËt PhÈm Quý /muaitem",
"Tho¸t./no")
end
...
function muaanbang()
Say("<color=green>Sø Gi¸ Liªn §Êu<color>: B¹n muèn ®æi g× ?",6,
"An Bang B¨ng Tinh Th¹ch Hang Liªn [10000 ®iÓm]/muaab1",
"An Bang Cóc Hoa Th¹ch ChØ Hoµn [7000 ®iÓm]/muaab1",
"An Bang Kª HuyÕt Th¹ch Giíi ChØ [7000 ®iÓm]/muaab1",
"An Bang §iÒn Hoµng Th¹ch Ngäc Béi [6000 ®iÓm]/muaab1",
"Th«ng tin An Bang Liªn §Êu /thongtinabliendau",
"Tho¸t./no")
end

function thongtinabliendau()
Talk(2,"","An Bang Liªn §Êu gåm 4 mãn, kh«ng thÓ dïng chung víi An Bang Th­êng, b¾t buéc ph¶i ®ñ 1 Set Liªn §Êu ","An Bang Liªn §Êu khi ®æi lÖnh bµi sÏ ra option ngÉu nhiªn 15 - 20 víi d©y chuyÒn vµ 25 - 30 víi nhÉn, ngäc béi")
end
...
Say("<color=green>Sø Gi¸ Liªn §Êu<color>: B¹n muèn ®æi g× ?",7,
"§Þnh Quèc ¤ Sa Ph¸t Qu¸n [3000 ®iÓm]/muadq1",
"§Þnh Quèc Thanh Sa Tr­êng Sam [3000 ®iÓm]/muadq1",
"§Þnh Quèc Ng©n TÇm Yªu §¸i [1500 ®iÓm]/muadq1",
"§Þnh Quèc XÝch QuyÒn NhuyÔn Ngoa [1500 ®iÓm]/muadq1",
"§Þnh Quèc Tö §»ng Hé UyÓn [1500 ®iÓm]/muadq1",
"Th«ng tin §Þnh Quèc Liªn §Êu/thongtindqliendau",
"Tho¸t./no")
end

function thongtindqliendau()
Talk(1,"","LÖnh bµi mua ë Shop Liªn §Êu sÏ ®æi ra trang bÞ §Þnh Quèc b×nh th­êng. Kh«ng cã bé trang bÞ §Þnh Quèc Liªn §Êu ")
end
...
function mualbvd()
Say("<color=green>Sø Gi¸ Liªn §Êu<color>: B¹n muèn ®æi g× ?",5,
...
function muavpquy()
Say("<color=green>Sø Gi¸ Liªn §Êu<color>: B¹n muèn ®æi g× ?",3,
"HuyÒn Tinh 6 [100 ®iÓm]/muavpquy1",
"HuyÒn Tinh 7 [500 ®iÓm]/muavpquy1",
"Tho¸t./no")
end
...
mangitem = {
{35,"LÖnh Bµi [Liªn §Êu] An Bang B¨ng Tinh Th¹ch H¹ng Liªn",10000},
{36,"LÖnh Bµi [Liªn §Êu] An Bang Cóc Hoa Th¹ch ChØ Hoµn",7000},
{37,"LÖnh Bµi [Liªn §Êu] An Bang Kª HuyÕt Th¹ch Giíi ChØ ",7000},
{38,"LÖnh Bµi [Liªn §Êu] An Bang §iÒn Hoµng Th¹ch Ngäc Béi ",6000},
...
Msg2Player("<color=pink>Tõ ngµy 10/7/2014, tÊt c¶ M¸u Tèng Kim ®Òu ph¶i bá vµo r­¬ng khi tham gia liªn ®Êu, nÕu kh«ng sÏ bÞ xãa khi vµo trËn ®Êu !")
