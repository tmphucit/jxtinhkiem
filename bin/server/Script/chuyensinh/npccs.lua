...
Say("<color=green>ChuyÓn Sinh L·o Nh©n<color>: B¹n vui lßng chän lo¹i phÇn th­ëng muèn nhËn :",3,
...
elseif nsel == 5 then
	...
	"Tho¸t./no")
elseif nsel == 6 then
	Say("Vui lßng chän lo¹i trang bÞ ",3,
