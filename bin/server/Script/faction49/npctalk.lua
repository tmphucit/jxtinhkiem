	...
	elseif GetFaction() == tenfaction then
			if GetSeries() == nguhanh then
				...
				if GetTask(103) < 9 then
					if GetLevel() >= 10 then
						Say("<color=green>"..tennpc.."<color>: Ng­¬i cã muèn tham gia vµo m«n ph¸i <color="..colorS(3)..">"..tenphai.."<color> hay kh«ng?",3,
				...
				elseif GetTask(103) >= 9 and GetTask(103) <= 11 then
					if GetLevel() >= 20 then
						Say("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y cè g¾ng lªn nhĞ ",3,
				...
				elseif GetTask(103) >= 34 and GetTask(103) <= 45 then
					...
					Say("<color=green>"..tennpc.."<color>: Con ®­êng tu luyÖn cña ng­¬i cßn dµi l¾m, h·y cè g¾ng lªn nhĞ ",2,
