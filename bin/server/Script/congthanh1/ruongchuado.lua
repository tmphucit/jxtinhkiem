...
Say("<color=red>HÖ Thèng<color>: HiÖn t¹i b¹n ch­a cã  <color=yellow>MËt KhÈu B¶o VÖ R­¬ng<color>. H·y h·y t¹o ®Ó ®­îc an toan ",2,
"Tao M· B¶o VÖ R­¬ng/taopassruong",
"Tho¸t./no")
 else
Say("<color=red>HÖ Thèng<color> Vui lßng nhËp <color=yellow>MËt KhÈu B¶o VÖ R­¬ng<color> ®Ó vµo bªn trong",4,
"Më Khãa R­¬ng/mokhoa",
"§æi M· R­¬ng/doipas",
"Quªn MËt M·/quenpas",
"Tho¸t/no")
...
function doipas()
Say("<color=red>HÖ Thèng<color>: B¹n ch¾c ch¾n muèn <color=yellow>§æi M· B¶o VÖ R­¬ng<color>?",2,
...
function doipas2()
SayEx({"<color=red>HÖ Thèng<color> : §iÒn mËt m·.","1/numberb1","2/numberb1","3/numberb1","4/numberb1","5/numberb1","6/numberb1","7/numberb1","8/numberb1","9/numberb1"})
end;
...
SayEx({"<color=red>HÖ Thèng<color> : §iÒn mËt m·.","1/number1","2/number1","3/number1","4/number1","5/number1","6/number1","7/number1","8/number1","9/number1"})
end;
...
function mokhoa()
SayEx({"<color=red>HÖ Thèng<color> : §iÒn mËt m·.","1/numbera1","2/numbera1","3/numbera1","4/numbera1","5/numbera1","6/numbera1","7/numbera1","8/numbera1","9/numbera1"})
end;
