...
if h == 18 or h == 19 then
	Say("<color=green>D≠Óc ßi’m: <color>: ChÁ ta chuy™n cung c p d≠Óc ph»m cho chi’n tr≠Íng ",3,
	"Giao dﬁch/giaodich",
	"NhÀn NgÚ Hoa Ng‰c LÈ Hoµn Mi‘n Ph› /nhanlebao",
	"Tho∏t ./no")
else
	Say("<color=green>D≠Óc ßi’m: <color>: ChÁ ta chuy™n cung c p d≠Óc ph»m cho chi’n tr≠Íng ",5,
	"Giao dﬁch/giaodich",
