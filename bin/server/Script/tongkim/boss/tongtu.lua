...
if GetGlbMissionV(60) == 2000 then
	...
	if (GetTask(12) == 2) then
		...
		Msg2World("<bclr=blue>Ng­êi ch¬i <bclr=green>["..danhhieu[GetTask(19)][1].."] "..giet.." <bclr>h¹ träng th­¬ng ng­êi ch¬i <bclr=red>["..danhhieu[die_dh][1].."] "..die_name.." <bclr>, tæng PK <bclr=cyan>"..GetTask(11).." <bclr>, ®iÓm tİch lòy <bclr=green>"..GetTask(31).." <bclr>, liªn tr¶m <bclr=cyan>"..GetTask(21).." .")
