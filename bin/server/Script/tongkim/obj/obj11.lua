...
Msg2Player("B¹n nhËn ®­îc "..name.." 1 phót t¨ng s¸t th­¬ng vËt lý néi c«ng "..(100 + (level-1)*10).." ®iÓm ")
Msg2Player("B¹n nhËn ®­îc "..name.." 1 phót t¨ng s¸t th­¬ng vËt lý ngo¹i c«ng "..(50 + (level-1)*5).." % ")
