...
function ddtldnvht()
Say("<color=green>Tèng Qu©n Nhu: <color> HiÖn giê ng­¬i ®ang cã <color=fire>"..GetTask(122).."<color> ®iÓm tÝch luü chiÕn trËn, ®Ó ®æi nh¹c v­¬ng hån th¹ch cÇn <color=wood>10<color> ®iÓm tÝch luü chiÕn trËn, ng­¬i ®æi chø ?",2,"Ta muèn ®æi Nh¹c V­¬ng Hån th¹ch/ddtldnvhtok","Tho¸t/no")
end;
function giaodich()
Sale(23)
end
...
function dlrv()
Say("<color=green>Tèng Qu©n Nhu: <color> HiÖn t¹i ng­¬i ®ang cã <color=fire>"..GetTask(15).."<color> ®iÓm tÝch luü, tuú ng­¬i sö dông",3,
