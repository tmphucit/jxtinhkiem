	...
	if GetGlbMissionV(60) == 0 then
		...
		if GetTask(123) == GetGlbMissionV(61) then
			...
			elseif GetTask(12) == 2 then	
				Say("Tªn Kim binh kia, c¶ gan th©m nhËp vµo l·nh ®Şa ®¹i Tèng, râ rµng lµ tù t×m c¸i chÕt!",1,"Tho¸t./no")
			...
			Say(""..returnType()..", mäi ng­êi h·y v× tö d©n ®¹i tèng, tôc ng÷ cã c©u: Thiªn h¹ h­ng vong, thÊt phu h÷u tr¸ch. Nay ng­êi kim x©m ph¹m bê câi chóng ta, ®©y lµ lóc b¸o hiÕu ®Êt n­íc, nµo ng­êi anh em cßn chÇn chõ g× n÷a!",2,"Ta tham gia! §iÓm tİch lòy trë vÒ 0/baodanh2","Tho¸t/no")
		end
	end;
end
...
if GetGlbMissionV(83)-GetGlbMissionV(84) >= 5 and m < 45 then
...
if GetGlbMissionV(83) >= 100 then
Talk(1,"","Sè l­îng qu©n Tèng ®· ®ñ 100 ng­êi, kh«ng thÓ tham gia thªm !")
return
end
