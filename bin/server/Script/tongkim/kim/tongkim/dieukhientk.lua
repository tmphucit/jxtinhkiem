...
if GetTask(13) >= 20*50 then
	AddEventItem(150)	
	Msg2Player("B¹n nhËn ®­îc 1 LÔ Bao VLTK do tham gia chiÕn tr­êng trªn 1000 tİch lòy")
end
if GetTask(13) >= 10*50 then
	...
	AddEventItem(181)	
	AddEventItem(179)	
	Msg2Player("B¹n nhËn ®­îc Nguyªn liÖu Ğp thuyÒn rång do ®iÓm tİch lòy trªn 500")
end
