...
Say("<color=green>TÈy Tuû §¹i S­ <color> §¹i hiÖp ®­îc tÈy tuû miÔm phİ: ",6,
...
Say("<color=red>TÈy Tuû §¹i S­ <color> B¹n ®· lªn ®¶o b»ng c¸ch dïng Thuû Tinh",4,
"TÈy ®iÔm kü n¨ng/taykn",
"ChuyÓn tr¹ng th¸i PK/chuyenpk",
"Rêi ®¶o tÈy tuû/roidao",
"Tho¸t./no")
elseif GetTask(196) == 4 then
Say("<color=red>TÈy Tuû §¹i S­ <color> B¹n ®· lªn ®¶o b»ng c¸ch dïng Tinh Hång B¶o Th¹ch",4,
"TÉy ®iÓm tiÒm n¨ng/taytn",
"ChuyÓn tr¹ng th¸i PK/chuyenpk",
"Rêi ®¶o tÈy tuû/roidao",
"Tho¸t./no")
elseif GetTask(196) == 5 then
Say("<color=red>TÈy Tuû §¹i S­ <color> B¹n ®· lªn ®¶o b»ng c¸ch dïng Thuû Tinh vµ Tinh Hång B¶o Th¹ch",6,
...
Say("<color=red>TÈy Tuû §¹i S­ <color> B¹n bŞ lçi lag täa ®é. tù ®éng move lªn ®¶o tÈy tñy ",2,
"Rêi ®·o tÈy tuû/roidaofree",
"Tho¸t./no")
end
end
function taykntm()
Say("<color=green>TÈy Tuû §¹i S­ <color> B¹n ch¾c ch¾n muèn tÈy tiÒm n¨ng vµ kü n¨ng chø?",2,
"Ta ch¾c ch¾n/tayca2",
"Tho¸t./no")
end
function roidaofree()
...
function roidao()
Say("<color=green>TÈy Tuû §¹i S­ <color> B¹n ch¾c ch¾n muèn rêi khái ®¶o tÈy tuû chø?",2,
"Ta ch¾c ch¾n/roidao2",
"Tho¸t./no")
end

function chuyenpk()
Say("<color=green>TÈy Tuû §¹i S­ <color> Vui lßng chän tr¹ng th¸i",3,
...
function taytn()
Say("<color=green>TÈy Tuû §¹i S­ <color> B¹n ch¾c ch¾n muèn tÈy ®iÓm tiÒm n¨ng chø?",2,
"Ta ch¾c ch¾n/TayTiemNang",
"Tho¸t./no")
end
function taykn()
Say("<color=green>TÈy Tuû §¹i S­ <color> B¹n ch¾c ch¾n muèn tÈy ®iÓm kü n¨ng chø?",2,
