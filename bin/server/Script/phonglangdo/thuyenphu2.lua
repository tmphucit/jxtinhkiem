...
SetNpcScript(quai1[i], "\\script\\phonglangdo\\thuyenphu2.lua")
end
...
function main()
Talk(1,"","<color=green>ThuyÒn Phu<color>: HiÖn nay ta kh«ng chë kh¸ch ë BÕn ThuyÒn nµy n÷a, ng­¬i h·y qua BÕn ThuyÒn kh¸c ®i !")
end
function main2()
gio = tonumber(date("%H"))
...
gio = tonumber(date("%H"))
phut = tonumber(date("%M"))
if phut >= 20 and GetGlbMissionV(17) == 1 then
	SetGlbMissionV(17,2)
	...
	SetNpcScript(Boss1, "\\script\\phonglangdo\\boss2.lua")
elseif phut >= 25 and GetGlbMissionV(17) == 2  then
	SetGlbMissionV(17,3)
	bossid = random(705,714)
	bosslvl = 99
	vt = random(1,getn(toadomap1))
	...
	SetNpcScript(Boss1, "\\script\\phonglangdo\\boss2.lua")
	Msg2Player("Thñ LÜnh Thñy TÆc ®· xuÊt hiÖn, h·y nhanh ch©n tiªu diÖt ! ")	
elseif phut >= 30 and GetGlbMissionV(17) == 3 then
	SetGlbMissionV(17,4)
		bossid = random(705,714)
	bosslvl = 99
	vt = random(1,getn(toadomap1))
