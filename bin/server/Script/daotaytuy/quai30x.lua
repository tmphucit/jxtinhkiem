...
if HaveMagic(a) >= 1 and HaveMagic(a) < 20 then
		SetTask(TaskSkillFaction9x1,GetTask(TaskSkillFaction9x1)+2300)
...
if HaveMagic(b) >= 1 and HaveMagic(b) < 20 then
		SetTask(TaskSkillFaction9x2,GetTask(TaskSkillFaction9x2)+2300)
...
if HaveMagic(c) >= 1 and HaveMagic(c) < 20 then
		SetTask(TaskSkillFaction9x3,GetTask(TaskSkillFaction9x3)+2300)
...
if HaveMagic(d) >= 1 and HaveMagic(d) < 20 then
		SetTask(TaskSkillFaction12x1,GetTask(TaskSkillFaction12x1)+1900)
...
a,b,c,d,e = SearchSkillFaction()
	...
	tinhphantram4 = floor((diem12x1/diemup12x1)*100)
	phantram4 = floor((diem12x1/(diemup12x1*10))*100)
		if HaveMagic(d) == 20 then
		MsgEx("Ky Nang dat den cap do toi da.")
		else
		MsgEx("Muc Do Luyen Tap Ky Nang 120 hien nay La: "..tinhphantram4.." ,"..phantram4.." %.")
		end
		end;