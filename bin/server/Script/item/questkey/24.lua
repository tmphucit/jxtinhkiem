...
Talk(1,"","Kh«ng thÓ sö dông cho nh©n vËt §ua Top !")
return
end
...
if check_accept_map() == 0 then
	Say("<color=red>HÖ Thèng: <color> §©y lµ giÊy phÐp th«ng hµnh gióp ng­¬i ®Õn chiÕn tr­êng nhanh nhÊt, ng­êi muèn vµo bªn nµo ?",3,
