...
Msg2Player("Kh«ng thÓ sù dông Thæ §Þa Phï trong Khu Vùc Bang Héi !")
return
end
if w == 34 or w == 35 then
	if GetFightState() == 0 then
		if GetTaskTemp(1) < 10 then
			...
			Msg2Player("<color=green>B¹n kh«ng thÓ dïng thë ®Þa phï t¹i ®©y , nÕu bÞ kÑt b¹n h·y nhÊp chuét ph¶i 10 lÇn vµo thæ ®Þa phï ®Ó gi¶i kÑt .")
			Msg2Player("Sè lÇn nhÊp vµo thæ ®Þa phï ®Ó gi¶i kÑt lµ : <color=yellow>"..GetTaskTemp(1).."/10 lÇn .")
		else
			SetFightState(0)
			SetRevPos(19)
			SetRank(1)
...
elseif GetTask(143) == 1 then
	...
	SetTask(143,0)
	Msg2Player("B¹n ®· gi¶i kÑt di chuyÓn vÒ Ba L¨ng HuyÖn thµnh c«ng .")
	SetTaskTemp(1,0)
	end
return
end
