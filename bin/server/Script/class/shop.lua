...
function banbikip()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip nao ?","Bi Kip 90./loai1","Bi Kip 120./loai2","Bi Kip 150./loai3","Thoat./Exit"})
end;

function loai1()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thieu Lam./a1","Thien Vuong./a2","Duong Mon./a3","Ngu Doc./a4","Nga Mi./a5","Tiep Theo./next1","Trang chinh./banbikip","Thoat./Exit"})
end;

function next1()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thuy Yen./a6","Cai Bang./a7","Thien Nhan./a8","Vo Dang./a9","Con Lon./a10","Quay Ve./loai1","Thoat./Exit"})
end;

function a1()
if GetItemCount(86) >= 1 and GetItemCount(87) >= 1 and GetItemCount(88) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Dat Ma Do Giang./tl1","Hoanh Tao Thien Quan./tl2","Vo Tuong Tram./tl3","Thoat./Exit"})
elseif GetItemCount(86) >= 1 and GetItemCount(87) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Dat Ma Do Giang./tl1","Hoanh Tao Thien Quan./tl2","Thoat./Exit"})
elseif GetItemCount(86) >= 1 and GetItemCount(88) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Dat Ma Do Giang./tl1","Vo Tuong Tram./tl3","Thoat./Exit"})
elseif GetItemCount(87) >= 1 and GetItemCount(88) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Hoanh Tao Thien Quan./tl2","Vo Tuong Tram./tl3","Thoat./Exit"})
elseif GetItemCount(86) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Dat Ma Do Giang./tl1","Thoat./Exit"})
elseif GetItemCount(87) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Hoanh Tao Thien Quan./tl2","Thoat./Exit"})
elseif GetItemCount(88) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Vo Tuong Tram./tl3","Thoat./Exit"})
end
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Pha Thien Tram./tv1","Truy Tinh Truc Nguyet./tv2","Truy Phong Quyet./tv3","Thoat./Exit"})
elseif GetItemCount(89) >= 1 and GetItemCount(90) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Pha Thien Tram./tv1","Truy Tinh Truc Nguyet./tv2","Thoat./Exit"})
elseif GetItemCount(89) >= 1 and GetItemCount(91) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Pha Thien Tram./tv1","Truy Phong Quyet./tv3","Thoat./Exit"})
elseif GetItemCount(90) >= 1 and GetItemCount(91) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Truy Tinh Truc Nguyet./tv2","Truy Phong Quyet./tv3","Thoat./Exit"})
elseif GetItemCount(89) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Pha Thien Tram./tv1","Thoat./Exit"})
elseif GetItemCount(90) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Truy Tinh Truc Nguyet./tv2","Thoat./Exit"})
elseif GetItemCount(91) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Truy Phong Quyet./tv3","Thoat./Exit"})
end
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Cuu Cung Phi Tinh./dm2","Bao Vu Le Hoa./dm3","Loan Hoan Kich./dm4","Thoat./Exit"})
elseif GetItemCount(92) >= 1 and GetItemCount(93) >= 1 and GetItemCount(94) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Cuu Cung Phi Tinh./dm2","Bao Vu Le Hoa./dm3","Thoat./Exit"})
elseif GetItemCount(92) >= 1 and GetItemCount(93) >= 1 and GetItemCount(95) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Cuu Cung Phi Tinh./dm2","Loan Hoan Kich./dm4","Thoat./Exit"})
elseif GetItemCount(92) >= 1 and GetItemCount(94) >= 1 and GetItemCount(95) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Bao Vu Le Hoa./dm3","Loan Hoan Kich./dm4","Thoat./Exit"})
elseif GetItemCount(93) >= 1 and GetItemCount(94) >= 1 and GetItemCount(95) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Cuu Cung Phi Tinh./dm2","Bao Vu Le Hoa./dm3","Loan Hoan Kich./dm4","Thoat./Exit"})
elseif GetItemCount(92) >= 1 and GetItemCount(93) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Cuu Cung Phi Tinh./dm2","Thoat./Exit"})
elseif GetItemCount(92) >= 1 and GetItemCount(94) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Bao Vu Le Hoa./dm3","Thoat./Exit"})
elseif GetItemCount(92) >= 1 and GetItemCount(95) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Loan Hoan Kich./dm4","Thoat./Exit"})
elseif GetItemCount(93) >= 1 and GetItemCount(94) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Cuu Cung Phi Tinh./dm2","Bao Vu Le Hoa./dm3","Thoat./Exit"})
elseif GetItemCount(94) >= 1 and GetItemCount(95) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Bao Vu Le Hoa./dm3","Loan Hoan Kich./dm4","Thoat./Exit"})
elseif GetItemCount(93) >= 1 and GetItemCount(95) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Cuu Cung Phi Tinh./dm2","Loan Hoan Kich./dm4","Thoat./Exit"})
elseif GetItemCount(92) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Nhiep Hon Nguyet Anh./dm1","Thoat./Exit"})
elseif GetItemCount(93) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Cuu Cung Phi Tinh./dm2","Thoat./Exit"})
elseif GetItemCount(94) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Bao Vu Le Hoa./dm3","Thoat./Exit"})
elseif GetItemCount(95) >= 1 then
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?","Loan Hoan Kich./dm4","Thoat./Exit"})
end
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban sach nao ?",
...
function loai2()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban Bi Kip nao ?","Thieu Lam./b1","Thien Vuong./b2","Duong Mon./b3","Ngu Doc./b4","Nga Mi./b5","Tiep Theo./next2","Trang chinh./banbikip","Thoat./Exit"})
end;

function next2()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban Bi Kip nao ?","Thuy Yen./b6","Cai Bang./b7","Thien Nhan./b8","Vo Dang./b9","Con Lon./b10","Quay ve./loai2","Thoat./Exit"})
end;
...
function loai3()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban Bi Kip nao ?","Thieu Lam./c1","Thien Vuong./c2","Duong Mon./c3","Ngu Doc./c4","Nga Mi./c5","Tiep Theo./next3","Trang chinh./banbikip","Thoat./Exit"})
end;

function next3()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban Bi Kip nao ?","Thuy Yen./c6","Cai Bang./c7","Thien Nhan./c8","Vo Dang./c9","Con Lon./c10","Quay Ve./loai3","Thoat./Exit"})
end;
...
function muabikip()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon mua Bi Kip nao ?","Bi Kip 90./loai_1","Bi Kip 120./loai_2","Bi Kip 150./loai_3","Thoat./Exit"})
end;

function loai_1()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thieu Lam./az1","Thien Vuong./az2","Duong Mon./az3","Ngu Doc./az4","Nga Mi./az5","Tiep Theo./next_1","Trang chinh./muabikip","Thoat./Exit"})
end;

function next_1()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thuy Yen./az6","Cai Bang./az7","Thien Nhan./az8","Vo Dang./az9","Con Lon./az10","Quay Ve./loai_1","Thoat./Exit"})
end;
...
function loai_2()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thieu Lam./bz1","Thien Vuong./bz2","Duong Mon./bz3","Ngu Doc./bz4","Nga Mi./bz5","Tiep Theo./next_2","Trang chinh./muabikip","Thoat./Exit"})
end;

function next_2()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thuy Yen./bz6","Cai Bang./bz7","Thien Nhan./bz8","Vo Dang./bz9","Con Lon./bz10","Quay Ve./loai_2","Thoat./Exit"})
end;

function bz1()
a = CountItemInShop("Bi Kip 120",2)
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Dai Thua Nhu Lai Chu.\nNguoi co muon mua hay khong?","Ta mua./tlx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Dao Hua Thien.\nNguoi co muon mua hay khong?","Ta mua./tvx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Me Tung Anh.\nNguoi co muon mua hay khong?","Ta mua./dmx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Hap Tinh Yem.\nNguoi co muon mua hay khong?","Ta mua./ndx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Be Nguyet Phat Tran.\nNguoi co muon mua hay khong?","Ta mua./nmx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Ngu Tuyet An.\nNguoi co muon mua hay khong?","Ta mua./tyx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Hon Thien Khi Cong.\nNguoi co muon mua hay khong?","Ta mua./cbx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Ma Am Phe Phach.\nNguoi co muon mua hay khong?","Ta mua./tnx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Luong Nghi Chan Khi.\nNguoi co muon mua hay khong?","Ta mua./vdx","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Hien tai dang co <color=red>"..a.." cuon<color> Xuat U Bat Nhiem.\nNguoi co muon mua hay khong?","Ta mua./clx","Thoat./Exit"})
end;
...
function loai_3()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thieu Lam./caz1","Thien Vuong./caz2","Duong Mon./caz3","Ngu Doc./caz4","Nga Mi./caz5","Tiep Theo./next_3","Trang chinh./muabikip","Thoat./Exit"})
end;

function next_3()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai bi kip mon phai nao ?","Thuy Yen./caz6","Cai Bang./caz7","Thien Nhan./caz8","Vo Dang./caz9","Con Lon./caz10","Quay Ve./loai_3","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Nhuoi muon mua ban loai khoang thach nao?","Huyen Tinh./htinh","Phi Thuy./pthuy","Thuy Tinh./ttinh","Hong Kim Thach./hkimthach","Thoat./Exit"})
end;

function htinh()
SayEx({"<color=cyan>Lai Buon<color>: Nhuoi muon ban Huyen Tinh cap may?","1/hz","2/hz","3/hz","4/hz","5/hz","6/hz","7/hz","8/hz","9/hz","10/hz","Thoat./Exit"})
end;
...
function pthuy()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai Phi Thuy nao ?","Tu Phi Thuy./ptz","Lam Phi Thuy./ptz","Luc Phi Thuy./ptz","Thoat./Exit"})
end;
...
function ttinh()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon ban loai Thuy Tinh nao ?","Lam Thuy Tinh./ttz","Tu Thuy Tinh./ttz","Luc Thuy Tinh./ttz","Thoat./Exit"})
end;
...
SayEx({"<color=cyan>Lai Buon<color>: Nhuoi muon mua ban loai khoang thach nao?","Huyen Tinh./htinhx","Phi Thuy./pthuyx","Thuy Tinh./ttinhx","Hong Kim Thach./hkimthachx","Thoat./Exit"})
end;

function htinhx()
SayEx({"<color=cyan>Lai Buon<color>: Nhuoi muon ban Huyen Tinh cap may?","1/hzx","2/hzx","3/hzx","4/hzx","5/hzx","6/hzx","7/hzx","8/hzx","9/hzx","10/hzx","Thoat./Exit"})
end;
...
function pthuyx()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon mua loai Phi Thuy nao ?","Tu Phi Thuy./ptx","Lam Phi Thuy./ptx","Luc Phi Thuy./ptx","Thoat./Exit"})
end;
...
function ttinhx()
SayEx({"<color=cyan>Lai Buon<color>: Nguoi muon mua loai Thuy Tinh nao ?","Lam Thuy Tinh./ttx","Tu Thuy Tinh./ttx","Luc Thuy Tinh./ttx","Thoat./Exit"})
end;
