...
if getn(mang_daugiakcl) > 1 then
	Msg2SubWorld("Bang héi ®ang dÉn ®Çu b¶ng ®Êu gi¸ Khiªu ChiÕn LÖnh lµ : "..mang_daugiakcl[bangnhat][1].." ")
else
...
Msg2SubWorld("Chóc mõng bang héi "..mang_daugiakcl[bangnhat][1].." ®· th¾ng trong cuéc ®Êu gi¸ h«m nay.")
		...
		if a == 0 then
			Msg2SubWorld("Do thµnh thÞ "..checkNameMAP().." ch­a cã bang héi chiÕm lÜnh nªn Bang Héi "..mang_daugiakcl[bangnhat][1].." ®­îc quyÒn qu¶n lý thµnh thÞ nµy !")
			...
			Msg2Player("B¹n ®­îc phong chøc Th¸i Thó. H·y ®Õn Nha DÞch ë Nha M«n ®Ó ®iÒu chØnh thuÕ !")
			...
			Msg2SubWorld("TrËn c«ng thµnh chiÕn ngµy mai vµo lóc 20h00 ngµy "..(ngay+1).."/"..thang.."/2015 ")
			Msg2SubWorld("C«ng Thµnh "..DSCTC[vitritt()][1][1].." vs. Thñ Thµnh  "..DSCTC[vitritt()][2][1].." ")
			AddGlobalCountNews("Bang héi <color=red>"..mang_daugiakcl[bangnhat][1].."<color> ®· giµnh chiÕn th¾ng trong ®Êu gi¸ h«m nay vµ sÏ tham gia C«ng Thµnh ChiÕn víi bang  "..DSCTC[vitritt()][2][1].." vµo lóc 20h00 ngµy "..(ngay+1).."/"..thang.."/2014 ",1)
		end	
end
		resetdaugia()
end
...
elseif gio == 19 and phut > 45 then
	...
	AddGlobalCountNews("C«ng thµnh chiÕn gi÷a bang c«ng thµnh <color=green>["..DSCTC[vitrictc()][1][1].."]<color> vµ bang thñ thµnh <color=yellow>["..DSCTC[vitrictc()][2][1].."]<color> sÏ b¾t ®Çu sau <color=red>"..time.."<color> phót n÷a. H·y vµo NPC Sø gi¶ bang héi ®Ó tham gia ",1)
	Msg2SubWorld("C«ng thµnh chiÕn gi÷a bang c«ng thµnh ["..DSCTC[vitrictc()][1][1].."] vµ bang thñ thµnh ["..DSCTC[vitrictc()][2][1].."] sÏ b¾t ®Çu sau "..time.." phót n÷a. H·y vµo NPC Sø gi¶ bang héi ®Ó tham gia !")
	end
...
return
		...
		if check_ngaythang() == 1 and gio == 18 and GetTongFigure() == 3 then
			Say("<color=green>Qu¶n Lý Bang Héi<color>:<enter>Thêi gian ®Êu gi¸ cßn l¹i lµ: <color=red>"..(59-phut).."<color> phót <color=red>"..(59-giay).."<color> gi©y ! ",6,
			...
			if w == checktimeCTC() then
				Say("<color=green>Qu¶n Lý Bang Héi<color>: Ta chuyªn qu¶n lý nh÷ng vÊn ®Ò vÒ Bang héi ",7,
			...
			Say("<color=green>Qu¶n Lý Bang Héi<color>: Ta chuyªn qu¶n lý nh÷ng vÊn ®Ò vÒ Bang héi ",6,
				"Giao nép khiªu chiÕn lÖnh /nopkcl",
				"Xem sè l­îng Khiªu ChiÕn LÖnh /xemsl",
				"Xem thêi gian §Êu Gi¸ /timedaugia",
				"Xem thêi gian C«ng Thµnh ChiÕn /timectc",
...
check = 0
	...
	if  check  == 3 then
		Talk(1,"","Time Ho¹t §éng:\n18h00 - 19h00 : §Êu Gi¸ Khiªu ChiÕn LÖnh <color=blue>Thµnh §«<color>")
	elseif check   == 2 then
		Talk(1,"","Time Ho¹t §éng:\n18h00 - 19h00 : §Êu Gi¸ Khiªu ChiÕn LÖnh <color=blue>Ph­îng T­êng<color>20h00 - 22h00: C«ng Thµnh chiÕn <color=red>Thµnh §«")
	elseif check   == 1 then
		Talk(1,"","Time Ho¹t §éng:\n18h00 - 19h00 : §Êu Gi¸ Khiªu ChiÕn LÖnh <color=blue>BiÖn Kinh<color>\n20h00 - 22h00: C«ng Thµnh chiÕn <color=red>Ph­îng T­êng")
	elseif check   == 0 then
		Talk(1,"","Time Ho¹t §éng:\n18h00 - 19h00 : §Êu Gi¸ Khiªu ChiÕn LÖnh <color=blue>T­¬ng D­¬ng<color>\n20h00 - 22h00: C«ng Thµnh chiÕn <color=red>BiÖn Kinh")
	elseif check   == 6 then
		Talk(1,"","Time Ho¹t §éng:\n20h00 - 2h00 : C«ng Thµnh ChiÕn <color=blue>T­¬ng D­¬ng<color>")
	else
		Talk(1,"","H«m nay kh«ng cã ho¹t ®éng liªn quan ®Õn Bang Héi !")
	end
end

function timedaugia()
Talk(3,"","Thêi gian ®Êu gi¸ b¾t ®Çu tõ 18h00 - 19h00 t¹i NPC Qu¶n Lý Bang Héi c¸c thµnh thÞ .",
"Thµnh §« thø 4, Ph­îng T­êng Thø 5, BiÖn Kinh thø 6, T­¬ng D­¬ng Thø 7 ",
"Sau khi kÕt thóc Bang Héi nµo giµnh chiÕn th¾ng ®Êu gi¸ sÏ ®­îc C«ng Thµnh ChiÕn vµo ngµy mai !")
end
function timectc()
Talk(3,"","Thêi gian ®Êu gi¸ b¾t ®Çu tõ 20h00 - 22h00 t¹i NPC Qu¶n Lý Bang Héi c¸c thµnh thÞ .",
"Thµnh §« thø 5, Ph­îng T­êng Thø 6, BiÖn Kinh thø 7, T­¬ng Duong chñ nhËt ",
"Th«ng tin chi tiÕt vui lßng lªn trang chñ ®Ó xem !")
end
...
if checkbang() == 0 then
	...
	Talk(1,"","V­ît qu¸ giíi h¹n 100 c¸i !")
	return
	end
	...
	for i=1,num2 do
		...
		if GetItemCount(IDKCL) == (sl-num2) then
			...
			Msg2Player("Sè l­îng KCL trong ngµy: "..GetTask(9).." / 100 ")
			for k=1,num2 do
				AddOwnExp(50000)
			end
			Msg2Player("B¹n nhËn ®­îc "..(num2*50000).." kinh nghiÖm ")
			Talk(0,"")
		else
			Talk(1,"","Hack ha em")
		end
