...
if GetTask(103) == 29 then
	...
	Msg2Player("NhiÖm vô m«n ph¸i: §Õn Chu Tiªn TrÊn ®¸nh b¹i LiÔu Tè Tè 217/180, lÊy l¹i Ngò S¾c Ngäc Béi !")
elseif GetTask(103) == 31 then
	...
	"TÝn VËt M«n Ph¸i theo nh­ ta biÕt ®ang n»m trong tay 1 g· ¨n mµy. HiÖn t¹i h¾n ®ang ë <color=yellow>Thµnh §« 384/322<color>, ®Õn ®ã hái th¨m thö xem ")
	Msg2Player("NhiÖm vô m«n ph¸i: §Õn Thµnh §« tÝm ¡n Mµy 384/322 ")
	SetTask(103,32)
else
