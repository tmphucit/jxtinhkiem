...
if GetTask(103) == 13 then
	...
	"H·y ®Õn <color=yellow>Phôc Ng­u S¬n 241/223<color> ®Ó tiªu diÖt Hæ d÷ !")
	Msg2Player("NhiÖm vô m«n ph¸i: §i Phôc Ng­u S¬n 241/223 quyÕt h¹ cho b»ng ®­îc Hç d÷ trõ häa cho d©n !")
	SetTask(103,14)
