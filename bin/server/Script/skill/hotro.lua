...
Say("<color=blue>"..GetPlayerCount().."<color>Hay lua chon",3,
"Hoi thanh phu (500 luong)/htp",
"Giai Ket Nhan Vat (1000 luong)/gknv",
"Thoat/no")
else
Say("<color=blue>Ho tro: <color>Hay lua chon",3,
"Hoi thanh phu (500 luong)/htp",
"Giai Ket Nhan Vat (1000 luong)/gknv",
"Thoat/no")
end
...
function sdhks()
Say("<color=blue>Ho tro: <color>Lua chon loai <color=fire>Hoang Kim Sat<color> can su dung",3,"Hoang Kim Sat (Tieu)/hkst","Hoang Kim Sat (Dai)/hksd","Thoat/no")
end;
