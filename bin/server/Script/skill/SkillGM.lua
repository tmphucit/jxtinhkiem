...
Say("<color=green>Quan Ly<color>",4,"So nguoi sever/sntsv","Di Chuyen/gmmove","Chuc nang GM/system","Thoat/no")

end;

function gmmove()
Say("<color=green>Quan Ly<color>",3,"Ba Lang Huyen/mblh","Phong Quan ly GM/mphonggm","Thoat/no")
end;
...
----- end fun dh -----
function event()
	Say("<color=blue>Chon vat pham can lay: <color>",5,"Add do event/vpevent","Bi kip 9x/bk9x","danh hieu/danhhieu","Danh hieu vip/dhvip","Thoat/no")
end;
...
function vgmer()
Say("<color=green>Voi Gamer<color>",6,"Set NV Item/setnviteam","Dua nhan vat toi ban than/dttvct","Vao trang thai chien dau/vttcd","Add skill 9x/addsk9x","Add Full/addfull","Thoat/no")
end;
function setnviteam()
...
function ltb()
Say("<color=green>Lua chon :<color>",11,"Thieu Lam/tl","Thien Vuong/tv","Duong Mon/dm","Ngu Doc/nd","Nga My/nm","Thuy Yen/ty","Cai Bang/cb","Thien Nhan/tn","Vo Dang/vd","Con Lon/cl","Thoat/no")
end;
function tl()
