function main()
Say("<color=green>Nha Sai<color> §iÓm PK hiÖn t¹i cña b¹n lµ: <color=red>"..GetPK().."<color> ®iÓm. B¹n sÏ ph¶i tr¶ <color=yellow>5 v¹n<color> ®Ó ®Çu thó. B¹n cã ch¾c ch¾n muèn vµo nhµ lao kh«ng? ",3,
