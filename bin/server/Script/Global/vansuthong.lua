function main()
Say("<color=green>V¹n Sù Th«ng<color>: Mäi sù trªn ®êi ta ®Òu biÕt, ng­êi cÇn ta gióp g× ?",2,
...
function timnguoi()
Say("<color=green>V¹n Sù Th«ng<color>: Ng­êi cÇn nhËp tªn chÝnh x¸c cña ng­êi ®ã bao gåm c¶ ký tù ®Æc biÖt. PhÝ t×m ng­êi lµ: <color=yellow>200 v¹n l­îng ",2,
"Ta sÏ ®­a ng­êi 200 v¹n ®Ó t×m tung tÝch ng­êi nµy /timnguoi2",
...
if idxplayer == 0 then
	...
	Pay(2000000)
	bando = tenbando(w)
	Say("<color=green>V¹n Sù Th«ng<color>: Ng­êi ch¬i <color=green>"..string.."<color> hiÖn ®ang ë <color=yellow>"..bando.."<color> täa ®é "..floor(x/8).." / "..floor(y/16).."",1,"Ta biÕt råi, c¶m ¬n ng­êi./no")
