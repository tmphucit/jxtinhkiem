function main()
Say("<color=green>C©y Th«ng Gi¸ng Sinh<color>:<enter><color=red>Mery Chrismas 2012 and Happy New Year 2013 !!!!!!<color> ",3,
...
function treothiep()
Say("<color=green>C©y Th«ng Gi¸ng Sinh<color>:<enter>ThiÖp Lo¹i 1: "..GetTask(2).."\tThiÖp Lo¹i 2: "..GetTask(3).."\nThiÖp Lo¹i 3: "..GetTask(4).."\tThiÖp Lo¹i 4: "..GetTask(5).."\nThiÖp Lo¹i 5: "..GetTask(6).." ",6,
