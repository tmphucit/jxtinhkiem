template <class _Tp, class _Alloc> class __simple_alloc {
...
public:
  ...
  static size_t _STLP_CALL __chunk(size_t __n) {
    return (sizeof(__alloc_value_type) == sizeof(value_type))
               ? __n
               : ((__n * sizeof(value_type) + sizeof(__alloc_value_type) - 1) /
                  sizeof(__alloc_value_type));
  }
...
template <class _Tp, class _Alloc> struct __allocator : public _Alloc {
  ...
  __allocator(const __allocator<_Tp, _Alloc> &__a) _STLP_NOTHROW : _Alloc(__a) {
  }
...
inline bool _STLP_CALL operator==(const __new_alloc &, const __new_alloc &) {
  return true;
}
...
inline bool _STLP_CALL operator==(const __debug_alloc<_Alloc> &,
...
struct _Alloc_traits<_Tp, __node_alloc<__threads, __inst>> {
  typedef __allocator<_Tp, __node_alloc<__threads, __inst>> allocator_type;
};
...
template <class _Tp>
inline __allocator<_Tp, __malloc_alloc_dfl>
    _STLP_CALL __stl_alloc_create(const __malloc_alloc_dfl &, const _Tp *) {
...
inline __allocator<_Tp, __malloc_alloc<__inst>>
    _STLP_CALL __stl_alloc_create(const __malloc_alloc<__inst> &, const _Tp *) {
...
inline __allocator<_Tp, __debug_alloc<_Alloc>>
    _STLP_CALL __stl_alloc_create(const __debug_alloc<_Alloc> &, const _Tp *) {
...
inline __allocator<_Tp, __new_alloc>
    _STLP_CALL __stl_alloc_create(const __new_alloc &, const _Tp *) {
