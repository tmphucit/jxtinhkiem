...
_STLP_INLINE_LOOP _Function for_each(_InputIter __first, _InputIter __last,
                                     _Function __f) {
...
_STLP_INLINE_LOOP void count(_InputIter __first, _InputIter __last,
                             const _Tp &__val, _Size &__n) {
  _STLP_DEBUG_CHECK(__check_range(__first, __last))
  for (; __first != __last; ++__first)
    if (*__first == __val)
      ++__n;
...
_STLP_INLINE_LOOP void count_if(_InputIter __first, _InputIter __last,
...
_STLP_INLINE_LOOP _OutputIter transform(_InputIter __first, _InputIter __last,
...
_STLP_INLINE_LOOP void replace_if(_ForwardIter __first, _ForwardIter __last,
...
_STLP_INLINE_LOOP void generate(_ForwardIter __first, _ForwardIter __last,
                                _Generator __gen) {
  _STLP_DEBUG_CHECK(__check_range(__first, __last))
  for (; __first != __last; ++__first)
    *__first = __gen();
...
_STLP_INLINE_LOOP _OutputIter generate_n(_OutputIter __first, _Size __n,
                                         _Generator __gen) {
...
template <class _InputIter, class _OutputIter, class _Tp>
_STLP_INLINE_LOOP _OutputIter remove_copy(_InputIter __first, _InputIter __last,
                                          _OutputIter __result,
                                          const _Tp &__val) {
  _STLP_DEBUG_CHECK(__check_range(__first, __last))
  for (; __first != __last; ++__first)
...
_STLP_INLINE_LOOP _ForwardIter remove(_ForwardIter __first, _ForwardIter __last,
                                      const _Tp &__val) {
  _STLP_DEBUG_CHECK(__check_range(__first, __last))
...
_OutputIter unique_copy(_InputIter __first, _InputIter __last,
                        _OutputIter __result);
...
inline void reverse(_BidirectionalIter __first, _BidirectionalIter __last) {
  ...
  __reverse(__first, __last,
            _STLP_ITERATOR_CATEGORY(__first, _BidirectionalIter));
}
...
template <class _ForwardIter>
_ForwardIter rotate(_ForwardIter __first, _ForwardIter __middle,
                    _ForwardIter __last);
...
_RandomAccessIter random_sample(_InputIter __first, _InputIter __last,
...
template <class _ForwardIter, class _Predicate>
_ForwardIter stable_partition(_ForwardIter __first, _ForwardIter __last,
                              _Predicate __pred);
...
inline bool binary_search(_ForwardIter __first, _ForwardIter __last,
                          const _Tp &__val) {
  _STLP_DEBUG_CHECK(__check_range(__first, __last))
  _ForwardIter __i = __lower_bound(__first, __last, __val, less<_Tp>(),
                                   _STLP_DISTANCE_TYPE(__first, _ForwardIter));
...
inline bool binary_search(_ForwardIter __first, _ForwardIter __last,
                          const _Tp &__val, _Compare __comp) {
  _STLP_DEBUG_CHECK(__check_range(__first, __last))
  _ForwardIter __i = __lower_bound(__first, __last, __val, __comp,
                                   _STLP_DISTANCE_TYPE(__first, _ForwardIter));
...
template <class _BidirectionalIter>
void inplace_merge(_BidirectionalIter __first, _BidirectionalIter __middle,
                   _BidirectionalIter __last);
...
inline bool is_sorted(_ForwardIter __first, _ForwardIter __last) {
  return __is_sorted(__first, __last,
                     __less(_STLP_VALUE_TYPE(__first, _ForwardIter)));
}
