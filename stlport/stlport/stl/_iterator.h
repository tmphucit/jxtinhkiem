...
public:
  ...
  template <class _Iter> _Self &operator=(const reverse_iterator<_Iter> &__x) {
    current = __x.base();
    return *this;
  }
...
inline back_insert_iterator<_Container>
    _STLP_CALL back_inserter(_Container &__x) {
...
inline front_insert_iterator<_Container>
    _STLP_CALL front_inserter(_Container &__x) {
...
inline insert_iterator<_Container> _STLP_CALL inserter(_Container &__x,
                                                       _Iterator __i) {
...
#if !defined(_STLP_CLASS_PARTIAL_SPECIALIZATION) ||                            \
    defined(_STLP_USE_OLD_HP_ITERATOR_QUERIES)
