...
#if !defined(_STLP_INTERNAL_STREAM_ITERATOR_H) &&                              \
...
template <class _Tp, class _CharT = _STLP_DEFAULTCHAR,
          class _Traits = char_traits<_CharT>, class _Dist = ptrdiff_t>
#define __ISI_TMPL_HEADER_ARGUMENTS                                            \
  class _Tp, class _CharT, class _Traits, class _Dist
...
#ifndef _STLP_LIMITED_DEFAULT_TEMPLATES
template <class _TpP, class _CharT = _STLP_DEFAULTCHAR,
...
public:
  ...
  inline bool
  _M_equal(const istream_iterator<__ISI_TMPL_ARGUMENTS> &__y) const {
    return (_M_stream == __y._M_stream && _M_end_marker == __y._M_end_marker) ||
