...
bool _STLP_CALL __stlp_string_fill(basic_ostream<_CharT, _Traits> &__os,
...
template <class _CharT, class _Traits, class _Alloc>
_OSTREAM_DLL &_STLP_CALL operator<<(
    _OSTREAM_DLL &__os, const basic_string<_CharT, _Traits, _Alloc> &__s);
...
inline void _STLP_CALL __stlp_string_fill(_OSTREAM_DLL &__os, streambuf *__buf,
                                          size_t __n) {
  char __f = __os.fill();
  size_t __i;
