...
_STLP_TEMPLATE_NULL
class _STLP_CLASS_DECLSPEC ctype<char> : public locale::facet,
                                         public ctype_base {
...
public:
  ...
  const char *narrow(const char *__low, const char *__high, char __dfault,
                     char *__to) const {
...
public:
  ...
  bool is(mask __m, wchar_t __c) const { return do_is(__m, __c); }
  ...
  const wchar_t *scan_is(mask __m, const wchar_t *__low,
                         const wchar_t *__high) const {
    return do_scan_is(__m, __low, __high);
  }

  const wchar_t *scan_not(mask __m, const wchar_t *__low,
                          const wchar_t *__high) const {
...
protected:
  ...
  virtual const wchar_t *do_scan_is(mask, const wchar_t *,
                                    const wchar_t *) const;
  virtual const wchar_t *do_scan_not(mask, const wchar_t *,
                                     const wchar_t *) const;
  ...
  virtual const wchar_t *do_narrow(const wchar_t *, const wchar_t *, char,
                                   char *) const;
};
