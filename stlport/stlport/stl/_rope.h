...
#define _STLP_CREATE_ALLOCATOR(__atype, __a, _Tp)                              \
  __stl_alloc_create<_Tp, __atype>(__a, (_Tp *)0)
#else
#define _STLP_CREATE_ALLOCATOR(__atype, __a, _Tp)                              \
  __stl_alloc_create(__a, (_Tp *)0)
#endif
...
template <class _CharT> inline _CharT _S_eos(_CharT *) { return _CharT(); }
...
template <class _CharT> inline bool _S_is_basic_char_type(_CharT *) {
  return false;
}
template <class _CharT> inline bool _S_is_one_byte_char_type(_CharT *) {
  return false;
}
...
template <class _CharT> inline void _S_cond_store_eos(_CharT &) {}
...
template <class _CharT> class char_producer {
public:
...
template <class _CharT> class _Rope_char_consumer {
public:
...
#define __ROPE_DEFINE_ALLOC(_Tp, __name, _M_proxy)                             \
  typedef typename _Alloc_traits<_Tp, _Alloc>::allocator_type __name##Allocator;
...
#define __ROPE_DEPTH_SIZE 46
  ...
  _Rope_RopeRep(_Tag __t, int __d, bool __b, size_t _p_size, allocator_type __a)
      :
#ifndef __GC
        _Refcount_Base(1),
#endif
...
public:
  ...
  _Rope_RopeLeaf(__GC_CONST _CharT *__d, size_t _p_size, allocator_type __a)
      : _Rope_RopeRep<_CharT, _Alloc>(_Rope_RopeRep<_CharT, _Alloc>::_S_leaf, 0,
                                      true, _p_size, __a),
        _M_data(__d) {
...
public:
  ...
  _Rope_RopeConcatenation(_Rope_RopeRep<_CharT, _Alloc> *__l,
      ...
      : _Rope_RopeRep<_CharT, _Alloc>(
            ...
            __l->_M_size._M_data + __r->_M_size._M_data, __a),
...
public:
  ...
  _Rope_RopeFunction(char_producer<_CharT> *__f, size_t _p_size, bool __d,
                     allocator_type __a)
      : _Rope_RopeRep<_CharT, _Alloc>(
...
#ifdef __GC
    if (__d) {
      GC_REGISTER_FINALIZER(this, _Rope_RopeFunction::_S_fn_finalization_proc,
                            0, 0, 0);
    }
#endif
  }
...
template <class _CharT, class _Alloc>
     ...
     (__IBMCPP__ ==                                                            \
      500)) // JFA 10-Aug-2000 for some reason xlC cares about the order
struct _Rope_RopeSubstring : public char_producer<_CharT>,
...
// updates.)
#ifndef __GC
template <class _CharT, class _Alloc> struct _Rope_self_destruct_ptr {
...
public:
  ...
  _Self &operator=(const _Self &__c) { return operator=((_CharT)__c); }
};
...
public:
  ...
  _Rope_char_ptr_proxy(_CharT *__x)
      : _M_pos(0),
        _M_root(0){_STLP_ASSERT(0 == __x)} _Self & operator=(const _Self &__x) {
    _M_pos = __x._M_pos;
    _M_root = __x._M_root;
    return *this;
  }
...
public:
  ...
  _Rope_const_iterator(const _RopeRep *__root, size_t __pos)
      : _Rope_iterator_base<_CharT, _Alloc>(__CONST_CAST(_RopeRep *, __root),
                                            __pos)
...
public:
  ...
  _Rope_iterator(const _Self &__x) : _Rope_iterator_base<_CharT, _Alloc>(__x) {
...
template <class _CharT, class _Alloc> class rope {
...
public:
  ...
  static bool _S_apply_to_pieces(
      ...
      _Rope_char_consumer<_CharT> &__c, const _RopeRep *__r, size_t __begin,
      size_t __end);
  // begin and end are assumed to be in range.

#ifndef __GC
  static void _S_unref(_RopeRep *__t) { _RopeRep::_S_unref(__t); }
  static void _S_ref(_RopeRep *__t) { _RopeRep::_S_ref(__t); }
#else /* __GC */
  ...
  static _RopeRep *_S_concat_char_iter(_RopeRep *__r, const _CharT *__iter,
                                       size_t __slen);
...
protected:
  ...
  static _RopeLeaf *_S_new_RopeLeaf(__GC_CONST _CharT *__s, size_t _p_size,
                                    allocator_type __a) {
    _RopeLeaf *__space = _STLP_CREATE_ALLOCATOR(allocator_type, __a, _RopeLeaf)
                             .allocate(1, (const void *)0);
    _STLP_TRY { _STLP_PLACEMENT_NEW(__space) _RopeLeaf(__s, _p_size, __a); }
    _STLP_UNWIND(_STLP_CREATE_ALLOCATOR(allocator_type, __a, _RopeLeaf)
                     .deallocate(__space, 1))
    return __space;
  }
  ...
  static _RopeConcatenation *_S_new_RopeConcatenation(_RopeRep *__left,
                                                      _RopeRep *__right,
                                                      allocator_type __a) {
    _RopeConcatenation *__space =
        _STLP_CREATE_ALLOCATOR(allocator_type, __a, _RopeConcatenation)
            .allocate(1, (const void *)0);
    return _STLP_PLACEMENT_NEW(__space)
        _RopeConcatenation(__left, __right, __a);
  }

  static _RopeFunction *_S_new_RopeFunction(char_producer<_CharT> *__f,
                                            size_t _p_size, bool __d,
                                            allocator_type __a) {
    _RopeFunction *__space =
        _STLP_CREATE_ALLOCATOR(allocator_type, __a, _RopeFunction)
            .allocate(1, (const void *)0);
  ...
  _S_new_RopeSubstring(_Rope_RopeRep<_CharT, _Alloc> *__b, size_t __s,
                       size_t __l, allocator_type __a) {
    _RopeSubstring *__space =
        _STLP_CREATE_ALLOCATOR(allocator_type, __a, _RopeSubstring)
            .allocate(1, (const void *)0);
...
#define _STLP_ROPE_FROM_UNOWNED_CHAR_PTR(__s, _p_size, __a)                    \
  ...
  static _RopeLeaf *_S_RopeLeaf_from_unowned_char_ptr(const _CharT *__s,
    ...
    _CharT *__buf = _STLP_CREATE_ALLOCATOR(allocator_type, __a, _CharT)
                        .allocate(_S_rounded_up_size(_p_size));

    uninitialized_copy_n(__s, _p_size, __buf);
    _S_cond_store_eos(__buf[_p_size]);

    _STLP_TRY { return _S_new_RopeLeaf(__buf, _p_size, __a); }
...
private:
  ...
  // Assumes that buffer is uninitialized.
  static _CharT *_S_flatten(_RopeRep *__r, size_t __start, size_t __len,
                            _CharT *__buffer);

  // fbp : HP aCC prohibits access to protected min_len from within static
  // methods ( ?? )
public:
...
public:
  ...
  rope(const _CharT *__s, const allocator_type &__a = allocator_type())
      : _M_tree_ptr(__a, _STLP_ROPE_FROM_UNOWNED_CHAR_PTR(
                             __s, _S_char_ptr_len(__s), __a)) {}
  ...
  rope(const _CharT *__s, const _CharT *__e,
       const allocator_type &__a = allocator_type())
      : _M_tree_ptr(__a,
                    _STLP_ROPE_FROM_UNOWNED_CHAR_PTR(__s, __e - __s, __a)) {}
  ...
  rope(_CharT __c, const allocator_type &__a = allocator_type())
    ...
    _STLP_TRY { _M_tree_ptr._M_data = _S_new_RopeLeaf(__buf, 1, __a); }
...
#define __exponentiate_threshold size_t(32)
    ...
    if (0 == __rest) {
      ...
      _STLP_TRY { __remainder = _S_new_RopeLeaf(__rest_buffer, __rest, __a); }
    ...
    if (__exponent != 0) {
      ...
      _STLP_TRY {
        __base_leaf =
            _S_new_RopeLeaf(__base_buffer, __exponentiate_threshold, __a);
      }
...
#undef __exponentiate_threshold
  ...
  rope(char_producer<_CharT> *__fn, size_t __len, bool __delete_fn,
      ...
      : _M_tree_ptr(__a, (_RopeRep *)0) {
    _M_tree_ptr._M_data =
        (0 == __len) ? 0 : _S_new_RopeFunction(__fn, __len, __delete_fn, __a);
  }
  ...
  ~rope() { _S_unref(_M_tree_ptr._M_data); }
  ...
  void push_back(_CharT __x) {
    _RopeRep *__old = _M_tree_ptr._M_data;
    _M_tree_ptr._M_data =
        _S_destr_concat_char_iter(_M_tree_ptr._M_data, &__x, 1);
    _S_unref(__old);
  }

  void pop_back() {
    _RopeRep *__old = _M_tree_ptr._M_data;
    _M_tree_ptr._M_data = _S_substring(
        _M_tree_ptr._M_data, 0, _M_tree_ptr._M_data->_M_size._M_data - 1);
    _S_unref(__old);
  }

  _CharT back() const {
    return _S_fetch(_M_tree_ptr._M_data,
                    _M_tree_ptr._M_data->_M_size._M_data - 1);
  }
  ...
  void pop_front() {
    _RopeRep *__old = _M_tree_ptr._M_data;
    _M_tree_ptr._M_data = _S_substring(_M_tree_ptr._M_data, 1,
                                       _M_tree_ptr._M_data->_M_size._M_data);
    _S_unref(__old);
  }

  _CharT front() const { return _S_fetch(_M_tree_ptr._M_data, 0); }
  ...
  void dump() { _S_dump(_M_tree_ptr._M_data); }
  ...
  size_type size() const {
    return (0 == _M_tree_ptr._M_data ? 0
                                     : _M_tree_ptr._M_data->_M_size._M_data);
  }
  ...
  _Self &append(const_iterator __s, const_iterator __e) {
    ...
    _Self_destruct_ptr __appendee(
        _S_substring(__s._M_root, __s._M_current_pos, __e._M_current_pos));
    _RopeRep *__result =
  ...
  _Self &append(const _Self &__y) {
    ...
    _RopeRep *__result =
        _S_concat_rep(_M_tree_ptr._M_data, __y._M_tree_ptr._M_data);
    _S_unref(_M_tree_ptr._M_data);
    _M_tree_ptr._M_data = __result;
    return *this;
  }
...
protected:
  ...
  static _RopeRep *replace(_RopeRep *__old, size_t __pos1, size_t __pos2,
                           _RopeRep *__r) {
    if (0 == __old) {
      _S_ref(__r);
      return __r;
...
public:
  ...
  void insert(size_t __p, _CharT __c) { insert(__p, &__c, 1); }
  ...
  void replace(size_t __p, size_t __n, const const_iterator &__i,
               const const_iterator &__j) {
    _Self __r(__i, __j);
    replace(__p, __n, __r);
  }

  void replace(size_t __p, size_t __n, const iterator &__i,
               const iterator &__j) {
    _Self __r(__i, __j);
    replace(__p, __n, __r);
  }
  ...
  void replace(size_t __p, const _Self &__r) { replace(__p, 1, __r); }
  ...
  void erase(size_t __p) { erase(__p, __p + 1); }
  ...
  iterator insert(const iterator &__p, const const_iterator &__i,
                  const const_iterator &__j) {
    insert(__p.index(), __i, __j);
    return __p;
  }
  iterator insert(const iterator &__p, const iterator &__i,
                  const iterator &__j) {
    insert(__p.index(), __i, __j);
    return __p;
  }
  ...
  void replace(const iterator &__p, const iterator &__q, const _CharT *__i,
               size_t __n) {
  ...
  void replace(const iterator &__p, const iterator &__q, const iterator &__i,
               const iterator &__j) {
    replace(__p.index(), __q.index() - __p.index(), __i, __j);
  }
  ...
  size_type find(const _CharT *__s, size_type __pos = 0) const {
    ...
    const_iterator __result =
        search(const_begin() + (ptrdiff_t)__pos, const_end(), __s,
  ...
  reverse_iterator mutable_rbegin() { return reverse_iterator(mutable_end()); }
...
#ifdef __STD_STUFF
  reference operator[](size_type __pos) { return reference(this, __pos); }
  ...
  size_type copy(_CharT *__buffer, size_type __n, size_type __pos = 0) const {
...
template <class _CharT, class _Alloc>
inline _CharT _Rope_const_iterator<_CharT, _Alloc>::operator[](size_t __n) {
...
inline ptrdiff_t operator-(const _Rope_const_iterator<_CharT, _Alloc> &__x,
  ...
  return (ptrdiff_t)__x._M_current_pos - (ptrdiff_t)__y._M_current_pos;
    ...
    __MWERKS__ >= 0x2000 // dwa 8/21/97  - "ambiguous access to overloaded
                         // function" bug.
template <class _CharT, class _Alloc>
...
template <class _CharT, class _Alloc>
inline rope<_CharT, _Alloc> operator+(const rope<_CharT, _Alloc> &__left,
                                      const rope<_CharT, _Alloc> &__right) {
  _STLP_ASSERT(__left.get_allocator() == __right.get_allocator())
  return rope<_CharT, _Alloc>(rope<_CharT, _Alloc>::_S_concat_rep(
      __left._M_tree_ptr._M_data, __right._M_tree_ptr._M_data));
  // Inlining this should make it possible to keep __left and
  // __right in registers.
}

template <class _CharT, class _Alloc>
inline rope<_CharT, _Alloc> &operator+=(rope<_CharT, _Alloc> &__left,
                                        const rope<_CharT, _Alloc> &__right) {
...
inline rope<_CharT, _Alloc> operator+(const rope<_CharT, _Alloc> &__left,
  ...
  return rope<_CharT, _Alloc>(rope<_CharT, _Alloc>::_S_concat_char_iter(
...
template <class _CharT, class _Alloc>
inline rope<_CharT, _Alloc> operator+(const rope<_CharT, _Alloc> &__left,
                                      _STLP_SIMPLE_TYPE(_CharT) __right) {
  return rope<_CharT, _Alloc>(rope<_CharT, _Alloc>::_S_concat_char_iter(
...
template <class _CharT, class _Alloc>
inline bool operator<(const rope<_CharT, _Alloc> &__left,
                      const rope<_CharT, _Alloc> &__right) {
...
template <class _CharT, class _Alloc>
inline bool operator!=(const rope<_CharT, _Alloc> &__x,
                       const rope<_CharT, _Alloc> &__y) {
  return !(__x == __y);
}
