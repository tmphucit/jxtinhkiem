...
_M_get_ostreambuf(basic_ostream<_CharT, _Traits> &);
...
public:
  ostreambuf_iterator(streambuf_type *__buf) _STLP_NOTHROW : _M_buf(__buf),
                                                             _M_ok(__buf != 0) {
  }
...
template <class _CharT, class _Traits>
inline ostreambuf_iterator<_CharT, _Traits>::ostreambuf_iterator(
    basic_ostream<_CharT, _Traits> &__o) _STLP_NOTHROW
    : _M_buf(_M_get_ostreambuf(__o)),
      _M_ok(_M_buf != 0) {}
