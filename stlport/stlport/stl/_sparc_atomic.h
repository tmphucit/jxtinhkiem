...
#define _STLP_EXCH_ASM                                                         \
  asm volatile("casx [%3], %4, %0 ;  membar  #LoadLoad | #LoadStore "          \
               : "=r"(_L_value2), "=m"(*_L_pvalue1)                            \
               : "m"(*_L_pvalue1), "r"(_L_pvalue1), "r"(_L_value1),            \
                 "0"(_L_value2))

#else /* __arch64__ */

#define _STLP_EXCH_ASM                                                         \
  asm volatile("cas [%3], %4, %0"                                              \
               : "=r"(_L_value2), "=m"(*_L_pvalue1)                            \
               : "m"(*_L_pvalue1), "r"(_L_pvalue1), "r"(_L_value1),            \
                 "0"(_L_value2))
#endif
...
#define _STLP_ATOMIC_EXCHANGE(__pvalue1, __value2)                             \
  ({                                                                           \
    ...
    do {                                                                       \
      _L_value1 = *_L_pvalue1;                                                 \
      _STLP_EXCH_ASM;                                                          \
    } while (_L_value1 != _L_value2);                                          \
    _L_value1;                                                                 \
  })
...
extern "C" __stl_atomic_t _STLP_atomic_exchange(__stl_atomic_t *__x,
                                                __stl_atomic_t __v);
...
#define _STLP_ATOMIC_INCREMENT(__x)                                            \
  _STLP_atomic_increment((__stl_atomic_t *)__x)
#define _STLP_ATOMIC_DECREMENT(__x)                                            \
  _STLP_atomic_decrement((__stl_atomic_t *)__x)
