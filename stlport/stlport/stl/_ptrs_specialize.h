...
#else
#define _STLP_TYPE_TRAITS_POD_SPECIALIZE(_Type)                                \
  _STLP_TEMPLATE_NULL struct __type_traits<_Type> : __type_traits_aux<true> {};
#define _STLP_TYPE_TRAITS_POD_SPECIALIZE_V(_Type)                              \
...
#define _STLP_POINTERS_SPECIALIZE(_Type)                                       \
  _STLP_TYPE_TRAITS_POD_SPECIALIZE_V(_Type)                                    \
  _STLP_ARROW_SPECIALIZE_WITH_PTRS(_Type)
