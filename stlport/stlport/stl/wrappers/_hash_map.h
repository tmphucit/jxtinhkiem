...
#define __HM_BASE_ARGUMENTS                                                    \
  _Key, _Tp, hash<_Key>, equal_to<_Key>,                                       \
      _STLP_DEFAULT_PAIR_ALLOCATOR(const _Key, _Tp)
#else
#define __HM_TEMPLATE_HEADER                                                   \
  template <class _Key, class _Tp, class _HashFcn, class _EqualKey>
#define __HM_ARGUMENTS _Key, _Tp, _HashFcn, _EqualKey
#define __HM_BASE_ARGUMENTS                                                    \
  _Key, _Tp, _HashFcn, _EqualKey, _STLP_DEFAULT_PAIR_ALLOCATOR(const _Key, _Tp)
#endif
...
public:
  ...
  hash_map(size_type __n, const hasher &__hf, const key_equal &__eql)
      : __HM_SUPER(__n, __hf, __eql) {}
  hash_map(const value_type *__f, const value_type *__l)
      : __HM_SUPER(__f, __l) {}
  hash_map(const value_type *__f, const value_type *__l, size_type __n)
      : __HM_SUPER(__f, __l, __n) {}
  hash_map(const value_type *__f, const value_type *__l, size_type __n,
           const hasher &__hf)
      : __HM_SUPER(__f, __l, __n, __hf) {}
  hash_map(const value_type *__f, const value_type *__l, size_type __n,
           const hasher &__hf, const key_equal &__eql)
      : __HM_SUPER(__f, __l, __n, __hf, __eql) {}
  ...
  friend inline bool operator==
      _STLP_NULL_TMPL_ARGS(const _Self &__hm1, const _Self &__hm2);
#endif
};
...
public:
  ...
  hash_multimap(size_type __n, const hasher &__hf, const key_equal &__eql)
      : __HMM_SUPER(__n, __hf, __eql) {}
  hash_multimap(const value_type *__f, const value_type *__l)
      : __HMM_SUPER(__f, __l) {}
  hash_multimap(const value_type *__f, const value_type *__l, size_type __n)
      : __HMM_SUPER(__f, __l, __n) {}
  hash_multimap(const value_type *__f, const value_type *__l, size_type __n,
                const hasher &__hf)
      : __HMM_SUPER(__f, __l, __n, __hf) {}
  hash_multimap(const value_type *__f, const value_type *__l, size_type __n,
                const hasher &__hf, const key_equal &__eql)
      : __HMM_SUPER(__f, __l, __n, __hf, __eql) {}
