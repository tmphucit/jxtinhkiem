...
#define __HS_BASE_ARGUMENTS                                                    \
  _Value, hash<_Value>, equal_to<_Value>, _STLP_DEFAULT_ALLOCATOR(_Value)
#else
...
#define __HS_BASE_ARGUMENTS                                                    \
  _Value, _HashFcn, _EqualKey, _STLP_DEFAULT_ALLOCATOR(_Value)
#endif
...
public:
  ...
  friend inline bool operator==
      _STLP_NULL_TMPL_ARGS(const _Self &hs1, const _Self &hs2);
#endif
};
...
public:
  ...
  hash_multiset(size_type __n, const hasher &__hf, const key_equal &__eql)
      : __HMS_SUPER(__n, __hf, __eql) {}

  hash_multiset(const value_type *__f, const value_type *__l)
      : __HMS_SUPER(__f, __l) {}
  hash_multiset(const value_type *__f, const value_type *__l, size_type __n)
      : __HMS_SUPER(__f, __l, __n) {}
  hash_multiset(const value_type *__f, const value_type *__l, size_type __n,
                const hasher &__hf)
      : __HMS_SUPER(__f, __l, __n, __hf) {}
  hash_multiset(const value_type *__f, const value_type *__l, size_type __n,
                const hasher &__hf, const key_equal &__eql)
      : __HMS_SUPER(__f, __l, __n, __hf, __eql) {}
...
#if defined(_STLP_BASE_MATCH_BUG)
  friend inline bool operator==
      _STLP_NULL_TMPL_ARGS(const _Self &__hs1, const _Self &__hs2);
#endif
};
