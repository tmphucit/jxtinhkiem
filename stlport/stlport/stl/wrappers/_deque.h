...
template <class _Tp> class deque : public _DEQUE_SUPER {
public:
  ...
  deque(const _Tp *__first, const _Tp *__last)
      : _DEQUE_SUPER(__first, __last) {}
...
template <class _Tp>
inline bool operator==(const deque<_Tp> &__x, const deque<_Tp> &__y) {
