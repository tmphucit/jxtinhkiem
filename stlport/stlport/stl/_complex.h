...
template <class _Tp> struct complex {
  ...
  complex(const value_type &__x, const value_type &__y)
      : _M_re(__x), _M_im(__y) {}
  complex(const _Self &__z) : _M_re(__z._M_re), _M_im(__z._M_im) {}
  ...
  _Self &operator=(const _Self &__z) {
    ...
    (defined(_STLP_FUNCTION_TMPL_PARTIAL_ORDER) ||                             \
     defined(_STLP_NO_COMPLEX_SPECIALIZATIONS))
  template <class _Tp2>
  ...
  static void _STLP_CALL _div(const value_type &__z1_r,
                              ...
                              const value_type &__z2_i, value_type &__res_r,
                              value_type &__res_i);
...
#if defined(_STLP_MEMBER_TEMPLATES) // && defined
...
struct _STLP_CLASS_DECLSPEC complex<float> {
  ...
  static void _STLP_CALL _div(const float &__z1_r, const float &__z2_r,
                              const float &__z2_i, float &__res_r,
                              float &__res_i);

#if defined(_STLP_MEMBER_TEMPLATES)

  template <class _Tp2> complex<float> &operator=(const complex<_Tp2> &__z) {
    _M_re = __z._M_re;
    _M_im = __z._M_im;
    return *this;
  }
...
_STLP_TEMPLATE_NULL struct _STLP_CLASS_DECLSPEC complex<double> {
  ...
  complex(const complex<double> &__z) : _M_re(__z._M_re), _M_im(__z._M_im) {}
  ...
  static void _STLP_CALL _div(const double &__z1_r, const double &__z2_r,
                              const double &__z2_i, double &__res_r,
                              double &__res_i);

#if defined(_STLP_MEMBER_TEMPLATES) &&                                         \
    defined(_STLP_FUNCTION_TMPL_PARTIAL_ORDER)

  template <class _Tp2> complex<double> &operator=(const complex<_Tp2> &__z) {
    _M_re = __z._M_re;
    _M_im = __z._M_im;
    return *this;
  }
...
_STLP_TEMPLATE_NULL struct _STLP_CLASS_DECLSPEC complex<long double> {
  ...
  static void _STLP_CALL _div(const long double &__z1_r,
                              ...
                              const long double &__z2_i, long double &__res_r,
                              long double &__res_i);
...
template <class _Tp>
inline complex<_Tp> _STLP_CALL operator+(const _Tp &__x,
...
inline complex<_Tp> _STLP_CALL operator/(const _Tp &__x,
  ...
  complex<_Tp>::_div(__x, __z._M_re, __z._M_im, __result._M_re, __result._M_im);
  return __result;
}
...
template <class _Tp>
inline complex<_Tp> _STLP_CALL operator+(const complex<_Tp> &__z1,
...
inline complex<_Tp> _STLP_CALL operator/(const complex<_Tp> &__z1,
                                         const complex<_Tp> &__z2) {
  complex<_Tp> __result;
  complex<_Tp>::_div(__z1._M_re, __z1._M_im, __z2._M_re, __z2._M_im,
...
template <class _Tp>
inline bool _STLP_CALL operator==(const complex<_Tp> &__z1,
                                  const complex<_Tp> &__z2) {
...
template <class _Tp> inline _Tp _STLP_CALL real(const complex<_Tp> &__z) {
  return __z._M_re;
}

template <class _Tp> inline _Tp _STLP_CALL imag(const complex<_Tp> &__z) {
  return __z._M_im;
}
...
_STLP_DECLSPEC complex<float> _STLP_CALL polar(const float &__rho,
                                               const float &__phi);
_STLP_DECLSPEC complex<double> _STLP_CALL polar(const double &__rho,
                                                const double &__phi);
...
_STLP_DECLSPEC complex<long double> _STLP_CALL polar(const long double &,
                                                     const long double &);
#endif

template <class _Tp> _Tp _STLP_CALL abs(const complex<_Tp> &__z) {
  return _Tp(abs(complex<double>(double(__z.real()), double(__z.imag()))));
}

template <class _Tp> _Tp _STLP_CALL arg(const complex<_Tp> &__z) {
  return _Tp(arg(complex<double>(double(__z.real()), double(__z.imag()))));
}

template <class _Tp> inline _Tp _STLP_CALL norm(const complex<_Tp> &__z) {
...
template <class _Tp> complex<_Tp> _STLP_CALL polar(const _Tp &__rho) {
...
_STLP_OPERATOR_TEMPLATE
_STLP_DECLSPEC basic_ostream<char, char_traits<char>> &_STLP_CALL operator<<(
    basic_ostream<char, char_traits<char>> &__is, const complex<float> &__z);

_STLP_OPERATOR_TEMPLATE
_STLP_DECLSPEC basic_ostream<char, char_traits<char>> &_STLP_CALL operator<<(
    basic_ostream<char, char_traits<char>> &__is, const complex<double> &__z);

#if !defined(_STLP_NO_LONG_DOUBLE)
_STLP_OPERATOR_TEMPLATE
_STLP_DECLSPEC basic_istream<char, char_traits<char>> &_STLP_CALL operator>>(
    basic_istream<char, char_traits<char>> &__is, complex<long double> &__z);

_STLP_OPERATOR_TEMPLATE
_STLP_DECLSPEC basic_ostream<char, char_traits<char>> &_STLP_CALL
operator<<(basic_ostream<char, char_traits<char>> &__is,
...
#ifndef _STLP_NO_LONG_DOUBLE
_STLP_DECLSPEC complex<long double>
    _STLP_CALL sqrt(const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL exp(const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL log(const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL log10(const complex<long double> &);
...
_STLP_DECLSPEC complex<long double> _STLP_CALL pow(const complex<long double> &,
                                                   const long double &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL pow(const long double &, const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL pow(const complex<long double> &, const complex<long double> &);

_STLP_DECLSPEC complex<long double>
    _STLP_CALL sin(const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL cos(const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL tan(const complex<long double> &);

_STLP_DECLSPEC complex<long double>
    _STLP_CALL sinh(const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL cosh(const complex<long double> &);
_STLP_DECLSPEC complex<long double>
    _STLP_CALL tanh(const complex<long double> &);
#endif
