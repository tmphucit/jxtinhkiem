...
template <class _Tp> struct _Valarray_base {
  _Tp *_M_first;
  size_t _M_size;
...
template <class _Tp> class valarray : private _Valarray_base<_Tp> {
  friend class gslice;
...
public: // Other member functions.
  ...
  valarray<_Tp> apply(value_type __f(value_type)) const {
    ...
    transform(this->_M_first + 0, this->_M_first + this->_M_size,
              __tmp._M_first, __f);
    return __tmp;
  }
...
template <class _Tp>
inline valarray<_Tp> _STLP_CALL operator*(const _Tp &__c,
...
template <class _Tp>
inline _Valarray_bool _STLP_CALL operator==(const _Tp &__c,
                                            const valarray<_Tp> &__x) {
  _Valarray_bool __tmp(__x.size(), _Valarray_bool::_NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
    __tmp[__i] = __c == __x[__i];
...
template <class _Tp> inline valarray<_Tp> abs(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> acos(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> asin(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> atan(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp>
inline valarray<_Tp> atan2(const valarray<_Tp> &__x, const valarray<_Tp> &__y) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> cos(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> cosh(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> exp(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> log(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> log10(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp>
inline valarray<_Tp> pow(const valarray<_Tp> &__x, const valarray<_Tp> &__y) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> sin(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> sinh(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> sqrt(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> tan(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
template <class _Tp> inline valarray<_Tp> tanh(const valarray<_Tp> &__x) {
  typedef typename valarray<_Tp>::_NoInit _NoInit;
  valarray<_Tp> __tmp(__x.size(), _NoInit());
  for (size_t __i = 0; __i < __x.size(); ++__i)
...
public:
  ...
  void operator=(const valarray<value_type> &__x) const {
    ...
    for (size_t __i = 0; __i < _M_slice.size();
...
inline valarray<_Tp>::valarray(const slice_array<_Tp> &__x)
  ...
  typedef
      typename __type_traits<_Tp>::has_trivial_default_constructor _Is_Trivial;
  _M_initialize(_Is_Trivial());
  *this = __x;
}
...
template <class _Size> struct _Gslice_Iter_tmpl;
...
public:
  ...
  gslice(size_t __start, const _Valarray_size_t &__lengths,
  ...
  size_t _M_size() const {
    return !this->_M_empty()
               ? accumulate(_M_lengths._M_first + 1,
                            ...
                            _M_lengths[0], multiplies<size_t>())
               : 0;
  }
...
template <class _Size> struct _Gslice_Iter_tmpl {
  _Gslice_Iter_tmpl(const gslice &__gslice)
      : _M_step(0), _M_1d_idx(__gslice.start()),
        _M_indices(size_t(0), __gslice._M_lengths.size()), _M_gslice(__gslice) {
  }
...
public:
  ...
  void operator=(const valarray<value_type> &__x) const {
    if (!_M_gslice._M_empty()) {
      ...
      do
        _M_array[__i._M_1d_idx] = __x[__i._M_step];
      while (__i._M_incr());
    }
  }
