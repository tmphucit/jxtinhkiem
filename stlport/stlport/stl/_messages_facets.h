...
_STLP_TEMPLATE_NULL
class _STLP_CLASS_DECLSPEC messages<char> : public locale::facet,
...
public:
  ...
  inline void close(catalog __c) const { do_close(__c); }
...
_STLP_TEMPLATE_NULL
class _STLP_CLASS_DECLSPEC messages<wchar_t> : public locale::facet,
                                               public messages_base {
  friend class _Locale;
