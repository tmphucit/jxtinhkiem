...
extern basic_streambuf<_CharT, _Traits> *_STLP_CALL
_M_get_istreambuf(basic_istream<_CharT, _Traits> &);

// We do not read any characters until operator* is called. operator* calls
// sgetc unless the iterator is unchanged from the last call in which case a
// cached value is used. Calls to operator++ use sbumpc.
...
template <class _CharT, class _Traits>
inline istreambuf_iterator<_CharT, _Traits>::istreambuf_iterator(
