...
inline _ForwardIter __uninitialized_copy(_InputIter __first, _InputIter __last,
  ...
  return __copy_aux(__first, __last, __result,
                    _BothPtrType<_InputIter, _ForwardIter>::_Ret());
}

template <class _InputIter, class _ForwardIter>
_STLP_INLINE_LOOP _ForwardIter __uninitialized_copy(_InputIter __first,
                                                    _InputIter __last,
                                                    _ForwardIter __result,
                                                    const __false_type &) {
...
inline wchar_t *uninitialized_copy(const wchar_t *__first,
                                   const wchar_t *__last, wchar_t *__result) {
...
_STLP_INLINE_LOOP pair<_InputIter, _ForwardIter>
...
__uninitialized_copy_n(_RandomAccessIter __first, _Size __count,
  ...
  return pair<_RandomAccessIter, _ForwardIter>(
      __last, __uninitialized_copy(__first, __last, __result,
                                   _IS_POD_ITER(__result, _ForwardIter)));
}
...
template <class _ForwardIter, class _Tp>
_STLP_INLINE_LOOP void __uninitialized_fill(_ForwardIter __first,
...
inline void uninitialized_fill(_ForwardIter __first, _ForwardIter __last,
                               const _Tp &__x) {
  __uninitialized_fill(__first, __last, __x,
                       _IS_POD_ITER(__first, _ForwardIter));
}
...
template <class _ForwardIter, class _Size, class _Tp>
_STLP_INLINE_LOOP _ForwardIter __uninitialized_fill_n(_ForwardIter __first,
...
__uninitialized_copy_copy(_InputIter1 __first1, _InputIter1 __last1,
  ...
  return __uninitialized_copy(
      __first2, __last2,
      __uninitialized_copy(__first1, __last1, __result, __true_type()),
      __true_type());
}
...
__uninitialized_copy_copy(_InputIter1 __first1, _InputIter1 __last1,
  ...
  _ForwardIter __mid = __uninitialized_copy(
      __first1, __last1, __result, _IS_POD_ITER(__result, _ForwardIter));
  _STLP_TRY {
    return __uninitialized_copy(__first2, __last2, __mid,
                                _IS_POD_ITER(__result, _ForwardIter));
  }
...
__uninitialized_fill_copy(_ForwardIter __result, _ForwardIter __mid,
  ...
  _STLP_TRY { return __uninitialized_copy(__first, __last, __mid, _I_POD()); }
  _STLP_UNWIND(_Destroy(__result, __mid));
#ifdef _STLP_THROW_RETURN_BUG
  return __result;
#endif
...
inline void __uninitialized_copy_fill(_InputIter __first1, _InputIter __last1,
  ...
  typedef typename __type_traits<_Tp>::is_POD_type _I_POD;
  _ForwardIter __mid2 =
      __uninitialized_copy(__first1, __last1, __first2, _I_POD());
  _STLP_TRY { __uninitialized_fill(__mid2, __last2, __x, _I_POD()); }
