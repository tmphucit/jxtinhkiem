...
#define _STLP_UNARY_FUNCTION_CHECK(__func, __ret, __arg)                       \
  do {                                                                         \
    __ret (*__x)(__func &, const __arg &) = _STL_UNARY_FUNCTION_ERROR<         \
...
#define _STLP_CLASS_GENERATOR_CHECK(__func, __ret)                             \
  ...
  static __dummy_struct_##__func##__ret##_generator<                           \
      _STL_GENERATOR_ERROR<__func, __ret>::__generator_requirement_violation>  \
...
#define _STLP_CLASS_BINARY_FUNCTION_CHECK(__func, __ret, __first, __second)    \
  typedef __ret (*__f_##__func##__ret##__first##__second##_binary_check)(      \
      __func &, const __first &, const __second &);                            \
...
#define _STLP_CLASS_REQUIRES_BINARY_OP(__opname, __ret, __first, __second)     \
  typedef __ret (*__f_##__func##__ret##__first##__second##_binary_op)(         \
      const __first &, const __second &);                                      \
...
template <class _Tp> struct _Mutable_trait {
  typedef _Tp _Type;
};
template <class _Tp> struct _Mutable_trait<const _Tp> {
  typedef _Tp _Type;
};
...
template <class _TypeX, class _TypeY> struct _STL_SAME_TYPE_ERROR {
...
template <class _Func, class _Ret> struct _STL_GENERATOR_ERROR {
  static _Ret __generator_requirement_violation(_Func &__f) { return __f(); }
};

template <class _Func> struct _STL_GENERATOR_ERROR<_Func, void> {
...
struct _STL_BINARY_FUNCTION_ERROR {
  static _Ret __binary_function_requirement_violation(_Func &__f,
...
struct _STL_BINARY_FUNCTION_ERROR<_Func, void, _First, _Second> {
  static void __binary_function_requirement_violation(_Func &__f,
                                                      const _First &__first,
                                                      const _Second &__second) {
...
#define _STLP_DEFINE_BINARY_OP_CHECK(_OP, _NAME)                               \
  ...
  struct _STL_BINARY##_NAME##_ERROR {                                          \
    ...
    static _Ret __binary_operator_requirement_violation(_First &__first,       \
                                                        _Second &__second) {   \
      return __first _OP __second;                                             \
    }                                                                          \
  }
...
struct _STL_ERROR {
  ...
  template <class _Iterator, class _Distance>
  static _Iterator __iterator_subtraction_requirement_violation(_Iterator __i,
                                                                _Distance __n) {
    __i = __i - __n;
    return __i;
  }
  template <class _Iterator, class _Distance>
  static _Distance __difference_operator_requirement_violation(_Iterator __i,
                                                               _Iterator __j,
                                                               _Distance __n) {
    __n = __i - __j;
    return __n;
  ...
  static _Type __element_access_operator_requirement_violation(_Exp __x,
                                                               _Type *,
                                                               _Distance __n) {
    return __x[__n];
  }
...
struct __difference_type_type_definition_requirement_violation {
  typedef
      typename __STD::iterator_traits<_Iter>::difference_type difference_type;
};
...
struct _Mutable_TrivialIterator_concept_specification {
  ...
  _Mutable_TrivialIterator_requirement_violation(_TrivialIterator __i) {
    ...
    // Valid Expressions
    _STL_ERROR::__dereference_operator_and_assignment_requirement_violation(
        __i);
  }
};
...
struct _BidirectionalIterator_concept_specification {
  ...
  _BidirectionalIterator_requirement_violation(_BidirectionalIterator __i) {
    ...
    _ForwardIterator_concept_specification<
        _BidirectionalIterator>::_ForwardIterator_requirement_violation(__i);
    // Valid Expressions
...
struct _RandomAccessIterator_concept_specification {
  static void _RandomAccessIterator_requirement_violation(_RandAccIter __i) {
    ...
    typedef typename __difference_type_type_definition_requirement_violation<
        _RandAccIter>::difference_type _Dist;
    typedef typename _Mutable_trait<_Dist>::_Type _MutDist;

    // Valid Expressions
    _STL_ERROR::__iterator_addition_assignment_requirement_violation(
        __i, _MutDist());
    _STL_ERROR::__iterator_addition_requirement_violation(__i, _MutDist());
    _STL_ERROR::__iterator_subtraction_assignment_requirement_violation(
        __i, _MutDist());
    ...
    _STL_ERROR::__element_access_operator_requirement_violation(
