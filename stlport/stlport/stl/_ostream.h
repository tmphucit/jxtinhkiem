...
template <class _CharT, class _Traits> class _Osentry;
#endif
...
public: // Formatted output.
  ...
  _Self &operator<<(short __x) {
    return _M_put_num(*this, __STATIC_CAST(long, __x));
  }
...
inline basic_ostream<char, char_traits<char>> &_STLP_CALL operator<<(
    basic_ostream<char, char_traits<char>> &__os, const signed char *__s) {
