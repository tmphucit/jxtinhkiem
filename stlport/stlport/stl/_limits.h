...
template <class __number> class _Numeric_limits_base {
public:
...
template <class _Int, _STLP_LIMITS_MIN_TYPE __imin,
          _STLP_LIMITS_MAX_TYPE __imax, int __idigits, bool __ismod>
...
public:
  ...
  static const int
#endif
    digits = (__idigits < 0) ? ((int)((sizeof(_Int) * (CHAR_BIT))) -
                                ((__imin == 0) ? 0 : 1))
                             : (__idigits),
...
template <class _Tp> class numeric_limits : public _Numeric_limits_base<_Tp> {};
...
class numeric_limits<_STLP_LONG_LONG>
    : public _Integer_limits<_STLP_LONG_LONG, LONGLONG_MIN, LONGLONG_MAX, -1,
                             true> {};

_STLP_TEMPLATE_NULL
class numeric_limits<unsigned _STLP_LONG_LONG>
    : public _Integer_limits<unsigned _STLP_LONG_LONG, 0, ULONGLONG_MAX, -1,
                             true> {};
...
public:
  static _STLP_LONG_LONG(_STLP_CALL min)() _STLP_NOTHROW {
    return LONGLONG_MIN;
  }
  static _STLP_LONG_LONG(_STLP_CALL max)() _STLP_NOTHROW {
    return LONGLONG_MAX;
  }
...
public:
  static unsigned _STLP_LONG_LONG(_STLP_CALL min)() _STLP_NOTHROW {
    return 0ULL;
  }
  static unsigned _STLP_LONG_LONG(_STLP_CALL max)() _STLP_NOTHROW {
...
template <class __dummy> class _LimG {
public:
...
public:
  ...
  static float(_STLP_CALL max)() _STLP_NOTHROW {
    _STLP_USING_VENDOR_CSTD return FLT_MAX;
  }
...
public:
  ...
  static double(_STLP_CALL max)() _STLP_NOTHROW {
    _STLP_USING_VENDOR_CSTD return DBL_MAX;
  }
...
public:
  ...
  static long double _STLP_CALL signaling_NaN() {
    return _LimG<bool>::_L_sNaN.val;
  }
};
