...
#define _Locale_PRINT                                                          \
  (_Locale_PUNCT | _Locale_UPPER | _Locale_LOWER | _Locale_DIGIT | _Locale_A | \
   _Locale_XDIGIT | _Locale_PR)
...
#define _Locale_PRINT                                                          \
  (_Locale_PUNCT | _Locale_UPPER | _Locale_LOWER | _Locale_DIGIT |             \
   _Locale_ALPHA | _Locale_XDIGIT | _Locale_SPACE) /* Printable */
#endif                                             /* __Lynx__ */
...
#define _Locale_ALPHA _ISalpha
    ...
    (defined(__digital__) && defined(__unix__)) || defined(_AIX)
