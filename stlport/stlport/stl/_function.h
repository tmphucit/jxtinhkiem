...
// as type parameters. SUN C++ 4.0.1 compiler gives errors for template type
// parameters of the form 'name1::name2', where name1 is itself a type
// parameter.
template <class _Pair> struct __pair_aux : private _Pair {
  typedef typename _Pair::first_type first_type;
  typedef typename _Pair::second_type second_type;
};

template <class _Operation> struct __unary_fun_aux : private _Operation {
  typedef typename _Operation::argument_type argument_type;
  typedef typename _Operation::result_type result_type;
};

template <class _Operation> struct __binary_fun_aux : private _Operation {
...
class unary_negate
    : public unary_function<typename __UNARY_ARG(_Predicate, argument_type),
                            bool> {
protected:
  _Predicate _M_pred;
...
class binary_negate
    : public binary_function<
          typename __BINARY_ARG(_Predicate, first_argument_type),
          typename __BINARY_ARG(_Predicate, second_argument_type), bool> {
protected:
  _Predicate _M_pred;
...
class binder1st
    : public unary_function<typename __BINARY_ARG(_Operation,
...
template <class _Result, __DFL_TMPL_PARAM(_Arg1, _Result),
          __DFL_TMPL_PARAM(_Arg2, _Arg1)>
...
public:
  explicit const_mem_fun_t _STLP_PSPEC2(void, _Tp)(_fun_type __pf)
      : _M_f(__pf) {}
...
public:
  explicit const_mem_fun_ref_t _STLP_PSPEC2(void, _Tp)(_fun_type __pf)
      : _M_f(__pf) {}
...
public:
  explicit mem_fun1_t _STLP_PSPEC3(void, _Tp, _Arg)(_fun_type __pf)
      : _M_f(__pf) {}
...
public:
  explicit const_mem_fun1_t _STLP_PSPEC3(void, _Tp, _Arg)(_fun_type __pf)
      : _M_f(__pf) {}
...
public:
  explicit mem_fun1_ref_t _STLP_PSPEC3(void, _Tp, _Arg)(_fun_type __pf)
      : _M_f(__pf) {}
...
public:
  explicit const_mem_fun1_ref_t _STLP_PSPEC3(void, _Tp, _Arg)(_fun_type __pf)
      : _M_f(__pf) {}
