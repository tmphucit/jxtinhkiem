...
template <class _CharT,
          class _OutputIter = ostreambuf_iterator<_CharT, char_traits<_CharT>>>
#endif
...
extern char *_STLP_CALL __write_float(char *, ios_base::fmtflags, int,
                                      long double);
#endif

#ifndef _STLP_NO_WCHAR_T
extern wchar_t *_STLP_CALL __convert_float_buffer(const char *, const char *,
                                                  wchar_t *,
                                                  const ctype<wchar_t> &,
                                                  wchar_t);
#endif
...
extern char *_STLP_CALL __write_integer(char *buf, ios_base::fmtflags flags,
                                        long x);

extern ptrdiff_t _STLP_CALL __insert_grouping(char *first, char *last,
                                              const string &, char, char, char,
                                              int);
#ifndef _STLP_NO_WCHAR_T
extern ptrdiff_t _STLP_CALL __insert_grouping(wchar_t *, wchar_t *,
                                              const string &, wchar_t, wchar_t,
                                              wchar_t, int);
#endif
