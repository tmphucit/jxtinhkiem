...
public: // Public members for reading characters.
  ...
  int_type sungetc() {
    return (_M_gbegin < _M_gnext) ? _Traits::to_int_type(*--_M_gnext)
                                  : this->pbackfail();
  }
...
protected: // Constructors.
  ...
  basic_streambuf _STLP_PSPEC2(char, char_traits<char>)(FILE *__get,
                                                        FILE *__put);
...
protected: // Virtual buffer-management functions.
  virtual basic_streambuf<char, char_traits<char>> *setbuf(char_type *,
                                                           streamsize);
  virtual pos_type seekoff(off_type, ios_base::seekdir,
                           ios_base::openmode = ios_base::in | ios_base::out);
  virtual pos_type seekpos(pos_type,
