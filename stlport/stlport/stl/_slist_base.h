...
inline _Slist_node_base *__slist_make_link(_Slist_node_base *__prev_node,
...
template <class _Dummy> class _Sl_global {
public:
  ...
  static _Slist_node_base *_STLP_CALL
  __previous(_Slist_node_base *__head, const _Slist_node_base *__node);
  static const _Slist_node_base *_STLP_CALL
