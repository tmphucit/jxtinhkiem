...
extern bool _STLP_CALL __valid_grouping(const char *, const char *,
                                        const char *, const char *);

template <class _InputIter, class _Integer>
bool _STLP_CALL __get_decimal_integer(_InputIter &__first, _InputIter &__last,
                                      _Integer &__val);
...
inline void _STLP_CALL _Initialize_get_float(const ctype<char> &, char &Plus,
                                             char &Minus, char &pow_e,
                                             char &pow_E, char *) {
  Plus = '+';
  Minus = '-';
  pow_e = 'e';
...
#ifndef _STLP_NO_WCHAR_T
void _STLP_CALL _Initialize_get_float(const ctype<wchar_t> &, wchar_t &,
