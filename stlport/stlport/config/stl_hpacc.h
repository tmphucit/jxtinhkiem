...
#define _STLP_FORCE_ALLOCATORS(t, a)                                           \
  ...
  typedef typename _STLP_dummy_type1::_STLP_TEMPLATE rebind<t>::other          \
      _STLP_dummy_type2;
...
// #      define _STLP_HPACC_ONLY_NATIVE_STRING 1 // STLPort _string.c includes
// <locale>
