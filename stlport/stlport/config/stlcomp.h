 ...
 * adjust flags for your compiler, and add  <include
 * config/stl_YOUR_COMPILER_NAME> to the secton controlled by unique macro
 * defined internaly by your compiler.
 *
...
#define __GIVE_UP_WITH_STL(message)                                            \
  void give_up() { upgrade_the_compiler_to_use_STL; }
