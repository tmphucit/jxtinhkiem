...
#error                                                                         \
    "The wrapper (_STLP_NO_OWN_IOSTREAMS) mode does not work well without _STLP_HAS_NO_NEW_IOSTREAMS. Please set this flag. You will also have to use -liostream option on link phase."
...
#if (__SUNPRO_CC >= 0x500) &&                                                  \
    (defined(_STLP_NO_NEW_IOSTREAMS) || defined(_STLP_HAS_NO_NEW_IOSTREAMS))
// if the project is set up to use libiostream (_STLP_NO_NEW_IOSTREAMS should be
// defined then), use classic iostreams
