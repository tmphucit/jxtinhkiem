...
#define _STLP_NO_FRIEND_TEMPLATES                                              \
  1 // Bug mysteriously reintroduced in this version.
...
#define _STLP_NON_TYPE_TMPL_PARAM_BUG                                          \
  1 // dwa 8/21/97 - this bug fixed for CWPro2
#define _STLP_UNINITIALIZABLE_PRIVATE                                          \
  1 // dwa 10/23/97 - this bug fixed for CWPro2
#endif
...
#define _STLP_NATIVE_INCLUDE_PATH                                              \
  Macintosh HD : Codewarrior Pro 4 : Metrowerks CodeWarrior                    \
      : Metrowerks Standard Library : MSL C++ : Include
#define _STLP_NATIVE_C_INCLUDE_PATH                                            \
  Macintosh HD : Codewarrior Pro 4 : Metrowerks CodeWarrior                    \
      : Metrowerks Standard Library : MSL C : MSL Common : Public Includes
#define _STLP_NATIVE_HEADER(header)                                            \
<Macintosh HD:Codewarrior Pro 4:Metrowerks CodeWarrior:Metrowerks Standard Library:MSL C++:Include:##header>
#define _STLP_NATIVE_CPP_C_HEADER(header)                                      \
<Macintosh HD:Codewarrior Pro 4:Metrowerks CodeWarrior:Metrowerks Standard Library:MSL C++:Include:##header>
#define _STLP_NATIVE_C_HEADER(header)                                          \
<Macintosh HD:Codewarrior Pro 4:Metrowerks CodeWarrior:Metrowerks Standard Library:MSL C:MSL Common:Public Includes:##header>
