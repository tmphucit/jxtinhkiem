...
#pragma warning(                                                               \
    disable : 4660) // template-class specialization 'basic_filebuf<char,class
                    // _STLD::char_traits<char> >' is already instantiated
#pragma warning(disable : 4701) // local variable 'base' may be used without
