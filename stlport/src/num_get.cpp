...
void _STLP_CALL _Initialize_get_digit(wchar_t *digits, wchar_t *xdigits,
...
int _STLP_CALL __get_digit(wchar_t c, const wchar_t *digits,
                           const wchar_t *xdigits, wchar_t separator) {
...
// basic_streambuf<char, char_traits<char> >* _STLP_CALL
// _M_get_istreambuf(basic_istream<char, char_traits<char> >& ) ;
