...
void *_Locale_ctype_create(const char *__DUMMY_PAR) { return 0; }
...
void *_Locale_monetary_create(const char *__DUMMY_PAR) { return 0; }
...
char *_Locale_extract_numeric_name(const char *__DUMMY_PAR1,
                                   char *__DUMMY_PAR) {
  return 0;
}
...
char *_Locale_extract_collate_name(const char *__DUMMY_PAR1,
                                   char *__DUMMY_PAR) {
  return 0;
}
char *_Locale_extract_monetary_name(const char *__DUMMY_PAR1,
                                    char *__DUMMY_PAR) {
  return 0;
}
char *_Locale_extract_messages_name(const char *__DUMMY_PAR1,
                                    char *__DUMMY_PAR) {
  return 0;
}

char *_Locale_compose_name(char *__DUMMY_PAR1, const char *__DUMMY_PAR2,
                           const char *__DUMMY_PAR3, const char *__DUMMY_PAR4,
                           const char *__DUMMY_PAR5, const char *__DUMMY_PAR6,
...
int _Locale_toupper(struct _Locale_ctype *__DUMMY_PAR1, int __DUMMY_PAR) {
  return 0;
}
int _Locale_tolower(struct _Locale_ctype *__DUMMY_PAR1, int __DUMMY_PAR) {
  return 0;
}
...
wint_t _Locale_wchar_tolower(struct _Locale_ctype *__DUMMY_PAR1,
                             wint_t __DUMMY_PAR) {
  return 0;
}
wint_t _Locale_wchar_toupper(struct _Locale_ctype *__DUMMY_PAR1,
                             wint_t __DUMMY_PAR) {
  return 0;
}
#endif
...
#ifndef _STLP_NO_WCHAR_T
wint_t _Locale_btowc(struct _Locale_ctype *__DUMMY_PAR1, int __DUMMY_PAR) {
  return 0;
}
int _Locale_wctob(struct _Locale_ctype *__DUMMY_PAR2, wint_t __DUMMY_PAR) {
  return 0;
}

size_t _Locale_mbtowc(struct _Locale_ctype *__DUMMY_PAR1, wchar_t *__DUMMY_PAR2,
                      const char *__DUMMY_PAR3, size_t __DUMMY_PAR4,
                      mbstate_t *__DUMMY_PAR5) {
  return (size_t)-1;
}
size_t _Locale_wctomb(struct _Locale_ctype *__DUMMY_PAR1, char *__DUMMY_PAR2,
                      size_t __DUMMY_PAR3, const wchar_t __DUMMY_PAR4,
                      mbstate_t *__DUMMY_PAR5) {
  return (size_t)-1;
}
#endif
...
size_t _Locale_unshift(struct _Locale_ctype *__DUMMY_PAR1,
                       mbstate_t *__DUMMY_PAR2, char *__DUMMY_PAR3,
                       size_t __DUMMY_PAR4, char **__DUMMY_PAR5) {
  return (size_t)-1;
}
...
int _Locale_strcmp(struct _Locale_collate *__DUMMY_PAR1,
                   const char *__DUMMY_PAR2, size_t __DUMMY_PAR3,
...
size_t _Locale_strxfrm(struct _Locale_collate *__DUMMY_PAR1, char *__DUMMY_PAR2,
                       size_t __DUMMY_PAR3, const char *__DUMMY_PAR4,
                       size_t __DUMMY_PAR5) {
  return 0;
}
...
const char *_Locale_grouping(struct _Locale_numeric *__DUMMY_PAR) { return ""; }
...
int _Locale_catopen(struct _Locale_messages *__DUMMY_PAR1,
                    const char *__DUMMY_PAR) {
  return -1;
}
void _Locale_catclose(struct _Locale_messages *__DUMMY_PAR1, int __DUMMY_PAR) {}
const char *_Locale_catgets(struct _Locale_messages *__DUMMY_PAR1,
                            int __DUMMY_PAR2, int __DUMMY_PAR3,
                            int __DUMMY_PAR4, const char *dfault) {
  return dfault;
}
