...
//*TY 02/25/2000 - added workaround for MPW compilers; they confuse on in-class
// static const
...
#define PRINTFLAG                                                              \
  ctype_base::mask(_Locale_PRINT &                                             \
                   ~(_Locale_UPPER | _Locale_LOWER | _Locale_ALPHA |           \
                     _Locale_DIGIT | _Locale_PUNCT | _Locale_SPACE |           \
                     _Locale_XDIGIT))
...
// _S_classic_table + 1.
const ctype_base::mask ctype<char>::_S_classic_table[257] = {
    ctype_base::mask(0) /* EOF */, cntrl /* null */, cntrl /* ^A */,
    cntrl /* ^B */, cntrl /* ^C */, cntrl /* ^D */, cntrl /* ^E */,
    cntrl /* ^F */, cntrl /* ^G */, cntrl /* ^H */,
    ctype_base::mask(space | cntrl) /* tab */,
    ctype_base::mask(space | cntrl) /* LF */,
    ctype_base::mask(space | cntrl) /* ^K */,
    ctype_base::mask(space | cntrl) /* FF */,
    ctype_base::mask(space | cntrl) /* ^M */, cntrl /* ^N */, cntrl /* ^O */,
    cntrl /* ^P */, cntrl /* ^Q */, cntrl /* ^R */, cntrl /* ^S */,
    cntrl /* ^T */, cntrl /* ^U */, cntrl /* ^V */, cntrl /* ^W */,
    cntrl /* ^X */, cntrl /* ^Y */, cntrl /* ^Z */, cntrl /* esc */,
    ...
    ctype_base::mask(punct | PRINTFLAG) /* | */,
    ctype_base::mask(punct | PRINTFLAG) /* } */,
    ctype_base::mask(punct | PRINTFLAG) /* ~ */, cntrl /* del (0x7f)*/,
    /* ASCII is a 7-bit code, so everything else is non-ASCII */
    ctype_base::mask(0), ctype_base::mask(0), ctype_base::mask(0),
    ctype_base::mask(0), ctype_base::mask(0), ctype_base::mask(0),
    ctype_base::mask(0), ctype_base::mask(0), ctype_base::mask(0),
    ctype_base::mask(0), ctype_base::mask(0), ctype_base::mask(0),
    ctype_base::mask(0), ctype_base::mask(0), ctype_base::mask(0),
    ...
    ctype_base::mask(0), ctype_base::mask(0), ctype_base::mask(0),
    ctype_base::mask(0), ctype_base::mask(0), ctype_base::mask(0),
    ctype_base::mask(0), ctype_base::mask(0)};
...
struct _Ctype_is_mask {
  ...
  _Ctype_is_mask(ctype_base::mask __m, const ctype_base::mask *__t)
      : _Mask(__m), _M_table(__t) {}
  bool operator()(char __c) const {
    return (_M_table[(unsigned char)__c] & _Mask) != 0;
  }
};
...
struct _Ctype_not_mask {
  ...
  _Ctype_not_mask(ctype_base::mask __m, const ctype_base::mask *__t)
      : _Mask(__m), _M_table(__t) {}
  bool operator()(char __c) const {
    return (_M_table[(unsigned char)__c] & _Mask) == 0;
  }
...
const char *ctype<char>::scan_is(ctype_base::mask __m, const char *__low,
                                 const char *__high) const {
  return _STLP_STD::find_if(__low, __high, _Ctype_is_mask(__m, _M_ctype_table));
}

const char *ctype<char>::scan_not(ctype_base::mask __m, const char *__low,
                                  const char *__high) const {
  return _STLP_STD::find_if(__low, __high,
                            _Ctype_not_mask(__m, _M_ctype_table));
}
...
char ctype<char>::do_widen(char __c) const { return __c; }
...
char ctype<char>::do_narrow(char __c, char /* dfault */) const { return __c; }
...
const wchar_t *ctype<wchar_t>::do_is(const wchar_t *low, const wchar_t *high,
  ...
  for (; low < high; ++low, ++vec) {
    wchar_t c = *low;
    *vec = c >= 0 && size_t(c) < ctype<char>::table_size ? table[c]
                                                         : ctype_base::mask(0);
  }
  return high;
}
...
const wchar_t *ctype<wchar_t>::do_toupper(wchar_t *low,
                                          const wchar_t *high) const {
  for (; low < high; ++low) {
    wchar_t c = *low;
...
const wchar_t *ctype<wchar_t>::do_tolower(wchar_t *low,
                                          const wchar_t *high) const {
  for (; low < high; ++low) {
    wchar_t c = *low;
    *low = c >= 0 && size_t(c) < ctype<char>::table_size
...
wchar_t ctype<wchar_t>::do_widen(char c) const { return (wchar_t)c; }
...
const wchar_t *ctype<wchar_t>::do_narrow(const wchar_t *low,
                                         const wchar_t *high, char dfault,
                                         char *dest) const {
  while (low != high) {
    wchar_t c = *low++;
