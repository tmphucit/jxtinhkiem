...
template <class K, class V, class Comp, class A>
inline map_tag container_category(const EH_STD::__map__<K, V, Comp, A> &) {
  return map_tag();
}

typedef EH_STD::__multimap__<TestClass, TestClass, ThrowCompare,
...
typedef EH_STD::__map__<TestClass, TestClass, ThrowCompare,
                        eh_allocator(TestClass)>
    TestMap;
