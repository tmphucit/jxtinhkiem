/***********************************************************************************
        TestController.h
                ...
                SUMMARY: An "faux-singleton" object to encapsulate a hodgepodge
of state and functionality relating to the test suite. Probably should be broken
                        into smaller pieces.
...
inline void simulate_possible_failure() { gTestController.maybe_fail(0); }
...
inline void simulate_destructor() { object_count--; }

inline void TestController::TrackAllocations(bool track) {
  track_allocations = track;
}

inline bool TestController::TrackingEnabled() { return track_allocations; }
...
inline void TestController::SetVerbose(bool val) { nc_verbose = val; }

inline void TestController::TurnOffExceptions() { never_fail = true; }
