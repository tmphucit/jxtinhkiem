...
template <class T> struct test_hash_resize {
  test_hash_resize() { gTestController.SetCurrentTestName("hash resize"); }
...
template <class T> struct test_construct_iter_range_n {
  test_construct_iter_range_n(const T &src) : fItems(src) {
