...
template <class T> struct test_copy_construct {
  test_copy_construct() {
...
template <class T> struct test_default_construct {
...
template <class T> struct test_construct_n {
...
template <class T> struct test_construct_n_instance {
...
template <class T> struct test_construct_pointer_range {
...
template <class T> struct test_construct_iter_range {
