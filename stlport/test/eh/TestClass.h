 ...
 * purpose.  It is provided "as is" without express or implied warranty.
                ...
                SUMMARY: TestClass simulates a class that uses resources. It is
designed to cause exceptions when it is constructed or copied.
...
inline TestClass::TestClass() { Init(int(get_random())); }

inline TestClass::TestClass(int value) { Init(value); }

inline TestClass::TestClass(const TestClass &rhs) { Init(rhs.value()); }
...
inline TestClass TestClass::operator!() const { return TestClass(value() + 1); }
