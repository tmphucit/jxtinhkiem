...
typedef interface IStreamBufferRecordingAttribute
...
typedef interface IEnumStreamBufferRecordingAttrib
...
IStreamBufferInitialize_SetHKEY_Proxy(IStreamBufferInitialize *This,
                                      /* [in] */ HKEY hkeyRoot);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferInitialize_SetSIDs_Proxy(IStreamBufferInitialize *This,
                                      /* [in] */ DWORD cSIDs,
                                      /* [size_is][in] */ PSID *ppSID);
...
#define IStreamBufferSink_CreateRecorder(This, pszFilename, dwRecordType,      \
                                         pRecordingIUnknown)                   \
  (This)->lpVtbl->CreateRecorder(This, pszFilename, dwRecordType,              \
                                 pRecordingIUnknown)
...
HRESULT STDMETHODCALLTYPE
IStreamBufferSink_LockProfile_Proxy(IStreamBufferSink *This,
                                    /* [in] */ LPCWSTR pszStreamBufferFilename);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferSink_IsProfileLocked_Proxy(IStreamBufferSink *This);
...
#define IStreamBufferRecordControl_GetRecordingStatus(This, phResult,          \
                                                      pbStarted, pbStopped)    \
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecordControl_Stop_Proxy(IStreamBufferRecordControl *This,
                                      /* [in] */ REFERENCE_TIME rtStop);
...
#define IStreamBufferRecComp_Initialize(This, pszTargetFilename,               \
                                        pszSBRecProfileRef)                    \
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecComp_Initialize_Proxy(IStreamBufferRecComp *This,
                                      /* [in] */ LPCWSTR pszTargetFilename,
                                      /* [in] */ LPCWSTR pszSBRecProfileRef);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecComp_Append_Proxy(IStreamBufferRecComp *This,
                                  /* [in] */ LPCWSTR pszSBRecording);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecComp_AppendEx_Proxy(IStreamBufferRecComp *This,
                                    /* [in] */ LPCWSTR pszSBRecording,
                                    /* [in] */ REFERENCE_TIME rtStart,
                                    /* [in] */ REFERENCE_TIME rtStop);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecComp_GetCurrentLength_Proxy(IStreamBufferRecComp *This,
                                            /* [out] */ DWORD *pcSeconds);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecComp_Close_Proxy(IStreamBufferRecComp *This);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecComp_Cancel_Proxy(IStreamBufferRecComp *This);
...
static const WCHAR g_wszStreamBufferRecordingSignature_Name[] =
    L"Signature_Name";
...
static const WCHAR g_wszStreamBufferRecordingCurrentBitrate[] =
    L"CurrentBitrate";
static const WCHAR g_wszStreamBufferRecordingOptimalBitrate[] =
    L"OptimalBitrate";
static const WCHAR g_wszStreamBufferRecordingHasAttachedImages[] =
    L"HasAttachedImages";
static const WCHAR g_wszStreamBufferRecordingSkipBackward[] =
    L"Can_Skip_Backward";
static const WCHAR g_wszStreamBufferRecordingSkipForward[] =
    L"Can_Skip_Forward";
static const WCHAR g_wszStreamBufferRecordingNumberOfFrames[] =
    L"NumberOfFrames";
static const WCHAR g_wszStreamBufferRecordingFileSize[] = L"FileSize";
static const WCHAR g_wszStreamBufferRecordingHasArbitraryDataStream[] =
    L"HasArbitraryDataStream";
static const WCHAR g_wszStreamBufferRecordingHasFileTransferStream[] =
    L"HasFileTransferStream";
...
////////////////////////////////////////////////////////////////
//
// These attributes are used to configure DRM using
...
static const WCHAR g_wszStreamBufferRecordingPromotionURL[] =
    L"WM/PromotionURL";
static const WCHAR g_wszStreamBufferRecordingAlbumCoverURL[] =
    L"WM/AlbumCoverURL";
...
//
static const WCHAR g_wszStreamBufferRecordingBannerImageType[] =
    L"BannerImageType";
static const WCHAR g_wszStreamBufferRecordingBannerImageData[] =
    L"BannerImageData";
static const WCHAR g_wszStreamBufferRecordingBannerImageURL[] =
    L"BannerImageURL";
...
static const WCHAR g_wszStreamBufferRecordingNSCDescription[] =
    L"NSC_Description";
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumAttributes(
      /* [out] */ IEnumStreamBufferRecordingAttrib *
      *ppIEnumStreamBufferAttrib) = 0;
};
...
#define IStreamBufferRecordingAttribute_SetAttribute(                          \
    This, ulReserved, pszAttributeName, StreamBufferAttributeType,             \
    pbAttribute, cbAttributeLength)                                            \
  (This)->lpVtbl->SetAttribute(This, ulReserved, pszAttributeName,             \
                               StreamBufferAttributeType, pbAttribute,         \
                               cbAttributeLength)

#define IStreamBufferRecordingAttribute_GetAttributeCount(This, ulReserved,    \
                                                          pcAttributes)        \
  (This)->lpVtbl->GetAttributeCount(This, ulReserved, pcAttributes)

#define IStreamBufferRecordingAttribute_GetAttributeByName(                    \
    This, pszAttributeName, pulReserved, pStreamBufferAttributeType,           \
    pbAttribute, pcbLength)                                                    \
  (This)->lpVtbl->GetAttributeByName(This, pszAttributeName, pulReserved,      \
                                     pStreamBufferAttributeType, pbAttribute,  \
                                     pcbLength)

#define IStreamBufferRecordingAttribute_GetAttributeByIndex(                   \
    This, wIndex, pulReserved, pszAttributeName, pcchNameLength,               \
    pStreamBufferAttributeType, pbAttribute, pcbLength)                        \
  (This)->lpVtbl->GetAttributeByIndex(                                         \
      This, wIndex, pulReserved, pszAttributeName, pcchNameLength,             \
      pStreamBufferAttributeType, pbAttribute, pcbLength)

#define IStreamBufferRecordingAttribute_EnumAttributes(                        \
    This, ppIEnumStreamBufferAttrib)                                           \
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecordingAttribute_GetAttributeCount_Proxy(
    IStreamBufferRecordingAttribute *This,
    /* [in] */ ULONG ulReserved,
    /* [out] */ WORD *pcAttributes);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecordingAttribute_GetAttributeByName_Proxy(
    IStreamBufferRecordingAttribute *This,
    /* [in] */ LPCWSTR pszAttributeName,
    /* [in] */ ULONG *pulReserved,
    /* [out] */ STREAMBUFFER_ATTR_DATATYPE *pStreamBufferAttributeType,
...
HRESULT STDMETHODCALLTYPE
IStreamBufferRecordingAttribute_GetAttributeByIndex_Proxy(
    IStreamBufferRecordingAttribute *This,
    /* [in] */ WORD wIndex,
    /* [in] */ ULONG *pulReserved,
    /* [out] */ WCHAR *pszAttributeName,
...
#define IEnumStreamBufferRecordingAttrib_Next(                                 \
    This, cRequest, pStreamBufferAttribute, pcReceived)                        \
...
#define IEnumStreamBufferRecordingAttrib_Clone(This,                           \
...
HRESULT STDMETHODCALLTYPE
IStreamBufferConfigure_SetDirectory_Proxy(IStreamBufferConfigure *This,
                                          /* [in] */ LPCWSTR pszDirectoryName);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferConfigure_SetBackingFileCount_Proxy(IStreamBufferConfigure *This,
                                                 /* [in] */ DWORD dwMin,
                                                 /* [in] */ DWORD dwMax);
...
HRESULT STDMETHODCALLTYPE
IStreamBufferConfigure_GetBackingFileCount_Proxy(IStreamBufferConfigure *This,
                                                 /* [out] */ DWORD *pdwMin,
                                                 /* [out] */ DWORD *pdwMax);
...
IStreamBufferMediaSeeking : public IMediaSeeking{public : };
...
#define IStreamBufferMediaSeeking_ConvertTimeFormat(                           \
    This, pTarget, pTargetFormat, Source, pSourceFormat)                       \
  (This)->lpVtbl->ConvertTimeFormat(This, pTarget, pTargetFormat, Source,      \
                                    pSourceFormat)

#define IStreamBufferMediaSeeking_SetPositions(This, pCurrent, dwCurrentFlags, \
                                               pStop, dwStopFlags)             \
