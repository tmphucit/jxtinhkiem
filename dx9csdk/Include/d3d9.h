...
DEFINE_GUID(IID_IDirect3D9, 0x81bdcbca, 0x64d4, 0x426d, 0xae, 0x8d, 0xad, 0x1,
            0x47, 0xf4, 0x27, 0x5c);

/* IID_IDirect3DDevice9 */
// {D0223B96-BF7A-43fd-92BD-A43B0D82B9EB} */
DEFINE_GUID(IID_IDirect3DDevice9, 0xd0223b96, 0xbf7a, 0x43fd, 0x92, 0xbd, 0xa4,
            0x3b, 0xd, 0x82, 0xb9, 0xeb);

/* IID_IDirect3DResource9 */
// {05EEC05D-8F7D-4362-B999-D1BAF357C704}
DEFINE_GUID(IID_IDirect3DResource9, 0x5eec05d, 0x8f7d, 0x4362, 0xb9, 0x99, 0xd1,
            0xba, 0xf3, 0x57, 0xc7, 0x4);

/* IID_IDirect3DBaseTexture9 */
/* {580CA87E-1D3C-4d54-991D-B7D3E3C298CE} */
DEFINE_GUID(IID_IDirect3DBaseTexture9, 0x580ca87e, 0x1d3c, 0x4d54, 0x99, 0x1d,
            0xb7, 0xd3, 0xe3, 0xc2, 0x98, 0xce);

/* IID_IDirect3DTexture9 */
/* {85C31227-3DE5-4f00-9B3A-F11AC38C18B5} */
DEFINE_GUID(IID_IDirect3DTexture9, 0x85c31227, 0x3de5, 0x4f00, 0x9b, 0x3a, 0xf1,
            0x1a, 0xc3, 0x8c, 0x18, 0xb5);

/* IID_IDirect3DCubeTexture9 */
/* {FFF32F81-D953-473a-9223-93D652ABA93F} */
DEFINE_GUID(IID_IDirect3DCubeTexture9, 0xfff32f81, 0xd953, 0x473a, 0x92, 0x23,
            0x93, 0xd6, 0x52, 0xab, 0xa9, 0x3f);

/* IID_IDirect3DVolumeTexture9 */
/* {2518526C-E789-4111-A7B9-47EF328D13E6} */
DEFINE_GUID(IID_IDirect3DVolumeTexture9, 0x2518526c, 0xe789, 0x4111, 0xa7, 0xb9,
            0x47, 0xef, 0x32, 0x8d, 0x13, 0xe6);

/* IID_IDirect3DVertexBuffer9 */
/* {B64BB1B5-FD70-4df6-BF91-19D0A12455E3} */
DEFINE_GUID(IID_IDirect3DVertexBuffer9, 0xb64bb1b5, 0xfd70, 0x4df6, 0xbf, 0x91,
            0x19, 0xd0, 0xa1, 0x24, 0x55, 0xe3);

/* IID_IDirect3DIndexBuffer9 */
/* {7C9DD65E-D3F7-4529-ACEE-785830ACDE35} */
DEFINE_GUID(IID_IDirect3DIndexBuffer9, 0x7c9dd65e, 0xd3f7, 0x4529, 0xac, 0xee,
            0x78, 0x58, 0x30, 0xac, 0xde, 0x35);

/* IID_IDirect3DSurface9 */
/* {0CFBAF3A-9FF6-429a-99B3-A2796AF8B89B} */
DEFINE_GUID(IID_IDirect3DSurface9, 0xcfbaf3a, 0x9ff6, 0x429a, 0x99, 0xb3, 0xa2,
            0x79, 0x6a, 0xf8, 0xb8, 0x9b);

/* IID_IDirect3DVolume9 */
/* {24F416E6-1F67-4aa7-B88E-D33F6F3128A1} */
DEFINE_GUID(IID_IDirect3DVolume9, 0x24f416e6, 0x1f67, 0x4aa7, 0xb8, 0x8e, 0xd3,
            0x3f, 0x6f, 0x31, 0x28, 0xa1);

/* IID_IDirect3DSwapChain9 */
/* {794950F2-ADFC-458a-905E-10A10B0B503B} */
DEFINE_GUID(IID_IDirect3DSwapChain9, 0x794950f2, 0xadfc, 0x458a, 0x90, 0x5e,
            0x10, 0xa1, 0xb, 0xb, 0x50, 0x3b);

/* IID_IDirect3DVertexDeclaration9 */
/* {DD13C59C-36FA-4098-A8FB-C7ED39DC8546} */
DEFINE_GUID(IID_IDirect3DVertexDeclaration9, 0xdd13c59c, 0x36fa, 0x4098, 0xa8,
            0xfb, 0xc7, 0xed, 0x39, 0xdc, 0x85, 0x46);

/* IID_IDirect3DVertexShader9 */
/* {EFC5557E-6265-4613-8A94-43857889EB36} */
DEFINE_GUID(IID_IDirect3DVertexShader9, 0xefc5557e, 0x6265, 0x4613, 0x8a, 0x94,
            0x43, 0x85, 0x78, 0x89, 0xeb, 0x36);

/* IID_IDirect3DPixelShader9 */
/* {6D3BDBDC-5B02-4415-B852-CE5E8BCCB289} */
DEFINE_GUID(IID_IDirect3DPixelShader9, 0x6d3bdbdc, 0x5b02, 0x4415, 0xb8, 0x52,
            0xce, 0x5e, 0x8b, 0xcc, 0xb2, 0x89);

/* IID_IDirect3DStateBlock9 */
/* {B07C4FE5-310D-4ba8-A23C-4F0F206F218B} */
DEFINE_GUID(IID_IDirect3DStateBlock9, 0xb07c4fe5, 0x310d, 0x4ba8, 0xa2, 0x3c,
            0x4f, 0xf, 0x20, 0x6f, 0x21, 0x8b);

/* IID_IDirect3DQuery9 */
/* {d9771460-a695-4f26-bbd3-27b840b541cc} */
DEFINE_GUID(IID_IDirect3DQuery9, 0xd9771460, 0xa695, 0x4f26, 0xbb, 0xd3, 0x27,
            0xb8, 0x40, 0xb5, 0x41, 0xcc);

/* IID_HelperName */
/* {E4A36723-FDFE-4b22-B146-3C04C07F4CC8} */
DEFINE_GUID(IID_HelperName, 0xe4a36723, 0xfdfe, 0x4b22, 0xb1, 0x46, 0x3c, 0x4,
            0xc0, 0x7f, 0x4c, 0xc8);
...
_COM_SMARTPTR_TYPEDEF(IDirect3DVertexDeclaration9,
...
_COM_SMARTPTR_TYPEDEF(IDirect3DVolumeTexture9,
...
DECLARE_INTERFACE_(IDirect3D9, IUnknown) {
  ...
  (THIS_ UINT Adapter, DWORD Flags, D3DADAPTER_IDENTIFIER9 * pIdentifier) PURE;
  STDMETHOD_(UINT, GetAdapterModeCount)
  (THIS_ UINT Adapter, D3DFORMAT Format) PURE;
  ...
  (THIS_ UINT Adapter, D3DDISPLAYMODE * pMode) PURE;
  STDMETHOD(CheckDeviceType)
  (THIS_ UINT Adapter, D3DDEVTYPE DevType, D3DFORMAT AdapterFormat,
   D3DFORMAT BackBufferFormat, BOOL bWindowed) PURE;
  ...
  (THIS_ UINT Adapter, D3DDEVTYPE DeviceType, D3DCAPS9 * pCaps) PURE;
...
#define IDirect3D9_RegisterSoftwareDevice(p, a)                                \
...
#define IDirect3D9_GetAdapterModeCount(p, a, b)                                \
...
#define IDirect3D9_CheckDepthStencilMatch(p, a, b, c, d, e)                    \
...
#define IDirect3D9_GetAdapterDisplayMode(p, a, b)                              \
  (p)->GetAdapterDisplayMode(a, b)
#define IDirect3D9_CheckDeviceType(p, a, b, c, d, e)                           \
  (p)->CheckDeviceType(a, b, c, d, e)
#define IDirect3D9_CheckDeviceFormat(p, a, b, c, d, e, f)                      \
  (p)->CheckDeviceFormat(a, b, c, d, e, f)
#define IDirect3D9_CheckDeviceMultiSampleType(p, a, b, c, d, e, f)             \
  (p)->CheckDeviceMultiSampleType(a, b, c, d, e, f)
#define IDirect3D9_CheckDepthStencilMatch(p, a, b, c, d, e)                    \
...
DECLARE_INTERFACE_(IDirect3DDevice9, IUnknown) {
  ...
  (THIS_ D3DDEVICE_CREATION_PARAMETERS * pParameters) PURE;
  STDMETHOD(SetCursorProperties)
  (THIS_ UINT XHotSpot, UINT YHotSpot, IDirect3DSurface9 * pCursorBitmap) PURE;
  STDMETHOD_(void, SetCursorPosition)(THIS_ int X, int Y, DWORD Flags) PURE;
  STDMETHOD_(BOOL, ShowCursor)(THIS_ BOOL bShow) PURE;
  STDMETHOD(CreateAdditionalSwapChain)
  (THIS_ D3DPRESENT_PARAMETERS * pPresentationParameters,
   IDirect3DSwapChain9 * *pSwapChain) PURE;
  STDMETHOD(GetSwapChain)
  (THIS_ UINT iSwapChain, IDirect3DSwapChain9 * *pSwapChain) PURE;
  ...
  (THIS_ UINT iSwapChain, UINT iBackBuffer, D3DBACKBUFFER_TYPE Type,
   IDirect3DSurface9 * *ppBackBuffer) PURE;
  STDMETHOD(GetRasterStatus)
  (THIS_ UINT iSwapChain, D3DRASTER_STATUS * pRasterStatus) PURE;
  STDMETHOD(SetDialogBoxMode)(THIS_ BOOL bEnableDialogs) PURE;
  STDMETHOD_(void, SetGammaRamp)
  (THIS_ UINT iSwapChain, DWORD Flags, CONST D3DGAMMARAMP * pRamp) PURE;
  STDMETHOD_(void, GetGammaRamp)
  (THIS_ UINT iSwapChain, D3DGAMMARAMP * pRamp) PURE;
  STDMETHOD(CreateTexture)
  (THIS_ UINT Width, UINT Height, UINT Levels, DWORD Usage, D3DFORMAT Format,
   D3DPOOL Pool, IDirect3DTexture9 * *ppTexture, HANDLE * pSharedHandle) PURE;
  ...
  (THIS_ UINT Length, DWORD Usage, DWORD FVF, D3DPOOL Pool,
   IDirect3DVertexBuffer9 * *ppVertexBuffer, HANDLE * pSharedHandle) PURE;
  STDMETHOD(CreateIndexBuffer)
  (THIS_ UINT Length, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool,
   IDirect3DIndexBuffer9 * *ppIndexBuffer, HANDLE * pSharedHandle) PURE;
  ...
  (THIS_ UINT Width, UINT Height, D3DFORMAT Format,
   ...
   IDirect3DSurface9 * *ppSurface, HANDLE * pSharedHandle) PURE;
  ...
  (THIS_ IDirect3DSurface9 * pSourceSurface, CONST RECT * pSourceRect,
   IDirect3DSurface9 * pDestinationSurface, CONST POINT * pDestPoint) PURE;
  STDMETHOD(UpdateTexture)
  (THIS_ IDirect3DBaseTexture9 * pSourceTexture,
   IDirect3DBaseTexture9 * pDestinationTexture) PURE;
  ...
  (THIS_ UINT iSwapChain, IDirect3DSurface9 * pDestSurface) PURE;
  STDMETHOD(StretchRect)
  (THIS_ IDirect3DSurface9 * pSourceSurface, CONST RECT * pSourceRect,
   IDirect3DSurface9 * pDestSurface, CONST RECT * pDestRect,
   D3DTEXTUREFILTERTYPE Filter) PURE;
  STDMETHOD(ColorFill)
  (THIS_ IDirect3DSurface9 * pSurface, CONST RECT * pRect, D3DCOLOR color) PURE;
  STDMETHOD(CreateOffscreenPlainSurface)
  (THIS_ UINT Width, UINT Height, D3DFORMAT Format, D3DPOOL Pool,
   IDirect3DSurface9 * *ppSurface, HANDLE * pSharedHandle) PURE;
  STDMETHOD(SetRenderTarget)
  (THIS_ DWORD RenderTargetIndex, IDirect3DSurface9 * pRenderTarget) PURE;
  STDMETHOD(GetRenderTarget)
  (THIS_ DWORD RenderTargetIndex, IDirect3DSurface9 * *ppRenderTarget) PURE;
  STDMETHOD(SetDepthStencilSurface)
  (THIS_ IDirect3DSurface9 * pNewZStencil) PURE;
  STDMETHOD(GetDepthStencilSurface)
  (THIS_ IDirect3DSurface9 * *ppZStencilSurface) PURE;
  ...
  (THIS_ D3DTRANSFORMSTATETYPE State, CONST D3DMATRIX * pMatrix) PURE;
  STDMETHOD(GetTransform)
  (THIS_ D3DTRANSFORMSTATETYPE State, D3DMATRIX * pMatrix) PURE;
  STDMETHOD(MultiplyTransform)
  (THIS_ D3DTRANSFORMSTATETYPE, CONST D3DMATRIX *)PURE;
  ...
  (THIS_ D3DRENDERSTATETYPE State, DWORD * pValue) PURE;
  STDMETHOD(CreateStateBlock)
  (THIS_ D3DSTATEBLOCKTYPE Type, IDirect3DStateBlock9 * *ppSB) PURE;
  STDMETHOD(BeginStateBlock)(THIS) PURE;
  STDMETHOD(EndStateBlock)(THIS_ IDirect3DStateBlock9 * *ppSB) PURE;
  STDMETHOD(SetClipStatus)(THIS_ CONST D3DCLIPSTATUS9 * pClipStatus) PURE;
  STDMETHOD(GetClipStatus)(THIS_ D3DCLIPSTATUS9 * pClipStatus) PURE;
  STDMETHOD(GetTexture)
  (THIS_ DWORD Stage, IDirect3DBaseTexture9 * *ppTexture) PURE;
  STDMETHOD(SetTexture)
  (THIS_ DWORD Stage, IDirect3DBaseTexture9 * pTexture) PURE;
  STDMETHOD(GetTextureStageState)
  (THIS_ DWORD Stage, D3DTEXTURESTAGESTATETYPE Type, DWORD * pValue) PURE;
  STDMETHOD(SetTextureStageState)
  (THIS_ DWORD Stage, D3DTEXTURESTAGESTATETYPE Type, DWORD Value) PURE;
  STDMETHOD(GetSamplerState)
  (THIS_ DWORD Sampler, D3DSAMPLERSTATETYPE Type, DWORD * pValue) PURE;
  STDMETHOD(SetSamplerState)
  (THIS_ DWORD Sampler, D3DSAMPLERSTATETYPE Type, DWORD Value) PURE;
  STDMETHOD(ValidateDevice)(THIS_ DWORD * pNumPasses) PURE;
  STDMETHOD(SetPaletteEntries)
  (THIS_ UINT PaletteNumber, CONST PALETTEENTRY * pEntries) PURE;
  STDMETHOD(GetPaletteEntries)
  (THIS_ UINT PaletteNumber, PALETTEENTRY * pEntries) PURE;
  ...
  (THIS_ D3DPRIMITIVETYPE, INT BaseVertexIndex, UINT MinVertexIndex,
   UINT NumVertices, UINT startIndex, UINT primCount) PURE;
  ...
  (THIS_ UINT SrcStartIndex, UINT DestIndex, UINT VertexCount,
   ...
   IDirect3DVertexDeclaration9 * pVertexDecl, DWORD Flags) PURE;
  STDMETHOD(CreateVertexDeclaration)
  (THIS_ CONST D3DVERTEXELEMENT9 * pVertexElements,
   IDirect3DVertexDeclaration9 * *ppDecl) PURE;
  STDMETHOD(SetVertexDeclaration)
  (THIS_ IDirect3DVertexDeclaration9 * pDecl) PURE;
  STDMETHOD(GetVertexDeclaration)
  (THIS_ IDirect3DVertexDeclaration9 * *ppDecl) PURE;
  STDMETHOD(SetFVF)(THIS_ DWORD FVF) PURE;
  STDMETHOD(GetFVF)(THIS_ DWORD * pFVF) PURE;
  STDMETHOD(CreateVertexShader)
  (THIS_ CONST DWORD * pFunction, IDirect3DVertexShader9 * *ppShader) PURE;
  ...
  (THIS_ UINT StartRegister, float *pConstantData, UINT Vector4fCount) PURE;
  STDMETHOD(SetVertexShaderConstantI)
  (THIS_ UINT StartRegister, CONST int *pConstantData, UINT Vector4iCount) PURE;
  STDMETHOD(GetVertexShaderConstantI)
  (THIS_ UINT StartRegister, int *pConstantData, UINT Vector4iCount) PURE;
  STDMETHOD(SetVertexShaderConstantB)
  (THIS_ UINT StartRegister, CONST BOOL * pConstantData, UINT BoolCount) PURE;
  STDMETHOD(GetVertexShaderConstantB)
  (THIS_ UINT StartRegister, BOOL * pConstantData, UINT BoolCount) PURE;
  STDMETHOD(SetStreamSource)
  (THIS_ UINT StreamNumber, IDirect3DVertexBuffer9 * pStreamData,
   UINT OffsetInBytes, UINT Stride) PURE;
  STDMETHOD(GetStreamSource)
  (THIS_ UINT StreamNumber, IDirect3DVertexBuffer9 * *ppStreamData,
   UINT * pOffsetInBytes, UINT * pStride) PURE;
  ...
  (THIS_ CONST DWORD * pFunction, IDirect3DPixelShader9 * *ppShader) PURE;
  ...
  (THIS_ D3DQUERYTYPE Type, IDirect3DQuery9 * *ppQuery) PURE;
...
#define IDirect3DDevice9_GetAvailableTextureMem(p)                             \
  (p)->lpVtbl->GetAvailableTextureMem(p)
#define IDirect3DDevice9_EvictManagedResources(p)                              \
  (p)->lpVtbl->EvictManagedResources(p)
...
#define IDirect3DDevice9_SetCursorProperties(p, a, b, c)                       \
...
#define IDirect3DDevice9_GetNumberOfSwapChains(p)                              \
  (p)->lpVtbl->GetNumberOfSwapChains(p)
...
#define IDirect3DDevice9_GetRasterStatus(p, a, b)                              \
  (p)->lpVtbl->GetRasterStatus(p, a, b)
#define IDirect3DDevice9_SetDialogBoxMode(p, a)                                \
  (p)->lpVtbl->SetDialogBoxMode(p, a)
#define IDirect3DDevice9_SetGammaRamp(p, a, b, c)                              \
...
#define IDirect3DDevice9_SetCurrentTexturePalette(p, a)                        \
  (p)->lpVtbl->SetCurrentTexturePalette(p, a)
#define IDirect3DDevice9_GetCurrentTexturePalette(p, a)                        \
...
#define IDirect3DDevice9_GetSoftwareVertexProcessing(p)                        \
  (p)->lpVtbl->GetSoftwareVertexProcessing(p)
...
#define IDirect3DDevice9_ProcessVertices(p, a, b, c, d, e, f)                  \
...
#define IDirect3DDevice9_DrawRectPatch(p, a, b, c)                             \
  (p)->lpVtbl->DrawRectPatch(p, a, b, c)
#define IDirect3DDevice9_DrawTriPatch(p, a, b, c)                              \
...
#define IDirect3DDevice9_GetCreationParameters(p, a)                           \
  (p)->GetCreationParameters(a)
#define IDirect3DDevice9_SetCursorProperties(p, a, b, c)                       \
  (p)->SetCursorProperties(a, b, c)
#define IDirect3DDevice9_SetCursorPosition(p, a, b, c)                         \
  (p)->SetCursorPosition(a, b, c)
#define IDirect3DDevice9_ShowCursor(p, a) (p)->ShowCursor(a)
#define IDirect3DDevice9_CreateAdditionalSwapChain(p, a, b)                    \
  (p)->CreateAdditionalSwapChain(a, b)
...
#define IDirect3DDevice9_CreateTexture(p, a, b, c, d, e, f, g, h)              \
  (p)->CreateTexture(a, b, c, d, e, f, g, h)
#define IDirect3DDevice9_CreateVolumeTexture(p, a, b, c, d, e, f, g, h, i)     \
  (p)->CreateVolumeTexture(a, b, c, d, e, f, g, h, i)
#define IDirect3DDevice9_CreateCubeTexture(p, a, b, c, d, e, f, g)             \
  (p)->CreateCubeTexture(a, b, c, d, e, f, g)
#define IDirect3DDevice9_CreateVertexBuffer(p, a, b, c, d, e, f)               \
  (p)->CreateVertexBuffer(a, b, c, d, e, f)
#define IDirect3DDevice9_CreateIndexBuffer(p, a, b, c, d, e, f)                \
  (p)->CreateIndexBuffer(a, b, c, d, e, f)
#define IDirect3DDevice9_CreateRenderTarget(p, a, b, c, d, e, f, g, h)         \
  (p)->CreateRenderTarget(a, b, c, d, e, f, g, h)
#define IDirect3DDevice9_CreateDepthStencilSurface(p, a, b, c, d, e, f, g, h)  \
  (p)->CreateDepthStencilSurface(a, b, c, d, e, f, g, h)
#define IDirect3DDevice9_UpdateSurface(p, a, b, c, d)                          \
  (p)->UpdateSurface(a, b, c, d)
#define IDirect3DDevice9_UpdateTexture(p, a, b) (p)->UpdateTexture(a, b)
#define IDirect3DDevice9_GetRenderTargetData(p, a, b)                          \
  (p)->GetRenderTargetData(a, b)
#define IDirect3DDevice9_GetFrontBufferData(p, a, b)                           \
  (p)->GetFrontBufferData(a, b)
#define IDirect3DDevice9_StretchRect(p, a, b, c, d, e)                         \
  (p)->StretchRect(a, b, c, d, e)
#define IDirect3DDevice9_ColorFill(p, a, b, c) (p)->ColorFill(a, b, c)
#define IDirect3DDevice9_CreateOffscreenPlainSurface(p, a, b, c, d, e, f)      \
  (p)->CreateOffscreenPlainSurface(a, b, c, d, e, f)
...
#define IDirect3DDevice9_SetDepthStencilSurface(p, a)                          \
  (p)->SetDepthStencilSurface(a)
#define IDirect3DDevice9_GetDepthStencilSurface(p, a)                          \
  (p)->GetDepthStencilSurface(a)
...
#define IDirect3DDevice9_GetTextureStageState(p, a, b, c)                      \
  (p)->GetTextureStageState(a, b, c)
#define IDirect3DDevice9_SetTextureStageState(p, a, b, c)                      \
  (p)->SetTextureStageState(a, b, c)
#define IDirect3DDevice9_GetSamplerState(p, a, b, c)                           \
  (p)->GetSamplerState(a, b, c)
#define IDirect3DDevice9_SetSamplerState(p, a, b, c)                           \
  (p)->SetSamplerState(a, b, c)
...
#define IDirect3DDevice9_SetCurrentTexturePalette(p, a)                        \
  (p)->SetCurrentTexturePalette(a)
#define IDirect3DDevice9_GetCurrentTexturePalette(p, a)                        \
  (p)->GetCurrentTexturePalette(a)
...
#define IDirect3DDevice9_SetSoftwareVertexProcessing(p, a)                     \
  (p)->SetSoftwareVertexProcessing(a)
#define IDirect3DDevice9_GetSoftwareVertexProcessing(p)                        \
  (p)->GetSoftwareVertexProcessing()
...
#define IDirect3DDevice9_DrawIndexedPrimitive(p, a, b, c, d, e, f)             \
  (p)->DrawIndexedPrimitive(a, b, c, d, e, f)
#define IDirect3DDevice9_DrawPrimitiveUP(p, a, b, c, d)                        \
  (p)->DrawPrimitiveUP(a, b, c, d)
#define IDirect3DDevice9_DrawIndexedPrimitiveUP(p, a, b, c, d, e, f, g, h)     \
  (p)->DrawIndexedPrimitiveUP(a, b, c, d, e, f, g, h)
#define IDirect3DDevice9_ProcessVertices(p, a, b, c, d, e, f)                  \
  (p)->ProcessVertices(a, b, c, d, e, f)
#define IDirect3DDevice9_CreateVertexDeclaration(p, a, b)                      \
  (p)->CreateVertexDeclaration(a, b)
...
#define IDirect3DDevice9_SetVertexShaderConstantF(p, a, b, c)                  \
  (p)->SetVertexShaderConstantF(a, b, c)
#define IDirect3DDevice9_GetVertexShaderConstantF(p, a, b, c)                  \
  (p)->GetVertexShaderConstantF(a, b, c)
#define IDirect3DDevice9_SetVertexShaderConstantI(p, a, b, c)                  \
  (p)->SetVertexShaderConstantI(a, b, c)
#define IDirect3DDevice9_GetVertexShaderConstantI(p, a, b, c)                  \
  (p)->GetVertexShaderConstantI(a, b, c)
#define IDirect3DDevice9_SetVertexShaderConstantB(p, a, b, c)                  \
  (p)->SetVertexShaderConstantB(a, b, c)
#define IDirect3DDevice9_GetVertexShaderConstantB(p, a, b, c)                  \
  (p)->GetVertexShaderConstantB(a, b, c)
#define IDirect3DDevice9_SetStreamSource(p, a, b, c, d)                        \
  (p)->SetStreamSource(a, b, c, d)
#define IDirect3DDevice9_GetStreamSource(p, a, b, c, d)                        \
  (p)->GetStreamSource(a, b, c, d)
#define IDirect3DDevice9_SetStreamSourceFreq(p, a, b)                          \
  (p)->SetStreamSourceFreq(a, b)
#define IDirect3DDevice9_GetStreamSourceFreq(p, a, b)                          \
  (p)->GetStreamSourceFreq(a, b)
...
#define IDirect3DDevice9_SetPixelShaderConstantF(p, a, b, c)                   \
  (p)->SetPixelShaderConstantF(a, b, c)
#define IDirect3DDevice9_GetPixelShaderConstantF(p, a, b, c)                   \
  (p)->GetPixelShaderConstantF(a, b, c)
#define IDirect3DDevice9_SetPixelShaderConstantI(p, a, b, c)                   \
  (p)->SetPixelShaderConstantI(a, b, c)
#define IDirect3DDevice9_GetPixelShaderConstantI(p, a, b, c)                   \
  (p)->GetPixelShaderConstantI(a, b, c)
#define IDirect3DDevice9_SetPixelShaderConstantB(p, a, b, c)                   \
  (p)->SetPixelShaderConstantB(a, b, c)
#define IDirect3DDevice9_GetPixelShaderConstantB(p, a, b, c)                   \
  (p)->GetPixelShaderConstantB(a, b, c)
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DStateBlock9_QueryInterface(p, a, b)                           \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
DECLARE_INTERFACE_(IDirect3DSwapChain9, IUnknown) {
  ...
  STDMETHOD(Present)
  (THIS_ CONST RECT * pSourceRect, CONST RECT * pDestRect,
   HWND hDestWindowOverride, CONST RGNDATA * pDirtyRegion, DWORD dwFlags) PURE;
  STDMETHOD(GetFrontBufferData)(THIS_ IDirect3DSurface9 * pDestSurface) PURE;
  STDMETHOD(GetBackBuffer)
  (THIS_ UINT iBackBuffer, D3DBACKBUFFER_TYPE Type,
   IDirect3DSurface9 * *ppBackBuffer) PURE;
  STDMETHOD(GetRasterStatus)(THIS_ D3DRASTER_STATUS * pRasterStatus) PURE;
  STDMETHOD(GetDisplayMode)(THIS_ D3DDISPLAYMODE * pMode) PURE;
  STDMETHOD(GetDevice)(THIS_ IDirect3DDevice9 * *ppDevice) PURE;
  STDMETHOD(GetPresentParameters)
  (THIS_ D3DPRESENT_PARAMETERS * pPresentationParameters) PURE;
...
#define IDirect3DSwapChain9_GetDisplayMode(p, a)                               \
...
DECLARE_INTERFACE_(IDirect3DResource9, IUnknown) {
  ...
  (THIS_ REFGUID refguid, void *pData, DWORD *pSizeOfData) PURE;
...
#define IDirect3DResource9_FreePrivateData(p, a)                               \
...
DECLARE_INTERFACE_(IDirect3DVertexDeclaration9, IUnknown) {
  ...
  (THIS_ D3DVERTEXELEMENT9 * pElement, UINT * pNumElements) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DVertexDeclaration9_QueryInterface(p, a, b)                    \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DVertexDeclaration9_GetDeclaration(p, a, b)                    \
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DVertexShader9_QueryInterface(p, a, b)                         \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DPixelShader9_QueryInterface(p, a, b)                          \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DPixelShader9_GetFunction(p, a, b)                             \
  (p)->lpVtbl->GetFunction(p, a, b)
#else
...
#define IDirect3DBaseTexture9_SetPrivateData(p, a, b, c, d)                    \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DBaseTexture9_GetPrivateData(p, a, b, c)                       \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DBaseTexture9_FreePrivateData(p, a)                            \
  (p)->lpVtbl->FreePrivateData(p, a)
...
#define IDirect3DBaseTexture9_SetAutoGenFilterType(p, a)                       \
  (p)->lpVtbl->SetAutoGenFilterType(p, a)
#define IDirect3DBaseTexture9_GetAutoGenFilterType(p)                          \
  (p)->lpVtbl->GetAutoGenFilterType(p)
#define IDirect3DBaseTexture9_GenerateMipSubLevels(p)                          \
  (p)->lpVtbl->GenerateMipSubLevels(p)
#else
...
#define IDirect3DBaseTexture9_SetAutoGenFilterType(p, a)                       \
  (p)->SetAutoGenFilterType(a)
#define IDirect3DBaseTexture9_GetAutoGenFilterType(p)                          \
  (p)->GetAutoGenFilterType()
#define IDirect3DBaseTexture9_GenerateMipSubLevels(p)                          \
...
DECLARE_INTERFACE_(IDirect3DTexture9, IDirect3DBaseTexture9) {
  ...
  (THIS_ UINT Level, IDirect3DSurface9 * *ppSurfaceLevel) PURE;
  STDMETHOD(LockRect)
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DTexture9_QueryInterface(p, a, b)                              \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DTexture9_SetPrivateData(p, a, b, c, d)                        \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DTexture9_GetPrivateData(p, a, b, c)                           \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DTexture9_FreePrivateData(p, a)                                \
  (p)->lpVtbl->FreePrivateData(p, a)
...
#define IDirect3DTexture9_SetAutoGenFilterType(p, a)                           \
  (p)->lpVtbl->SetAutoGenFilterType(p, a)
#define IDirect3DTexture9_GetAutoGenFilterType(p)                              \
  (p)->lpVtbl->GetAutoGenFilterType(p)
#define IDirect3DTexture9_GenerateMipSubLevels(p)                              \
  (p)->lpVtbl->GenerateMipSubLevels(p)
...
DECLARE_INTERFACE_(IDirect3DVolumeTexture9, IDirect3DBaseTexture9) {
  ...
  (THIS_ UINT Level, IDirect3DVolume9 * *ppVolumeLevel) PURE;
  STDMETHOD(LockBox)
  (THIS_ UINT Level, D3DLOCKED_BOX * pLockedVolume, CONST D3DBOX * pBox,
   DWORD Flags) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DVolumeTexture9_QueryInterface(p, a, b)                        \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DVolumeTexture9_SetPrivateData(p, a, b, c, d)                  \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DVolumeTexture9_GetPrivateData(p, a, b, c)                     \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DVolumeTexture9_FreePrivateData(p, a)                          \
  (p)->lpVtbl->FreePrivateData(p, a)
...
#define IDirect3DVolumeTexture9_SetAutoGenFilterType(p, a)                     \
  (p)->lpVtbl->SetAutoGenFilterType(p, a)
#define IDirect3DVolumeTexture9_GetAutoGenFilterType(p)                        \
  (p)->lpVtbl->GetAutoGenFilterType(p)
#define IDirect3DVolumeTexture9_GenerateMipSubLevels(p)                        \
  (p)->lpVtbl->GenerateMipSubLevels(p)
...
DECLARE_INTERFACE_(IDirect3DCubeTexture9, IDirect3DBaseTexture9) {
  ...
  (THIS_ D3DCUBEMAP_FACES FaceType, UINT Level,
   IDirect3DSurface9 * *ppCubeMapSurface) PURE;
  STDMETHOD(LockRect)
  (THIS_ D3DCUBEMAP_FACES FaceType, UINT Level, D3DLOCKED_RECT * pLockedRect,
   CONST RECT * pRect, DWORD Flags) PURE;
  STDMETHOD(UnlockRect)(THIS_ D3DCUBEMAP_FACES FaceType, UINT Level) PURE;
  STDMETHOD(AddDirtyRect)
  (THIS_ D3DCUBEMAP_FACES FaceType, CONST RECT * pDirtyRect) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DCubeTexture9_QueryInterface(p, a, b)                          \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DCubeTexture9_SetPrivateData(p, a, b, c, d)                    \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DCubeTexture9_GetPrivateData(p, a, b, c)                       \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DCubeTexture9_FreePrivateData(p, a)                            \
  (p)->lpVtbl->FreePrivateData(p, a)
...
#define IDirect3DCubeTexture9_SetAutoGenFilterType(p, a)                       \
  (p)->lpVtbl->SetAutoGenFilterType(p, a)
#define IDirect3DCubeTexture9_GetAutoGenFilterType(p)                          \
  (p)->lpVtbl->GetAutoGenFilterType(p)
#define IDirect3DCubeTexture9_GenerateMipSubLevels(p)                          \
  (p)->lpVtbl->GenerateMipSubLevels(p)
...
#define IDirect3DCubeTexture9_AddDirtyRect(p, a, b)                            \
...
#define IDirect3DCubeTexture9_GetCubeMapSurface(p, a, b, c)                    \
  (p)->GetCubeMapSurface(a, b, c)
#define IDirect3DCubeTexture9_LockRect(p, a, b, c, d, e)                       \
  (p)->LockRect(a, b, c, d, e)
...
DECLARE_INTERFACE_(IDirect3DVertexBuffer9, IDirect3DResource9) {
  ...
  STDMETHOD_(D3DRESOURCETYPE, GetType)(THIS) PURE;
  STDMETHOD(Lock)
  (THIS_ UINT OffsetToLock, UINT SizeToLock, void **ppbData, DWORD Flags) PURE;
...
#define IDirect3DVertexBuffer9_SetPrivateData(p, a, b, c, d)                   \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DVertexBuffer9_GetPrivateData(p, a, b, c)                      \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
...
#define IDirect3DIndexBuffer9_SetPrivateData(p, a, b, c, d)                    \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DIndexBuffer9_GetPrivateData(p, a, b, c)                       \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
...
DECLARE_INTERFACE_(IDirect3DSurface9, IDirect3DResource9) {
  ...
  STDMETHOD(LockRect)
  (THIS_ D3DLOCKED_RECT * pLockedRect, CONST RECT * pRect, DWORD Flags) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DSurface9_QueryInterface(p, a, b)                              \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DSurface9_GetPrivateData(p, a, b, c)                           \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DSurface9_FreePrivateData(p, a)                                \
  (p)->lpVtbl->FreePrivateData(p, a)
...
DECLARE_INTERFACE_(IDirect3DVolume9, IUnknown) {
  ...
  STDMETHOD(LockBox)
  (THIS_ D3DLOCKED_BOX * pLockedVolume, CONST D3DBOX * pBox, DWORD Flags) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DVolume9_QueryInterface(p, a, b)                               \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DVolume9_GetPrivateData(p, a, b, c)                            \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DVolume9_FreePrivateData(p, a)                                 \
  (p)->lpVtbl->FreePrivateData(p, a)
...
DECLARE_INTERFACE_(IDirect3DQuery9, IUnknown) {
  ...
  STDMETHOD(GetData)
  (THIS_ void *pData, DWORD dwSize, DWORD dwGetDataFlags) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirect3DQuery9_QueryInterface(p, a, b)                                \
  (p)->lpVtbl->QueryInterface(p, a, b)
 ...
 *SetPrivateData must be set to sizeof(IUnknown*). Direct3D will call AddRef
 *through this pointer and Release when the private data is destroyed. The data
 *will be destroyed when another SetPrivateData with the same GUID is set, when
