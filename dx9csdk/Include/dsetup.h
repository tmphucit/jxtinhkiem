...
#define DSETUP_DIRECTXSETUP                                                    \
  0x00001000                   /* OBSOLETE. install DirectXSetup DLL's   */
#define DSETUP_NOUI 0x00002000 /* OBSOLETE. install DirectX with NO UI   */
#define DSETUP_PROMPTFORDRIVERS                                                \
  0x10000000 /* OBSOLETE. prompt when replacing display/audio drivers */
#define DSETUP_RESTOREDRIVERS                                                  \
  0x20000000 /* OBSOLETE. restore display/audio drivers */
...
typedef DWORD(FAR PASCAL *DSETUP_CALLBACK)(
    DWORD Reason, DWORD MsgType, /* Same as flags to MessageBox */
    LPSTR szMessage, LPSTR szName, void *pInfo);
