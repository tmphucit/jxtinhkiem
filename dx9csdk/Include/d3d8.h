...
DEFINE_GUID(IID_IDirect3D8, 0x1dd9e8da, 0x1c77, 0x4d40, 0xb0, 0xcf, 0x98, 0xfe,
            0xfd, 0xff, 0x95, 0x12);

/* IID_IDirect3DDevice8 */
/* {7385E5DF-8FE8-41D5-86B6-D7B48547B6CF} */
DEFINE_GUID(IID_IDirect3DDevice8, 0x7385e5df, 0x8fe8, 0x41d5, 0x86, 0xb6, 0xd7,
            0xb4, 0x85, 0x47, 0xb6, 0xcf);

/* IID_IDirect3DResource8 */
/* {1B36BB7B-09B7-410a-B445-7D1430D7B33F} */
DEFINE_GUID(IID_IDirect3DResource8, 0x1b36bb7b, 0x9b7, 0x410a, 0xb4, 0x45, 0x7d,
            0x14, 0x30, 0xd7, 0xb3, 0x3f);

/* IID_IDirect3DBaseTexture8 */
/* {B4211CFA-51B9-4a9f-AB78-DB99B2BB678E} */
DEFINE_GUID(IID_IDirect3DBaseTexture8, 0xb4211cfa, 0x51b9, 0x4a9f, 0xab, 0x78,
            0xdb, 0x99, 0xb2, 0xbb, 0x67, 0x8e);

/* IID_IDirect3DTexture8 */
/* {E4CDD575-2866-4f01-B12E-7EECE1EC9358} */
DEFINE_GUID(IID_IDirect3DTexture8, 0xe4cdd575, 0x2866, 0x4f01, 0xb1, 0x2e, 0x7e,
            0xec, 0xe1, 0xec, 0x93, 0x58);

/* IID_IDirect3DCubeTexture8 */
/* {3EE5B968-2ACA-4c34-8BB5-7E0C3D19B750} */
DEFINE_GUID(IID_IDirect3DCubeTexture8, 0x3ee5b968, 0x2aca, 0x4c34, 0x8b, 0xb5,
            0x7e, 0x0c, 0x3d, 0x19, 0xb7, 0x50);

/* IID_IDirect3DVolumeTexture8 */
/* {4B8AAAFA-140F-42ba-9131-597EAFAA2EAD} */
DEFINE_GUID(IID_IDirect3DVolumeTexture8, 0x4b8aaafa, 0x140f, 0x42ba, 0x91, 0x31,
            0x59, 0x7e, 0xaf, 0xaa, 0x2e, 0xad);

/* IID_IDirect3DVertexBuffer8 */
/* {8AEEEAC7-05F9-44d4-B591-000B0DF1CB95} */
DEFINE_GUID(IID_IDirect3DVertexBuffer8, 0x8aeeeac7, 0x05f9, 0x44d4, 0xb5, 0x91,
            0x00, 0x0b, 0x0d, 0xf1, 0xcb, 0x95);

/* IID_IDirect3DIndexBuffer8 */
/* {0E689C9A-053D-44a0-9D92-DB0E3D750F86} */
DEFINE_GUID(IID_IDirect3DIndexBuffer8, 0x0e689c9a, 0x053d, 0x44a0, 0x9d, 0x92,
            0xdb, 0x0e, 0x3d, 0x75, 0x0f, 0x86);

/* IID_IDirect3DSurface8 */
/* {B96EEBCA-B326-4ea5-882F-2FF5BAE021DD} */
DEFINE_GUID(IID_IDirect3DSurface8, 0xb96eebca, 0xb326, 0x4ea5, 0x88, 0x2f, 0x2f,
            0xf5, 0xba, 0xe0, 0x21, 0xdd);

/* IID_IDirect3DVolume8 */
/* {BD7349F5-14F1-42e4-9C79-972380DB40C0} */
DEFINE_GUID(IID_IDirect3DVolume8, 0xbd7349f5, 0x14f1, 0x42e4, 0x9c, 0x79, 0x97,
            0x23, 0x80, 0xdb, 0x40, 0xc0);

/* IID_IDirect3DSwapChain8 */
/* {928C088B-76B9-4C6B-A536-A590853876CD} */
DEFINE_GUID(IID_IDirect3DSwapChain8, 0x928c088b, 0x76b9, 0x4c6b, 0xa5, 0x36,
            0xa5, 0x90, 0x85, 0x38, 0x76, 0xcd);
...
DECLARE_INTERFACE_(IDirect3D8, IUnknown) {
  ...
  (THIS_ UINT Adapter, UINT Mode, D3DDISPLAYMODE * pMode) PURE;
  STDMETHOD(GetAdapterDisplayMode)
  (THIS_ UINT Adapter, D3DDISPLAYMODE * pMode) PURE;
  STDMETHOD(CheckDeviceType)
  (THIS_ UINT Adapter, D3DDEVTYPE CheckType, D3DFORMAT DisplayFormat,
  ...
  (THIS_ UINT Adapter, D3DDEVTYPE DeviceType, D3DCAPS8 * pCaps) PURE;
...
#define IDirect3D8_RegisterSoftwareDevice(p, a)                                \
...
#define IDirect3D8_GetAdapterModeCount(p, a)                                   \
  (p)->lpVtbl->GetAdapterModeCount(p, a)
#define IDirect3D8_EnumAdapterModes(p, a, b, c)                                \
...
DECLARE_INTERFACE_(IDirect3DDevice8, IUnknown) {
  ...
  (THIS_ UINT XHotSpot, UINT YHotSpot, IDirect3DSurface8 * pCursorBitmap) PURE;
  ...
  (THIS_ UINT BackBuffer, D3DBACKBUFFER_TYPE Type,
   IDirect3DSurface8 * *ppBackBuffer) PURE;
  STDMETHOD(GetRasterStatus)(THIS_ D3DRASTER_STATUS * pRasterStatus) PURE;
  STDMETHOD_(void, SetGammaRamp)
  (THIS_ DWORD Flags, CONST D3DGAMMARAMP * pRamp) PURE;
  ...
  (THIS_ UINT Width, UINT Height, D3DFORMAT Format,
   IDirect3DSurface8 * *ppSurface) PURE;
  STDMETHOD(CopyRects)
  (THIS_ IDirect3DSurface8 * pSourceSurface, CONST RECT * pSourceRectsArray,
   UINT cRects, IDirect3DSurface8 * pDestinationSurface,
   CONST POINT * pDestPointsArray) PURE;
  STDMETHOD(UpdateTexture)
  (THIS_ IDirect3DBaseTexture8 * pSourceTexture,
  ...
  (THIS_ IDirect3DSurface8 * *ppZStencilSurface) PURE;
  ...
  (THIS_ D3DSTATEBLOCKTYPE Type, DWORD * pToken) PURE;
  ...
  (THIS_ DWORD Stage, IDirect3DBaseTexture8 * *ppTexture) PURE;
  STDMETHOD(SetTexture)
  (THIS_ DWORD Stage, IDirect3DBaseTexture8 * pTexture) PURE;
  ...
  STDMETHOD(GetInfo)
  (THIS_ DWORD DevInfoID, void *pDevInfoStruct, DWORD DevInfoStructSize) PURE;
  ...
  (THIS_ D3DPRIMITIVETYPE, UINT minIndex, UINT NumVertices, UINT startIndex,
   UINT primCount) PURE;
  ...
  (THIS_ D3DPRIMITIVETYPE PrimitiveType, UINT MinVertexIndex,
  ...
  (THIS_ CONST DWORD * pDeclaration, CONST DWORD * pFunction, DWORD * pHandle,
   DWORD Usage) PURE;
  ...
  (THIS_ DWORD Register, CONST void *pConstantData, DWORD ConstantCount) PURE;
  STDMETHOD(GetVertexShaderConstant)
  (THIS_ DWORD Register, void *pConstantData, DWORD ConstantCount) PURE;
  STDMETHOD(GetVertexShaderDeclaration)
  (THIS_ DWORD Handle, void *pData, DWORD *pSizeOfData) PURE;
  STDMETHOD(GetVertexShaderFunction)
  (THIS_ DWORD Handle, void *pData, DWORD *pSizeOfData) PURE;
  STDMETHOD(SetStreamSource)
  (THIS_ UINT StreamNumber, IDirect3DVertexBuffer8 * pStreamData, UINT Stride)
      PURE;
  STDMETHOD(GetStreamSource)
  (THIS_ UINT StreamNumber, IDirect3DVertexBuffer8 * *ppStreamData,
   UINT * pStride) PURE;
  STDMETHOD(SetIndices)
  (THIS_ IDirect3DIndexBuffer8 * pIndexData, UINT BaseVertexIndex) PURE;
  STDMETHOD(GetIndices)
  (THIS_ IDirect3DIndexBuffer8 * *ppIndexData, UINT * pBaseVertexIndex) PURE;
  STDMETHOD(CreatePixelShader)
  (THIS_ CONST DWORD * pFunction, DWORD * pHandle) PURE;
...
#define IDirect3DDevice8_GetRasterStatus(p, a)                                 \
  (p)->lpVtbl->GetRasterStatus(p, a)
#define IDirect3DDevice8_SetGammaRamp(p, a, b)                                 \
...
#define IDirect3DDevice8_CopyRects(p, a, b, c, d, e)                           \
  (p)->lpVtbl->CopyRects(p, a, b, c, d, e)
#define IDirect3DDevice8_UpdateTexture(p, a, b)                                \
...
#define IDirect3DDevice8_GetDepthStencilSurface(p, a)                          \
...
#define IDirect3DDevice8_GetTransform(p, a, b)                                 \
  (p)->lpVtbl->GetTransform(p, a, b)
#define IDirect3DDevice8_MultiplyTransform(p, a, b)                            \
...
#define IDirect3DDevice8_GetLightEnable(p, a, b)                               \
  (p)->lpVtbl->GetLightEnable(p, a, b)
#define IDirect3DDevice8_SetClipPlane(p, a, b)                                 \
  (p)->lpVtbl->SetClipPlane(p, a, b)
#define IDirect3DDevice8_GetClipPlane(p, a, b)                                 \
...
#define IDirect3DDevice8_ApplyStateBlock(p, a)                                 \
  (p)->lpVtbl->ApplyStateBlock(p, a)
#define IDirect3DDevice8_CaptureStateBlock(p, a)                               \
  (p)->lpVtbl->CaptureStateBlock(p, a)
#define IDirect3DDevice8_DeleteStateBlock(p, a)                                \
  (p)->lpVtbl->DeleteStateBlock(p, a)
#define IDirect3DDevice8_CreateStateBlock(p, a, b)                             \
...
#define IDirect3DDevice8_SetPaletteEntries(p, a, b)                            \
  (p)->lpVtbl->SetPaletteEntries(p, a, b)
#define IDirect3DDevice8_GetPaletteEntries(p, a, b)                            \
  (p)->lpVtbl->GetPaletteEntries(p, a, b)
#define IDirect3DDevice8_SetCurrentTexturePalette(p, a)                        \
  (p)->lpVtbl->SetCurrentTexturePalette(p, a)
#define IDirect3DDevice8_GetCurrentTexturePalette(p, a)                        \
...
#define IDirect3DDevice8_GetVertexShader(p, a)                                 \
  (p)->lpVtbl->GetVertexShader(p, a)
#define IDirect3DDevice8_DeleteVertexShader(p, a)                              \
...
#define IDirect3DDevice8_GetStreamSource(p, a, b, c)                           \
...
#define IDirect3DDevice8_CreatePixelShader(p, a, b)                            \
...
#define IDirect3DDevice8_DeletePixelShader(p, a)                               \
...
#define IDirect3DDevice8_DrawRectPatch(p, a, b, c)                             \
  (p)->lpVtbl->DrawRectPatch(p, a, b, c)
#define IDirect3DDevice8_DrawTriPatch(p, a, b, c)                              \
...
#define IDirect3DDevice8_ResourceManagerDiscardBytes(p, a)                     \
  (p)->ResourceManagerDiscardBytes(a)
...
#define IDirect3DDevice8_CreateVertexBuffer(p, a, b, c, d, e)                  \
  (p)->CreateVertexBuffer(a, b, c, d, e)
#define IDirect3DDevice8_CreateIndexBuffer(p, a, b, c, d, e)                   \
  (p)->CreateIndexBuffer(a, b, c, d, e)
#define IDirect3DDevice8_CreateRenderTarget(p, a, b, c, d, e, f)               \
...
#define IDirect3DDevice8_SetVertexShaderConstant(p, a, b, c)                   \
  (p)->SetVertexShaderConstant(a, b, c)
#define IDirect3DDevice8_GetVertexShaderConstant(p, a, b, c)                   \
  (p)->GetVertexShaderConstant(a, b, c)
#define IDirect3DDevice8_GetVertexShaderDeclaration(p, a, b, c)                \
  (p)->GetVertexShaderDeclaration(a, b, c)
#define IDirect3DDevice8_GetVertexShaderFunction(p, a, b, c)                   \
  (p)->GetVertexShaderFunction(a, b, c)
#define IDirect3DDevice8_SetStreamSource(p, a, b, c)                           \
  (p)->SetStreamSource(a, b, c)
#define IDirect3DDevice8_GetStreamSource(p, a, b, c)                           \
  (p)->GetStreamSource(a, b, c)
...
#define IDirect3DDevice8_SetPixelShaderConstant(p, a, b, c)                    \
  (p)->SetPixelShaderConstant(a, b, c)
#define IDirect3DDevice8_GetPixelShaderConstant(p, a, b, c)                    \
  (p)->GetPixelShaderConstant(a, b, c)
#define IDirect3DDevice8_GetPixelShaderFunction(p, a, b, c)                    \
  (p)->GetPixelShaderFunction(a, b, c)
...
#define IDirect3DSwapChain8_Present(p, a, b, c, d)                             \
  (p)->lpVtbl->Present(p, a, b, c, d)
#define IDirect3DSwapChain8_GetBackBuffer(p, a, b, c)                          \
  (p)->lpVtbl->GetBackBuffer(p, a, b, c)
#else
...
#define IDirect3DResource8_SetPrivateData(p, a, b, c, d)                       \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DResource8_GetPrivateData(p, a, b, c)                          \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DResource8_FreePrivateData(p, a)                               \
...
DECLARE_INTERFACE_(IDirect3DVolumeTexture8, IDirect3DBaseTexture8) {
  ...
  (THIS_ UINT Level, IDirect3DVolume8 * *ppVolumeLevel) PURE;
  STDMETHOD(LockBox)
...
#define IDirect3DVolumeTexture8_GetLevelDesc(p, a, b)                          \
  (p)->lpVtbl->GetLevelDesc(p, a, b)
#define IDirect3DVolumeTexture8_GetVolumeLevel(p, a, b)                        \
...
#define IDirect3DCubeTexture8_GetLevelDesc(p, a, b)                            \
  (p)->lpVtbl->GetLevelDesc(p, a, b)
#define IDirect3DCubeTexture8_GetCubeMapSurface(p, a, b, c)                    \
  (p)->lpVtbl->GetCubeMapSurface(p, a, b, c)
#define IDirect3DCubeTexture8_LockRect(p, a, b, c, d, e)                       \
  (p)->lpVtbl->LockRect(p, a, b, c, d, e)
#define IDirect3DCubeTexture8_UnlockRect(p, a, b)                              \
  (p)->lpVtbl->UnlockRect(p, a, b)
#define IDirect3DCubeTexture8_AddDirtyRect(p, a, b)                            \
...
DECLARE_INTERFACE_(IDirect3DVertexBuffer8, IDirect3DResource8) {
  ...
  STDMETHOD_(D3DRESOURCETYPE, GetType)(THIS) PURE;
  STDMETHOD(Lock)
  (THIS_ UINT OffsetToLock, UINT SizeToLock, BYTE * *ppbData, DWORD Flags) PURE;
...
#define IDirect3DIndexBuffer8_Lock(p, a, b, c, d)                              \
  (p)->lpVtbl->Lock(p, a, b, c, d)
...
#define IDirect3DSurface8_SetPrivateData(p, a, b, c, d)                        \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DSurface8_GetPrivateData(p, a, b, c)                           \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DSurface8_FreePrivateData(p, a)                                \
  (p)->lpVtbl->FreePrivateData(p, a)
#define IDirect3DSurface8_GetContainer(p, a, b)                                \
...
#define IDirect3DVolume8_SetPrivateData(p, a, b, c, d)                         \
  (p)->lpVtbl->SetPrivateData(p, a, b, c, d)
#define IDirect3DVolume8_GetPrivateData(p, a, b, c)                            \
  (p)->lpVtbl->GetPrivateData(p, a, b, c)
#define IDirect3DVolume8_FreePrivateData(p, a)                                 \
  (p)->lpVtbl->FreePrivateData(p, a)
#define IDirect3DVolume8_GetContainer(p, a, b)                                 \
  (p)->lpVtbl->GetContainer(p, a, b)
