...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE TakeOwnership(
      /* [in] */ IUnknown * pDevice, BOOL Exclusive) = 0;
...
typedef struct IDXGIOutputVtbl {
  ...
  (IDXGIOutput *This,
   /* [in] */ IUnknown *pDevice, BOOL Exclusive);
...
#define IDXGIOutput_GetDisplayModeList(This, EnumFormat, Flags, pNumModes,     \
                                       pDesc)                                  \
  ((This)->lpVtbl->GetDisplayModeList(This, EnumFormat, Flags, pNumModes,      \
                                      pDesc))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetContainingOutput(IDXGIOutput *
                                                        *ppOutput) = 0;
...
typedef struct IDXGISwapChainVtbl {
  ...
  (IDXGISwapChain *This, IDXGIOutput **ppOutput);
...
#define IDXGISwapChain_ResizeBuffers(This, BufferCount, Width, Height,         \
                                     NewFormat, SwapChainFlags)                \
  ((This)->lpVtbl->ResizeBuffers(This, BufferCount, Width, Height, NewFormat,  \
                                 SwapChainFlags))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetWindowAssociation(HWND *
                                                         pWindowHandle) = 0;
...
typedef struct IDXGIFactoryVtbl {
  ...
  (IDXGIFactory *This, HWND WindowHandle, UINT Flags);

  HRESULT(STDMETHODCALLTYPE *GetWindowAssociation)
  (IDXGIFactory *This, HWND *pWindowHandle);

  HRESULT(STDMETHODCALLTYPE *CreateSwapChain)
  (IDXGIFactory *This, IUnknown *pDevice, DXGI_SWAP_CHAIN_DESC *pDesc,
...
#define IDXGIDevice_CreateSurface(This, pDesc, NumSurfaces, Usage,             \
                                  pSharedResource, ppSurface)                  \
  ((This)->lpVtbl->CreateSurface(This, pDesc, NumSurfaces, Usage,              \
                                 pSharedResource, ppSurface))

#define IDXGIDevice_QueryResourceResidency(This, ppResources,                  \
                                           pResidencyStatus, NumResources)     \
  ((This)->lpVtbl->QueryResourceResidency(This, ppResources, pResidencyStatus, \
                                          NumResources))
...
#ifdef __cplusplus
#endif /*__cplusplus*/
DEFINE_GUID(IID_IDXGIObject, 0xaec22fb8, 0x76f3, 0x4639, 0x9b, 0xe0, 0x28, 0xeb,
            0x43, 0xa6, 0x7a, 0x2e);
DEFINE_GUID(IID_IDXGIDeviceSubObject, 0x3d3e0379, 0xf9de, 0x4d58, 0xbb, 0x6c,
            0x18, 0xd6, 0x29, 0x92, 0xf1, 0xa6);
DEFINE_GUID(IID_IDXGIResource, 0x035f3ab4, 0x482e, 0x4e50, 0xb4, 0x1f, 0x8a,
            0x7f, 0x8b, 0xd8, 0x96, 0x0b);
DEFINE_GUID(IID_IDXGISurface, 0xcafcb56c, 0x6ac3, 0x4889, 0xbf, 0x47, 0x9e,
            0x23, 0xbb, 0xd2, 0x60, 0xec);
DEFINE_GUID(IID_IDXGIAdapter, 0x2411e7e1, 0x12ac, 0x4ccf, 0xbd, 0x14, 0x97,
            0x98, 0xe8, 0x53, 0x4d, 0xc0);
DEFINE_GUID(IID_IDXGIOutput, 0xae02eedb, 0xc735, 0x4690, 0x8d, 0x52, 0x5a, 0x8d,
            0xc2, 0x02, 0x13, 0xaa);
DEFINE_GUID(IID_IDXGISwapChain, 0x310d36a0, 0xd2e7, 0x4c0a, 0xaa, 0x04, 0x6a,
            0x9d, 0x23, 0xb8, 0x88, 0x6a);
DEFINE_GUID(IID_IDXGIFactory, 0x7b7166ec, 0x21c7, 0x44ae, 0xb2, 0x1a, 0xc9,
            0xae, 0x32, 0x1a, 0xe3, 0x69);
DEFINE_GUID(IID_IDXGIDevice, 0x54ec77fa, 0x1377, 0x44e6, 0x8c, 0x32, 0x88, 0xfd,
            0x5f, 0x44, 0xc8, 0x4c);
