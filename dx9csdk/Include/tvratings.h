...
typedef struct IXDSToRatVtbl {
  ...
  /* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *Init)(IXDSToRat *This);
...
interface IXDSToRat { CONST_VTBL struct IXDSToRatVtbl *lpVtbl; };
...
#define IXDSToRat_ParseXDSBytePair(This, byte1, byte2, pEnSystem, pEnLevel,    \
                                   plBfEnAttributes)                           \
  (This)->lpVtbl->ParseXDSBytePair(This, byte1, byte2, pEnSystem, pEnLevel,    \
                                   plBfEnAttributes)
...
IXDSToRat_Init_Proxy(IXDSToRat *This);

void __RPC_STUB IXDSToRat_Init_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);

/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
IXDSToRat_ParseXDSBytePair_Proxy(IXDSToRat *This,
                                 /* [in] */ BYTE byte1,
                                 /* [in] */ BYTE byte2,
                                 /* [out] */ EnTvRat_System *pEnSystem,
                                 /* [out] */ EnTvRat_GenericLevel *pEnLevel,
...
typedef struct IEvalRatVtbl {
  ...
  /* [helpstring][id][propget] */ HRESULT(
      STDMETHODCALLTYPE *get_BlockedRatingAttributes)(
      IEvalRat *This,
      /* [in] */ EnTvRat_System enSystem,
      /* [in] */ EnTvRat_GenericLevel enLevel,
  ...
  /* [helpstring][id][propput] */ HRESULT(
      STDMETHODCALLTYPE *put_BlockedRatingAttributes)(
      IEvalRat *This,
      /* [in] */ EnTvRat_System enSystem,
      /* [in] */ EnTvRat_GenericLevel enLevel,
      /* [in] */ LONG lbfAttrs);
...
interface IEvalRat { CONST_VTBL struct IEvalRatVtbl *lpVtbl; };
...
#define IEvalRat_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,   \
                        pVarResult, pExcepInfo, puArgErr)                      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)

#define IEvalRat_get_BlockedRatingAttributes(This, enSystem, enLevel,          \
                                             plbfAttrs)                        \
  (This)->lpVtbl->get_BlockedRatingAttributes(This, enSystem, enLevel,         \
                                              plbfAttrs)

#define IEvalRat_put_BlockedRatingAttributes(This, enSystem, enLevel,          \
                                             lbfAttrs)                         \
...
#define IEvalRat_MostRestrictiveRating(                                        \
    This, enSystem1, enEnLevel1, lbfEnAttr1, enSystem2, enEnLevel2,            \
    lbfEnAttr2, penSystem, penEnLevel, plbfEnAttr)                             \
  (This)->lpVtbl->MostRestrictiveRating(                                       \
      This, enSystem1, enEnLevel1, lbfEnAttr1, enSystem2, enEnLevel2,          \
      lbfEnAttr2, penSystem, penEnLevel, plbfEnAttr)

#define IEvalRat_TestRating(This, enShowSystem, enShowLevel,                   \
                            lbfEnShowAttributes)                               \
  (This)->lpVtbl->TestRating(This, enShowSystem, enShowLevel,                  \
                             lbfEnShowAttributes)
...
IEvalRat_get_BlockedRatingAttributes_Proxy(
    IEvalRat *This,
    /* [in] */ EnTvRat_System enSystem,
    /* [in] */ EnTvRat_GenericLevel enLevel,
    /* [retval][out] */ LONG *plbfAttrs);
...
IEvalRat_put_BlockedRatingAttributes_Proxy(
    IEvalRat *This,
    /* [in] */ EnTvRat_System enSystem,
    /* [in] */ EnTvRat_GenericLevel enLevel,
    /* [in] */ LONG lbfAttrs);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
IEvalRat_get_BlockUnRated_Proxy(IEvalRat *This,
                                /* [retval][out] */ BOOL *pfBlockUnRatedShows);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE
IEvalRat_put_BlockUnRated_Proxy(IEvalRat *This,
                                /* [in] */ BOOL fBlockUnRatedShows);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
IEvalRat_MostRestrictiveRating_Proxy(
    IEvalRat *This,
    /* [in] */ EnTvRat_System enSystem1,
    /* [in] */ EnTvRat_GenericLevel enEnLevel1,
    /* [in] */ LONG lbfEnAttr1,
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE
IEvalRat_TestRating_Proxy(IEvalRat *This,
                          /* [in] */ EnTvRat_System enShowSystem,
                          /* [in] */ EnTvRat_GenericLevel enShowLevel,
                          /* [in] */ LONG lbfEnShowAttributes);

void __RPC_STUB IEvalRat_TestRating_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
