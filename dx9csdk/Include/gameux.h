...
interface IGameExplorer { CONST_VTBL struct IGameExplorerVtbl *lpVtbl; };
...
#define IGameExplorer_AddGame(This, bstrGDFBinaryPath,                         \
                              bstrGameInstallDirectory, installScope,          \
                              pguidInstanceID)                                 \
  ((This)->lpVtbl->AddGame(This, bstrGDFBinaryPath, bstrGameInstallDirectory,  \
                           installScope, pguidInstanceID))
