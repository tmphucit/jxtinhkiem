...
interface IMixerOCXNotify { CONST_VTBL struct IMixerOCXNotifyVtbl *lpVtbl; };
...
IMixerOCXNotify_OnInvalidateRect_Proxy(IMixerOCXNotify *This,
                                       /* [in] */ LPCRECT lpcRect);
...
HRESULT STDMETHODCALLTYPE
IMixerOCXNotify_OnStatusChange_Proxy(IMixerOCXNotify *This,
                                     /* [in] */ ULONG ulStatusFlags);
...
HRESULT STDMETHODCALLTYPE
IMixerOCXNotify_OnDataChange_Proxy(IMixerOCXNotify *This,
                                   /* [in] */ ULONG ulDataFlags);
...
interface IMixerOCX { CONST_VTBL struct IMixerOCXVtbl *lpVtbl; };
...
#define IMixerOCX_OnDisplayChange(This, ulBitsPerPixel, ulScreenWidth,         \
                                  ulScreenHeight)                              \
  (This)->lpVtbl->OnDisplayChange(This, ulBitsPerPixel, ulScreenWidth,         \
                                  ulScreenHeight)

#define IMixerOCX_GetAspectRatio(This, pdwPictAspectRatioX,                    \
                                 pdwPictAspectRatioY)                          \
...
HRESULT STDMETHODCALLTYPE
IMixerOCX_OnDisplayChange_Proxy(IMixerOCX *This,
                                /* [in] */ ULONG ulBitsPerPixel,
                                /* [in] */ ULONG ulScreenWidth,
                                /* [in] */ ULONG ulScreenHeight);
...
HRESULT STDMETHODCALLTYPE
IMixerOCX_GetAspectRatio_Proxy(IMixerOCX *This,
                               /* [out] */ LPDWORD pdwPictAspectRatioX,
                               /* [out] */ LPDWORD pdwPictAspectRatioY);
...
HRESULT STDMETHODCALLTYPE
IMixerOCX_GetVideoSize_Proxy(IMixerOCX *This,
                             /* [out] */ LPDWORD pdwVideoWidth,
                             /* [out] */ LPDWORD pdwVideoHeight);
...
HRESULT STDMETHODCALLTYPE
IMixerOCX_GetStatus_Proxy(IMixerOCX *This,
                          /* [out] */ LPDWORD *pdwStatus);

void __RPC_STUB IMixerOCX_GetStatus_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE IMixerOCX_OnDraw_Proxy(IMixerOCX *This,
                                                 /* [in] */ HDC hdcDraw,
                                                 /* [in] */ LPCRECT prcDraw);

void __RPC_STUB IMixerOCX_OnDraw_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IMixerOCX_SetDrawRegion_Proxy(IMixerOCX *This,
                              /* [in] */ LPPOINT lpptTopLeftSC,
                              /* [in] */ LPCRECT prcDrawCC,
                              /* [in] */ LPCRECT lprcClip);
...
HRESULT STDMETHODCALLTYPE
IMixerOCX_Advise_Proxy(IMixerOCX *This,
                       /* [in] */ IMixerOCXNotify *pmdns);

void __RPC_STUB IMixerOCX_Advise_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE IMixerOCX_UnAdvise_Proxy(IMixerOCX *This);

void __RPC_STUB IMixerOCX_UnAdvise_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
