...
DEFINE_GUID(IID_IDirectInputEffectDriver, 0x02538130, 0x898F, 0x11D0, 0x9A,
            0xD0, 0x00, 0xA0, 0xC9, 0xA0, 0x6E, 0x35);
DEFINE_GUID(IID_IDirectInputJoyConfig, 0x1DE12AB1, 0xC9F5, 0x11CF, 0xBF, 0xC7,
            0x44, 0x45, 0x53, 0x54, 0x00, 0x00);
DEFINE_GUID(IID_IDirectInputPIDDriver, 0xEEC6993A, 0xB3FD, 0x11D2, 0xA9, 0x16,
            0x00, 0xC0, 0x4F, 0xB9, 0x86, 0x38);

DEFINE_GUID(IID_IDirectInputJoyConfig8, 0xeb0d7dfa, 0x1990, 0x4f27, 0xb4, 0xd6,
            0xed, 0xf2, 0xee, 0xc4, 0xa4, 0x4c);
...
DEFINE_GUID(GUID_KeyboardClass, 0x4D36E96B, 0xE325, 0x11CE, 0xBF, 0xC1, 0x08,
            0x00, 0x2B, 0xE1, 0x03, 0x18);
DEFINE_GUID(GUID_MediaClass, 0x4D36E96C, 0xE325, 0x11CE, 0xBF, 0xC1, 0x08, 0x00,
            0x2B, 0xE1, 0x03, 0x18);
DEFINE_GUID(GUID_MouseClass, 0x4D36E96F, 0xE325, 0x11CE, 0xBF, 0xC1, 0x08, 0x00,
            0x2B, 0xE1, 0x03, 0x18);
DEFINE_GUID(GUID_HIDClass, 0x745A17A0, 0x74D3, 0x11D0, 0xB6, 0xFE, 0x00, 0xA0,
            0xC9, 0x0F, 0x57, 0xDA);
...
#if !defined(__cplusplus) || defined(CINTERFACE)
#define IDirectInputJoyConfig8_QueryInterface(p, a, b)                         \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirectInputJoyConfig8_SetCooperativeLevel(p, a, b)                    \
  (p)->lpVtbl->SetCooperativeLevel(p, a, b)
#define IDirectInputJoyConfig8_SendNotify(p) (p)->lpVtbl->SendNotify(p)
#define IDirectInputJoyConfig8_EnumTypes(p, a, b)                              \
  (p)->lpVtbl->EnumTypes(p, a, b)
#define IDirectInputJoyConfig8_GetTypeInfo(p, a, b, c)                         \
  (p)->lpVtbl->GetTypeInfo(p, a, b, c)
#define IDirectInputJoyConfig8_SetTypeInfo(p, a, b, c, d)                      \
...
#define IDirectInputJoyConfig8_GetConfig(p, a, b, c)                           \
  (p)->lpVtbl->GetConfig(p, a, b, c)
#define IDirectInputJoyConfig8_SetConfig(p, a, b, c)                           \
  (p)->lpVtbl->SetConfig(p, a, b, c)
#define IDirectInputJoyConfig8_DeleteConfig(p, a)                              \
  (p)->lpVtbl->DeleteConfig(p, a)
#define IDirectInputJoyConfig8_GetUserValues(p, a, b)                          \
  (p)->lpVtbl->GetUserValues(p, a, b)
#define IDirectInputJoyConfig8_SetUserValues(p, a, b)                          \
  (p)->lpVtbl->SetUserValues(p, a, b)
#define IDirectInputJoyConfig8_AddNewHardware(p, a, b)                         \
  (p)->lpVtbl->AddNewHardware(p, a, b)
#define IDirectInputJoyConfig8_OpenTypeKey(p, a, b, c)                         \
  (p)->lpVtbl->OpenTypeKey(p, a, b, c)
#define IDirectInputJoyConfig8_OpenAppStatusKey(p, a)                          \
...
#define DIRECTINPUT_NOTIFICATION_MSGSTRINGW                                    \
  L"DIRECTINPUT_NOTIFICATION_MSGSTRING"
