...
typedef interface IDirectDrawMediaSampleAllocator
...
typedef struct IDirectShowStreamVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDirectShowStream *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDirectShowStream *This);
...
#define IDirectShowStream_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)

#define IDirectShowStream_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
IDirectShowStream_get_FileName_Proxy(IDirectShowStream *This,
                                     /* [retval][out] */ BSTR *pVal);
...
IDirectShowStream_put_FileName_Proxy(IDirectShowStream *This,
                                     /* [in] */ BSTR newVal);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
IDirectShowStream_get_Video_Proxy(IDirectShowStream *This,
                                  /* [retval][out] */ OUTPUT_STATE *pVal);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE
IDirectShowStream_put_Video_Proxy(IDirectShowStream *This,
                                  /* [in] */ OUTPUT_STATE newVal);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE
IDirectShowStream_get_Audio_Proxy(IDirectShowStream *This,
                                  /* [retval][out] */ OUTPUT_STATE *pVal);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE
IDirectShowStream_put_Audio_Proxy(IDirectShowStream *This,
                                  /* [in] */ OUTPUT_STATE newVal);
...
#define IAMMultiMediaStream_Initialize(This, StreamType, dwFlags,              \
                                       pFilterGraph)                           \
...
#define IAMMultiMediaStream_AddMediaStream(This, pStreamObject, PurposeId,     \
                                           dwFlags, ppNewStream)               \
  (This)->lpVtbl->AddMediaStream(This, pStreamObject, PurposeId, dwFlags,      \
                                 ppNewStream)
...
IAMMultiMediaStream_Initialize_Proxy(IAMMultiMediaStream *This,
                                     /* [in] */ STREAM_TYPE StreamType,
                                     /* [in] */ DWORD dwFlags,
                                     /* [in] */ IGraphBuilder *pFilterGraph);
...
HRESULT STDMETHODCALLTYPE
IAMMultiMediaStream_GetFilter_Proxy(IAMMultiMediaStream *This,
                                    /* [out] */ IMediaStreamFilter **ppFilter);
...
HRESULT STDMETHODCALLTYPE
IAMMultiMediaStream_OpenFile_Proxy(IAMMultiMediaStream *This,
                                   /* [in] */ LPCWSTR pszFileName,
                                   /* [in] */ DWORD dwFlags);
...
HRESULT STDMETHODCALLTYPE
IAMMultiMediaStream_OpenMoniker_Proxy(IAMMultiMediaStream *This,
                                      /* [in] */ IBindCtx *pCtx,
                                      /* [in] */ IMoniker *pMoniker,
                                      /* [in] */ DWORD dwFlags);
...
HRESULT STDMETHODCALLTYPE
IAMMultiMediaStream_Render_Proxy(IAMMultiMediaStream *This,
                                 /* [in] */ DWORD dwFlags);
...
typedef struct IAMMediaStreamVtbl {
  ...
  (IAMMediaStream *This, DWORD dwFlags);
...
interface IAMMediaStream { CONST_VTBL struct IAMMediaStreamVtbl *lpVtbl; };
...
#define IAMMediaStream_SetSameFormat(This, pStreamThatHasDesiredFormat,        \
                                     dwFlags)                                  \
...
#define IAMMediaStream_CreateSharedSample(This, pExistingSample, dwFlags,      \
                                          ppNewSample)                         \
  (This)->lpVtbl->CreateSharedSample(This, pExistingSample, dwFlags,           \
                                     ppNewSample)

#define IAMMediaStream_SendEndOfStream(This, dwFlags)                          \
  (This)->lpVtbl->SendEndOfStream(This, dwFlags)

#define IAMMediaStream_Initialize(This, pSourceObject, dwFlags, PurposeId,     \
                                  StreamType)                                  \
  (This)->lpVtbl->Initialize(This, pSourceObject, dwFlags, PurposeId,          \
                             StreamType)
...
HRESULT STDMETHODCALLTYPE
IAMMediaStream_Initialize_Proxy(IAMMediaStream *This,
                                /* [in] */ IUnknown *pSourceObject,
                                /* [in] */ DWORD dwFlags,
                                /* [in] */ REFMSPID PurposeId,
                                /* [in] */ const STREAM_TYPE StreamType);
...
HRESULT STDMETHODCALLTYPE
IAMMediaStream_SetState_Proxy(IAMMediaStream *This,
                              /* [in] */ FILTER_STATE State);
...
HRESULT STDMETHODCALLTYPE
IAMMediaStream_JoinFilterGraph_Proxy(IAMMediaStream *This,
                                     /* [in] */ IFilterGraph *pFilterGraph);
...
typedef struct IMediaStreamFilterVtbl {
  ...
  (IMediaStreamFilter *This, REFERENCE_TIME tStart);
...
HRESULT STDMETHODCALLTYPE
IMediaStreamFilter_SupportSeeking_Proxy(IMediaStreamFilter *This,
                                        /* [in] */ BOOL bRenderer);
...
HRESULT STDMETHODCALLTYPE
IMediaStreamFilter_WaitUntil_Proxy(IMediaStreamFilter *This,
                                   /* [in] */ REFERENCE_TIME WaitStreamTime);
...
HRESULT STDMETHODCALLTYPE
IMediaStreamFilter_Flush_Proxy(IMediaStreamFilter *This,
                               /* [in] */ BOOL bCancelEOS);
...
HRESULT STDMETHODCALLTYPE
IMediaStreamFilter_EndOfStream_Proxy(IMediaStreamFilter *This);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetDirectDraw(IDirectDraw *
                                                  *ppDirectDraw) = 0;
};
...
typedef struct IDirectDrawMediaSampleAllocatorVtbl {
  ...
  (IDirectDrawMediaSampleAllocator *This, IDirectDraw **ppDirectDraw);
...
#define IDirectDrawMediaSample_GetSurfaceAndReleaseLock(                       \
    This, ppDirectDrawSurface, pRect)                                          \
...
typedef struct IAMMediaTypeStreamVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SendEndOfStream)
  (IAMMediaTypeStream *This, DWORD dwFlags);
...
#define IAMMediaTypeStream_SetSameFormat(This, pStreamThatHasDesiredFormat,    \
                                         dwFlags)                              \
  (This)->lpVtbl->SetSameFormat(This, pStreamThatHasDesiredFormat, dwFlags)
...
#define IAMMediaTypeStream_CreateSharedSample(This, pExistingSample, dwFlags,  \
                                              ppNewSample)                     \
  (This)->lpVtbl->CreateSharedSample(This, pExistingSample, dwFlags,           \
                                     ppNewSample)
...
#define IAMMediaTypeStream_CreateSample(This, lSampleSize, pbBuffer, dwFlags,  \
                                        pUnkOuter, ppAMMediaTypeSample)        \
  (This)->lpVtbl->CreateSample(This, lSampleSize, pbBuffer, dwFlags,           \
                               pUnkOuter, ppAMMediaTypeSample)
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeStream_GetFormat_Proxy(IAMMediaTypeStream *This,
                                   /* [out] */ AM_MEDIA_TYPE *pMediaType,
                                   /* [in] */ DWORD dwFlags);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeStream_SetFormat_Proxy(IAMMediaTypeStream *This,
                                   /* [in] */ AM_MEDIA_TYPE *pMediaType,
                                   /* [in] */ DWORD dwFlags);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetActualDataLength(long __MIDL_0020) = 0;
...
typedef struct IAMMediaTypeSampleVtbl {
  ...
  (IAMMediaTypeSample *This, BOOL bIsSyncPoint);

  HRESULT(STDMETHODCALLTYPE *IsPreroll)(IAMMediaTypeSample *This);

  HRESULT(STDMETHODCALLTYPE *SetPreroll)
  (IAMMediaTypeSample *This, BOOL bIsPreroll);

  long(STDMETHODCALLTYPE *GetActualDataLength)(IAMMediaTypeSample *This);

  HRESULT(STDMETHODCALLTYPE *SetActualDataLength)
  (IAMMediaTypeSample *This, long __MIDL_0020);

  HRESULT(STDMETHODCALLTYPE *GetMediaType)
  (IAMMediaTypeSample *This, AM_MEDIA_TYPE **ppMediaType);

  HRESULT(STDMETHODCALLTYPE *SetMediaType)
  (IAMMediaTypeSample *This, AM_MEDIA_TYPE *pMediaType);

  HRESULT(STDMETHODCALLTYPE *IsDiscontinuity)(IAMMediaTypeSample *This);

  HRESULT(STDMETHODCALLTYPE *SetDiscontinuity)
  (IAMMediaTypeSample *This, BOOL bDiscontinuity);
...
#define IAMMediaTypeSample_GetSampleTimes(This, pStartTime, pEndTime,          \
                                          pCurrentTime)                        \
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_SetPointer_Proxy(IAMMediaTypeSample *This,
                                    /* [in] */ BYTE *pBuffer,
                                    /* [in] */ long lSize);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_GetPointer_Proxy(IAMMediaTypeSample *This,
                                    /* [out] */ BYTE **ppBuffer);
...
IAMMediaTypeSample_GetSize_Proxy(IAMMediaTypeSample *This);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_GetTime_Proxy(IAMMediaTypeSample *This,
                                 /* [out] */ REFERENCE_TIME *pTimeStart,
                                 /* [out] */ REFERENCE_TIME *pTimeEnd);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_SetTime_Proxy(IAMMediaTypeSample *This,
                                 /* [in] */ REFERENCE_TIME *pTimeStart,
                                 /* [in] */ REFERENCE_TIME *pTimeEnd);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_IsSyncPoint_Proxy(IAMMediaTypeSample *This);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_IsPreroll_Proxy(IAMMediaTypeSample *This);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_SetPreroll_Proxy(IAMMediaTypeSample *This, BOOL bIsPreroll);
...
long STDMETHODCALLTYPE
IAMMediaTypeSample_GetActualDataLength_Proxy(IAMMediaTypeSample *This);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_IsDiscontinuity_Proxy(IAMMediaTypeSample *This);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_GetMediaTime_Proxy(IAMMediaTypeSample *This,
                                      /* [out] */ LONGLONG *pTimeStart,
                                      /* [out] */ LONGLONG *pTimeEnd);
...
HRESULT STDMETHODCALLTYPE
IAMMediaTypeSample_SetMediaTime_Proxy(IAMMediaTypeSample *This,
                                      /* [in] */ LONGLONG *pTimeStart,
                                      /* [in] */ LONGLONG *pTimeEnd);
...
DEFINE_GUID(CLSID_AMDirectDrawStream, /* 49c47ce4-9ba4-11d0-8212-00c04fc32c45 */
            0x49c47ce4, 0x9ba4, 0x11d0, 0x82, 0x12, 0x00, 0xc0, 0x4f, 0xc3,
            0x2c, 0x45);
DEFINE_GUID(CLSID_AMAudioStream, /* 8496e040-af4c-11d0-8212-00c04fc32c45 */
            0x8496e040, 0xaf4c, 0x11d0, 0x82, 0x12, 0x00, 0xc0, 0x4f, 0xc3,
            0x2c, 0x45);
DEFINE_GUID(CLSID_AMAudioData, /* f2468580-af8a-11d0-8212-00c04fc32c45 */
            0xf2468580, 0xaf8a, 0x11d0, 0x82, 0x12, 0x00, 0xc0, 0x4f, 0xc3,
            0x2c, 0x45);
DEFINE_GUID(CLSID_AMMediaTypeStream, /* CF0F2F7C-F7BF-11d0-900D-00C04FD9189D */
            0xcf0f2f7c, 0xf7bf, 0x11d0, 0x90, 0xd, 0x0, 0xc0, 0x4f, 0xd9, 0x18,
            0x9d);
