...
typedef enum { KSRESET_BEGIN, KSRESET_END } KSRESET;
...
typedef KSIDENTIFIER KSPROPERTY, *PKSPROPERTY, KSMETHOD, *PKSMETHOD, KSEVENT,
    *PKSEVENT;
...
typedef enum { KSPROPERTY_GENERAL_COMPONENTID } KSPROPERTY_GENERAL;
...
#define DEFINE_KSPROPERTY_ITEM_GENERAL_COMPONENTID(Handler)                    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_GENERAL_COMPONENTID, (Handler),            \
                         sizeof(KSPROPERTY), sizeof(KSCOMPONENTID), NULL,      \
                         NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_CAPABILITIES(Handler)              \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_CAPABILITIES, (Handler),      \
                         sizeof(KSPROPERTY), sizeof(KS_SEEKING_CAPABILITIES),  \
                         NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_FORMATS(Handler)                   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_FORMATS, (Handler),           \
                         sizeof(KSPROPERTY), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_TIMEFORMAT(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_TIMEFORMAT, (GetHandler),     \
                         sizeof(KSPROPERTY), sizeof(GUID), (SetHandler), NULL, \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_POSITION(Handler)                  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_POSITION, (Handler),          \
                         sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0,  \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_STOPPOSITION(Handler)              \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_STOPPOSITION, (Handler),      \
                         sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0,  \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_POSITIONS(Handler)                 \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_POSITIONS, NULL,              \
                         sizeof(KSPROPERTY), sizeof(KSPROPERTY_POSITIONS),     \
                         (Handler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_DURATION(Handler)                  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_DURATION, (Handler),          \
                         sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0,  \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_AVAILABLE(Handler)                 \
  DEFINE_KSPROPERTY_ITEM(                                                      \
      KSPROPERTY_MEDIASEEKING_AVAILABLE, (Handler), sizeof(KSPROPERTY),        \
      sizeof(KSPROPERTY_MEDIAAVAILABLE), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_PREROLL(Handler)                   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_PREROLL, (Handler),           \
                         sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0,  \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_MEDIASEEKING_CONVERTTIMEFORMAT(Handler)         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEDIASEEKING_CONVERTTIMEFORMAT, (Handler), \
                         sizeof(KSP_TIMEFORMAT), sizeof(LONGLONG), NULL, NULL, \
                         0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_TOPOLOGY_CATEGORIES(Handler)                    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_TOPOLOGY_CATEGORIES, (Handler),            \
                         sizeof(KSPROPERTY), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_TOPOLOGY_NODES(Handler)                         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_TOPOLOGY_NODES, (Handler),                 \
                         sizeof(KSPROPERTY), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_TOPOLOGY_CONNECTIONS(Handler)                   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_TOPOLOGY_CONNECTIONS, (Handler),           \
                         sizeof(KSPROPERTY), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_TOPOLOGY_NAME(Handler)                          \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_TOPOLOGY_NAME, (Handler),                  \
                         sizeof(KSP_NODE), 0, NULL, NULL, 0, NULL, NULL, 0)
...
typedef VOID (*PFNKSGRAPHMANAGER_NOTIFY)(IN PFILE_OBJECT GraphManager,
                                         IN ULONG EventId, IN PVOID Filter,
                                         IN PVOID Pin, IN PVOID Frame,
                                         IN ULONG Duration);
...
typedef enum { KSINTERFACE_FILEIO_STREAMING } KSINTERFACE_FILEIO;
...
#define KSDATAFORMAT_TEMPORAL_COMPRESSION                                      \
...
#define KSDATARANGE_REQUIRED_ATTRIBUTES                                        \
...
#if defined(_NTDDK_)
typedef NTSTATUS (*PFNKSINTERSECTHANDLER)(IN PIRP Irp, IN PKSP_PIN Pin,
                                          IN PKSDATARANGE DataRange,
                                          OUT PVOID Data OPTIONAL);
typedef NTSTATUS (*PFNKSINTERSECTHANDLEREX)(
    IN PVOID Context, IN PIRP Irp, IN PKSP_PIN Pin, IN PKSDATARANGE DataRange,
...
#define DEFINE_KSPROPERTY_ITEM_PIN_CINSTANCES(Handler)                         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_CINSTANCES, (Handler),                 \
                         sizeof(KSP_PIN), sizeof(KSPIN_CINSTANCES), NULL,      \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_CTYPES(Handler)                             \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_CTYPES, (Handler), sizeof(KSPROPERTY), \
                         sizeof(ULONG), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_DATAFLOW(Handler)                           \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_DATAFLOW, (Handler), sizeof(KSP_PIN),  \
                         sizeof(KSPIN_DATAFLOW), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_DATARANGES(Handler)                         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_DATARANGES, (Handler),                 \
                         sizeof(KSP_PIN), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_DATAINTERSECTION(Handler)                   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_DATAINTERSECTION, (Handler),           \
                         sizeof(KSP_PIN) + sizeof(KSMULTIPLE_ITEM), 0, NULL,   \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_INTERFACES(Handler)                         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_INTERFACES, (Handler),                 \
                         sizeof(KSP_PIN), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_MEDIUMS(Handler)                            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_MEDIUMS, (Handler), sizeof(KSP_PIN),   \
                         0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_COMMUNICATION(Handler)                      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_COMMUNICATION, (Handler),              \
                         sizeof(KSP_PIN), sizeof(KSPIN_COMMUNICATION), NULL,   \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_GLOBALCINSTANCES(Handler)                   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_GLOBALCINSTANCES, (Handler),           \
                         sizeof(KSP_PIN), sizeof(KSPIN_CINSTANCES), NULL,      \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_NECESSARYINSTANCES(Handler)                 \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_NECESSARYINSTANCES, (Handler),         \
                         sizeof(KSP_PIN), sizeof(ULONG), NULL, NULL, 0, NULL,  \
                         NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_PHYSICALCONNECTION(Handler)                 \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_PHYSICALCONNECTION, (Handler),         \
                         sizeof(KSP_PIN), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_CATEGORY(Handler)                           \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_CATEGORY, (Handler), sizeof(KSP_PIN),  \
                         sizeof(GUID), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_NAME(Handler)                               \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_NAME, (Handler), sizeof(KSP_PIN), 0,   \
                         NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_CONSTRAINEDDATARANGES(Handler)              \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_CONSTRAINEDDATARANGES, (Handler),      \
                         sizeof(KSP_PIN), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_PIN_PROPOSEDATAFORMAT(Handler)                  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_PIN_PROPOSEDATAFORMAT, NULL,               \
                         sizeof(KSP_PIN), sizeof(KSDATAFORMAT), (Handler),     \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_PINSET(PinSet, PropGeneral, PropInstances,           \
                                 PropIntersection)                             \
...
#define DEFINE_KSPROPERTY_PINSETCONSTRAINED(PinSet, PropGeneral,               \
                                            PropInstances, PropIntersection)   \
  DEFINE_KSPROPERTY_TABLE(PinSet) {                                            \
    DEFINE_KSPROPERTY_ITEM_PIN_CINSTANCES(PropInstances),                      \
        DEFINE_KSPROPERTY_ITEM_PIN_CTYPES(PropGeneral),                        \
        DEFINE_KSPROPERTY_ITEM_PIN_DATAFLOW(PropGeneral),                      \
...
#define DEFINE_KSPIN_DESCRIPTOR_ITEM(InterfacesCount, Interfaces,              \
                                     MediumsCount, Mediums, DataRangesCount,   \
                                     DataRanges, DataFlow, Communication)      \
  {InterfacesCount,                                                            \
   Interfaces,                                                                 \
   MediumsCount,                                                               \
   Mediums,                                                                    \
...
#define DEFINE_KSPIN_DESCRIPTOR_ITEMEX(                                        \
    InterfacesCount, Interfaces, MediumsCount, Mediums, DataRangesCount,       \
...
#define KSDATAFORMAT_SPECIFIER_FILENAME                                        \
...
#define KSDATAFORMAT_SPECIFIER_FILEHANDLE                                      \
...
#define DEFINE_KSPROPERTY_ITEM_QUALITY_REPORT(GetHandler, SetHandler)          \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_QUALITY_REPORT, (GetHandler),              \
                         sizeof(KSPROPERTY), sizeof(KSQUALITY), (SetHandler),  \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_QUALITY_ERROR(GetHandler, SetHandler)           \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_QUALITY_ERROR, (GetHandler),               \
                         sizeof(KSPROPERTY), sizeof(KSERROR), (SetHandler),    \
                         NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_CONNECTION_STATE(GetHandler, SetHandler)        \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_STATE, (GetHandler),            \
                         sizeof(KSPROPERTY), sizeof(KSSTATE), (SetHandler),    \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_PRIORITY(GetHandler, SetHandler)     \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_PRIORITY, (GetHandler),         \
                         sizeof(KSPROPERTY), sizeof(KSPRIORITY), (SetHandler), \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_DATAFORMAT(GetHandler, SetHandler)   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_DATAFORMAT, (GetHandler),       \
                         sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, NULL,   \
                         NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ALLOCATORFRAMING(Handler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ALLOCATORFRAMING, (Handler),    \
                         sizeof(KSPROPERTY), sizeof(KSALLOCATOR_FRAMING),      \
                         NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ALLOCATORFRAMING_EX(Handler)         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ALLOCATORFRAMING_EX, (Handler), \
                         sizeof(KSPROPERTY), 0, NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_PROPOSEDATAFORMAT(Handler)           \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_PROPOSEDATAFORMAT, NULL,        \
                         sizeof(KSPROPERTY), sizeof(KSDATAFORMAT), (Handler),  \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_ACQUIREORDERING(Handler)             \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_ACQUIREORDERING, (Handler),     \
                         sizeof(KSPROPERTY), sizeof(int), NULL, NULL, 0, NULL, \
                         NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CONNECTION_STARTAT(Handler)                     \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CONNECTION_STARTAT, NULL,                  \
                         sizeof(KSPROPERTY), sizeof(KSRELATIVEEVENT),          \
                         (Handler), NULL, 0, NULL, NULL, 0)
...
typedef NTSTATUS (*PFNKSINITIALIZEALLOCATOR)(
    IN PVOID InitialContext, IN PKSALLOCATOR_FRAMING AllocatorFraming,
    OUT PVOID *Context);
...
// Easiest to use but takes a little more memory than the varsize layout
// Pin\Memories\Buses\Ranges.
//
typedef struct {
  GUID MemoryType;
  GUID BusType;
...
#define KSMEMORY_TYPE_KERNEL_NONPAGED                                          \
...
#define KSMEMORY_TYPE_DEVICE_UNKNOWN                                           \
  DEFINE_GUIDNAMED(KSMEMORY_TYPE_DEVICE_UNKNOWN)

//
// Helper framing macros.
//
#define DECLARE_SIMPLE_FRAMING_EX(FramingExName, MemoryType, Flags, Frames,    \
                                  Alignment, MinFrameSize, MaxFrameSize)       \
...
#define SetKsFramingRange(KsFramingRangePointer, P_MinFrameSize,               \
                          P_MaxFrameSize)                                      \
  {                                                                            \
...
#define INITIALIZE_SIMPLE_FRAMING_EX(FramingExPointer, P_MemoryType, P_Flags,  \
                                     P_Frames, P_Alignment, P_MinFrameSize,    \
                                     P_MaxFrameSize)                           \
  {                                                                            \
    ...
    SetKsFramingRangeWeighted(KsFramingRangeWeighted, P_MinFrameSize,          \
                              P_MaxFrameSize);                                 \
  }
...
#define DEFINE_KSMETHOD_ITEM_STREAMALLOCATOR_ALLOC(Handler)                    \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMALLOCATOR_ALLOC, KSMETHOD_TYPE_WRITE,    \
                       (Handler), sizeof(KSMETHOD), sizeof(PVOID), NULL)

#define DEFINE_KSMETHOD_ITEM_STREAMALLOCATOR_FREE(Handler)                     \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_STREAMALLOCATOR_FREE, KSMETHOD_TYPE_READ,      \
                       (Handler), sizeof(KSMETHOD), sizeof(PVOID), NULL)
...
#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_FUNCTIONTABLE(Handler)          \
  DEFINE_KSPROPERTY_ITEM(                                                      \
      KSPROPERTY_STREAMALLOCATOR_FUNCTIONTABLE, (Handler), sizeof(KSPROPERTY), \
...
#define DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_STATUS(Handler)                 \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMALLOCATOR_STATUS, (Handler),         \
                         sizeof(KSPROPERTY), sizeof(KSSTREAMALLOCATOR_STATUS), \
                         NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ALLOCATORSET(AllocatorSet, PropFunctionTable,        \
                                       PropStatus)                             \
  DEFINE_KSPROPERTY_TABLE(AllocatorSet) {                                      \
    DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_STATUS(PropStatus),                 \
        DEFINE_KSPROPERTY_ITEM_STREAMALLOCATOR_FUNCTIONTABLE(                  \
            PropFunctionTable)                                                 \
  }

typedef NTSTATUS (*PFNALLOCATOR_ALLOCATEFRAME)(IN PFILE_OBJECT FileObject,
                                               PVOID *Frame);

typedef VOID (*PFNALLOCATOR_FREEFRAME)(IN PFILE_OBJECT FileObject,
                                       IN PVOID Frame);
...
#define DEFINE_KSPROPERTY_ITEM_STREAMINTERFACE_HEADERSIZE(GetHandler)          \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAMINTERFACE_HEADERSIZE, (GetHandler),  \
...
#define DEFINE_KSPROPERTY_ITEM_STREAM_ALLOCATOR(GetHandler, SetHandler)        \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_ALLOCATOR, (GetHandler),            \
                         sizeof(KSPROPERTY), sizeof(HANDLE), (SetHandler),     \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_QUALITY(Handler)                         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_QUALITY, (Handler),                 \
                         sizeof(KSPROPERTY), sizeof(KSQUALITY_MANAGER), NULL,  \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_DEGRADATION(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_DEGRADATION, (GetHandler),          \
                         sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, NULL,   \
                         NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_MASTERCLOCK(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_MASTERCLOCK, (GetHandler),          \
                         sizeof(KSPROPERTY), sizeof(HANDLE), (SetHandler),     \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_TIMEFORMAT(Handler)                      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_TIMEFORMAT, (Handler),              \
                         sizeof(KSPROPERTY), sizeof(GUID), NULL, NULL, 0,      \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_PRESENTATIONTIME(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_PRESENTATIONTIME, (GetHandler),     \
                         sizeof(KSPROPERTY), sizeof(KSTIME), (SetHandler),     \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_PRESENTATIONEXTENT(Handler)              \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_PRESENTATIONEXTENT, (Handler),      \
                         sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0,  \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_FRAMETIME(Handler)                       \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_FRAMETIME, (Handler),               \
                         sizeof(KSPROPERTY), sizeof(KSFRAMETIME), NULL, NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_RATECAPABILITY(Handler)                  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_RATECAPABILITY, (Handler),          \
                         sizeof(KSRATE_CAPABILITY), sizeof(KSRATE), NULL,      \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_RATE(GetHandler, SetHandler)             \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_RATE, (GetHandler),                 \
                         sizeof(KSPROPERTY), sizeof(KSRATE), (SetHandler),     \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_STREAM_PIPE_ID(GetHandler, SetHandler)          \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_STREAM_PIPE_ID, (GetHandler),              \
                         sizeof(KSPROPERTY), sizeof(HANDLE), (SetHandler),     \
                         NULL, 0, NULL, NULL, 0)
...
// upper 32 bits.
//
// (xh * 10000000 / Frequency) * 2^32 + ((((xh * 10000000) % Frequency) * 2^32 +
// (xl * 10000000)) / Frequency)
//
...
typedef BOOLEAN (*PFNKSSETTIMER)(IN PVOID Context, IN PKTIMER Timer,
                                 IN LARGE_INTEGER DueTime, IN PKDPC Dpc);

typedef BOOLEAN (*PFNKSCANCELTIMER)(IN PVOID Context, IN PKTIMER Timer);

typedef LONGLONG(FASTCALL *PFNKSCORRELATEDTIME)(IN PVOID Context,
                                                OUT PLONGLONG SystemTime);

typedef PVOID PKSDEFAULTCLOCK;

#define DEFINE_KSPROPERTY_ITEM_CLOCK_TIME(Handler)                             \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_TIME, (Handler), sizeof(KSPROPERTY), \
                         sizeof(LONGLONG), NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_PHYSICALTIME(Handler)                     \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_PHYSICALTIME, (Handler),             \
                         sizeof(KSPROPERTY), sizeof(LONGLONG), NULL, NULL, 0,  \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_CORRELATEDTIME(Handler)                   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_CORRELATEDTIME, (Handler),           \
                         sizeof(KSPROPERTY), sizeof(KSCORRELATED_TIME), NULL,  \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_CORRELATEDPHYSICALTIME(Handler)           \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_CORRELATEDPHYSICALTIME, (Handler),   \
                         sizeof(KSPROPERTY), sizeof(KSCORRELATED_TIME), NULL,  \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_RESOLUTION(Handler)                       \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_RESOLUTION, (Handler),               \
                         sizeof(KSPROPERTY), sizeof(KSRESOLUTION), NULL, NULL, \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_STATE(Handler)                            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_STATE, (Handler),                    \
                         sizeof(KSPROPERTY), sizeof(KSSTATE), NULL, NULL, 0,   \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_CLOCK_FUNCTIONTABLE(Handler)                    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CLOCK_FUNCTIONTABLE, (Handler),            \
                         sizeof(KSPROPERTY), sizeof(KSCLOCK_FUNCTIONTABLE),    \
                         NULL, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_CLOCKSET(                                            \
    ClockSet, PropTime, PropPhysicalTime, PropCorrelatedTime,                  \
...
typedef NTSTATUS (*PFNKSHANDLER)(IN PIRP Irp, IN PKSIDENTIFIER Request,
                                 IN OUT PVOID Data);

typedef BOOLEAN (*PFNKSFASTHANDLER)(IN PFILE_OBJECT FileObject,
                                    IN PKSIDENTIFIER Request,
                                    IN ULONG RequestLength, IN OUT PVOID Data,
                                    IN ULONG DataLength,
                                    OUT PIO_STATUS_BLOCK IoStatus);

typedef NTSTATUS (*PFNKSALLOCATOR)(IN PIRP Irp, IN ULONG BufferSize,
...
#define DEFINE_KSPROPERTY_ITEM(PropertyId, GetHandler, MinProperty, MinData,   \
                               SetHandler, Values, RelationsCount, Relations,  \
...
#define DEFINE_KSPROPERTY_SET(Set, PropertiesCount, PropertyItem, FastIoCount, \
                              FastIoTable)                                     \
...
#define DEFINE_KSMETHOD_ITEM(MethodId, Flags, MethodHandler, MinMethod,        \
                             MinData, SupportHandler)                          \
  {MethodId, (PFNKSHANDLER)MethodHandler, MinMethod, MinData, SupportHandler,  \
   Flags}
...
#define DEFINE_KSMETHOD_SET(Set, MethodsCount, MethodItem, FastIoCount,        \
                            FastIoTable)                                       \
...
typedef NTSTATUS (*PFNKSADDEVENT)(IN PIRP Irp, IN PKSEVENTDATA EventData,
                                  IN struct _KSEVENT_ENTRY *EventEntry);

typedef VOID (*PFNKSREMOVEEVENT)(IN PFILE_OBJECT FileObject,
                                 IN struct _KSEVENT_ENTRY *EventEntry);

#define DEFINE_KSEVENT_TABLE(tablename) const KSEVENT_ITEM tablename[] =

#define DEFINE_KSEVENT_ITEM(EventId, DataInput, ExtraEntryData, AddHandler,    \
                            RemoveHandler, SupportHandler)                     \
...
#define DEFINE_KSCREATE_ITEM(DispatchCreate, TypeName, Context)                \
  {(DispatchCreate),                                                           \
   (PVOID)(Context),                                                           \
   {sizeof(TypeName) - sizeof(UNICODE_NULL), sizeof(TypeName),                 \
    (PWCHAR)(TypeName)},                                                       \
   NULL,                                                                       \
   0}
...
#define DEFINE_KSDISPATCH_TABLE(tablename, DeviceIoControl, Read, Write,       \
  ...
  const KSDISPATCH_TABLE tablename = {                                         \
      DeviceIoControl, Read,          Write,       Flush,                      \
      Close,           QuerySecurity, SetSecurity, FastDeviceIoControl,        \
      FastRead,        FastWrite,                                              \
  }
...
typedef enum { KsListEntryTail, KsListEntryHead } KSLIST_ENTRY_LOCATION;
...
typedef enum { KSTARGET_STATE_DISABLED, KSTARGET_STATE_ENABLED } KSTARGET_STATE;
...
typedef NTSTATUS (*PFNQUERYREFERENCESTRING)(IN PVOID Context,
...
typedef NTSTATUS (*PFNQUERYMEDIUMSLIST)(IN PVOID Context,
...
DEFINE_GUIDSTRUCT("4EC35C3E-201B-11D2-8745-00A0C9223196",
...
void __inline KsGateInitialize(
    IN PKSGATE Gate, IN LONG InitialCount, IN PKSGATE NextGate OPTIONAL,
...
void __inline KsGateInitializeAnd(IN PKSGATE AndGate,
                                  IN PKSGATE NextOrGate OPTIONAL) {
  KsGateInitialize(AndGate, 1, NextOrGate, TRUE);
}

void __inline KsGateInitializeOr(IN PKSGATE OrGate,
...
typedef NTSTATUS (*PFNKSDEVICEQUERYCAPABILITIES)(
    IN PKSDEVICE Device, IN PIRP Irp, IN OUT PDEVICE_CAPABILITIES Capabilities);
typedef NTSTATUS (*PFNKSDEVICEQUERYPOWER)(IN PKSDEVICE Device, IN PIRP Irp,
                                          IN DEVICE_POWER_STATE DeviceTo,
                                          IN DEVICE_POWER_STATE DeviceFrom,
                                          IN SYSTEM_POWER_STATE SystemTo,
                                          IN SYSTEM_POWER_STATE SystemFrom,
                                          IN POWER_ACTION Action);
typedef void (*PFNKSDEVICESETPOWER)(IN PKSDEVICE Device, IN PIRP Irp,
                                    IN DEVICE_POWER_STATE To,
                                    IN DEVICE_POWER_STATE From);
typedef NTSTATUS (*PFNKSFILTERFACTORYVOID)(IN PKSFILTERFACTORY FilterFactory);
typedef void (*PFNKSFILTERFACTORYPOWER)(IN PKSFILTERFACTORY FilterFactory,
                                        IN DEVICE_POWER_STATE State);
typedef NTSTATUS (*PFNKSFILTERIRP)(IN PKSFILTER Filter, IN PIRP Irp);
typedef NTSTATUS (*PFNKSFILTERPROCESS)(IN PKSFILTER Filter,
                                       IN PKSPROCESSPIN_INDEXENTRY Index);
typedef NTSTATUS (*PFNKSFILTERVOID)(IN PKSFILTER Filter);
typedef void (*PFNKSFILTERPOWER)(IN PKSFILTER Filter,
                                 IN DEVICE_POWER_STATE State);
typedef NTSTATUS (*PFNKSPINIRP)(IN PKSPIN Pin, IN PIRP Irp);
typedef NTSTATUS (*PFNKSPINSETDEVICESTATE)(IN PKSPIN Pin, IN KSSTATE ToState,
                                           IN KSSTATE FromState);
typedef NTSTATUS (*PFNKSPINSETDATAFORMAT)(
    IN PKSPIN Pin, IN PKSDATAFORMAT OldFormat OPTIONAL,
    IN PKSMULTIPLE_ITEM OldAttributeList OPTIONAL,
    IN const KSDATARANGE *DataRange,
    IN const KSATTRIBUTE_LIST *AttributeRange OPTIONAL);
typedef NTSTATUS (*PFNKSPINHANDSHAKE)(IN PKSPIN Pin, IN PKSHANDSHAKE In,
                                      IN PKSHANDSHAKE Out);
...
#define DEFINE_KSAUTOMATION_PROPERTIES(table)                                  \
  SIZEOF_ARRAY(table), sizeof(KSPROPERTY_ITEM), table

#define DEFINE_KSAUTOMATION_METHODS(table)                                     \
  SIZEOF_ARRAY(table), sizeof(KSMETHOD_ITEM), table

#define DEFINE_KSAUTOMATION_EVENTS(table)                                      \
  SIZEOF_ARRAY(table), sizeof(KSEVENT_ITEM), table
...
#define DEFINE_KSFILTER_PIN_DESCRIPTORS(table)                                 \
  SIZEOF_ARRAY(table), sizeof(table[0]), table
...
typedef void (*PFNKSPINFRAMERETURN)(IN PKSPIN Pin, IN PVOID Data OPTIONAL,
...
#define DEFINE_ABSTRACT_UNKNOWN()                                              \
  ...
  (THIS_ REFIID InterfaceId, PVOID * Interface) PURE;                          \
...
DECLARE_INTERFACE_(IKsControl, IUnknown) {
  ...
  (THIS_ IN PKSPROPERTY Property, IN ULONG PropertyLength,
   IN OUT PVOID PropertyData, IN ULONG DataLength, OUT ULONG * BytesReturned)
      PURE;
  STDMETHOD_(NTSTATUS, KsMethod)
  (THIS_ IN PKSMETHOD Method, IN ULONG MethodLength, IN OUT PVOID MethodData,
   IN ULONG DataLength, OUT ULONG * BytesReturned) PURE;
  STDMETHOD_(NTSTATUS, KsEvent)
  (THIS_ IN PKSEVENT Event OPTIONAL, IN ULONG EventLength,
   IN OUT PVOID EventData, IN ULONG DataLength, OUT ULONG * BytesReturned) PURE;
};
...
DECLARE_INTERFACE_(IKsReferenceClock, IUnknown) {
  ...
  (THIS_ OUT PLONGLONG SystemTime) PURE;
...
DEFINE_GUID(IID_IKsControl, 0x28F54685L, 0x06FD, 0x11D2, 0xB2, 0x7A, 0x00, 0xA0,
            0xC9, 0x22, 0x31, 0x96);
#if defined(__cplusplus) && _MSC_VER >= 1100
...
DEFINE_GUID(IID_IKsFastClock, 0xc9902485, 0xc180, 0x11d2, 0x84, 0x73, 0xd4,
            0x23, 0x94, 0x45, 0x9e, 0x5e);
#if defined(__cplusplus) && _MSC_VER >= 1100
...
NTSTATUS
NTAPI
KsEnableEvent(IN PIRP Irp, IN ULONG EventSetsCount,
...
NTSTATUS
NTAPI
KsEnableEventWithAllocator(IN PIRP Irp, IN ULONG EventSetsCount,
                           IN const KSEVENT_SET *EventSet,
                           IN OUT PLIST_ENTRY EventsList OPTIONAL,
                           IN KSEVENTS_LOCKTYPE EventsFlags OPTIONAL,
                           IN PVOID EventsLock OPTIONAL,
...
NTSTATUS
NTAPI
KsDisableEvent(IN PIRP Irp, IN OUT PLIST_ENTRY EventsList,
...
KSDDKAPI
VOID NTAPI KsFreeEventList(IN PFILE_OBJECT FileObject,
...
NTSTATUS
NTAPI
KsGenerateDataEvent(IN PKSEVENT_ENTRY EventEntry, IN ULONG DataSize,
                    IN PVOID Data);

KSDDKAPI
VOID NTAPI KsGenerateEventList(IN GUID *Set OPTIONAL, IN ULONG EventId,
...
NTSTATUS
NTAPI
KsPropertyHandler(IN PIRP Irp, IN ULONG PropertySetsCount,
                  IN const KSPROPERTY_SET *PropertySet);

KSDDKAPI
NTSTATUS
NTAPI
KsPropertyHandlerWithAllocator(IN PIRP Irp, IN ULONG PropertySetsCount,
                               IN const KSPROPERTY_SET *PropertySet,
                               IN PFNKSALLOCATOR Allocator OPTIONAL,
...
BOOLEAN
NTAPI
KsFastPropertyHandler(IN PFILE_OBJECT FileObject, IN PKSPROPERTY Property,
                      IN ULONG PropertyLength, IN OUT PVOID Data,
                      IN ULONG DataLength, OUT PIO_STATUS_BLOCK IoStatus,
...
NTSTATUS
NTAPI
KsMethodHandler(IN PIRP Irp, IN ULONG MethodSetsCount,
                IN const KSMETHOD_SET *MethodSet);

KSDDKAPI
NTSTATUS
NTAPI
KsMethodHandlerWithAllocator(IN PIRP Irp, IN ULONG MethodSetsCount,
                             IN const KSMETHOD_SET *MethodSet,
                             IN PFNKSALLOCATOR Allocator OPTIONAL,
...
BOOLEAN
NTAPI
KsFastMethodHandler(IN PFILE_OBJECT FileObject, IN PKSMETHOD Method,
                    IN ULONG MethodLength, IN OUT PVOID Data,
                    IN ULONG DataLength, OUT PIO_STATUS_BLOCK IoStatus,
                    IN ULONG MethodSetsCount, IN const KSMETHOD_SET *MethodSet);
...
KsCreateDefaultAllocatorEx(IN PIRP Irp, IN PVOID InitializeContext OPTIONAL,
                           ...
                           IN PFNKSINITIALIZEALLOCATOR InitializeAllocator
                               OPTIONAL,
...
NTSTATUS
NTAPI
KsValidateAllocatorCreateRequest(IN PIRP Irp,
                                 OUT PKSALLOCATOR_FRAMING *AllocatorFraming);

KSDDKAPI
NTSTATUS
NTAPI
KsValidateAllocatorFramingEx(IN PKSALLOCATOR_FRAMING_EX Framing,
                             IN ULONG BufferSize,
...
NTSTATUS
NTAPI
KsCreateClock(IN HANDLE ConnectionHandle, IN PKSCLOCK_CREATE ClockCreate,
...
KSDDKAPI
VOID NTAPI KsSetDefaultClockState(IN PKSDEFAULTCLOCK DefaultClock,
                                  IN KSSTATE State);
...
KSDDKAPI
VOID NTAPI KsSetDefaultClockTime(IN PKSDEFAULTCLOCK DefaultClock,
                                 IN LONGLONG Time);
...
NTSTATUS
NTAPI
KsCreatePin(IN HANDLE FilterHandle, IN PKSPIN_CONNECT Connect,
            IN ACCESS_MASK DesiredAccess, OUT PHANDLE ConnectionHandle);

KSDDKAPI
NTSTATUS
NTAPI
KsValidateConnectRequest(IN PIRP Irp, IN ULONG DescriptorsCount,
...
NTSTATUS
NTAPI
KsPinPropertyHandler(IN PIRP Irp, IN PKSPROPERTY Property, IN OUT PVOID Data,
...
NTSTATUS
NTAPI
KsPinDataIntersection(IN PIRP Irp, IN PKSP_PIN Pin, OUT PVOID Data OPTIONAL,
                      IN ULONG DescriptorsCount,
                      IN const KSPIN_DESCRIPTOR *Descriptor,
...
NTSTATUS
NTAPI
KsPinDataIntersectionEx(IN PIRP Irp, IN PKSP_PIN Pin, OUT PVOID Data,
                        IN ULONG DescriptorsCount,
                        IN const KSPIN_DESCRIPTOR *Descriptor,
...
NTSTATUS
NTAPI
KsHandleSizedListQuery(IN PIRP Irp, IN ULONG DataItemsCount,
                       IN ULONG DataItemSize, IN const VOID *DataItems);
...
NTSTATUS
NTAPI
KsLoadResource(IN PVOID ImageBase, IN POOL_TYPE PoolType,
               IN ULONG_PTR ResourceName, IN ULONG ResourceType,
               OUT PVOID *Resource, OUT PULONG ResourceSize);

KSDDKAPI
NTSTATUS
NTAPI
KsGetImageNameAndResourceId(IN HANDLE RegKey, OUT PUNICODE_STRING ImageName,
                            OUT PULONG_PTR ResourceId, OUT PULONG ValueType);

KSDDKAPI
NTSTATUS
NTAPI
KsMapModuleName(IN PDEVICE_OBJECT PhysicalDeviceObject,
                IN PUNICODE_STRING ModuleName, OUT PUNICODE_STRING ImageName,
                OUT PULONG_PTR ResourceId, OUT PULONG ValueType);
...
NTSTATUS
NTAPI
KsReadFile(IN PFILE_OBJECT FileObject, IN PKEVENT Event OPTIONAL,
           IN PVOID PortContext OPTIONAL, OUT PIO_STATUS_BLOCK IoStatusBlock,
           OUT PVOID Buffer, IN ULONG Length, IN ULONG Key OPTIONAL,
           IN KPROCESSOR_MODE RequestorMode);

KSDDKAPI
NTSTATUS
NTAPI
KsWriteFile(IN PFILE_OBJECT FileObject, IN PKEVENT Event OPTIONAL,
            IN PVOID PortContext OPTIONAL, OUT PIO_STATUS_BLOCK IoStatusBlock,
            IN PVOID Buffer, IN ULONG Length, IN ULONG Key OPTIONAL,
            IN KPROCESSOR_MODE RequestorMode);

KSDDKAPI
NTSTATUS
NTAPI
KsQueryInformationFile(IN PFILE_OBJECT FileObject, OUT PVOID FileInformation,
                       IN ULONG Length,
...
NTSTATUS
NTAPI
KsSetInformationFile(IN PFILE_OBJECT FileObject, IN PVOID FileInformation,
                     IN ULONG Length,
                     IN FILE_INFORMATION_CLASS FileInformationClass);
...
NTSTATUS
NTAPI
KsStreamIo(IN PFILE_OBJECT FileObject, IN PKEVENT Event OPTIONAL,
           IN PVOID PortContext OPTIONAL,
           IN PIO_COMPLETION_ROUTINE CompletionRoutine OPTIONAL,
           IN PVOID CompletionContext OPTIONAL,
           IN KSCOMPLETION_INVOCATION CompletionInvocationFlags OPTIONAL,
           OUT PIO_STATUS_BLOCK IoStatusBlock, IN OUT PVOID StreamHeaders,
           IN ULONG Length, IN ULONG Flags, IN KPROCESSOR_MODE RequestorMode);

KSDDKAPI
NTSTATUS
NTAPI
KsProbeStreamIrp(IN OUT PIRP Irp, IN ULONG ProbeFlags,
                 IN ULONG HeaderSize OPTIONAL);

KSDDKAPI
NTSTATUS
NTAPI
KsAllocateExtraData(IN OUT PIRP Irp, IN ULONG ExtraSize,
...
KsDispatchFastIoDeviceControlFailure(
    IN PFILE_OBJECT FileObject, IN BOOLEAN Wait, IN PVOID InputBuffer OPTIONAL,
...
KsDispatchFastReadFailure(IN PFILE_OBJECT FileObject,
                          ...
                          IN BOOLEAN Wait, IN ULONG LockKey, OUT PVOID Buffer,
                          OUT PIO_STATUS_BLOCK IoStatus,
...
KSDDKAPI
VOID NTAPI KsReleaseIrpOnCancelableQueue(
    IN PIRP Irp, IN PDRIVER_CANCEL DriverCancel OPTIONAL);

KSDDKAPI
PIRP NTAPI KsRemoveIrpFromCancelableQueue(
    IN OUT PLIST_ENTRY QueueHead, IN PKSPIN_LOCK SpinLock,
...
KSDDKAPI
VOID NTAPI KsAddIrpToCancelableQueue(IN OUT PLIST_ENTRY QueueHead,
                                     IN PKSPIN_LOCK SpinLock, IN PIRP Irp,
                                     IN KSLIST_ENTRY_LOCATION ListLocation,
...
NTSTATUS
NTAPI
KsTopologyPropertyHandler(IN PIRP Irp, IN PKSPROPERTY Property,
                          IN OUT PVOID Data, IN const KSTOPOLOGY *Topology);

KSDDKAPI
VOID NTAPI KsAcquireDeviceSecurityLock(IN KSDEVICE_HEADER Header,
...
KSDDKAPI
VOID NTAPI KsSetDevicePnpAndBaseObject(IN KSDEVICE_HEADER Header,
...
KSDDKAPI
VOID NTAPI KsRecalculateStackDepth(IN KSDEVICE_HEADER Header,
                                   IN BOOLEAN ReuseStackLocation);

KSDDKAPI
VOID NTAPI KsSetTargetState(IN KSOBJECT_HEADER Header,
                            IN KSTARGET_STATE TargetState);

KSDDKAPI
VOID NTAPI KsSetTargetDeviceObject(IN KSOBJECT_HEADER Header,
                                   IN PDEVICE_OBJECT TargetDevice OPTIONAL);

KSDDKAPI
VOID NTAPI KsSetPowerDispatch(IN KSOBJECT_HEADER Header,
...
KsAllocateObjectHeader(OUT KSOBJECT_HEADER *Header, IN ULONG ItemsCount,
                       IN PKSOBJECT_CREATE_ITEM ItemsList OPTIONAL, IN PIRP Irp,
...
KsAddObjectCreateItemToDeviceHeader(
    IN KSDEVICE_HEADER Header, IN PDRIVER_DISPATCH Create, IN PVOID Context,
...
KsAddObjectCreateItemToObjectHeader(
    IN KSOBJECT_HEADER Header, IN PDRIVER_DISPATCH Create, IN PVOID Context,
    IN PWCHAR ObjectClass, IN PSECURITY_DESCRIPTOR SecurityDescriptor OPTIONAL);
...
NTSTATUS
NTAPI
KsForwardIrp(IN PIRP Irp, IN PFILE_OBJECT FileObject,
             IN BOOLEAN ReuseStackLocation);

KSDDKAPI
NTSTATUS
NTAPI
KsForwardAndCatchIrp(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp,
                     IN PFILE_OBJECT FileObject, IN KSSTACK_USE StackUse);
...
KsSynchronousIoControlDevice(IN PFILE_OBJECT FileObject,
                             IN KPROCESSOR_MODE RequestorMode,
                             IN ULONG IoControl, IN PVOID InBuffer,
                             IN ULONG InSize, OUT PVOID OutBuffer,
                             IN ULONG OutSize, OUT PULONG BytesReturned);

KSDDKAPI
NTSTATUS
NTAPI
KsUnserializeObjectPropertiesFromRegistry(
    IN PFILE_OBJECT FileObject, IN HANDLE ParentKey OPTIONAL,
    IN PUNICODE_STRING RegistryPath OPTIONAL);

KSDDKAPI
NTSTATUS
NTAPI
KsCacheMedium(IN PUNICODE_STRING SymbolicLink, IN PKSPIN_MEDIUM Medium,
...
NTSTATUS
NTAPI
KsCreateTopologyNode(IN HANDLE ParentHandle, IN PKSNODE_CREATE NodeCreate,
                     IN ACCESS_MASK DesiredAccess, OUT PHANDLE NodeHandle);

KSDDKAPI
NTSTATUS
NTAPI
KsValidateTopologyNodeCreateRequest(IN PIRP Irp, IN PKSTOPOLOGY Topology,
...
KsCreateDevice(IN PDRIVER_OBJECT DriverObject,
               IN PDEVICE_OBJECT PhysicalDeviceObject,
               IN const KSDEVICE_DESCRIPTOR *Descriptor OPTIONAL,
               IN ULONG ExtensionSize OPTIONAL, OUT PKSDEVICE *Device OPTIONAL);
...
KSDDKAPI
void NTAPI KsDeviceRegisterAdapterObject(IN PKSDEVICE Device,
...
ULONG
NTAPI
KsDeviceGetBusData(IN PKSDEVICE Device, IN ULONG DataType, IN PVOID Buffer,
                   IN ULONG Offset, IN ULONG Length);

KSDDKAPI
ULONG
NTAPI
KsDeviceSetBusData(IN PKSDEVICE Device, IN ULONG DataType, IN PVOID Buffer,
                   IN ULONG Offset, IN ULONG Length);
...
#define KsDeleteFilterFactory(FilterFactory)                                   \
  KsFreeObjectCreateItemsByContext(                                            \
      *(KSDEVICE_HEADER *)(KsFilterFactoryGetParentDevice(FilterFactory)       \
...
KsFilterFactoryAddCreateItem(
    IN PKSFILTERFACTORY FilterFactory, IN PWCHAR RefString,
    IN PSECURITY_DESCRIPTOR SecurityDescriptor OPTIONAL,
    IN ULONG CreateItemFlags);
...
void _inline KsFilterAddEvent(IN PKSFILTER Filter,
                              IN PKSEVENT_ENTRY EventEntry) {
...
NTSTATUS
NTAPI
KsDefaultAddEventHandler(IN PIRP Irp, IN PKSEVENTDATA EventData,
                         IN OUT PKSEVENT_ENTRY EventEntry);

KSDDKAPI
void NTAPI KsGenerateEvents(IN PVOID Object, IN const GUID *EventSet OPTIONAL,
                            IN ULONG EventId, IN ULONG DataSize,
                            IN PVOID Data OPTIONAL,
                            IN PFNKSGENERATEEVENTCALLBACK CallBack OPTIONAL,
                            IN PVOID CallBackContext OPTIONAL);

void _inline KsFilterGenerateEvents(
    IN PKSFILTER Filter, IN const GUID *EventSet OPTIONAL, IN ULONG EventId,
...
void _inline KsPinGenerateEvents(
    IN PKSPIN Pin, IN const GUID *EventSet OPTIONAL, IN ULONG EventId,
    IN ULONG DataSize, IN PVOID Data OPTIONAL,
    IN PFNKSGENERATEEVENTCALLBACK CallBack OPTIONAL,
    IN PVOID CallBackContext OPTIONAL) {
...
NTSTATUS
NTAPI
KsPinGetAvailableByteCount(IN PKSPIN Pin, OUT PLONG InputDataBytes OPTIONAL,
...
KSDDKAPI
void NTAPI KsStreamPointerUnlock(IN PKSSTREAM_POINTER StreamPointer,
                                 IN BOOLEAN Eject);

KSDDKAPI
void NTAPI KsStreamPointerAdvanceOffsetsAndUnlock(
    IN PKSSTREAM_POINTER StreamPointer, IN ULONG InUsed, IN ULONG OutUsed,
    IN BOOLEAN Eject);
...
KsStreamPointerAdvanceOffsets(IN PKSSTREAM_POINTER StreamPointer,
                              IN ULONG InUsed, IN ULONG OutUsed,
                              IN BOOLEAN Eject);
...
KSDDKAPI
PIRP NTAPI KsStreamPointerGetIrp(IN PKSSTREAM_POINTER StreamPointer,
                                 OUT PBOOLEAN FirstFrameInIrp OPTIONAL,
                                 OUT PBOOLEAN LastFrameInIrp OPTIONAL);

KSDDKAPI
void NTAPI KsStreamPointerScheduleTimeout(IN PKSSTREAM_POINTER StreamPointer,
...
KSDDKAPI
void NTAPI KsFilterAttemptProcessing(IN PKSFILTER Filter,
...
KSDDKAPI
void NTAPI KsPinGetCopyRelationships(IN PKSPIN Pin, OUT PKSPIN *CopySource,
...
NTSTATUS
NTAPI
KsAddItemToObjectBag(IN KSOBJECT_BAG ObjectBag, IN PVOID Item,
                     IN PFNKSFREE Free OPTIONAL);

KSDDKAPI
ULONG
NTAPI
KsRemoveItemFromObjectBag(IN KSOBJECT_BAG ObjectBag, IN PVOID Item,
                          IN BOOLEAN Free);
...
NTSTATUS
NTAPI
_KsEdit(IN KSOBJECT_BAG ObjectBag, IN OUT PVOID *PointerToPointerToItem,
        IN ULONG NewSize, IN ULONG OldSize, IN ULONG Tag);
...
#define KsEditSized(Object, PointerToPointer, NewSize, OldSize, Tag)           \
  _KsEdit((Object)->Bag, (PVOID *)(PointerToPointer), (NewSize), (OldSize),    \
          (Tag))
...
KsRegisterFilterWithNoKSPins(IN PDEVICE_OBJECT DeviceObject,
                             ...
                             IN ULONG PinCount, IN BOOL *PinDirection,
...
KsFilterAddTopologyConnections(
    IN PKSFILTER Filter, IN ULONG NewConnectionsCount,
    IN const KSTOPOLOGY_CONNECTION *const NewTopologyConnections);

KSDDKAPI
NTSTATUS
NTAPI
KsPinGetConnectedPinInterface(IN PKSPIN Pin, IN const GUID *InterfaceId,
                              OUT PVOID *Interface);
...
NTSTATUS
NTAPI
KsPinGetConnectedFilterInterface(IN PKSPIN Pin, IN const GUID *InterfaceId,
                                 OUT PVOID *Interface);
...
NTSTATUS
NTAPI
KsPinSubmitFrameMdl(IN PKSPIN Pin, IN PMDL Mdl OPTIONAL,
                    IN PKSSTREAM_HEADER StreamHeader OPTIONAL,
                    IN PVOID Context OPTIONAL);
...
KSDDKAPI
void NTAPI KsPinRegisterIrpCompletionCallback(
    IN PKSPIN Pin, IN PFNKSPINIRPCOMPLETION IrpCompletion);
...
KSDDKAPI
void NTAPI KsFilterRegisterPowerCallbacks(IN PKSFILTER Filter,
...
PUNKNOWN __inline KsDeviceRegisterAggregatedClientUnknown(
    IN PKSDEVICE Device, IN PUNKNOWN ClientUnknown) {
...
PUNKNOWN __inline KsFilterFactoryRegisterAggregatedClientUnknown(
    IN PKSFILTERFACTORY FilterFactory, IN PUNKNOWN ClientUnknown) {
...
PUNKNOWN __inline KsFilterRegisterAggregatedClientUnknown(
    IN PKSFILTER Filter, IN PUNKNOWN ClientUnknown) {
...
PUNKNOWN __inline KsPinRegisterAggregatedClientUnknown(
    IN PKSPIN Pin, IN PUNKNOWN ClientUnknown) {
