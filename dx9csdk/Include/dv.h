...
typedef struct Tag_DVAudInfo {
  ...
  // MSB 2 bits: 0 for mon. 1: stereo in one 5/6 DIF sequences, 2: stereo audio
  // in both 5/6 DIF sequences example: 0x00: mon, audio in first 5/6 DIF
  // sequence
  ...
  //                  0x20: stereo, left ch in 1st 5/6 DIF sequence, right ch in
  //                  2nd 5/6 DIF sequence 0x26: stereo, rightch in 1st 6 DIF
  //                  sequence, left ch in 2nd 6 DIF sequence
