...
DWORD WINAPI XInputSetState(
    DWORD dwUserIndex, // [in] Index of the gamer associated with the device
    XINPUT_VIBRATION *pVibration // [in, out] The vibration information to send
                                 // to the controller
);
...
DWORD WINAPI XInputGetKeystroke(
    ...
    PXINPUT_KEYSTROKE pKeystroke // [out] Pointer to an XINPUT_KEYSTROKE
                                 // structure that receives an input event.
);
