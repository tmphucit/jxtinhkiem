...
typedef /* [public][public][public][public][public][public][public][public][public][public][public][public][public]
         */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0002 {
  WORD Bits;
} MPEG_HEADER_BITS_MIDL;

typedef /* [public][public][public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0003 {
  BYTE Bits;
...
typedef /* [public][public][public][public][public][public][public][public][public][public]
         */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0016 {
...
typedef /* [public][public][public][public][public][public][public][public][public][public]
         */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0017 {
  BOOL fSpecifyEtmId;
  DWORD EtmId;
} ATSC_FILTER_OPTIONS;

typedef /* [public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0018 {
  BYTE bVersionNumber;
  WORD wFilterSize;
...
typedef /* [public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0020 {
  BYTE Hours;
  BYTE Minutes;
  BYTE Seconds;
} MPEG_TIME;
...
typedef /* [public][public][public][public][public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0024 {
  DWORD AVMGraphId;
} MPEG_BCS_DEMUX;

typedef /* [public][public][public][public][public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0025 {
  DWORD AVMGraphId;
} MPEG_WINSOCK;

typedef /* [public][public][public] */
    struct __MIDL___MIDL_itf_mpeg2data_0000_0026 {
...
interface IMpeg2Data { CONST_VTBL struct IMpeg2DataVtbl *lpVtbl; };
...
#define IMpeg2Data_GetSection(This, pid, tid, pFilter, dwTimeout,              \
                              ppSectionList)                                   \
...
#define IMpeg2Data_GetStreamOfSections(This, pid, tid, pFilter,                \
                                       hDataReadyEvent, ppMpegStream)          \
  (This)->lpVtbl->GetStreamOfSections(This, pid, tid, pFilter,                 \
                                      hDataReadyEvent, ppMpegStream)
...
IMpeg2Data_GetSection_Proxy(IMpeg2Data *This,
                            /* [in] */ PID pid,
                            /* [in] */ TID tid,
                            /* [in] */ PMPEG2_FILTER pFilter,
                            /* [in] */ DWORD dwTimeout,
...
HRESULT STDMETHODCALLTYPE
IMpeg2Data_GetTable_Proxy(IMpeg2Data *This,
                          /* [in] */ PID pid,
                          /* [in] */ TID tid,
                          /* [in] */ PMPEG2_FILTER pFilter,
                          /* [in] */ DWORD dwTimeout,
...
void __RPC_STUB IMpeg2Data_GetTable_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IMpeg2Data_GetStreamOfSections_Proxy(IMpeg2Data *This,
                                     /* [in] */ PID pid,
                                     /* [in] */ TID tid,
                                     /* [in] */ PMPEG2_FILTER pFilter,
                                     /* [in] */ HANDLE hDataReadyEvent,
...
typedef struct ISectionListVtbl {
  ...
  (ISectionList *This, PID *pPid);

  HRESULT(STDMETHODCALLTYPE *GetTableIdentifier)
  (ISectionList *This, TID *pTableId);

  END_INTERFACE
} ISectionListVtbl;

interface ISectionList { CONST_VTBL struct ISectionListVtbl *lpVtbl; };
...
#define ISectionList_Initialize(This, requestType, pMpeg2Data, pContext, pid,  \
                                tid, pFilter, timeout, hDoneEvent)             \
  (This)->lpVtbl->Initialize(This, requestType, pMpeg2Data, pContext, pid,     \
                             tid, pFilter, timeout, hDoneEvent)
...
#define ISectionList_GetSectionData(This, sectionNumber, pdwRawPacketLength,   \
                                    ppSection)                                 \
  (This)->lpVtbl->GetSectionData(This, sectionNumber, pdwRawPacketLength,      \
                                 ppSection)
...
HRESULT STDMETHODCALLTYPE
ISectionList_Initialize_Proxy(ISectionList *This,
                              /* [in] */ MPEG_REQUEST_TYPE requestType,
                              /* [in] */ IMpeg2Data *pMpeg2Data,
                              /* [in] */ PMPEG_CONTEXT pContext,
                              /* [in] */ PID pid,
...
HRESULT STDMETHODCALLTYPE
ISectionList_CancelPendingRequest_Proxy(ISectionList *This);
...
HRESULT STDMETHODCALLTYPE
ISectionList_GetNumberOfSections_Proxy(ISectionList *This,
                                       /* [out] */ WORD *pCount);
...
HRESULT STDMETHODCALLTYPE
ISectionList_GetSectionData_Proxy(ISectionList *This,
                                  /* [in] */ WORD sectionNumber,
                                  /* [out] */ DWORD *pdwRawPacketLength,
                                  /* [out] */ PSECTION *ppSection);
...
HRESULT STDMETHODCALLTYPE
ISectionList_GetProgramIdentifier_Proxy(ISectionList *This, PID *pPid);
...
HRESULT STDMETHODCALLTYPE
ISectionList_GetTableIdentifier_Proxy(ISectionList *This, TID *pTableId);
...
interface IMpeg2Stream { CONST_VTBL struct IMpeg2StreamVtbl *lpVtbl; };
...
#define IMpeg2Stream_Initialize(This, requestType, pMpeg2Data, pContext, pid,  \
                                tid, pFilter, hDataReadyEvent)                 \
  (This)->lpVtbl->Initialize(This, requestType, pMpeg2Data, pContext, pid,     \
                             tid, pFilter, hDataReadyEvent)
...
HRESULT STDMETHODCALLTYPE
IMpeg2Stream_Initialize_Proxy(IMpeg2Stream *This,
                              /* [in] */ MPEG_REQUEST_TYPE requestType,
                              /* [in] */ IMpeg2Data *pMpeg2Data,
                              /* [in] */ PMPEG_CONTEXT pContext,
                              /* [in] */ PID pid,
