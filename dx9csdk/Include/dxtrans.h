...
//
//   All GUIDs for DXTransform are declared in DXTGUID.C in the SDK include
//   directory
//
...
typedef struct IDXBaseObjectVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXBaseObject *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXBaseObject *This);
...
interface IDXBaseObject { CONST_VTBL struct IDXBaseObjectVtbl *lpVtbl; };
...
#define IDXBaseObject_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXBaseObject_Release(This) (This)->lpVtbl->Release(This)
...
IDXBaseObject_GetGenerationId_Proxy(IDXBaseObject *This,
                                    /* [out] */ ULONG *pID);
...
HRESULT STDMETHODCALLTYPE
IDXBaseObject_IncrementGenerationId_Proxy(IDXBaseObject *This,
                                          /* [in] */ BOOL bRefresh);
...
HRESULT STDMETHODCALLTYPE
IDXBaseObject_GetObjectSize_Proxy(IDXBaseObject *This,
                                  /* [out] */ ULONG *pcbSize);
...
typedef enum DXBNDID { DXB_X = 0, DXB_Y = 1, DXB_Z = 2, DXB_T = 3 } DXBNDID;
...
typedef struct IDXTransformFactoryVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXTransformFactory *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXTransformFactory *This);
...
#define IDXTransformFactory_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXTransformFactory_Release(This) (This)->lpVtbl->Release(This)

#define IDXTransformFactory_QueryService(This, guidService, riid, ppvObject)   \
  (This)->lpVtbl->QueryService(This, guidService, riid, ppvObject)

#define IDXTransformFactory_SetService(This, guidService, pUnkService,         \
                                       bWeakReference)                         \
  (This)->lpVtbl->SetService(This, guidService, pUnkService, bWeakReference)

#define IDXTransformFactory_CreateTransform(                                   \
    This, punkInputs, ulNumInputs, punkOutputs, ulNumOutputs, pInitProps,      \
    pErrLog, TransCLSID, TransIID, ppTransform)                                \
  (This)->lpVtbl->CreateTransform(This, punkInputs, ulNumInputs, punkOutputs,  \
                                  ulNumOutputs, pInitProps, pErrLog,           \
                                  TransCLSID, TransIID, ppTransform)

#define IDXTransformFactory_InitializeTransform(                               \
    This, pTransform, punkInputs, ulNumInputs, punkOutputs, ulNumOutputs,      \
    pInitProps, pErrLog)                                                       \
  (This)->lpVtbl->InitializeTransform(This, pTransform, punkInputs,            \
                                      ulNumInputs, punkOutputs, ulNumOutputs,  \
                                      pInitProps, pErrLog)
...
HRESULT STDMETHODCALLTYPE
IDXTransformFactory_SetService_Proxy(IDXTransformFactory *This,
                                     /* [in] */ REFGUID guidService,
                                     /* [in] */ IUnknown *pUnkService,
                                     /* [in] */ BOOL bWeakReference);
...
typedef enum DXINOUTINFOFLAGS { DXINOUTF_OPTIONAL = 1L << 0 } DXINOUTINFOFLAGS;
...
typedef struct IDXTransformVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXTransform *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXTransform *This);
...
interface IDXTransform { CONST_VTBL struct IDXTransformVtbl *lpVtbl; };
...
#define IDXTransform_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXTransform_Release(This) (This)->lpVtbl->Release(This)
...
#define IDXTransform_Setup(This, punkInputs, ulNumInputs, punkOutputs,         \
                           ulNumOutputs, dwFlags)                              \
  (This)->lpVtbl->Setup(This, punkInputs, ulNumInputs, punkOutputs,            \
                        ulNumOutputs, dwFlags)

#define IDXTransform_Execute(This, pRequestID, pClipBnds, pPlacement)          \
  (This)->lpVtbl->Execute(This, pRequestID, pClipBnds, pPlacement)

#define IDXTransform_MapBoundsIn2Out(This, pInBounds, ulNumInBnds, ulOutIndex, \
                                     pOutBounds)                               \
  (This)->lpVtbl->MapBoundsIn2Out(This, pInBounds, ulNumInBnds, ulOutIndex,    \
                                  pOutBounds)

#define IDXTransform_MapBoundsOut2In(This, ulOutIndex, pOutBounds, ulInIndex,  \
                                     pInBounds)                                \
  (This)->lpVtbl->MapBoundsOut2In(This, ulOutIndex, pOutBounds, ulInIndex,     \
                                  pInBounds)
...
#define IDXTransform_GetInOutInfo(This, bIsOutput, ulIndex, pdwFlags, pIDs,    \
                                  pcIDs, ppUnkCurrentObject)                   \
  (This)->lpVtbl->GetInOutInfo(This, bIsOutput, ulIndex, pdwFlags, pIDs,       \
                               pcIDs, ppUnkCurrentObject)
...
HRESULT STDMETHODCALLTYPE
IDXTransform_Setup_Proxy(IDXTransform *This,
                         /* [size_is][in] */ IUnknown *const *punkInputs,
                         /* [in] */ ULONG ulNumInputs,
                         /* [size_is][in] */ IUnknown *const *punkOutputs,
                         /* [in] */ ULONG ulNumOutputs,
...
void __RPC_STUB IDXTransform_Setup_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IDXTransform_Execute_Proxy(IDXTransform *This,
                           /* [in] */ const GUID *pRequestID,
                           /* [in] */ const DXBNDS *pClipBnds,
                           /* [in] */ const DXVEC *pPlacement);

void __RPC_STUB IDXTransform_Execute_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IDXTransform_MapBoundsIn2Out_Proxy(IDXTransform *This,
                                   /* [in] */ const DXBNDS *pInBounds,
                                   /* [in] */ ULONG ulNumInBnds,
                                   /* [in] */ ULONG ulOutIndex,
                                   /* [out] */ DXBNDS *pOutBounds);
...
HRESULT STDMETHODCALLTYPE
IDXTransform_MapBoundsOut2In_Proxy(IDXTransform *This,
                                   /* [in] */ ULONG ulOutIndex,
                                   /* [in] */ const DXBNDS *pOutBounds,
                                   /* [in] */ ULONG ulInIndex,
                                   /* [out] */ DXBNDS *pInBounds);
...
HRESULT STDMETHODCALLTYPE
IDXTransform_SetMiscFlags_Proxy(IDXTransform *This,
                                /* [in] */ DWORD dwMiscFlags);
...
HRESULT STDMETHODCALLTYPE
IDXTransform_GetMiscFlags_Proxy(IDXTransform *This,
                                /* [out] */ DWORD *pdwMiscFlags);
...
HRESULT STDMETHODCALLTYPE
IDXTransform_GetInOutInfo_Proxy(IDXTransform *This,
                                /* [in] */ BOOL bIsOutput,
                                /* [in] */ ULONG ulIndex,
                                /* [out] */ DWORD *pdwFlags,
                                /* [size_is][out] */ GUID *pIDs,
...
HRESULT STDMETHODCALLTYPE
IDXTransform_SetQuality_Proxy(IDXTransform *This,
                              /* [in] */ float fQuality);
...
HRESULT STDMETHODCALLTYPE
IDXTransform_GetQuality_Proxy(IDXTransform *This,
                              /* [out] */ float *fQuality);
...
typedef struct IDXSurfacePickVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXSurfacePick *This);
...
interface IDXSurfacePick { CONST_VTBL struct IDXSurfacePickVtbl *lpVtbl; };
...
#define IDXSurfacePick_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXSurfacePick_Release(This) (This)->lpVtbl->Release(This)

#define IDXSurfacePick_PointPick(This, pPoint, pulInputSurfaceIndex,           \
                                 pInputPoint)                                  \
...
HRESULT STDMETHODCALLTYPE
IDXSurfacePick_PointPick_Proxy(IDXSurfacePick *This,
                               /* [in] */ const DXVEC *pPoint,
                               /* [out] */ ULONG *pulInputSurfaceIndex,
                               /* [out] */ DXVEC *pInputPoint);
...
typedef struct IDXTBindHostVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXTBindHost *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXTBindHost *This);
...
interface IDXTBindHost { CONST_VTBL struct IDXTBindHostVtbl *lpVtbl; };
...
#define IDXTBindHost_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXTBindHost_Release(This) (This)->lpVtbl->Release(This)
...
HRESULT STDMETHODCALLTYPE
IDXTBindHost_SetBindHost_Proxy(IDXTBindHost *This,
                               /* [in] */ IBindHost *pBindHost);
...
typedef void __stdcall __stdcall DXTASKPROC(void *pTaskData,
                                            BOOL *pbContinueProcessing);

typedef DXTASKPROC *PFNDXTASKPROC;

typedef void __stdcall __stdcall DXAPCPROC(DWORD dwData);
...
typedef struct IDXTaskManagerVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXTaskManager *This);
...
interface IDXTaskManager { CONST_VTBL struct IDXTaskManagerVtbl *lpVtbl; };
...
#define IDXTaskManager_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXTaskManager_Release(This) (This)->lpVtbl->Release(This)
...
#define IDXTaskManager_ScheduleTasks(This, TaskInfo, Events, TaskIDs,          \
                                     ulNumTasks, ulWaitPeriod)                 \
  (This)->lpVtbl->ScheduleTasks(This, TaskInfo, Events, TaskIDs, ulNumTasks,   \
                                ulWaitPeriod)
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_QueryNumProcessors_Proxy(IDXTaskManager *This,
                                        /* [out] */ ULONG *pulNumProc);
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_SetThreadPoolSize_Proxy(IDXTaskManager *This,
                                       /* [in] */ ULONG ulNumThreads);
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_GetThreadPoolSize_Proxy(IDXTaskManager *This,
                                       /* [out] */ ULONG *pulNumThreads);
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_SetConcurrencyLimit_Proxy(IDXTaskManager *This,
                                         /* [in] */ ULONG ulNumThreads);
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_GetConcurrencyLimit_Proxy(IDXTaskManager *This,
                                         /* [out] */ ULONG *pulNumThreads);
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_ScheduleTasks_Proxy(IDXTaskManager *This,
                                   /* [in] */ DXTMTASKINFO TaskInfo[],
                                   /* [in] */ HANDLE Events[],
                                   /* [out] */ DWORD TaskIDs[],
                                   /* [in] */ ULONG ulNumTasks,
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_TerminateTasks_Proxy(IDXTaskManager *This,
                                    /* [in] */ DWORD TaskIDs[],
                                    /* [in] */ ULONG ulCount,
                                    /* [in] */ ULONG ulTimeOut);
...
HRESULT STDMETHODCALLTYPE
IDXTaskManager_TerminateRequest_Proxy(IDXTaskManager *This,
                                      /* [in] */ REFIID RequestID,
                                      /* [in] */ ULONG ulTimeOut);
...
public:
  DXPMSAMPLE() {}
  DXPMSAMPLE(const BYTE alpha, const BYTE red, const BYTE green,
             const BYTE blue)
      : DXBASESAMPLE(alpha, red, green, blue) {}
...
//
// The following cast operators are to prevent a direct assignment of a DXSAMPLE
// to a DXPMSAMPLE
//
...
typedef struct IDXSurfaceFactoryVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXSurfaceFactory *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXSurfaceFactory *This);
...
#define IDXSurfaceFactory_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXSurfaceFactory_Release(This) (This)->lpVtbl->Release(This)

#define IDXSurfaceFactory_CreateSurface(This, pDirectDraw, pDDSurfaceDesc,     \
                                        pFormatID, pBounds, dwFlags,           \
                                        punkOuter, riid, ppDXSurface)          \
  (This)->lpVtbl->CreateSurface(This, pDirectDraw, pDDSurfaceDesc, pFormatID,  \
                                pBounds, dwFlags, punkOuter, riid,             \
                                ppDXSurface)

#define IDXSurfaceFactory_CreateFromDDSurface(                                 \
    This, pDDrawSurface, pFormatID, dwFlags, punkOuter, riid, ppDXSurface)     \
  (This)->lpVtbl->CreateFromDDSurface(This, pDDrawSurface, pFormatID, dwFlags, \
                                      punkOuter, riid, ppDXSurface)

#define IDXSurfaceFactory_LoadImage(This, pszFileName, pDirectDraw,            \
                                    pDDSurfaceDesc, pFormatID, riid,           \
                                    ppDXSurface)                               \
  (This)->lpVtbl->LoadImage(This, pszFileName, pDirectDraw, pDDSurfaceDesc,    \
                            pFormatID, riid, ppDXSurface)

#define IDXSurfaceFactory_LoadImageFromStream(                                 \
    This, pStream, pDirectDraw, pDDSurfaceDesc, pFormatID, riid, ppDXSurface)  \
  (This)->lpVtbl->LoadImageFromStream(This, pStream, pDirectDraw,              \
                                      pDDSurfaceDesc, pFormatID, riid,         \
                                      ppDXSurface)

#define IDXSurfaceFactory_CopySurfaceToNewFormat(                              \
    This, pSrc, pDirectDraw, pDDSurfaceDesc, pDestFormatID, ppNewSurface)      \
  (This)->lpVtbl->CopySurfaceToNewFormat(                                      \
      This, pSrc, pDirectDraw, pDDSurfaceDesc, pDestFormatID, ppNewSurface)

#define IDXSurfaceFactory_CreateD3DRMTexture(This, pSrc, pDirectDraw, pD3DRM3, \
                                             riid, ppTexture3)                 \
  (This)->lpVtbl->CreateD3DRMTexture(This, pSrc, pDirectDraw, pD3DRM3, riid,   \
                                     ppTexture3)

#define IDXSurfaceFactory_BitBlt(This, pDest, pPlacement, pSrc, pClipBounds,   \
                                 dwFlags)                                      \
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceFactory_BitBlt_Proxy(IDXSurfaceFactory *This,
                               /* [in] */ IDXSurface *pDest,
                               /* [in] */ const DXVEC *pPlacement,
                               /* [in] */ IDXSurface *pSrc,
                               /* [in] */ const DXBNDS *pClipBounds,
...
typedef struct IDXSurfaceModifierVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXSurfaceModifier *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXSurfaceModifier *This);
...
#define IDXSurfaceModifier_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXSurfaceModifier_Release(This) (This)->lpVtbl->Release(This)
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_SetFillColor_Proxy(IDXSurfaceModifier *This,
                                      /* [in] */ DXSAMPLE Color);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_GetFillColor_Proxy(IDXSurfaceModifier *This,
                                      /* [out] */ DXSAMPLE *pColor);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_SetBounds_Proxy(IDXSurfaceModifier *This,
                                   /* [in] */ const DXBNDS *pBounds);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_SetBackground_Proxy(IDXSurfaceModifier *This,
                                       /* [in] */ IDXSurface *pSurface);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_GetBackground_Proxy(IDXSurfaceModifier *This,
                                       /* [out] */ IDXSurface **ppSurface);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_SetForeground_Proxy(IDXSurfaceModifier *This,
                                       /* [in] */ IDXSurface *pSurface,
                                       /* [in] */ BOOL bTile,
                                       /* [in] */ const POINT *pOrigin);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_GetForeground_Proxy(IDXSurfaceModifier *This,
                                       /* [out] */ IDXSurface **ppSurface,
                                       /* [out] */ BOOL *pbTile,
                                       /* [out] */ POINT *pOrigin);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_SetOpacity_Proxy(IDXSurfaceModifier *This,
                                    /* [in] */ float Opacity);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_GetOpacity_Proxy(IDXSurfaceModifier *This,
                                    /* [out] */ float *pOpacity);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_SetLookup_Proxy(IDXSurfaceModifier *This,
                                   /* [in] */ IDXLookupTable *pLookupTable);
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceModifier_GetLookup_Proxy(IDXSurfaceModifier *This,
                                   /* [out] */ IDXLookupTable **ppLookupTable);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetColorKey(DXSAMPLE * pColorKey) = 0;

  virtual HRESULT STDMETHODCALLTYPE SetColorKey(DXSAMPLE ColorKey) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAppData(DWORD_PTR dwAppData) = 0;

  virtual HRESULT STDMETHODCALLTYPE GetAppData(DWORD_PTR * pdwAppData) = 0;
};
...
typedef struct IDXSurfaceVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXSurface *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXSurface *This);
  ...
  (IDXSurface *This, DXSAMPLE *pColorKey);

  HRESULT(STDMETHODCALLTYPE *SetColorKey)(IDXSurface *This, DXSAMPLE ColorKey);
  ...
  HRESULT(STDMETHODCALLTYPE *SetAppData)(IDXSurface *This, DWORD_PTR dwAppData);
...
interface IDXSurface { CONST_VTBL struct IDXSurfaceVtbl *lpVtbl; };
...
#define IDXSurface_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXSurface_Release(This) (This)->lpVtbl->Release(This)
...
#define IDXSurface_LockSurface(This, pBounds, ulTimeOut, dwFlags, riid,        \
                               ppPointer, pulGenerationId)                     \
  (This)->lpVtbl->LockSurface(This, pBounds, ulTimeOut, dwFlags, riid,         \
                              ppPointer, pulGenerationId)
...
HRESULT STDMETHODCALLTYPE
IDXSurface_GetBounds_Proxy(IDXSurface *This,
                           /* [out] */ DXBNDS *pBounds);

void __RPC_STUB IDXSurface_GetBounds_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IDXSurface_GetStatusFlags_Proxy(IDXSurface *This,
                                /* [out] */ DWORD *pdwStatusFlags);
...
HRESULT STDMETHODCALLTYPE
IDXSurface_SetStatusFlags_Proxy(IDXSurface *This,
                                /* [in] */ DWORD dwStatusFlags);
...
HRESULT STDMETHODCALLTYPE
IDXSurface_LockSurface_Proxy(IDXSurface *This,
                             /* [in] */ const DXBNDS *pBounds,
                             /* [in] */ ULONG ulTimeOut,
                             /* [in] */ DWORD dwFlags,
                             /* [in] */ REFIID riid,
...
HRESULT STDMETHODCALLTYPE
IDXSurface_GetDirectDrawSurface_Proxy(IDXSurface *This,
                                      /* [in] */ REFIID riid,
                                      /* [iid_is][out] */ void **ppSurface);
...
HRESULT STDMETHODCALLTYPE IDXSurface_GetColorKey_Proxy(IDXSurface *This,
                                                       DXSAMPLE *pColorKey);
...
HRESULT STDMETHODCALLTYPE IDXSurface_SetColorKey_Proxy(IDXSurface *This,
                                                       DXSAMPLE ColorKey);
...
HRESULT STDMETHODCALLTYPE
IDXSurface_LockSurfaceDC_Proxy(IDXSurface *This,
                               /* [in] */ const DXBNDS *pBounds,
                               /* [in] */ ULONG ulTimeOut,
                               /* [in] */ DWORD dwFlags,
                               /* [out] */ IDXDCLock **ppDCLock);
...
HRESULT STDMETHODCALLTYPE IDXSurface_SetAppData_Proxy(IDXSurface *This,
                                                      DWORD_PTR dwAppData);
...
HRESULT STDMETHODCALLTYPE IDXSurface_GetAppData_Proxy(IDXSurface *This,
...
typedef struct IDXSurfaceInitVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXSurfaceInit *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXSurfaceInit *This);
...
interface IDXSurfaceInit { CONST_VTBL struct IDXSurfaceInitVtbl *lpVtbl; };
...
#define IDXSurfaceInit_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXSurfaceInit_Release(This) (This)->lpVtbl->Release(This)

#define IDXSurfaceInit_InitSurface(This, pDirectDraw, pDDSurfaceDesc,          \
                                   pFormatID, pBounds, dwFlags)                \
  (This)->lpVtbl->InitSurface(This, pDirectDraw, pDDSurfaceDesc, pFormatID,    \
                              pBounds, dwFlags)
...
HRESULT STDMETHODCALLTYPE
IDXSurfaceInit_InitSurface_Proxy(IDXSurfaceInit *This,
                                 /* [in] */ IUnknown *pDirectDraw,
                                 /* [in] */ const DDSURFACEDESC *pDDSurfaceDesc,
                                 /* [in] */ const GUID *pFormatID,
                                 /* [in] */ const DXBNDS *pBounds,
...
typedef struct IDXARGBSurfaceInitVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXARGBSurfaceInit *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXARGBSurfaceInit *This);
...
#define IDXARGBSurfaceInit_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXARGBSurfaceInit_Release(This) (This)->lpVtbl->Release(This)

#define IDXARGBSurfaceInit_InitSurface(This, pDirectDraw, pDDSurfaceDesc,      \
                                       pFormatID, pBounds, dwFlags)            \
  (This)->lpVtbl->InitSurface(This, pDirectDraw, pDDSurfaceDesc, pFormatID,    \
                              pBounds, dwFlags)

#define IDXARGBSurfaceInit_InitFromDDSurface(This, pDDrawSurface, pFormatID,   \
                                             dwFlags)                          \
...
HRESULT STDMETHODCALLTYPE
IDXARGBSurfaceInit_InitFromDDSurface_Proxy(IDXARGBSurfaceInit *This,
                                           /* [in] */ IUnknown *pDDrawSurface,
                                           /* [in] */ const GUID *pFormatID,
                                           /* [in] */ DWORD dwFlags);
...
typedef struct IDXARGBReadPtrVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXARGBReadPtr *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXARGBReadPtr *This);
  ...
  void(STDMETHODCALLTYPE *Move)(IDXARGBReadPtr *This,
                                /* [in] */ long cSamples);

  void(STDMETHODCALLTYPE *MoveToRow)(IDXARGBReadPtr *This,
                                     /* [in] */ ULONG y);

  void(STDMETHODCALLTYPE *MoveToXY)(IDXARGBReadPtr *This,
                                    /* [in] */ ULONG x,
                                    /* [in] */ ULONG y);
  ...
  DXSAMPLE *(STDMETHODCALLTYPE *Unpack)(IDXARGBReadPtr *This,
                                        /* [in] */ DXSAMPLE *pSamples,
                                        /* [in] */ ULONG cSamples,
                                        /* [in] */ BOOL bMove);
...
interface IDXARGBReadPtr { CONST_VTBL struct IDXARGBReadPtrVtbl *lpVtbl; };
...
#define IDXARGBReadPtr_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXARGBReadPtr_Release(This) (This)->lpVtbl->Release(This)
...
#define IDXARGBReadPtr_Move(This, cSamples) (This)->lpVtbl->Move(This, cSamples)

#define IDXARGBReadPtr_MoveToRow(This, y) (This)->lpVtbl->MoveToRow(This, y)

#define IDXARGBReadPtr_MoveToXY(This, x, y) (This)->lpVtbl->MoveToXY(This, x, y)
...
HRESULT STDMETHODCALLTYPE
IDXARGBReadPtr_GetSurface_Proxy(IDXARGBReadPtr *This,
                                /* [in] */ REFIID riid,
                                /* [iid_is][out] */ void **ppSurface);
...
IDXARGBReadPtr_GetNativeType_Proxy(IDXARGBReadPtr *This,
                                   /* [out] */ DXNATIVETYPEINFO *pInfo);
...
void STDMETHODCALLTYPE IDXARGBReadPtr_Move_Proxy(IDXARGBReadPtr *This,
                                                 /* [in] */ long cSamples);

void __RPC_STUB IDXARGBReadPtr_Move_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);

void STDMETHODCALLTYPE IDXARGBReadPtr_MoveToRow_Proxy(IDXARGBReadPtr *This,
                                                      /* [in] */ ULONG y);
...
void STDMETHODCALLTYPE IDXARGBReadPtr_MoveToXY_Proxy(IDXARGBReadPtr *This,
                                                     /* [in] */ ULONG x,
                                                     /* [in] */ ULONG y);
...
IDXARGBReadPtr_MoveAndGetRunInfo_Proxy(IDXARGBReadPtr *This,
                                       /* [in] */ ULONG Row,
                                       /* [out] */ const DXRUNINFO **ppInfo);
...
DXSAMPLE *STDMETHODCALLTYPE
IDXARGBReadPtr_Unpack_Proxy(IDXARGBReadPtr *This,
                            /* [in] */ DXSAMPLE *pSamples,
                            /* [in] */ ULONG cSamples,
                            /* [in] */ BOOL bMove);
...
DXPMSAMPLE *STDMETHODCALLTYPE
IDXARGBReadPtr_UnpackPremult_Proxy(IDXARGBReadPtr *This,
                                   /* [in] */ DXPMSAMPLE *pSamples,
                                   /* [in] */ ULONG cSamples,
                                   /* [in] */ BOOL bMove);
...
IDXARGBReadPtr_UnpackRect_Proxy(IDXARGBReadPtr *This,
                                /* [in] */ const DXPACKEDRECTDESC *pRectDesc);
...
typedef struct IDXARGBReadWritePtrVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXARGBReadWritePtr *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXARGBReadWritePtr *This);
  ...
  void(STDMETHODCALLTYPE *Move)(IDXARGBReadWritePtr *This,
                                /* [in] */ long cSamples);

  void(STDMETHODCALLTYPE *MoveToRow)(IDXARGBReadWritePtr *This,
                                     /* [in] */ ULONG y);

  void(STDMETHODCALLTYPE *MoveToXY)(IDXARGBReadWritePtr *This,
                                    /* [in] */ ULONG x,
                                    /* [in] */ ULONG y);
  ...
  DXSAMPLE *(STDMETHODCALLTYPE *Unpack)(IDXARGBReadWritePtr *This,
                                        /* [in] */ DXSAMPLE *pSamples,
                                        /* [in] */ ULONG cSamples,
                                        /* [in] */ BOOL bMove);
  ...
  void(STDMETHODCALLTYPE *PackAndMove)(IDXARGBReadWritePtr *This,
                                       /* [in] */ const DXSAMPLE *pSamples,
                                       /* [in] */ ULONG cSamples);
  ...
  void(STDMETHODCALLTYPE *CopyRect)(IDXARGBReadWritePtr *This,
                                    /* [in] */ DXBASESAMPLE *pScratchBuffer,
                                    /* [in] */ const RECT *pDestRect,
                                    /* [in] */ IDXARGBReadPtr *pSrc,
                                    /* [in] */ const POINT *pSrcOrigin,
  ...
  void(STDMETHODCALLTYPE *FillAndMove)(IDXARGBReadWritePtr *This,
                                       /* [in] */ DXBASESAMPLE *pScratchBuffer,
                                       /* [in] */ DXPMSAMPLE SampVal,
                                       /* [in] */ ULONG cSamples,
                                       /* [in] */ BOOL bDoOver);

  void(STDMETHODCALLTYPE *FillRect)(IDXARGBReadWritePtr *This,
                                    /* [in] */ const RECT *pRect,
                                    /* [in] */ DXPMSAMPLE SampVal,
                                    /* [in] */ BOOL bDoOver);
...
#define IDXARGBReadWritePtr_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXARGBReadWritePtr_Release(This) (This)->lpVtbl->Release(This)
...
#define IDXARGBReadWritePtr_CopyAndMoveBoth(This, pScratchBuffer, pSrc,        \
                                            cSamples, bIsOpaque)               \
  (This)->lpVtbl->CopyAndMoveBoth(This, pScratchBuffer, pSrc, cSamples,        \
                                  bIsOpaque)

#define IDXARGBReadWritePtr_CopyRect(This, pScratchBuffer, pDestRect, pSrc,    \
                                     pSrcOrigin, bIsOpaque)                    \
  (This)->lpVtbl->CopyRect(This, pScratchBuffer, pDestRect, pSrc, pSrcOrigin,  \
                           bIsOpaque)

#define IDXARGBReadWritePtr_FillAndMove(This, pScratchBuffer, SampVal,         \
                                        cSamples, bDoOver)                     \
...
#define IDXARGBReadWritePtr_OverArrayAndMove(This, pScratchBuffer, pSrc,       \
                                             cSamples)                         \
...
void STDMETHODCALLTYPE
IDXARGBReadWritePtr_PackAndMove_Proxy(IDXARGBReadWritePtr *This,
                                      /* [in] */ const DXSAMPLE *pSamples,
                                      /* [in] */ ULONG cSamples);
...
void STDMETHODCALLTYPE
IDXARGBReadWritePtr_CopyRect_Proxy(IDXARGBReadWritePtr *This,
                                   /* [in] */ DXBASESAMPLE *pScratchBuffer,
                                   /* [in] */ const RECT *pDestRect,
                                   /* [in] */ IDXARGBReadPtr *pSrc,
                                   /* [in] */ const POINT *pSrcOrigin,
...
void STDMETHODCALLTYPE
IDXARGBReadWritePtr_FillAndMove_Proxy(IDXARGBReadWritePtr *This,
                                      /* [in] */ DXBASESAMPLE *pScratchBuffer,
                                      /* [in] */ DXPMSAMPLE SampVal,
                                      /* [in] */ ULONG cSamples,
                                      /* [in] */ BOOL bDoOver);
...
void STDMETHODCALLTYPE
IDXARGBReadWritePtr_FillRect_Proxy(IDXARGBReadWritePtr *This,
                                   /* [in] */ const RECT *pRect,
                                   /* [in] */ DXPMSAMPLE SampVal,
                                   /* [in] */ BOOL bDoOver);
...
typedef struct IDXDCLockVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXDCLock *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXDCLock *This);

  HDC(STDMETHODCALLTYPE *GetDC)(IDXDCLock *This);

  END_INTERFACE
} IDXDCLockVtbl;

interface IDXDCLock { CONST_VTBL struct IDXDCLockVtbl *lpVtbl; };
...
#define IDXDCLock_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXDCLock_Release(This) (This)->lpVtbl->Release(This)

#define IDXDCLock_GetDC(This) (This)->lpVtbl->GetDC(This)

#endif /* COBJMACROS */

#endif /* C style interface */

HDC STDMETHODCALLTYPE IDXDCLock_GetDC_Proxy(IDXDCLock *This);

void __RPC_STUB IDXDCLock_GetDC_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
...
typedef struct IDXTScaleOutputVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXTScaleOutput *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXTScaleOutput *This);
...
interface IDXTScaleOutput { CONST_VTBL struct IDXTScaleOutputVtbl *lpVtbl; };
...
#define IDXTScaleOutput_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXTScaleOutput_Release(This) (This)->lpVtbl->Release(This)
...
HRESULT STDMETHODCALLTYPE
IDXTScaleOutput_SetOutputSize_Proxy(IDXTScaleOutput *This,
                                    /* [in] */ const SIZE OutSize,
                                    /* [in] */ BOOL bMaintainAspect);
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetGradient(
      DXSAMPLE StartColor, DXSAMPLE EndColor, BOOL bHorizontal) = 0;
...
typedef struct IDXGradientVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXGradient *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXGradient *This);
  ...
  (IDXGradient *This, DXSAMPLE StartColor, DXSAMPLE EndColor, BOOL bHorizontal);
...
interface IDXGradient { CONST_VTBL struct IDXGradientVtbl *lpVtbl; };
...
#define IDXGradient_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXGradient_Release(This) (This)->lpVtbl->Release(This)
...
HRESULT STDMETHODCALLTYPE IDXGradient_SetGradient_Proxy(IDXGradient *This,
                                                        DXSAMPLE StartColor,
                                                        DXSAMPLE EndColor,
                                                        BOOL bHorizontal);
...
HRESULT STDMETHODCALLTYPE
IDXGradient_GetOutputSize_Proxy(IDXGradient *This,
                                /* [out] */ SIZE *pOutSize);
...
typedef struct IDXTScaleVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXTScale *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXTScale *This);
...
interface IDXTScale { CONST_VTBL struct IDXTScaleVtbl *lpVtbl; };
...
#define IDXTScale_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXTScale_Release(This) (This)->lpVtbl->Release(This)
...
#define IDXTScale_ScaleFitToSize(This, pClipBounds, FitToSize,                 \
                                 bMaintainAspect)                              \
...
HRESULT STDMETHODCALLTYPE IDXTScale_SetScales_Proxy(IDXTScale *This,
                                                    /* [in] */ float Scales[2]);

void __RPC_STUB IDXTScale_SetScales_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IDXTScale_GetScales_Proxy(IDXTScale *This,
                          /* [out] */ float Scales[2]);

void __RPC_STUB IDXTScale_GetScales_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IDXTScale_ScaleFitToSize_Proxy(IDXTScale *This,
                               /* [out][in] */ DXBNDS *pClipBounds,
                               /* [in] */ SIZE FitToSize,
                               /* [in] */ BOOL bMaintainAspect);
...
typedef struct IDXEffectVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXEffect *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXEffect *This);
...
interface IDXEffect { CONST_VTBL struct IDXEffectVtbl *lpVtbl; };
...
IDXEffect_get_Capabilities_Proxy(IDXEffect *This,
                                 /* [retval][out] */ long *pVal);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE
IDXEffect_get_Progress_Proxy(IDXEffect *This,
                             /* [retval][out] */ float *pVal);
...
IDXEffect_put_Progress_Proxy(IDXEffect *This,
                             /* [in] */ float newVal);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE
IDXEffect_get_StepResolution_Proxy(IDXEffect *This,
                                   /* [retval][out] */ float *pVal);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE
IDXEffect_get_Duration_Proxy(IDXEffect *This,
                             /* [retval][out] */ float *pVal);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE
IDXEffect_put_Duration_Proxy(IDXEffect *This,
                             /* [in] */ float newVal);
...
typedef struct IDXLookupTableVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXLookupTable *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXLookupTable *This);
...
interface IDXLookupTable { CONST_VTBL struct IDXLookupTableVtbl *lpVtbl; };
...
#define IDXLookupTable_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXLookupTable_Release(This) (This)->lpVtbl->Release(This)
...
HRESULT STDMETHODCALLTYPE
IDXLookupTable_GetTables_Proxy(IDXLookupTable *This,
                               /* [out] */ BYTE RedLUT[256],
                               /* [out] */ BYTE GreenLUT[256],
                               /* [out] */ BYTE BlueLUT[256],
                               /* [out] */ BYTE AlphaLUT[256]);
...
HRESULT STDMETHODCALLTYPE
IDXLookupTable_IsChannelIdentity_Proxy(IDXLookupTable *This,
                                       /* [out] */ DXBASESAMPLE *pSampleBools);
...
HRESULT STDMETHODCALLTYPE
IDXLookupTable_GetIndexValues_Proxy(IDXLookupTable *This,
                                    /* [in] */ ULONG Index,
                                    /* [out] */ DXBASESAMPLE *pSample);
...
HRESULT STDMETHODCALLTYPE
IDXLookupTable_ApplyTables_Proxy(IDXLookupTable *This,
                                 /* [out][in] */ DXSAMPLE *pSamples,
                                 /* [in] */ ULONG cSamples);
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetSurfaceInfo(DXRAWSURFACEINFO *
                                                   pSurfaceInfo) = 0;
};
...
typedef struct IDXRawSurfaceVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXRawSurface *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDXRawSurface *This);

  HRESULT(STDMETHODCALLTYPE *GetSurfaceInfo)
  (IDXRawSurface *This, DXRAWSURFACEINFO *pSurfaceInfo);

  END_INTERFACE
} IDXRawSurfaceVtbl;

interface IDXRawSurface { CONST_VTBL struct IDXRawSurfaceVtbl *lpVtbl; };
...
#define IDXRawSurface_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IDXRawSurface_Release(This) (This)->lpVtbl->Release(This)
...
public:
  virtual HRESULT STDMETHODCALLTYPE SetHostUrl(BSTR bstrHostUrl) = 0;
};
...
typedef struct IHTMLDXTransformVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IHTMLDXTransform *This);

  ULONG(STDMETHODCALLTYPE *Release)(IHTMLDXTransform *This);

  HRESULT(STDMETHODCALLTYPE *SetHostUrl)
  (IHTMLDXTransform *This, BSTR bstrHostUrl);

  END_INTERFACE
} IHTMLDXTransformVtbl;

interface IHTMLDXTransform { CONST_VTBL struct IHTMLDXTransformVtbl *lpVtbl; };
...
#define IHTMLDXTransform_AddRef(This) (This)->lpVtbl->AddRef(This)

#define IHTMLDXTransform_Release(This) (This)->lpVtbl->Release(This)
...
HRESULT STDMETHODCALLTYPE
IHTMLDXTransform_SetHostUrl_Proxy(IHTMLDXTransform *This, BSTR bstrHostUrl);
...
typedef struct ICSSFilterDispatchVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(ICSSFilterDispatch *This);

  ULONG(STDMETHODCALLTYPE *Release)(ICSSFilterDispatch *This);
  ...
  /* [id] */ HRESULT(STDMETHODCALLTYPE *Apply)(ICSSFilterDispatch *This);

  /* [id] */ HRESULT(STDMETHODCALLTYPE *Play)(
      ICSSFilterDispatch *This,
      /* [optional][in] */ VARIANT varDuration);

  /* [id] */ HRESULT(STDMETHODCALLTYPE *Stop)(ICSSFilterDispatch *This);
...
#define ICSSFilterDispatch_AddRef(This) (This)->lpVtbl->AddRef(This)

#define ICSSFilterDispatch_Release(This) (This)->lpVtbl->Release(This)
...
#define ICSSFilterDispatch_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)

#define ICSSFilterDispatch_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
#define ICSSFilterDispatch_Apply(This) (This)->lpVtbl->Apply(This)

#define ICSSFilterDispatch_Play(This, varDuration)                             \
  (This)->lpVtbl->Play(This, varDuration)

#define ICSSFilterDispatch_Stop(This) (This)->lpVtbl->Stop(This)
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_get_Percent_Proxy(ICSSFilterDispatch *This,
                                     /* [retval][out] */ float *pVal);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_put_Percent_Proxy(ICSSFilterDispatch *This,
                                     /* [in] */ float newVal);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_get_Duration_Proxy(ICSSFilterDispatch *This,
                                      /* [retval][out] */ float *pVal);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_put_Duration_Proxy(ICSSFilterDispatch *This,
                                      /* [in] */ float newVal);
...
/* [id][propget] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_get_Enabled_Proxy(ICSSFilterDispatch *This,
                                     /* [retval][out] */ VARIANT_BOOL *pfVal);
...
/* [id][propput] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_put_Enabled_Proxy(ICSSFilterDispatch *This,
                                     /* [in] */ VARIANT_BOOL fVal);
...
ICSSFilterDispatch_Apply_Proxy(ICSSFilterDispatch *This);
...
/* [id] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_Play_Proxy(ICSSFilterDispatch *This,
                              /* [optional][in] */ VARIANT varDuration);
...
/* [id] */ HRESULT STDMETHODCALLTYPE
ICSSFilterDispatch_Stop_Proxy(ICSSFilterDispatch *This);
...
class DECLSPEC_UUID("D1FE6762-FC48-11D0-883A-3C8B00C10000") DXTransformFactory;
#endif
...
class DECLSPEC_UUID("4CB26C03-FF93-11d0-817E-0000F87557DB") DXTaskManager;
#endif
...
class DECLSPEC_UUID("555278E2-05DB-11D1-883A-3C8B00C10000") DXTScale;
#endif
...
class DECLSPEC_UUID("0E890F83-5F79-11D1-9043-00C04FD9189D") DXSurface;
#endif
...
class DECLSPEC_UUID("3E669F1D-9C23-11d1-9053-00C04FD9189D") DXSurfaceModifier;
#endif
...
class DECLSPEC_UUID("C6365470-F667-11d1-9067-00C04FD9189D") DXGradient;
#endif
...
class DECLSPEC_UUID("385A91BC-1E8A-4e4a-A7A6-F4FC1E6CA1BD") DXTFilter;
#endif
