...
//
//   The following declarations within the 'if 0' block are dummy typedefs used
//   to make the motncomp.idl file build.  The actual definitions are contained
//   in ddraw.h and amva.h
//
#if 0
typedef void *LPVOID;
...
#define IAMVideoAcceleratorNotify_GetUncompSurfacesInfo(This, pGuid,           \
                                                        pUncompBufferInfo)     \
  (This)->lpVtbl->GetUncompSurfacesInfo(This, pGuid, pUncompBufferInfo)

#define IAMVideoAcceleratorNotify_SetUncompSurfacesInfo(                       \
    This, dwActualUncompSurfacesAllocated)                                     \
  (This)->lpVtbl->SetUncompSurfacesInfo(This, dwActualUncompSurfacesAllocated)

#define IAMVideoAcceleratorNotify_GetCreateVideoAcceleratorData(               \
    This, pGuid, pdwSizeMiscData, ppMiscData)                                  \
  (This)->lpVtbl->GetCreateVideoAcceleratorData(This, pGuid, pdwSizeMiscData,  \
                                                ppMiscData)
...
IAMVideoAcceleratorNotify_GetCreateVideoAcceleratorData_Proxy(
    IAMVideoAcceleratorNotify *This,
    /* [in] */ const GUID *pGuid,
    /* [out] */ LPDWORD pdwSizeMiscData,
    /* [out] */ LPVOID *ppMiscData);
...
#define IAMVideoAccelerator_GetVideoAcceleratorGUIDs(                          \
    This, pdwNumGuidsSupported, pGuidsSupported)                               \
  (This)->lpVtbl->GetVideoAcceleratorGUIDs(This, pdwNumGuidsSupported,         \
                                           pGuidsSupported)

#define IAMVideoAccelerator_GetUncompFormatsSupported(                         \
    This, pGuid, pdwNumFormatsSupported, pFormatsSupported)                    \
  (This)->lpVtbl->GetUncompFormatsSupported(                                   \
      This, pGuid, pdwNumFormatsSupported, pFormatsSupported)

#define IAMVideoAccelerator_GetInternalMemInfo(                                \
    This, pGuid, pamvaUncompDataInfo, pamvaInternalMemInfo)                    \
  (This)->lpVtbl->GetInternalMemInfo(This, pGuid, pamvaUncompDataInfo,         \
                                     pamvaInternalMemInfo)

#define IAMVideoAccelerator_GetCompBufferInfo(                                 \
    This, pGuid, pamvaUncompDataInfo, pdwNumTypesCompBuffers,                  \
    pamvaCompBufferInfo)                                                       \
  (This)->lpVtbl->GetCompBufferInfo(This, pGuid, pamvaUncompDataInfo,          \
                                    pdwNumTypesCompBuffers,                    \
                                    pamvaCompBufferInfo)

#define IAMVideoAccelerator_GetInternalCompBufferInfo(                         \
    This, pdwNumTypesCompBuffers, pamvaCompBufferInfo)                         \
  (This)->lpVtbl->GetInternalCompBufferInfo(This, pdwNumTypesCompBuffers,      \
                                            pamvaCompBufferInfo)
...
#define IAMVideoAccelerator_GetBuffer(This, dwTypeIndex, dwBufferIndex,        \
                                      bReadOnly, ppBuffer, lpStride)           \
  (This)->lpVtbl->GetBuffer(This, dwTypeIndex, dwBufferIndex, bReadOnly,       \
                            ppBuffer, lpStride)
...
#define IAMVideoAccelerator_Execute(                                           \
    This, dwFunction, lpPrivateInputData, cbPrivateInputData,                  \
    lpPrivateOutputDat, cbPrivateOutputData, dwNumBuffers, pamvaBufferInfo)    \
  (This)->lpVtbl->Execute(This, dwFunction, lpPrivateInputData,                \
                          cbPrivateInputData, lpPrivateOutputDat,              \
                          cbPrivateOutputData, dwNumBuffers, pamvaBufferInfo)

#define IAMVideoAccelerator_QueryRenderStatus(This, dwTypeIndex,               \
                                              dwBufferIndex, dwFlags)          \
...
HRESULT STDMETHODCALLTYPE
IAMVideoAccelerator_GetBuffer_Proxy(IAMVideoAccelerator *This,
                                    /* [in] */ DWORD dwTypeIndex,
                                    /* [in] */ DWORD dwBufferIndex,
                                    /* [in] */ BOOL bReadOnly,
                                    /* [out] */ LPVOID *ppBuffer,
...
HRESULT STDMETHODCALLTYPE
IAMVideoAccelerator_ReleaseBuffer_Proxy(IAMVideoAccelerator *This,
                                        /* [in] */ DWORD dwTypeIndex,
                                        /* [in] */ DWORD dwBufferIndex);
...
HRESULT STDMETHODCALLTYPE
IAMVideoAccelerator_QueryRenderStatus_Proxy(IAMVideoAccelerator *This,
                                            /* [in] */ DWORD dwTypeIndex,
                                            /* [in] */ DWORD dwBufferIndex,
                                            /* [in] */ DWORD dwFlags);
...
HRESULT STDMETHODCALLTYPE
IAMVideoAccelerator_DisplayFrame_Proxy(IAMVideoAccelerator *This,
                                       /* [in] */ DWORD dwFlipToIndex,
                                       /* [in] */ IMediaSample *pMediaSample);
