...
DEFINE_GUID(CLSID_DMOWrapperFilter, 0x94297043, 0xbd82, 0x4dfd, 0xb0, 0xde,
            0x81, 0x77, 0x73, 0x9c, 0x6d, 0x20);
DEFINE_GUID(CLSID_DMOFilterCategory, 0xbcd5796c, 0xbd52, 0x4d30, 0xab, 0x76,
            0x70, 0xf9, 0x75, 0xb8, 0x91, 0x99);
...
public:
  virtual HRESULT STDMETHODCALLTYPE Init(REFCLSID clsidDMO,
                                         REFCLSID catDMO) = 0;
};
...
typedef struct IDMOWrapperFilterVtbl {
  ...
  (IDMOWrapperFilter *This, REFCLSID clsidDMO, REFCLSID catDMO);
...
HRESULT STDMETHODCALLTYPE IDMOWrapperFilter_Init_Proxy(IDMOWrapperFilter *This,
                                                       REFCLSID clsidDMO,
                                                       REFCLSID catDMO);
