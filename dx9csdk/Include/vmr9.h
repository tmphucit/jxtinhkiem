...
typedef struct IVMRImagePresenter9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRImagePresenter9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRImagePresenter9 *This);
...
IVMRImagePresenter9_StartPresenting_Proxy(IVMRImagePresenter9 *This,
                                          /* [in] */ DWORD_PTR dwUserID);
...
HRESULT STDMETHODCALLTYPE
IVMRImagePresenter9_StopPresenting_Proxy(IVMRImagePresenter9 *This,
                                         /* [in] */ DWORD_PTR dwUserID);
...
typedef struct IVMRSurfaceAllocator9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRSurfaceAllocator9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRSurfaceAllocator9 *This);
...
#define IVMRSurfaceAllocator9_InitializeDevice(This, dwUserID, lpAllocInfo,    \
                                               lpNumBuffers)                   \
...
#define IVMRSurfaceAllocator9_GetSurface(This, dwUserID, SurfaceIndex,         \
                                         SurfaceFlags, lplpSurface)            \
  (This)->lpVtbl->GetSurface(This, dwUserID, SurfaceIndex, SurfaceFlags,       \
                             lplpSurface)
...
HRESULT STDMETHODCALLTYPE
IVMRSurfaceAllocator9_TerminateDevice_Proxy(IVMRSurfaceAllocator9 *This,
                                            /* [in] */ DWORD_PTR dwID);
...
typedef struct IVMRSurfaceAllocatorNotify9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRSurfaceAllocatorNotify9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRSurfaceAllocatorNotify9 *This);
...
#define IVMRSurfaceAllocatorNotify9_ChangeD3DDevice(This, lpD3DDevice,         \
                                                    hMonitor)                  \
  (This)->lpVtbl->ChangeD3DDevice(This, lpD3DDevice, hMonitor)

#define IVMRSurfaceAllocatorNotify9_AllocateSurfaceHelper(                     \
    This, lpAllocInfo, lpNumBuffers, lplpSurface)                              \
  (This)->lpVtbl->AllocateSurfaceHelper(This, lpAllocInfo, lpNumBuffers,       \
                                        lplpSurface)

#define IVMRSurfaceAllocatorNotify9_NotifyEvent(This, EventCode, Param1,       \
                                                Param2)                        \
...
HRESULT STDMETHODCALLTYPE
IVMRSurfaceAllocatorNotify9_AdviseSurfaceAllocator_Proxy(
    IVMRSurfaceAllocatorNotify9 *This,
    /* [in] */ DWORD_PTR dwUserID,
    /* [in] */ IVMRSurfaceAllocator9 *lpIVRMSurfaceAllocator);
...
HRESULT STDMETHODCALLTYPE
IVMRSurfaceAllocatorNotify9_AllocateSurfaceHelper_Proxy(
    IVMRSurfaceAllocatorNotify9 *This,
    /* [in] */ VMR9AllocationInfo *lpAllocInfo,
    /* [out][in] */ DWORD *lpNumBuffers,
    /* [out] */ IDirect3DSurface9 **lplpSurface);
...
HRESULT STDMETHODCALLTYPE
IVMRSurfaceAllocatorNotify9_NotifyEvent_Proxy(IVMRSurfaceAllocatorNotify9 *This,
                                              /* [in] */ LONG EventCode,
                                              /* [in] */ LONG_PTR Param1,
                                              /* [in] */ LONG_PTR Param2);
...
typedef struct IVMRWindowlessControl9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRWindowlessControl9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRWindowlessControl9 *This);
  ...
  HRESULT(STDMETHODCALLTYPE *DisplayModeChanged)(IVMRWindowlessControl9 *This);
...
#define IVMRWindowlessControl9_GetNativeVideoSize(This, lpWidth, lpHeight,     \
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_GetNativeVideoSize_Proxy(IVMRWindowlessControl9 *This,
                                                /* [out] */ LONG *lpWidth,
                                                /* [out] */ LONG *lpHeight,
                                                /* [out] */ LONG *lpARWidth,
                                                /* [out] */ LONG *lpARHeight);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_GetMinIdealVideoSize_Proxy(IVMRWindowlessControl9 *This,
                                                  /* [out] */ LONG *lpWidth,
                                                  /* [out] */ LONG *lpHeight);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_GetMaxIdealVideoSize_Proxy(IVMRWindowlessControl9 *This,
                                                  /* [out] */ LONG *lpWidth,
                                                  /* [out] */ LONG *lpHeight);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_GetVideoPosition_Proxy(IVMRWindowlessControl9 *This,
                                              /* [out] */ LPRECT lpSRCRect,
                                              /* [out] */ LPRECT lpDSTRect);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_RepaintVideo_Proxy(IVMRWindowlessControl9 *This,
                                          /* [in] */ HWND hwnd,
                                          /* [in] */ HDC hdc);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_DisplayModeChanged_Proxy(IVMRWindowlessControl9 *This);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_GetCurrentImage_Proxy(IVMRWindowlessControl9 *This,
                                             /* [out] */ BYTE **lpDib);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_SetBorderColor_Proxy(IVMRWindowlessControl9 *This,
                                            /* [in] */ COLORREF Clr);
...
HRESULT STDMETHODCALLTYPE
IVMRWindowlessControl9_GetBorderColor_Proxy(IVMRWindowlessControl9 *This,
                                            /* [out] */ COLORREF *lpClr);
...
typedef struct IVMRMixerControl9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRMixerControl9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRMixerControl9 *This);
...
#define IVMRMixerControl9_GetProcAmpControlRange(This, dwStreamID,             \
                                                 lpClrControl)                 \
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_SetAlpha_Proxy(IVMRMixerControl9 *This,
                                 /* [in] */ DWORD dwStreamID,
                                 /* [in] */ float Alpha);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_GetAlpha_Proxy(IVMRMixerControl9 *This,
                                 /* [in] */ DWORD dwStreamID,
                                 /* [out] */ float *pAlpha);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_SetZOrder_Proxy(IVMRMixerControl9 *This,
                                  /* [in] */ DWORD dwStreamID,
                                  /* [in] */ DWORD dwZ);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_GetZOrder_Proxy(IVMRMixerControl9 *This,
                                  /* [in] */ DWORD dwStreamID,
                                  /* [out] */ DWORD *pZ);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_GetOutputRect_Proxy(IVMRMixerControl9 *This,
                                      /* [in] */ DWORD dwStreamID,
                                      /* [out] */ VMR9NormalizedRect *pRect);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_SetBackgroundClr_Proxy(IVMRMixerControl9 *This,
                                         /* [in] */ COLORREF ClrBkg);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_GetBackgroundClr_Proxy(IVMRMixerControl9 *This,
                                         /* [in] */ COLORREF *lpClrBkg);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_SetMixingPrefs_Proxy(IVMRMixerControl9 *This,
                                       /* [in] */ DWORD dwMixerPrefs);
...
HRESULT STDMETHODCALLTYPE
IVMRMixerControl9_GetMixingPrefs_Proxy(IVMRMixerControl9 *This,
                                       /* [out] */ DWORD *pdwMixerPrefs);
...
typedef struct IVMRMixerBitmap9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRMixerBitmap9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRMixerBitmap9 *This);
...
interface IVMRMixerBitmap9 { CONST_VTBL struct IVMRMixerBitmap9Vtbl *lpVtbl; };
...
typedef struct IVMRSurface9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRSurface9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRSurface9 *This);

  HRESULT(STDMETHODCALLTYPE *IsSurfaceLocked)(IVMRSurface9 *This);

  HRESULT(STDMETHODCALLTYPE *LockSurface)
  (IVMRSurface9 *This,
   /* [out] */ BYTE **lpSurface);

  HRESULT(STDMETHODCALLTYPE *UnlockSurface)(IVMRSurface9 *This);
...
interface IVMRSurface9 { CONST_VTBL struct IVMRSurface9Vtbl *lpVtbl; };
...
HRESULT STDMETHODCALLTYPE
IVMRSurface9_IsSurfaceLocked_Proxy(IVMRSurface9 *This);
...
HRESULT STDMETHODCALLTYPE
IVMRSurface9_LockSurface_Proxy(IVMRSurface9 *This,
                               /* [out] */ BYTE **lpSurface);
...
HRESULT STDMETHODCALLTYPE IVMRSurface9_UnlockSurface_Proxy(IVMRSurface9 *This);
...
HRESULT STDMETHODCALLTYPE
IVMRSurface9_GetSurface_Proxy(IVMRSurface9 *This,
                              /* [out] */ IDirect3DSurface9 **lplpSurface);
...
typedef struct IVMRImagePresenterConfig9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRImagePresenterConfig9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRImagePresenterConfig9 *This);
...
typedef struct IVMRVideoStreamControl9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRVideoStreamControl9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRVideoStreamControl9 *This);
...
typedef struct IVMRFilterConfig9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRFilterConfig9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRFilterConfig9 *This);
...
HRESULT STDMETHODCALLTYPE
IVMRFilterConfig9_SetNumberOfStreams_Proxy(IVMRFilterConfig9 *This,
                                           /* [in] */ DWORD dwMaxStreams);
...
HRESULT STDMETHODCALLTYPE
IVMRFilterConfig9_GetNumberOfStreams_Proxy(IVMRFilterConfig9 *This,
                                           /* [out] */ DWORD *pdwMaxStreams);
...
HRESULT STDMETHODCALLTYPE
IVMRFilterConfig9_SetRenderingPrefs_Proxy(IVMRFilterConfig9 *This,
                                          /* [in] */ DWORD dwRenderFlags);
...
HRESULT STDMETHODCALLTYPE
IVMRFilterConfig9_GetRenderingPrefs_Proxy(IVMRFilterConfig9 *This,
                                          /* [out] */ DWORD *pdwRenderFlags);
...
HRESULT STDMETHODCALLTYPE
IVMRFilterConfig9_SetRenderingMode_Proxy(IVMRFilterConfig9 *This,
                                         /* [in] */ DWORD Mode);
...
HRESULT STDMETHODCALLTYPE
IVMRFilterConfig9_GetRenderingMode_Proxy(IVMRFilterConfig9 *This,
                                         /* [out] */ DWORD *pMode);
...
typedef struct IVMRAspectRatioControl9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRAspectRatioControl9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRAspectRatioControl9 *This);
...
HRESULT STDMETHODCALLTYPE
IVMRAspectRatioControl9_SetAspectRatioMode_Proxy(IVMRAspectRatioControl9 *This,
                                                 /* [in] */ DWORD dwARMode);
...
typedef struct IVMRMonitorConfig9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRMonitorConfig9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRMonitorConfig9 *This);
...
#define IVMRMonitorConfig9_GetAvailableMonitors(                               \
...
HRESULT STDMETHODCALLTYPE
IVMRMonitorConfig9_SetMonitor_Proxy(IVMRMonitorConfig9 *This,
                                    /* [in] */ UINT uDev);
...
HRESULT STDMETHODCALLTYPE
IVMRMonitorConfig9_GetMonitor_Proxy(IVMRMonitorConfig9 *This,
                                    /* [out] */ UINT *puDev);
...
HRESULT STDMETHODCALLTYPE
IVMRMonitorConfig9_SetDefaultMonitor_Proxy(IVMRMonitorConfig9 *This,
                                           /* [in] */ UINT uDev);
...
HRESULT STDMETHODCALLTYPE
IVMRMonitorConfig9_GetDefaultMonitor_Proxy(IVMRMonitorConfig9 *This,
                                           /* [out] */ UINT *puDev);
...
typedef struct IVMRDeinterlaceControl9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRDeinterlaceControl9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRDeinterlaceControl9 *This);
...
#define IVMRDeinterlaceControl9_GetActualDeinterlaceMode(This, dwStreamID,     \
                                                         lpDeinterlaceMode)    \
...
HRESULT STDMETHODCALLTYPE
IVMRDeinterlaceControl9_GetNumberOfDeinterlaceModes_Proxy(
    IVMRDeinterlaceControl9 *This,
    /* [in] */ VMR9VideoDesc *lpVideoDescription,
    /* [out][in] */ LPDWORD lpdwNumDeinterlaceModes,
    /* [out] */ LPGUID lpDeinterlaceModes);
...
HRESULT STDMETHODCALLTYPE
IVMRDeinterlaceControl9_GetActualDeinterlaceMode_Proxy(
    IVMRDeinterlaceControl9 *This,
    /* [in] */ DWORD dwStreamID,
    /* [out] */ LPGUID lpDeinterlaceMode);
...
typedef struct IVMRImageCompositor9Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IVMRImageCompositor9 *This);

  ULONG(STDMETHODCALLTYPE *Release)(IVMRImageCompositor9 *This);
...
#define IVMRImageCompositor9_CompositeImage(                                   \
...
HRESULT STDMETHODCALLTYPE
IVMRImageCompositor9_SetStreamMediaType_Proxy(IVMRImageCompositor9 *This,
                                              /* [in] */ DWORD dwStrmID,
                                              /* [in] */ AM_MEDIA_TYPE *pmt,
                                              /* [in] */ BOOL fTexture);
