...
//   to make the ddstream.idl file build.  The actual definitions are contained
//   in DDRAW.H
//
#if 0
...
typedef struct IDirectDrawMediaStreamVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDirectDrawMediaStream *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDirectDrawMediaStream *This);
  ...
  (IDirectDrawMediaStream *This, DWORD dwFlags);
...
#define IDirectDrawMediaStream_SetSameFormat(                                  \
    This, pStreamThatHasDesiredFormat, dwFlags)                                \
  (This)->lpVtbl->SetSameFormat(This, pStreamThatHasDesiredFormat, dwFlags)

#define IDirectDrawMediaStream_AllocateSample(This, dwFlags, ppSample)         \
  (This)->lpVtbl->AllocateSample(This, dwFlags, ppSample)

#define IDirectDrawMediaStream_CreateSharedSample(This, pExistingSample,       \
                                                  dwFlags, ppNewSample)        \
...
#define IDirectDrawMediaStream_GetFormat(                                      \
    This, pDDSDCurrent, ppDirectDrawPalette, pDDSDDesired, pdwFlags)           \
  (This)->lpVtbl->GetFormat(This, pDDSDCurrent, ppDirectDrawPalette,           \
                            pDDSDDesired, pdwFlags)

#define IDirectDrawMediaStream_SetFormat(This, pDDSurfaceDesc,                 \
                                         pDirectDrawPalette)                   \
...
#define IDirectDrawMediaStream_CreateSample(This, pSurface, pRect, dwFlags,    \
                                            ppSample)                          \
...
IDirectDrawMediaStream_SetDirectDraw_Proxy(IDirectDrawMediaStream *This,
                                           /* [in] */ IDirectDraw *pDirectDraw);
...
typedef struct IDirectDrawStreamSampleVtbl {
  ...
  ULONG(STDMETHODCALLTYPE *AddRef)(IDirectDrawStreamSample *This);

  ULONG(STDMETHODCALLTYPE *Release)(IDirectDrawStreamSample *This);
...
#define IDirectDrawStreamSample_GetSampleTimes(This, pStartTime, pEndTime,     \
                                               pCurrentTime)                   \
...
#define IDirectDrawStreamSample_Update(This, dwFlags, hEvent, pfnAPC,          \
                                       dwAPCData)                              \
  (This)->lpVtbl->Update(This, dwFlags, hEvent, pfnAPC, dwAPCData)

#define IDirectDrawStreamSample_CompletionStatus(This, dwFlags,                \
                                                 dwMilliseconds)               \
...
HRESULT STDMETHODCALLTYPE
IDirectDrawStreamSample_SetRect_Proxy(IDirectDrawStreamSample *This,
                                      /* [in] */ const RECT *pRect);
