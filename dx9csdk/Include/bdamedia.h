...
//      To receive,
//          0) Implement IBroadcastEvent in your receiving object - this has one
//          Method on it: Fire() 1) QI the graphs service provider for
//          SID_SBroadcastEventService
//                 for the IID_IBroadcastEvent object
//          2) OR create the event service (CLSID_BroadcastEventService) if not
//          already there
//                 and register it
//          3) QI that object for it's IConnectionPoint interface (*pCP)
//          4) Advise your object on *pCP  (e.g.
//          pCP->Advise(static_cast<IBroadCastEvent*>(this), &dwCookie) 5)
//          Unadvise when done.. 6) Implement IBroadcastEvent::Fire(GUID
//          gEventID)
...
DEFINE_GUIDSTRUCT("9D7E6235-4B7D-425d-A6D1-D717C33B9C4C",
...
DEFINE_GUIDSTRUCT("2A65C528-2249-4070-AC16-00390CDFB2DD",
                  EVENTID_CADenialCountChanged);
#define EVENTID_CADenialCountChanged                                           \
...
DEFINE_GUIDSTRUCT("6D9CFAF2-702D-4b01-8DFF-6892AD20D191",
                  EVENTID_SignalStatusChanged);
#define EVENTID_SignalStatusChanged                                            \
...
#define KSDATAFORMAT_TYPE_BDA_ANTENNA                                          \
...
#define KSDATAFORMAT_SUBTYPE_ATSC_SI                                           \
...
#define KSDATAFORMAT_SUBTYPE_DVB_SI                                            \
...
DEFINE_GUIDSTRUCT("78216A81-CFA8-493e-9711-36A61C08BD9D",
...
DEFINE_GUIDSTRUCT("5C0C8281-5667-486c-8482-63E31F01A6E9",
...
DEFINE_GUIDSTRUCT("D28A580A-9B1F-4b0c-9C33-9BF0A8EA636B",
...
DEFINE_GUIDSTRUCT("297BB104-E5C9-4ACE-B123-95C3CBB24D4F",
                  PINNAME_BDA_OPENCABLE_PSIP_PIN);
#define PINNAME_BDA_OPENCABLE_PSIP_PIN                                         \
...
DEFINE_GUIDSTRUCT("71985F43-1CA1-11d3-9CC8-00C04F7971E0",
                  KSPROPSETID_BdaEthernetFilter);
#define KSPROPSETID_BdaEthernetFilter                                          \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_ETHERNET_FILTER_MULTICAST_LIST_SIZE(        \
    GetHandler, SetHandler)                                                    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ETHERNET_FILTER_MULTICAST_LIST_SIZE,   \
                         (GetHandler), sizeof(KSPROPERTY), sizeof(ULONG),      \
                         FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ETHERNET_FILTER_MULTICAST_LIST(GetHandler,  \
                                                                  SetHandler)  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ETHERNET_FILTER_MULTICAST_LIST,        \
                         (GetHandler), sizeof(KSPROPERTY),                     \
                         sizeof(BDA_ETHERNET_ADDRESS_LIST), (SetHandler),      \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ETHERNET_FILTER_MULTICAST_MODE(GetHandler,  \
                                                                  SetHandler)  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ETHERNET_FILTER_MULTICAST_MODE,        \
                         (GetHandler), sizeof(KSPROPERTY),                     \
                         sizeof(BDA_MULTICAST_MODE), (SetHandler), NULL, 0,    \
                         NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("71985F44-1CA1-11d3-9CC8-00C04F7971E0",
...
#define DEFINE_KSPROPERTY_ITEM_BDA_IPv4_FILTER_MULTICAST_LIST_SIZE(GetHandler, \
                                                                   SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv4_FILTER_MULTICAST_LIST_SIZE,       \
                         (GetHandler), sizeof(KSPROPERTY), sizeof(ULONG),      \
                         FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv4_FILTER_MULTICAST_LIST(GetHandler,      \
                                                              SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv4_FILTER_MULTICAST_LIST,            \
                         (GetHandler), sizeof(KSPROPERTY),                     \
                         sizeof(BDA_IPv4_ADDRESS_LIST), (SetHandler), NULL, 0, \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv4_FILTER_MULTICAST_MODE(GetHandler,      \
                                                              SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv4_FILTER_MULTICAST_MODE,            \
                         (GetHandler), sizeof(KSPROPERTY),                     \
                         sizeof(BDA_MULTICAST_MODE), (SetHandler), NULL, 0,    \
                         NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("E1785A74-2A23-4fb3-9245-A8F88017EF33",
...
#define DEFINE_KSPROPERTY_ITEM_BDA_IPv6_FILTER_MULTICAST_LIST_SIZE(GetHandler, \
                                                                   SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv6_FILTER_MULTICAST_LIST_SIZE,       \
                         (GetHandler), sizeof(KSPROPERTY), sizeof(ULONG),      \
                         FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv6_FILTER_MULTICAST_LIST(GetHandler,      \
                                                              SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv6_FILTER_MULTICAST_LIST,            \
                         (GetHandler), sizeof(KSPROPERTY),                     \
                         sizeof(BDA_IPv6_ADDRESS_LIST), (SetHandler), NULL, 0, \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv6_FILTER_MULTICAST_MODE(GetHandler,      \
                                                              SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv6_FILTER_MULTICAST_MODE,            \
                         (GetHandler), sizeof(KSPROPERTY),                     \
                         sizeof(BDA_MULTICAST_MODE), (SetHandler), NULL, 0,    \
                         NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_STRENGTH(GetHandler, SetHandler)     \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_STRENGTH, (GetHandler),         \
                         sizeof(KSP_NODE), sizeof(LONG), (SetHandler), NULL,   \
                         0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_QUALITY(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_QUALITY, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(LONG), (SetHandler), NULL,   \
                         0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_PRESENT(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_PRESENT, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(BOOL), (SetHandler), NULL,   \
                         0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_LOCKED(GetHandler, SetHandler)       \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_LOCKED, (GetHandler),           \
                         sizeof(KSP_NODE), sizeof(BOOL), (SetHandler), NULL,   \
                         0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SAMPLE_TIME(GetHandler, SetHandler)         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SAMPLE_TIME, (GetHandler),             \
                         sizeof(KSP_NODE), sizeof(LONG), (SetHandler), NULL,   \
                         0, NULL, NULL, 0)
...
#define KSMETHODSETID_BdaChangeSync                                            \
...
#define DEFINE_KSMETHOD_ITEM_BDA_START_CHANGES(MethodHandler, SupportHandler)  \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_START_CHANGES, KSMETHOD_TYPE_NONE,         \
                       (MethodHandler), sizeof(KSMETHOD), 0, SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_CHECK_CHANGES(MethodHandler, SupportHandler)  \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CHECK_CHANGES, KSMETHOD_TYPE_NONE,         \
                       (MethodHandler), sizeof(KSMETHOD), 0, SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_COMMIT_CHANGES(MethodHandler, SupportHandler) \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_COMMIT_CHANGES, KSMETHOD_TYPE_NONE,        \
                       (MethodHandler), sizeof(KSMETHOD), 0, SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GET_CHANGE_STATE(MethodHandler,               \
                                                  SupportHandler)              \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GET_CHANGE_STATE, KSMETHOD_TYPE_READ,      \
                       (MethodHandler), sizeof(KSMETHOD), 0, SupportHandler)
...
#define DEFINE_KSMETHOD_ITEM_BDA_CREATE_PIN_FACTORY(MethodHandler,             \
                                                    SupportHandler)            \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CREATE_PIN_FACTORY, KSMETHOD_TYPE_READ,    \
                       (MethodHandler), sizeof(KSM_BDA_PIN), sizeof(ULONG),    \
                       SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_DELETE_PIN_FACTORY(MethodHandler,             \
                                                    SupportHandler)            \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_DELETE_PIN_FACTORY, KSMETHOD_TYPE_NONE,    \
                       (MethodHandler), sizeof(KSM_BDA_PIN), 0,                \
                       SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_CREATE_TOPOLOGY(MethodHandler,                \
                                                 SupportHandler)               \
  DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CREATE_TOPOLOGY, KSMETHOD_TYPE_WRITE,      \
                       (MethodHandler), sizeof(KSM_BDA_PIN_PAIR), 0,           \
                       SupportHandler)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_TYPES(GetHandler, SetHandler)          \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_TYPES, (GetHandler),              \
                         sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIN_TYPES(GetHandler, SetHandler)           \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIN_TYPES, (GetHandler),               \
                         sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_TEMPLATE_CONNECTIONS(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_TEMPLATE_CONNECTIONS, (GetHandler),    \
                         sizeof(KSPROPERTY), sizeof(BDA_TEMPLATE_CONNECTION),  \
                         FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_METHODS(GetHandler, SetHandler)        \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_METHODS, (GetHandler),            \
                         sizeof(KSP_NODE), 0, FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_PROPERTIES(GetHandler, SetHandler)     \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_PROPERTIES, (GetHandler),         \
                         sizeof(KSP_NODE), 0, FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_EVENTS(GetHandler, SetHandler)         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_EVENTS, (GetHandler),             \
                         sizeof(KSP_NODE), 0, FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CONTROLLING_PIN_ID(GetHandler, SetHandler)  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CONTROLLING_PIN_ID, (GetHandler),      \
                         sizeof(KSP_BDA_NODE_PIN), sizeof(ULONG), FALSE, NULL, \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_DESCRIPTORS(GetHandler, SetHandler)    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_DESCRIPTORS, (GetHandler),        \
                         sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_PIN_ID(GetHandler, SetHandler)              \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIN_ID, (GetHandler),                  \
                         sizeof(KSPROPERTY), sizeof(ULONG), FALSE, NULL, 0,    \
                         NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIN_TYPE(GetHandler, SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIN_TYPE, (GetHandler),                \
                         sizeof(KSPROPERTY), sizeof(ULONG), FALSE, NULL, 0,    \
                         NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("104781CD-50BD-40d5-95FB-087E0E86A591",
...
#define DEFINE_KSEVENT_ITEM_BDA_PIN_CONNECTED(AddHandler, RemoveHandler,       \
                                              SupportHandler)                  \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_PIN_CONNECTED, sizeof(KSEVENTDATA), 0,       \
                      (AddHandler), (RemoveHandler), (SupportHandler))

#define DEFINE_KSEVENT_ITEM_BDA_PIN_DISCONNECTED(AddHandler, RemoveHandler,    \
                                                 SupportHandler)               \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_PIN_DISCONNECTED, sizeof(KSEVENTDATA), 0,    \
                      (AddHandler), (RemoveHandler), (SupportHandler))
...
DEFINE_GUIDSTRUCT("71985F46-1CA1-11d3-9CC8-00C04F7971E0",
                  KSPROPSETID_BdaVoidTransform);
#define KSPROPSETID_BdaVoidTransform                                           \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_VOID_TRANSFORM_START(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_VOID_TRANSFORM_START, FALSE,           \
                         sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, NULL,   \
                         NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_VOID_TRANSFORM_STOP(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_VOID_TRANSFORM_STOP, FALSE,            \
                         sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, NULL,   \
                         NULL, 0)
...
DEFINE_GUIDSTRUCT("DDF15B0D-BD25-11d2-9CA0-00C04F7971E0",
...
#define DEFINE_KSPROPERTY_ITEM_BDA_NULL_TRANSFORM_START(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NULL_TRANSFORM_START, FALSE,           \
                         sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, NULL,   \
                         NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NULL_TRANSFORM_STOP(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NULL_TRANSFORM_STOP, FALSE,            \
                         sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, NULL,   \
                         NULL, 0)
...
#define KSPROPSETID_BdaFrequencyFilter                                         \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_FREQUENCY(GetHandler, SetHandler)  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_FREQUENCY, (GetHandler),      \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_POLARITY(GetHandler, SetHandler)   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_POLARITY, (GetHandler),       \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_RANGE(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_RANGE, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_TRANSPONDER(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_TRANSPONDER, (GetHandler),    \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_BANDWIDTH(GetHandler, SetHandler)  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_BANDWIDTH, (GetHandler),      \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_FREQUENCY_MULTIPLIER(GetHandler,   \
                                                                 SetHandler)   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_FREQUENCY_MULTIPLIER,         \
                         (GetHandler), sizeof(KSP_NODE), sizeof(ULONG),        \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_LNB_LOF_LOW_BAND(GetHandler, SetHandler)    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_LNB_LOF_LOW_BAND, (GetHandler),        \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_LNB_LOF_HIGH_BAND(GetHandler, SetHandler)   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_LNB_LOF_HIGH_BAND, (GetHandler),       \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_LNB_SWITCH_FREQUENCY(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_LNB_SWITCH_FREQUENCY, (GetHandler),    \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_MODULATION_TYPE(GetHandler, SetHandler)     \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_MODULATION_TYPE, (GetHandler),         \
                         sizeof(KSP_NODE), sizeof(ModulationType),             \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_INNER_FEC_TYPE(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_INNER_FEC_TYPE, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(FECMethod), (SetHandler),    \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_INNER_FEC_RATE(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_INNER_FEC_RATE, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(BinaryConvolutionCodeRate),  \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_OUTER_FEC_TYPE(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_OUTER_FEC_TYPE, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(FECMethod), (SetHandler),    \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_OUTER_FEC_RATE(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_OUTER_FEC_RATE, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(BinaryConvolutionCodeRate),  \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SYMBOL_RATE(GetHandler, SetHandler)         \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SYMBOL_RATE, (GetHandler),             \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SPECTRAL_INVERSION(GetHandler, SetHandler)  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SPECTRAL_INVERSION, (GetHandler),      \
                         sizeof(KSP_NODE), sizeof(SpectralInversion),          \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_GUARD_INTERVAL(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_GUARD_INTERVAL, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(GuardInterval),              \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_TRANSMISSION_MODE(GetHandler, SetHandler)   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_TRANSMISSION_MODE, (GetHandler),       \
                         sizeof(KSP_NODE), sizeof(TransmissionMode),           \
                         (SetHandler), NULL, 0, NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("DDF15B12-BD25-11d2-9CA0-00C04F7971E0",
                  KSPROPSETID_BdaAutodemodulate);
#define KSPROPSETID_BdaAutodemodulate                                          \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_AUTODEMODULATE_START(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_AUTODEMODULATE_START, FALSE,           \
                         sizeof(KSP_NODE), 0, (SetHandler), NULL, 0, NULL,     \
                         NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_AUTODEMODULATE_STOP(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_AUTODEMODULATE_STOP, FALSE,            \
                         sizeof(KSP_NODE), 0, (SetHandler), NULL, 0, NULL,     \
                         NULL, 0)
...
DEFINE_GUIDSTRUCT("516B99C5-971C-4aaf-B3F3-D9FDA8A15E16",
                  KSPROPSETID_BdaTableSection);
#define KSPROPSETID_BdaTableSection                                            \
...
#define DEFINE_KSPROPERTY_ITEM_BDA_TABLE_SECTION(GetHandler, SetHandler)       \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_TABLE_SECTION, (GetHandler),           \
                         sizeof(KSP_NODE), sizeof(BDA_TABLE_SECTION),          \
                         (SetHandler), NULL, 0, NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("D0A67D65-08DF-4fec-8533-E5B550410B85",
...
#define DEFINE_KSPROPERTY_ITEM_BDA_PIDFILTER_MAP_PIDS(GetHandler, SetHandler)  \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIDFILTER_MAP_PIDS, (GetHandler),      \
                         sizeof(KSP_NODE), sizeof(BDA_PID_MAP), (SetHandler),  \
                         NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIDFILTER_UNMAP_PIDS(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIDFILTER_UNMAP_PIDS, (GetHandler),    \
                         sizeof(KSP_NODE), sizeof(BDA_PID_UNMAP),              \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIDFILTER_LIST_PIDS(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIDFILTER_LIST_PIDS, (GetHandler),     \
                         sizeof(KSP_NODE), 0, (SetHandler), NULL, 0, NULL,     \
                         NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_ECM_MAP_STATUS(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ECM_MAP_STATUS, (GetHandler),          \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_MODULE_STATUS(GetHandler, SetHandler)    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_MODULE_STATUS, (GetHandler),        \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_SMART_CARD_STATUS(GetHandler,            \
                                                        SetHandler)            \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_SMART_CARD_STATUS, (GetHandler),    \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_MODULE_UI(GetHandler, SetHandler)        \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_MODULE_UI, (GetHandler),            \
                         sizeof(KSP_NODE), sizeof(BDA_CA_MODULE_UI),           \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_SET_PROGRAM_PIDS(GetHandler, SetHandler) \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_SET_PROGRAM_PIDS, (GetHandler),     \
                         sizeof(KSP_NODE), sizeof(BDA_PROGRAM_PID_LIST),       \
                         (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_REMOVE_PROGRAM(GetHandler, SetHandler)   \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_REMOVE_PROGRAM, (GetHandler),       \
                         sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), NULL,  \
                         0, NULL, NULL, 0)
...
DEFINE_GUIDSTRUCT("488C4CCC-B768-4129-8EB1-B00A071F9068",
...
#define DEFINE_KSEVENT_BDA_PROGRAM_FLOW_STATUS_CHANGED(                        \
    AddHandler, RemoveHandler, SupportHandler)                                 \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_PROGRAM_FLOW_STATUS_CHANGED,                 \
                      sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler),   \
                      (SupportHandler))

#define DEFINE_KSEVENT_BDA_CA_MODULE_STATUS_CHANGED(AddHandler, RemoveHandler, \
                                                    SupportHandler)            \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_CA_MODULE_STATUS_CHANGED,                    \
                      sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler),   \
                      (SupportHandler))

#define DEFINE_KSEVENT_BDA_CA_SMART_CARD_STATUS_CHANGED(                       \
    AddHandler, RemoveHandler, SupportHandler)                                 \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_CA_SMART_CARD_STATUS_CHANGED,                \
                      sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler),   \
                      (SupportHandler))

#define DEFINE_KSEVENT_BDA_CA_MODULE_UI_REQUESTED(AddHandler, RemoveHandler,   \
                                                  SupportHandler)              \
  DEFINE_KSEVENT_ITEM(KSEVENT_BDA_CA_MODULE_UI_REQUESTED, sizeof(KSEVENTDATA), \
                      0, (AddHandler), (RemoveHandler), (SupportHandler))
...
DEFINE_GUIDSTRUCT("FD0A5AF4-B41D-11d2-9C95-00C04F7971E0",
                  KSCATEGORY_BDA_RECEIVER_COMPONENT);
#define KSCATEGORY_BDA_RECEIVER_COMPONENT                                      \
...
DEFINE_GUIDSTRUCT("71985F48-1CA1-11d3-9CC8-00C04F7971E0",
                  KSCATEGORY_BDA_NETWORK_TUNER);
#define KSCATEGORY_BDA_NETWORK_TUNER                                           \
...
DEFINE_GUIDSTRUCT("71985F49-1CA1-11d3-9CC8-00C04F7971E0",
...
DEFINE_GUIDSTRUCT("71985F4A-1CA1-11d3-9CC8-00C04F7971E0",
...
DEFINE_GUIDSTRUCT("71985F4B-1CA1-11d3-9CC8-00C04F7971E0",
                  KSCATEGORY_BDA_NETWORK_PROVIDER);
#define KSCATEGORY_BDA_NETWORK_PROVIDER                                        \
...
DEFINE_GUIDSTRUCT("A2E3074F-6C3D-11d3-B653-00C04F79498E",
                  KSCATEGORY_BDA_TRANSPORT_INFORMATION);
#define KSCATEGORY_BDA_TRANSPORT_INFORMATION                                   \
...
DEFINE_GUIDSTRUCT("71985F4D-1CA1-11d3-9CC8-00C04F7971E0",
...
DEFINE_GUIDSTRUCT("6390C905-27C1-4d67-BDB7-77C50D079300",
                  KSNODE_BDA_QPSK_DEMODULATOR);
#define KSNODE_BDA_QPSK_DEMODULATOR                                            \
...
DEFINE_GUIDSTRUCT("71985F4F-1CA1-11d3-9CC8-00C04F7971E0",
                  KSNODE_BDA_8VSB_DEMODULATOR);
#define KSNODE_BDA_8VSB_DEMODULATOR                                            \
...
DEFINE_GUIDSTRUCT("2DAC6E05-EDBE-4b9c-B387-1B6FAD7D6495",
...
DEFINE_GUIDSTRUCT("D83EF8FC-F3B8-45ab-8B71-ECF7C339DEB4",
...
DEFINE_GUIDSTRUCT("F5412789-B0A0-44e1-AE4F-EE999B1B7FBE",
...
DEFINE_GUIDSTRUCT("e25f7b8e-cccc-11d2-8f25-00c04f7971e2",
...
DEFINE_GUIDSTRUCT("5a9a213c-db08-11d2-8f32-00c04f7971e2",
                  KSDATAFORMAT_SUBTYPE_BDA_IP);
#define KSDATAFORMAT_SUBTYPE_BDA_IP                                            \
...
DEFINE_GUIDSTRUCT("6B891420-DB09-11d2-8F32-00C04F7971E2",
                  KSDATAFORMAT_SPECIFIER_BDA_IP);
#define KSDATAFORMAT_SPECIFIER_BDA_IP                                          \
...
DEFINE_GUIDSTRUCT("DADD5799-7D5B-4b63-80FB-D1442F26B621",
                  KSDATAFORMAT_TYPE_BDA_IP_CONTROL);
#define KSDATAFORMAT_TYPE_BDA_IP_CONTROL                                       \
...
DEFINE_GUIDSTRUCT("499856E8-E85B-48ed-9BEA-410D0DD4EF81",
                  KSDATAFORMAT_SUBTYPE_BDA_IP_CONTROL);
#define KSDATAFORMAT_SUBTYPE_BDA_IP_CONTROL                                    \
