...
#define IAMPlayListItem_GetSourceStartMarkerName(This, dwSourceIndex,          \
                                                 pbstrStartMarker)             \
  (This)->lpVtbl->GetSourceStartMarkerName(This, dwSourceIndex,                \
                                           pbstrStartMarker)

#define IAMPlayListItem_GetSourceEndMarkerName(This, dwSourceIndex,            \
                                               pbstrEndMarker)                 \
...
IAMPlayListItem_GetFlags_Proxy(IAMPlayListItem __RPC_FAR *This,
                               /* [out] */ DWORD __RPC_FAR *pdwFlags);
...
HRESULT STDMETHODCALLTYPE
IAMPlayListItem_GetSourceCount_Proxy(IAMPlayListItem __RPC_FAR *This,
                                     /* [out] */ DWORD __RPC_FAR *pdwSources);
...
HRESULT STDMETHODCALLTYPE
IAMPlayListItem_GetSourceURL_Proxy(IAMPlayListItem __RPC_FAR *This,
                                   /* [in] */ DWORD dwSourceIndex,
                                   /* [out] */ BSTR __RPC_FAR *pbstrURL);
...
HRESULT STDMETHODCALLTYPE
IAMPlayListItem_GetLinkURL_Proxy(IAMPlayListItem __RPC_FAR *This,
                                 /* [out] */ BSTR __RPC_FAR *pbstrURL);
...
interface IAMPlayList { CONST_VTBL struct IAMPlayListVtbl __RPC_FAR *lpVtbl; };
...
#define IAMPlayList_GetNamedEvent(This, pwszEventName, dwItemIndex, ppItem,    \
                                  pdwFlags)                                    \
  (This)->lpVtbl->GetNamedEvent(This, pwszEventName, dwItemIndex, ppItem,      \
                                pdwFlags)

#define IAMPlayList_GetRepeatInfo(This, pdwRepeatCount, pdwRepeatStart,        \
                                  pdwRepeatEnd)                                \
  (This)->lpVtbl->GetRepeatInfo(This, pdwRepeatCount, pdwRepeatStart,          \
                                pdwRepeatEnd)
...
HRESULT STDMETHODCALLTYPE
IAMPlayList_GetFlags_Proxy(IAMPlayList __RPC_FAR *This,
                           /* [out] */ DWORD __RPC_FAR *pdwFlags);

void __RPC_STUB IAMPlayList_GetFlags_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);

HRESULT STDMETHODCALLTYPE
IAMPlayList_GetItemCount_Proxy(IAMPlayList __RPC_FAR *This,
                               /* [out] */ DWORD __RPC_FAR *pdwItems);
...
void __RPC_STUB IAMPlayList_GetItem_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE
IAMPlayList_GetRepeatInfo_Proxy(IAMPlayList __RPC_FAR *This,
                                /* [out] */ DWORD __RPC_FAR *pdwRepeatCount,
                                /* [out] */ DWORD __RPC_FAR *pdwRepeatStart,
                                /* [out] */ DWORD __RPC_FAR *pdwRepeatEnd);
...
HRESULT STDMETHODCALLTYPE
ISpecifyParticularPages_GetPages_Proxy(ISpecifyParticularPages __RPC_FAR *This,
                                       /* [in] */ REFGUID guidWhatPages,
                                       /* [out] */ CAUUID __RPC_FAR *pPages);
...
interface IAMRebuild { CONST_VTBL struct IAMRebuildVtbl __RPC_FAR *lpVtbl; };
...
HRESULT STDMETHODCALLTYPE
IAMRebuild_RebuildNow_Proxy(IAMRebuild __RPC_FAR *This);
...
EXTERN_GUID(IID_IAMPlayListItem, 0x56a868ff, 0x0ad4, 0x11ce, 0xb0, 0xa3, 0x0,
            0x20, 0xaf, 0x0b, 0xa7, 0x70);
EXTERN_GUID(IID_IAMRebuild, 0x2ef04dd, 0x7580, 0x11d1, 0xbe, 0xce, 0x0, 0xc0,
            0x4f, 0xb6, 0xe9, 0x37);
EXTERN_GUID(IID_IAMPlayList, 0x56a868fe, 0x0ad4, 0x11ce, 0xb0, 0xa3, 0x0, 0x20,
            0xaf, 0x0b, 0xa7, 0x70);
EXTERN_GUID(SPECIFYPAGES_STATISTICS, 0x4c437b92, 0x6e9e, 0x11d1, 0xa7, 0x4, 0x0,
            0x60, 0x97, 0xc4, 0xe4, 0x76);
EXTERN_GUID(IID_ISpecifyParticularPages, 0x4c437b91, 0x6e9e, 0x11d1, 0xa7, 0x4,
            0x0, 0x60, 0x97, 0xc4, 0xe4, 0x76);
