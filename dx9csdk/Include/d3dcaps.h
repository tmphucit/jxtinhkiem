...
typedef HRESULT(CALLBACK *LPD3DENUMDEVICESCALLBACK)(GUID FAR *lpGuid,
...
#if (DIRECT3D_VERSION >= 0x0700)
typedef HRESULT(CALLBACK *LPD3DENUMDEVICESCALLBACK7)(LPSTR lpDeviceDescription,
                                                     LPSTR lpDeviceName,
...
#define D3DDD_DEVICERENDERBITDEPTH                                             \
  0x00000080L /* dwDeviceRenderBitDepth is valid */
#define D3DDD_DEVICEZBUFFERBITDEPTH                                            \
  0x00000100L                            /* dwDeviceZBufferBitDepth is valid */
...
#define D3DFDS_TEXTUREFILTERCAPS                                               \
  0x00002000L /* Match primCaps.dwTextureFilterCaps */
#define D3DFDS_TEXTUREBLENDCAPS                                                \
  0x00004000L /* Match primCaps.dwTextureBlendCaps */
#define D3DFDS_TEXTUREADDRESSCAPS                                              \
  0x00008000L /* Match primCaps.dwTextureBlendCaps */
...
typedef struct _D3DDEVINFO_TEXTUREMANAGER {
  ...
  DWORD dwApproxBytesDownloaded; /* Approximate number of bytes downloaded by
                                    texture manager */
