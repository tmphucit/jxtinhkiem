...
#pragma message(                                                               \
    __FILE__ ": DIRECTINPUT_VERSION undefined. Defaulting to version 0x0800")
#endif
...
DECLARE_INTERFACE_(IDirectInputDeviceW, IUnknown) {
  ...
  (THIS_ LPDIENUMDEVICEOBJECTSCALLBACKW, LPVOID, DWORD) PURE;
  ...
  (THIS_ DWORD, LPDIDEVICEOBJECTDATA, LPDWORD, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInputDeviceA, IUnknown) {
  ...
  STDMETHOD(GetCapabilities)(THIS_ LPDIDEVCAPS) PURE;
  STDMETHOD(EnumObjects)
  (THIS_ LPDIENUMDEVICEOBJECTSCALLBACKA, LPVOID, DWORD) PURE;
  STDMETHOD(GetProperty)(THIS_ REFGUID, LPDIPROPHEADER) PURE;
  STDMETHOD(SetProperty)(THIS_ REFGUID, LPCDIPROPHEADER) PURE;
  STDMETHOD(Acquire)(THIS) PURE;
  STDMETHOD(Unacquire)(THIS) PURE;
...
#endif // !UNICODE
typedef BOOL(FAR PASCAL *LPDIENUMCREATEDEFFECTOBJECTSCALLBACK)(
...
DECLARE_INTERFACE_(IDirectInputDevice2W, IDirectInputDeviceW) {
  ...
  (THIS_ REFGUID, LPCDIEFFECT, LPDIRECTINPUTEFFECT *, LPUNKNOWN) PURE;
  ...
  (THIS_ LPDIENUMCREATEDEFFECTOBJECTSCALLBACK, LPVOID, DWORD) PURE;
  STDMETHOD(Escape)(THIS_ LPDIEFFESCAPE) PURE;
  STDMETHOD(Poll)(THIS) PURE;
  STDMETHOD(SendDeviceData)
  (THIS_ DWORD, LPCDIDEVICEOBJECTDATA, LPDWORD, DWORD) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice7W, IDirectInputDevice2W) {
  ...
  (THIS_ LPCWSTR, LPDIENUMEFFECTSINFILECALLBACK, LPVOID, DWORD) PURE;
  STDMETHOD(WriteEffectToFile)
  (THIS_ LPCWSTR, DWORD, LPDIFILEEFFECT, DWORD) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice7A, IDirectInputDevice2A) {
  ...
  STDMETHOD(EnumEffectsInFile)
  (THIS_ LPCSTR, LPDIENUMEFFECTSINFILECALLBACK, LPVOID, DWORD) PURE;
...
#define DIK_PREVTRACK                                                          \
  0x90              /* Previous Track (DIK_CIRCUMFLEX on Japanese keyboard) */
...
typedef BOOL(FAR PASCAL *LPDIENUMDEVICESCALLBACKA)(LPCDIDEVICEINSTANCEA,
                                                   LPVOID);
typedef BOOL(FAR PASCAL *LPDIENUMDEVICESCALLBACKW)(LPCDIDEVICEINSTANCEW,
                                                   LPVOID);
#ifdef UNICODE
...
#if (DIRECTINPUT_VERSION >= 0x0800)
typedef BOOL(FAR PASCAL *LPDIENUMDEVICESBYSEMANTICSCBA)(LPCDIDEVICEINSTANCEA,
                                                        LPDIRECTINPUTDEVICE8A,
                                                        DWORD, DWORD, LPVOID);
typedef BOOL(FAR PASCAL *LPDIENUMDEVICESBYSEMANTICSCBW)(LPCDIDEVICEINSTANCEW,
...
DECLARE_INTERFACE_(IDirectInputW, IUnknown) {
  ...
  (THIS_ REFGUID, LPDIRECTINPUTDEVICEW *, LPUNKNOWN) PURE;
  STDMETHOD(EnumDevices)
  (THIS_ DWORD, LPDIENUMDEVICESCALLBACKW, LPVOID, DWORD) PURE;
...
DECLARE_INTERFACE_(IDirectInputA, IUnknown) {
  ...
  STDMETHOD(CreateDevice)
  (THIS_ REFGUID, LPDIRECTINPUTDEVICEA *, LPUNKNOWN) PURE;
  STDMETHOD(EnumDevices)
  (THIS_ DWORD, LPDIENUMDEVICESCALLBACKA, LPVOID, DWORD) PURE;
  STDMETHOD(GetDeviceStatus)(THIS_ REFGUID) PURE;
  STDMETHOD(RunControlPanel)(THIS_ HWND, DWORD) PURE;
  STDMETHOD(Initialize)(THIS_ HINSTANCE, DWORD) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown) {
  ...
  STDMETHOD(CreateDevice)
  (THIS_ REFGUID, LPDIRECTINPUTDEVICE8W *, LPUNKNOWN) PURE;
  STDMETHOD(EnumDevices)
  (THIS_ DWORD, LPDIENUMDEVICESCALLBACKW, LPVOID, DWORD) PURE;
  STDMETHOD(GetDeviceStatus)(THIS_ REFGUID) PURE;
  STDMETHOD(RunControlPanel)(THIS_ HWND, DWORD) PURE;
  ...
  (THIS_ LPCWSTR, LPDIACTIONFORMATW, LPDIENUMDEVICESBYSEMANTICSCBW, LPVOID,
   DWORD) PURE;
  STDMETHOD(ConfigureDevices)
  (THIS_ LPDICONFIGUREDEVICESCALLBACK, LPDICONFIGUREDEVICESPARAMSW, DWORD,
   LPVOID) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8A, IUnknown) {
  ...
  STDMETHOD(CreateDevice)
  (THIS_ REFGUID, LPDIRECTINPUTDEVICE8A *, LPUNKNOWN) PURE;
  STDMETHOD(EnumDevices)
  (THIS_ DWORD, LPDIENUMDEVICESCALLBACKA, LPVOID, DWORD) PURE;
  STDMETHOD(GetDeviceStatus)(THIS_ REFGUID) PURE;
  STDMETHOD(RunControlPanel)(THIS_ HWND, DWORD) PURE;
  ...
  STDMETHOD(FindDevice)(THIS_ REFGUID, LPCSTR, LPGUID) PURE;
  STDMETHOD(EnumDevicesBySemantics)
  (THIS_ LPCSTR, LPDIACTIONFORMATA, LPDIENUMDEVICESBYSEMANTICSCBA, LPVOID,
   DWORD) PURE;
  STDMETHOD(ConfigureDevices)
  (THIS_ LPDICONFIGUREDEVICESCALLBACK, LPDICONFIGUREDEVICESPARAMSA, DWORD,
   LPVOID) PURE;
};
...
extern HRESULT WINAPI DirectInput8Create(HINSTANCE hinst, DWORD dwVersion,
...
extern HRESULT WINAPI DirectInputCreateEx(HINSTANCE hinst, DWORD dwVersion,
                                          REFIID riidltf, LPVOID *ppvOut,
                                          LPUNKNOWN punkOuter);
...
#define DIMOUSE_XAXISAB                                                        \
  (0x82000200 | DIMOFS_X) /* X Axis-absolute: Some mice natively report        \
                             absolute coordinates  */
#define DIMOUSE_YAXISAB                                                        \
  (0x82000200 | DIMOFS_Y) /* Y Axis-absolute: Some mice natively report        \
                             absolute coordinates */
...
#define DIBUTTON_DRIVINGR_DASHBOARD                                            \
  0x01004405                               /* Select next dashboard option */
...
#define DIBUTTON_DRIVINGR_ACCELERATE_LINK                                      \
  0x0103D4E0 /* Fallback Accelerate button */
#define DIBUTTON_DRIVINGR_STEER_LEFT_LINK                                      \
  0x0100CCE4 /* Fallback Steer Left button */
#define DIBUTTON_DRIVINGR_STEER_RIGHT_LINK                                     \
  0x0100CCEC /* Fallback Steer Right button */
...
#define DIBUTTON_DRIVINGC_DASHBOARD                                            \
...
#define DIBUTTON_DRIVINGC_STEER_LEFT_LINK                                      \
  0x0200CCE4 /* Fallback Steer Left button */
#define DIBUTTON_DRIVINGC_STEER_RIGHT_LINK                                     \
  0x0200CCEC /* Fallback Steer Right button */
...
#define DIBUTTON_DRIVINGT_STEER_LEFT_LINK                                      \
  0x0300CCE4 /* Fallback Steer Left button */
#define DIBUTTON_DRIVINGT_STEER_RIGHT_LINK                                     \
  0x0300CCEC /* Fallback Steer Right button */
#define DIBUTTON_DRIVINGT_BARREL_UP_LINK                                       \
  0x030144E0 /* Fallback Barrel up button */
#define DIBUTTON_DRIVINGT_BARREL_DOWN_LINK                                     \
  0x030144E8 /* Fallback Barrel down button */
#define DIBUTTON_DRIVINGT_ROTATE_LEFT_LINK                                     \
  0x030244E4 /* Fallback Rotate left button */
#define DIBUTTON_DRIVINGT_ROTATE_RIGHT_LINK                                    \
  0x030244EC /* Fallback Rotate right button */
...
#define DIBUTTON_FLYINGC_DISPLAY                                               \
  0x04002402 /* Select next dashboard / heads up display option */
...
#define DIBUTTON_FLYINGC_FLAPSUP                                               \
  0x04006404 /* Increment stepping up until fully retracted */
#define DIBUTTON_FLYINGC_FLAPSDOWN                                             \
  0x04006405 /* Decrement stepping down until fully extended */
#define DIBUTTON_FLYINGC_BRAKE_LINK 0x04046CE0 /* Fallback brake button */
#define DIBUTTON_FLYINGC_FASTER_LINK                                           \
  0x0403D4E0 /* Fallback throttle up button */
#define DIBUTTON_FLYINGC_SLOWER_LINK                                           \
  0x0403D4E8 /* Fallback throttle down button */
#define DIBUTTON_FLYINGC_GLANCE_LEFT_LINK                                      \
  0x0407C4E4 /* Fallback Glance Left button */
#define DIBUTTON_FLYINGC_GLANCE_RIGHT_LINK                                     \
  0x0407C4EC /* Fallback Glance Right button */
...
#define DIBUTTON_FLYINGM_FLAPSUP                                               \
...
#define DIBUTTON_FLYINGM_SLOWER_LINK                                           \
  0x0503D4E8 /* Fallback throttle down button */
#define DIBUTTON_FLYINGM_GLANCE_LEFT_LINK                                      \
  0x0507C4E4 /* Fallback Glance Left button */
#define DIBUTTON_FLYINGM_GLANCE_RIGHT_LINK                                     \
  0x0507C4EC /* Fallback Glance Right button */
...
#define DIAXIS_FLYINGH_COLLECTIVE                                              \
  0x06018A03                                /* Collective - Blade pitch/power */
...
#define DIAXIS_FLYINGH_TORQUE                                                  \
  0x06025A04 /* Torque - Rotate ship around left / right axis */
...
#define DIBUTTON_FLYINGH_SLOWER_LINK                                           \
  0x0603DCE8 /* Fallback throttle down button */
#define DIBUTTON_FLYINGH_GLANCE_LEFT_LINK                                      \
  0x0607C4E4 /* Fallback Glance Left button */
#define DIBUTTON_FLYINGH_GLANCE_RIGHT_LINK                                     \
  0x0607C4EC /* Fallback Glance Right button */
...
#define DIBUTTON_SPACESIM_DISPLAY                                              \
  0x07004405 /* Select next dashboard / heads up display option */
#define DIBUTTON_SPACESIM_RAISE                                                \
...
#define DIBUTTON_SPACESIM_BACKWARD_LINK                                        \
  0x070144E8 /* Fallback move backwards button */
#define DIBUTTON_SPACESIM_FASTER_LINK                                          \
  0x0703C4E0 /* Fallback throttle up button */
#define DIBUTTON_SPACESIM_SLOWER_LINK                                          \
  0x0703C4E8 /* Fallback throttle down button */
#define DIBUTTON_SPACESIM_TURN_LEFT_LINK                                       \
  0x070244E4 /* Fallback turn left button */
#define DIBUTTON_SPACESIM_TURN_RIGHT_LINK                                      \
  0x070244EC /* Fallback turn right button */
#define DIBUTTON_SPACESIM_GLANCE_LEFT_LINK                                     \
  0x0707C4E4 /* Fallback Glance Left button */
#define DIBUTTON_SPACESIM_GLANCE_RIGHT_LINK                                    \
  0x0707C4EC /* Fallback Glance Right button */
...
#define DIBUTTON_FIGHTINGH_DEVICE                                              \
  0x080044FE                                /* Show input device and controls */
...
#define DIBUTTON_FPS_DISPLAY                                                   \
  0x09004408 /* Shows next on-screen display option/ map */
...
#define DIBUTTON_FPS_ROTATE_LEFT_LINK                                          \
  0x0900C4E4 /* Fallback rotate left button */
#define DIBUTTON_FPS_ROTATE_RIGHT_LINK                                         \
...
#define DIBUTTON_STRATEGYR_DISPLAY                                             \
  0x0B004409 /* Shows next on-screen display option */
#define DIAXIS_STRATEGYR_ROTATE 0x0B024203 /* Turn body left/right */
#define DIBUTTON_STRATEGYR_LEFT_LINK                                           \
  0x0B00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_STRATEGYR_RIGHT_LINK                                          \
  0x0B00C4EC /* Fallback sidestep right button */
#define DIBUTTON_STRATEGYR_FORWARD_LINK                                        \
  0x0B0144E0 /* Fallback move forward button */
#define DIBUTTON_STRATEGYR_BACK_LINK                                           \
  0x0B0144E8 /* Fallback move backward button */
#define DIBUTTON_STRATEGYR_ROTATE_LEFT_LINK                                    \
  0x0B0244E4 /* Fallback turn body left button */
#define DIBUTTON_STRATEGYR_ROTATE_RIGHT_LINK                                   \
  0x0B0244EC /* Fallback turn body right button */
#define DIBUTTON_STRATEGYR_DEVICE                                              \
  0x0B0044FE                                /* Show input device and controls */
...
#define DIBUTTON_STRATEGYT_DISPLAY                                             \
  0x0C004408 /* shows next on-screen display options */
#define DIBUTTON_STRATEGYT_LEFT_LINK                                           \
  0x0C00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_STRATEGYT_RIGHT_LINK                                          \
...
#define DIBUTTON_HUNTING_DISPLAY                                               \
  0x0D004408 /* show next on-screen display option */
...
#define DIBUTTON_HUNTING_RIGHT_LINK                                            \
  0x0D00C4EC /* Fallback sidestep right button */
#define DIBUTTON_HUNTING_FORWARD_LINK                                          \
  0x0D0144E0                                  /* Fallback move forward button */
...
#define DIBUTTON_FISHING_DISPLAY                                               \
  0x0E004406 /* Show next on-screen display option */
...
#define DIBUTTON_FISHING_LEFT_LINK                                             \
  0x0E00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_FISHING_RIGHT_LINK                                            \
  0x0E00C4EC /* Fallback sidestep right button */
#define DIBUTTON_FISHING_FORWARD_LINK                                          \
  0x0E0144E0                                  /* Fallback move forward button */
...
#define DIBUTTON_BASEBALLB_STEAL                                               \
  0x0F000405 /* Base runner attempts to steal a base */
#define DIBUTTON_BASEBALLB_BURST                                               \
  0x0F000406 /* Base runner invokes burst of speed */
...
#define DIBUTTON_BASEBALLB_NOSTEAL                                             \
  0x0F004409                              /* Base runner goes back to a base */
#define DIBUTTON_BASEBALLB_BOX 0x0F00440A /* Enter or exit batting box */
#define DIBUTTON_BASEBALLB_LEFT_LINK                                           \
  0x0F00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_BASEBALLB_RIGHT_LINK                                          \
...
#define DIBUTTON_BASEBALLP_SELECT                                              \
  0x10000401                                /* cycle through pitch selections */
...
#define DIBUTTON_BASEBALLP_WALK                                                \
  0x10004406 /* Throw intentional walk / pitch out */
#define DIBUTTON_BASEBALLP_LOOK 0x10004407 /* Look at runners on bases */
#define DIBUTTON_BASEBALLP_LEFT_LINK                                           \
  0x1000C4E4 /* Fallback sidestep left button */
#define DIBUTTON_BASEBALLP_RIGHT_LINK                                          \
...
#define DIBUTTON_BASEBALLF_NEAREST                                             \
  0x11000401 /* Switch to fielder nearest to the ball */
...
#define DIBUTTON_BASEBALLF_SHIFTIN                                             \
  0x11004407 /* Shift the infield positioning */
#define DIBUTTON_BASEBALLF_SHIFTOUT                                            \
  0x11004408 /* Shift the outfield positioning */
#define DIBUTTON_BASEBALLF_AIM_LEFT_LINK                                       \
  0x1100C4E4 /* Fallback aim left button */
#define DIBUTTON_BASEBALLF_AIM_RIGHT_LINK                                      \
...
#define DIBUTTON_BBALLO_FORWARD_LINK                                           \
  0x120144E0                                 /* Fallback move forward button */
...
#define DIBUTTON_BBALLD_FORWARD_LINK                                           \
  0x130144E0                                 /* Fallback move forward button */
...
#define DIBUTTON_FOOTBALLP_DEVICE                                              \
  0x140044FE                                /* Show input device and controls */
...
#define DIBUTTON_FOOTBALLQ_AUDIBLE                                             \
  0x15004409 /* Change offensive play at line of scrimmage */
#define DIBUTTON_FOOTBALLQ_LEFT_LINK                                           \
  0x1500C4E4 /* Fallback sidestep left button */
#define DIBUTTON_FOOTBALLQ_RIGHT_LINK                                          \
...
#define DIBUTTON_FOOTBALLO_THROW                                               \
  0x16000404 /* throw pass or lateral ball to another runner */
...
#define DIBUTTON_FOOTBALLO_JUKE                                                \
  0x16004406 /* Use special move to avoid defenders */
#define DIBUTTON_FOOTBALLO_SHOULDER                                            \
  0x16004407 /* Lower shoulder to run over defenders */
...
#define DIBUTTON_FOOTBALLO_SUBSTITUTE                                          \
  0x1600440B /* substitute one player for another */
#define DIBUTTON_FOOTBALLO_LEFT_LINK                                           \
  0x1600C4E4 /* Fallback sidestep left button */
#define DIBUTTON_FOOTBALLO_RIGHT_LINK                                          \
...
#define DIBUTTON_FOOTBALLD_SELECT                                              \
  0x17000402 /* select player closest to the ball */
...
#define DIBUTTON_FOOTBALLD_AUDIBLE                                             \
  0x1700440B /* Change defensive play at the line of scrimmage */
#define DIBUTTON_FOOTBALLD_ZOOM 0x1700440C /* Zoom view in / out */
#define DIBUTTON_FOOTBALLD_SUBSTITUTE                                          \
  0x1700440D /* substitute one player for another */
#define DIBUTTON_FOOTBALLD_LEFT_LINK                                           \
  0x1700C4E4 /* Fallback sidestep left button */
#define DIBUTTON_FOOTBALLD_RIGHT_LINK                                          \
...
#define DIBUTTON_HOCKEYO_STRATEGY                                              \
  0x19004407 /* Invoke coaching menu for strategy help */
#define DIBUTTON_HOCKEYO_TIMEOUT 0x19004408 /* Call for time out */
#define DIBUTTON_HOCKEYO_SUBSTITUTE                                            \
  0x19004409 /* substitute one player for another */
#define DIBUTTON_HOCKEYO_LEFT_LINK                                             \
  0x1900C4E4 /* Fallback sidestep left button */
#define DIBUTTON_HOCKEYO_RIGHT_LINK                                            \
  0x1900C4EC /* Fallback sidestep right button */
...
#define DIBUTTON_HOCKEYD_PLAYER                                                \
  0x1A000401 /* control player closest to the puck */
...
#define DIBUTTON_HOCKEYD_FAKE                                                  \
  0x1A000405 /* hold down to fake tackle or intercept */
...
#define DIBUTTON_HOCKEYD_STRATEGY                                              \
  0x1A004407 /* Invoke coaching menu for strategy help */
#define DIBUTTON_HOCKEYD_TIMEOUT 0x1A004408 /* Call for time out */
#define DIBUTTON_HOCKEYD_SUBSTITUTE                                            \
  0x1A004409 /* substitute one player for another */
#define DIBUTTON_HOCKEYD_LEFT_LINK                                             \
  0x1A00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_HOCKEYD_RIGHT_LINK                                            \
  0x1A00C4EC /* Fallback sidestep right button */
...
#define DIBUTTON_HOCKEYG_STRATEGY                                              \
  0x1B004406 /* Invoke coaching menu for strategy help */
#define DIBUTTON_HOCKEYG_TIMEOUT 0x1B004407 /* Call for time out */
#define DIBUTTON_HOCKEYG_SUBSTITUTE                                            \
  0x1B004408 /* substitute one player for another */
#define DIBUTTON_HOCKEYG_LEFT_LINK                                             \
  0x1B00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_HOCKEYG_RIGHT_LINK                                            \
  0x1B00C4EC /* Fallback sidestep right button */
...
#define DIBUTTON_SKIING_FASTER_LINK                                            \
  0x1D0144E0 /* Fallback increase speed button */
#define DIBUTTON_SKIING_SLOWER_LINK                                            \
  0x1D0144E8                              /* Fallback decrease speed button */
...
#define DIBUTTON_SOCCERO_SUBSTITUTE                                            \
  0x1E004407 /* Substitute one player for another */
...
#define DIBUTTON_SOCCERO_LEFT_LINK                                             \
  0x1E00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_SOCCERO_RIGHT_LINK                                            \
  0x1E00C4EC /* Fallback sidestep right button */
...
#define DIBUTTON_SOCCERD_CLEAR                                                 \
  0x1F00440A /* Attempt to clear the ball down the field */
#define DIBUTTON_SOCCERD_GOALIECHARGE                                          \
  0x1F00440B /* Make the goalie charge out of the box */
#define DIBUTTON_SOCCERD_SUBSTITUTE                                            \
  0x1F00440C /* Substitute one player for another */
#define DIBUTTON_SOCCERD_LEFT_LINK                                             \
  0x1F00C4E4 /* Fallback sidestep left button */
#define DIBUTTON_SOCCERD_RIGHT_LINK                                            \
  0x1F00C4EC /* Fallback sidestep right button */
...
#define DIBUTTON_RACQUET_SUBSTITUTE                                            \
  0x20004407 /* Substitute one player for another */
#define DIBUTTON_RACQUET_LEFT_LINK                                             \
  0x2000C4E4 /* Fallback sidestep left button */
#define DIBUTTON_RACQUET_RIGHT_LINK                                            \
  0x2000C4EC /* Fallback sidestep right button */
...
#define DIHATSWITCH_ARCADES_VIEW                                               \
  0x21004601 /* scroll view left / right / up / down */
#define DIBUTTON_ARCADES_LEFT_LINK                                             \
  0x2100C4E4 /* Fallback sidestep left button */
#define DIBUTTON_ARCADES_RIGHT_LINK                                            \
  0x2100C4EC /* Fallback sidestep right button */
#define DIBUTTON_ARCADES_FORWARD_LINK                                          \
  0x210144E0                                  /* Fallback move forward button */
#define DIBUTTON_ARCADES_BACK_LINK 0x210144E8 /* Fallback move back button */
#define DIBUTTON_ARCADES_VIEW_UP_LINK                                          \
  0x2107C4E0 /* Fallback scroll view up button */
#define DIBUTTON_ARCADES_VIEW_DOWN_LINK                                        \
  0x2107C4E8 /* Fallback scroll view down button */
#define DIBUTTON_ARCADES_VIEW_LEFT_LINK                                        \
...
#define DIBUTTON_ARCADEP_RIGHT_LINK                                            \
  0x2200C4EC /* Fallback sidestep right button */
#define DIBUTTON_ARCADEP_FORWARD_LINK                                          \
  0x220144E0                                  /* Fallback move forward button */
#define DIBUTTON_ARCADEP_BACK_LINK 0x220144E8 /* Fallback move back button */
#define DIBUTTON_ARCADEP_VIEW_UP_LINK                                          \
  0x2207C4E0 /* Fallback scroll view up button */
#define DIBUTTON_ARCADEP_VIEW_DOWN_LINK                                        \
  0x2207C4E8 /* Fallback scroll view down button */
#define DIBUTTON_ARCADEP_VIEW_LEFT_LINK                                        \
...
#define DIAXIS_2DCONTROL_ROTATEZ                                               \
  0x23024204 /* Rotate view clockwise / counterclockwise */
#define DIBUTTON_2DCONTROL_DISPLAY                                             \
  0x23004405 /* Shows next on-screen display options */
#define DIBUTTON_2DCONTROL_DEVICE                                              \
  0x230044FE                                /* Show input device and controls */
...
#define DIAXIS_3DCONTROL_ROTATEX                                               \
  0x24034204 /* Rotate view forward or up / backward or down */
#define DIAXIS_3DCONTROL_ROTATEY                                               \
  0x2402C205 /* Rotate view clockwise / counterclockwise */
#define DIAXIS_3DCONTROL_ROTATEZ 0x24024206 /* Rotate view left / right */
#define DIBUTTON_3DCONTROL_DISPLAY                                             \
  0x24004405 /* Show next on-screen display options */
#define DIBUTTON_3DCONTROL_DEVICE                                              \
  0x240044FE                                /* Show input device and controls */
...
#define DIAXIS_CADF_ROTATEX                                                    \
  0x25034204 /* Rotate view forward or up / backward or down */
#define DIAXIS_CADF_ROTATEY                                                    \
  0x2502C205 /* Rotate view clockwise / counterclockwise */
#define DIAXIS_CADF_ROTATEZ 0x25024206 /* Rotate view left / right */
#define DIBUTTON_CADF_DISPLAY                                                  \
  0x25004405 /* shows next on-screen display options */
...
#define DIAXIS_CADM_ROTATEX                                                    \
  0x26034204 /* Rotate view forward or up / backward or down */
#define DIAXIS_CADM_ROTATEY                                                    \
  0x2602C205 /* Rotate view clockwise / counterclockwise */
#define DIAXIS_CADM_ROTATEZ 0x26024206 /* Rotate view left / right */
#define DIBUTTON_CADM_DISPLAY                                                  \
  0x26004405 /* shows next on-screen display options */
...
#define DIAXIS_REMOTE_SLIDER                                                   \
  0x27050201 /* Slider for adjustment: volume / color / bass / etc */
#define DIBUTTON_REMOTE_MUTE                                                   \
  0x27000401 /* Set volume on current device to zero */
#define DIBUTTON_REMOTE_SELECT                                                 \
  0x27000402 /* Next/previous: channel/ track / chapter / picture / station */
#define DIBUTTON_REMOTE_PLAY                                                   \
  0x27002403 /* Start or pause entertainment on current device */
...
#define DIBUTTON_REMOTE_RECORD                                                 \
  0x27002407                            /* Start recording the current media */
...
#define DIBUTTON_BROWSER_FAVORITES                                             \
  0x28004406                                 /* Mark current site as favorite */
...
#define DIBUTTON_MECHA_TARGET                                                  \
  0x29000403 /* Select closest enemy available target */
#define DIBUTTON_MECHA_REVERSE                                                 \
  0x29000404                           /* Toggles throttle in/out of reverse */
...
#define DIBUTTON_MECHA_FORWARD_LINK                                            \
  0x290144E0 /* Fallback tilt torso forward button */
#define DIBUTTON_MECHA_BACK_LINK                                               \
  0x290144E8 /* Fallback tilt toroso backward button */
#define DIBUTTON_MECHA_ROTATE_LEFT_LINK                                        \
  0x290244E4 /* Fallback rotate toroso right button */
#define DIBUTTON_MECHA_ROTATE_RIGHT_LINK                                       \
  0x290244EC /* Fallback rotate torso left button */
#define DIBUTTON_MECHA_FASTER_LINK                                             \
  0x2903C4E0 /* Fallback increase engine speed */
#define DIBUTTON_MECHA_SLOWER_LINK                                             \
  0x2903C4E8                             /* Fallback decrease engine speed */
